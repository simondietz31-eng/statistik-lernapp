const VERTRIEB_CHAPTER4_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Steigt die Tiefe des Vertriebssystems mit der Anzahl paralleler Partner auf einer Stufe?", correctAnswer: false, reasons: ["Nein, weil die Tiefe die Anzahl aufeinanderfolgender Vertriebsstufen beschreibt, nicht die Zahl paralleler Partner.", "Ja, weil mehr parallele Partner automatisch mehr Vertriebsstufen bedeuten.", "Nein, weil die Tiefe ausschließlich von der Kundenzahl abhängt.", "Ja, weil Tiefe und Breite im Vertriebssystem synonym verwendete Begriffe sind."], correctReasonIndex: 0, explanation: "Die Tiefe beschreibt die Anzahl aufeinanderfolgender Vertriebsstufen (nullstufig, einstufig, mehrstufig); die Anzahl paralleler Partner auf einer Stufe ist dagegen die Breite - beide Dimensionen sind klar zu trennen." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Erwirbt ein Handelsvertreter Eigentum am vertriebenen Produkt?", correctAnswer: false, reasons: ["Nein, weil der Handelsvertreter als Absatzhelfer kein Eigentum am Produkt erwirbt.", "Ja, weil alle unternehmensexternen Vertriebsorgane Eigentum am Produkt erwerben.", "Nein, weil der Handelsvertreter kein selbstständiges Organ ist.", "Ja, weil Absatzhelfer und Absatzmittler rechtlich identisch definiert sind."], correctReasonIndex: 0, explanation: "Der Handelsvertreter zählt zu den Absatzhelfern, die im Unterschied zu Absatzmittlern wie Großhandel und Einzelhandel kein Eigentum am Produkt erwerben, sondern nur vermitteln." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Beruht Expertenmacht auf vertraglich zugesicherten Kontrollrechten?", correctAnswer: false, reasons: ["Nein, weil Expertenmacht auf überlegenem Fachwissen beruht, nicht auf vertraglichen Kontrollrechten.", "Ja, weil Experten stets auch vertragliche Kontrollrechte gegenüber ihren Partnern besitzen.", "Nein, weil Expertenmacht ausschließlich auf Markenprestige beruht.", "Ja, weil Legitimationsmacht und Expertenmacht in der Vorlesung identisch definiert werden."], correctReasonIndex: 0, explanation: "Expertenmacht beruht auf überlegenem Fachwissen, etwa Technologie- oder Marktkenntnis; vertraglich zugesicherte Kontrollrechte sind dagegen das Merkmal der Legitimationsmacht." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Führt eine Gliederung nach Kunden typischerweise zu geringerem produktspezifischem Wissen?", correctAnswer: true, reasons: ["Ja, weil bei kundenbezogener Gliederung der Fokus auf der ganzheitlichen Kundenbeziehung liegt, wodurch Produktwissen zurücktritt.", "Nein, weil kundenbezogene Gliederung automatisch das höchste Produktwissen erzeugt.", "Ja, weil bei kundenbezogener Gliederung grundsätzlich keine Vertriebsmitarbeiter Produkte verkaufen dürfen.", "Nein, weil das Produktwissen bei jedem Gliederungsprinzip laut Vorlesung identisch hoch ausfällt."], correctReasonIndex: 0, explanation: "Die Gliederung nach Kunden bringt laut Vorlesung als Nachteil kaum spezifisches Produktwissen mit sich, da der Fokus auf der ganzheitlichen Kundenbeziehung statt auf einzelnen Produkten liegt - das ist gerade die Stärke der produktbezogenen Gliederung." },
