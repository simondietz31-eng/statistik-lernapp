  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        solution: "Der Kommissionär handelt im eigenen Namen (der Kunde muss nicht wissen, wer wirklich hinter dem Geschäft steht), aber auf fremde Rechnung (das wirtschaftliche Risiko trägt der Auftraggeber, nicht der Kommissionär selbst). Das entspricht genau der Definition des Kommissionärs im Kommissionsvertrag."
      },
      {
    ...
    exercises: [
      {
        ...
        solution: "Die fünf Gliederungsprinzipien sind: Gliederung nach Produkten, Gliederung nach Regionen, Gliederung nach Absatzkanälen, Gliederung nach Kunden und Gliederung nach Funktionen."
      },
      {
      ...
      },
      {
        ...
        solution: "Die Gliederung nach Kunden ermöglicht eine ganzheitliche Sicht auf den einzelnen Kunden, engere Kundenbeziehungen und eine bessere Unterstützung von Cross-Selling, da ein Verantwortlicher den gesamten Kunden über alle Produkte hinweg betreut. Ihr Nachteil ist kaum spezifisches Produktwissen und eine geringere Anpassung an unternehmensweite Informations- und Controlling-Systeme. Die Gliederung nach Funktionen dagegen fördert den Aufbau von Fachwissen und Expertentum sowie Economies of Scale und höhere Effizienz durch Spezialisierung, hat aber den Nachteil, dass kaum spezifisches Kundenwissen vorhanden ist und innerhalb der funktionalen Abteilung oft noch zusätzliche Spezialisierung nötig wird."
      },
      {
