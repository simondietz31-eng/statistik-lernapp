const BILANZIERUNG_CHAPTER10_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Welche Software wurde in der Vorlesung als Beispiel für die Digitalisierung im externen Rechnungswesen vorgestellt?", options: ["SAP S/4HANA", "Lexware buchhaltung plus", "Microsoft Excel", "DATEV Kanzlei-Rechnungswesen pro"], correctIndex: 1, explanation: "Die Vorlesung präsentiert exemplarisch die Software \"Lexware buchhaltung plus\" anhand von Screenshots und ihres Leistungsumfangs." },
      { id: "q2", question: "Für welche Zielgruppe ist \"Lexware buchhaltung plus\" laut Anbieter insbesondere konzipiert?", options: ["Ausschließlich Großkonzerne", "Ausschließlich Steuerberatungskanzleien", "Freiberufler, Handwerker und Kleinbetriebe", "Ausschließlich Vereine"], correctIndex: 2, explanation: "Der Anbieter bewirbt die Software als \"die einfache und sichere Buchhaltungssoftware für Freiberufler, Handwerker und Kleinbetriebe\"." },
      { id: "q3", question: "Wofür steht ELSTER im Kontext der in der Vorlesung genannten Softwarefunktionen?", options: ["Ein Buchungsschlüssel im SKR03", "Ein spezieller Kontenrahmen für Vereine", "Ein Verfahren zur Bilanzverlängerung", "Elektronische Steuererklärung, u. a. für die elektronische Umsatzsteuer-Voranmeldung"], correctIndex: 3, explanation: "ELSTER ermöglicht laut Funktionsübersicht die elektronische Umsatzsteuer-Voranmeldung gem. § 18 Abs. 1 UStG." },
      { id: "q4", question: "Wozu dient die EHUG-Schnittstelle in der Finanzbuchhaltungssoftware?", options: ["Zur Berechnung der Grunderwerbsteuer", "Zur elektronischen Übermittlung u. a. der E-Bilanz an das Finanzamt", "Ausschließlich zur internen Kostenstellenrechnung", "Zur Verwaltung von Skonto-Fristen"], correctIndex: 1, explanation: "Die EHUG-Schnittstelle sorgt für die elektronische Übermittlung u. a. der E-Bilanz ans Finanzamt." },
      { id: "q5", question: "Was ermöglicht der \"Betriebsprüfer-Modus\" in moderner Buchhaltungssoftware?", options: ["Die automatische Zahlung fälliger Steuerschulden", "Das automatische Löschen alter Buchungen", "Einen speziell für die (digitale) Betriebsprüfung vorgesehenen Zugriff auf die Buchhaltungsdaten", "Die automatische Umstellung auf ein anderes Wirtschaftsjahr"], correctIndex: 2, explanation: "Der Betriebsprüfer-Modus ist auf die Bedürfnisse der (digitalen) Betriebsprüfung zugeschnitten." },
      { id: "q6", question: "Wofür steht ein \"GoBD-Testat\" bei Buchhaltungssoftware?", options: ["Ein Gütesiegel für besonders schnelle Software", "Eine gesetzliche Deckelung des Softwarepreises", "Ein Nachweis über eine ISO-9001-Zertifizierung", "Bestätigung, dass die Software die Grundsätze ordnungsmäßiger elektronischer Buchführung und Aufbewahrung (GoBD) einhält"], correctIndex: 3, explanation: "Ein GoBD-Testat bescheinigt die Einhaltung der Grundsätze zur ordnungsmäßigen Führung und Aufbewahrung von Büchern, Aufzeichnungen und Unterlagen in elektronischer Form sowie zum Datenzugriff." },
      { id: "q7", question: "Auf welche Kontenrahmen bezieht sich unter anderem die beworbene DATEV-Kompatibilität von Fibu-Software wie Lexware buchhaltung plus?", options: ["Einen ausschließlich firmenindividuellen Kontenrahmen ohne Standard", "IFRS-Kontenplan", "SKR 01–04", "US-GAAP-Kontenplan"], correctIndex: 2, explanation: "Die Software bietet mehr als 10 Musterkontenrahmen, u. a. die DATEV-kompatiblen Standardkontenrahmen SKR 01–04." },
      { id: "q8", question: "Was zeigt laut Vorlesung eine Recherche z. B. bei softguide.de zum Suchbegriff \"Fibu\"?", options: ["Dass es aktuell keine Anbieter für Finanzbuchhaltungssoftware gibt", "Dass nur eine einzige Software existiert", "Eine große Zahl an Anbietern/Treffern für Finanzbuchhaltungssoftware am Markt", "Dass Fibu-Software ausschließlich für Großkonzerne verfügbar ist"], correctIndex: 2, explanation: "Der gezeigte Ausschnitt der Suchergebnisse belegt einen breiten Anbietermarkt für Finanzbuchhaltungssoftware." },
      { id: "q9", question: "Wird laut Vorlesung trotz fortschreitender Digitalisierung weiterhin der Mensch bei der Erstellung und Prüfung des Jahresabschlusses benötigt?", options: ["Nein, das übernimmt inzwischen vollständig die Software", "Nein, das übernimmt inzwischen vollständig die Finanzverwaltung", "Diese Frage wird in der Vorlesung nicht thematisiert", "Ja, für fachliche Beurteilungen, Ermessensentscheidungen und die Verantwortung der Abschlussprüfung"], correctIndex: 3, explanation: "Diese Frage wird als Wiederholungs-/Kontrollfrage explizit gestellt; die Antwort lautet, dass der Mensch trotz Digitalisierung weiterhin benötigt wird." },
      { id: "q10", question: "Welche der folgenden Funktionen zählt zu den in der Vorlesung genannten Auswertungsfunktionen moderner Fibu-Software?", options: ["Automatische Gehaltsabrechnung für alle Mitarbeiter", "Verwaltung des unternehmenseigenen Fuhrparks", "Erstellung von Marketingkampagnen", "Business Cockpit mit den wichtigsten Unternehmens-Eckdaten auf einen Blick"], correctIndex: 3, explanation: "Zu den Auswertungsfunktionen zählt u. a. das \"Business Cockpit\", das alle Unternehmens-Eckdaten auf einen Blick zeigt." }
    ]
  }
];
