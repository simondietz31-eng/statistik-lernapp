const NATWISS_CHAPTER16_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "natwiss-ueb-thermo1-q4", question: "Wie ist das Druckverhältnis mit dem Molmassenverhältnis verknüpft (gleicher Tank, gleiche Temperatur)?", options: ["p₁/p₂ = m₁M₂/(m₂M₁), aus pV = (m/M)RT", "p₁/p₂ = M₁/M₂, ohne Berücksichtigung der Massen", "p₁/p₂ = m₁M₁/(m₂M₂), mit falsch zugeordneten Molmassen", "p₁/p₂ = m₁/m₂, ohne Berücksichtigung der Molmassen"], correctIndex: 0, explanation: "Aus pV = (m/M)RT bei gleichem V und T folgt p ∝ m/M, sodass p₁/p₂ = (m₁/M₁)/(m₂/M₂) = m₁M₂/(m₂M₁) gilt. Sowohl die eingefüllte Masse als auch die Molmasse des jeweiligen Gases gehen dabei ein — keine der beiden Größen darf isoliert betrachtet werden." },
      { id: "yn1", type: "yesno", question: "Hängt das Druckverhältnis zweier verschiedener Gase im selben Tank bei gleicher Temperatur nur von der eingefüllten Masse ab, unabhängig von der Molmasse?", correctAnswer: false, reasons: ["Nein, weil p ∝ m/M gilt; bei gleichem Volumen und gleicher Temperatur hängt der Druck von Masse und Molmasse ab.", "Ja, weil der Druck eines idealen Gases laut pV=nRT nur von der Masse und der Temperatur bestimmt wird, nicht von der Molmasse M des Gases.", "Nein, weil der Druck ausschließlich von der Molmasse abhängt, die eingefüllte Masse spielt dabei überhaupt keine Rolle für p.", "Ja, weil sich unterschiedliche Molmassen bei gleicher Temperatur automatisch ausgleichen und keinen Einfluss auf den resultierenden Druck haben."], correctReasonIndex: 0, explanation: "Aus pV = (m/M)RT folgt p ∝ m/M: Bei gleichem Volumen und gleicher Temperatur bestimmt das Verhältnis aus eingefüllter Masse m und Molmasse M des Gases den Druck – ein leichteres Gas (kleines M) erzeugt bei gleicher Masse einen höheren Druck als ein schwereres, da es mehr Mol enthält." },
      { id: "natwiss-ueb-thermo1-q5", question: "Was ist die mittlere kinetische Energie eines einatomigen Gasmoleküls?", options: ["E_kin = 3/2 k_BT, aus drei Translationsfreiheitsgraden", "E_kin = ½k_BT, nur ein Freiheitsgrad", "E_kin = k_BT, nur zwei Freiheitsgrade", "E_kin = 3k_BT, um den Faktor 2 zu groß"], correctIndex: 0, explanation: "Nach dem Gleichverteilungssatz entfällt auf jeden Freiheitsgrad ½k_BT Energie; ein einatomiges Gas hat genau 3 Translationsfreiheitsgrade (x, y, z), sodass E_kin = 3·½k_BT = 3/2 k_BT resultiert. Mehratomige Moleküle mit zusätzlichen Rotationsfreiheitsgraden hätten dementsprechend eine höhere mittlere kinetische Energie." },
      ...
      { id: "natwiss-ueb-thermo1-q7", question: "Bei konstanter Temperatur (isotherm) wird das Volumen eines idealen Gases verdoppelt. Was passiert mit dem Druck?", options: ["Er verdoppelt sich zusammen mit dem Volumen", "Er bleibt trotz Volumenänderung konstant", "Er wird viermal so groß wie zuvor", "Er halbiert sich, gemäß Boyle-Mariotte"], correctIndex: 3, explanation: "Da bei konstanter Temperatur pV = const. gilt (Boyle-Mariotte), folgt aus V₂ = 2V₁ direkt p₂ = p₁·V₁/V₂ = p₁/2 — der Druck halbiert sich genau umgekehrt proportional zur Volumenverdopplung." },
  ...
  },
  {
    ...
    quiz: [
      { id: "natwiss-ueb-thermo2-q1", question: "Was gilt für die innere Energie bei einer isothermen Zustandsänderung eines idealen Gases?", options: ["ΔU = W, als wäre keine Wärme beteiligt", "ΔU = Q, als wäre keine Arbeit beteiligt", "ΔU = 0, da isotherm ΔT = 0 bedeutet", "ΔU = nCᵥΔT > 0, als gäbe es eine Temperaturänderung"], correctIndex: 2, explanation: "Beim idealen Gas hängt die innere Energie U ausschließlich von der Temperatur T ab (U = nCᵥT). Da isotherm gerade ΔT = 0 bedeutet, folgt zwingend ΔU = 0 — unabhängig davon, wie viel Wärme zu- oder Arbeit abgeführt wird." },
      { id: "natwiss-ueb-thermo2-q2", question: "Wie lautet der erste Hauptsatz der Thermodynamik?", options: ["ΔU = W − Q, mit vertauschten Vorzeichen", "ΔU = Q − W_vom_Gas, der 1. Hauptsatz", "Q = W, als gäbe es keine innere Energie", "ΔU = Q + W = 0, als wäre die Summe stets null"], correctIndex: 1, explanation: "In der Techniker-Konvention gilt ΔU = Q − W_vom_Gas: Die zugeführte Wärme erhöht die innere Energie, die vom Gas geleistete Arbeit senkt sie. Äquivalent dazu ist die Physiker-Konvention ΔU = Q + W_am_Gas, bei der die am Gas verrichtete Arbeit positiv eingeht." },
      ...
      { id: "natwiss-ueb-thermo2-q4", question: "Ein Gas wird isochor erwärmt. Welche Arbeit wird dabei geleistet?", options: ["W = nRΔT, die isobare Formel", "W = Q, als wären Arbeit und Wärme identisch", "W = nCᵥΔT, was stattdessen ΔU entspricht", "W = p·ΔV = 0, da isochor ΔV = 0 gilt"], correctIndex: 3, explanation: "Isochor bedeutet konstantes Volumen, ΔV = 0, sodass die Volumenarbeit W = p·ΔV zwangsläufig null ist — die gesamte zugeführte Wärme fließt in diesem Fall vollständig in die innere Energie (Q = ΔU = nCᵥΔT), nicht in mechanische Arbeit." },
      { id: "natwiss-ueb-thermo2-q5", question: "Was ist die Wärmekapazität bei konstantem Druck Cₚ für ein zweiatomiges ideales Gas?", options: ["Cₚ = 3/2 R, der Wert für einatomige Gase", "Cₚ = 5/2 R, was stattdessen Cᵥ entspricht", "Cₚ = 7/2 R, nach der Mayer-Relation Cₚ = Cᵥ + R", "Cₚ = R, ohne Berücksichtigung der Freiheitsgrade"], correctIndex: 2, explanation: "Ein zweiatomiges Gas hat neben 3 Translations- auch 2 Rotationsfreiheitsgrade, sodass Cᵥ = 5/2 R gilt. Über die Mayer-Relation Cₚ = Cᵥ + R ergibt sich daraus Cₚ = 7/2 R — der zusätzliche Term R entsteht durch die bei konstantem Druck zusätzlich geleistete Ausdehnungsarbeit." },
      { id: "natwiss-ueb-thermo2-q6", question: "Wie viel Arbeit leistet ein Gas bei isothermer Expansion von V₁ = 1 m³ auf V₂ = 2 m³ bei T = 300 K (n = 1 mol)?", options: ["W = nRT·ln(2) ≈ 1729 J, mit dem natürlichen Logarithmus", "W = 0, als fände keine Expansion statt", "W = nRT·2 ≈ 4988 J, mit falscher Multiplikation statt Logarithmus", "W = nRT ≈ 2494 J, ohne den Logarithmus-Faktor"], correctIndex: 0, explanation: "Bei isothermer Expansion gilt W = nRT·ln(V₂/V₁) = 1·8,314·300·ln(2) ≈ 2494·0,693 ≈ 1729 J. Der natürliche Logarithmus des Volumenverhältnisses ist dabei entscheidend — eine reine Multiplikation mit dem Faktor 2 oder das Weglassen des Logarithmus führt zu falschen Werten." },
      ...
      { id: "yn1", type: "yesno", question: "Ist die Wärmekapazität bei konstantem Druck Cp für ein Gas stets kleiner als bei konstantem Volumen Cv?", correctAnswer: false, reasons: ["Nein, weil nach der Mayer-Relation Cp = Cv + R stets Cp > Cv gilt.", "Ja, weil bei konstantem Druck weniger Freiheitsgrade zur Energieaufnahme zur Verfügung stehen als bei konstantem Volumen des Gases.", "Nein, weil Cp und Cv bei jedem idealen Gas exakt denselben Wert besitzen, unabhängig von der Prozessführung und der Art der Wärmezufuhr.", "Ja, weil bei konstantem Druck keine Arbeit verrichtet wird und daher insgesamt weniger Wärme pro Kelvin benötigt wird als bei Cv."], correctReasonIndex: 0, explanation: "Die Mayer-Relation Cp − Cv = R zeigt, dass Cp stets um genau R größer ist als Cv: Bei konstantem Druck muss das Gas zusätzlich zur Temperaturerhöhung noch Ausdehnungsarbeit gegen den Umgebungsdruck leisten, wofür mehr Wärme pro Kelvin aufgebracht werden muss als bei konstantem Volumen." },
  ...
  },
  {
    ...
    quiz: [
      { id: "natwiss-ueb-thermo3-q1", question: "Was ist der Wirkungsgrad einer Wärmekraftmaschine?", options: ["η = Q_H/W, mit vertauschtem Zähler und Nenner", "η = Q_C/Q_H, was stattdessen 1 − η entspricht", "η = T_C/T_H, was stattdessen 1 − η_Carnot entspricht", "η = W/Q_H, das Verhältnis von Nutzarbeit zu Wärme"], correctIndex: 3, explanation: "Der Wirkungsgrad ist definiert als das Verhältnis von gewonnener Nutzarbeit zu zugeführter Wärme, η = W/Q_H = (Q_H − Q_C)/Q_H = 1 − Q_C/Q_H. Die Distraktoren verwechseln η entweder mit seinem Kehrwert oder mit dem Komplement 1 − η." },
      ...
      { id: "natwiss-ueb-thermo3-q4", question: "Welche Entropieänderung hat ein reversibler Kreisprozess insgesamt?", options: ["ΔS > 0, wie bei einem irreversiblen Prozess", "ΔS < 0, was dem 2. Hauptsatz widerspräche", "Es hängt ausschließlich von der absoluten Temperatur ab", "ΔS = 0, da Entropie eine Zustandsgröße ist"], correctIndex: 3, explanation: "Da ein Kreisprozess zum Ausgangszustand zurückkehrt und die Entropie eine Zustandsgröße ist, muss die Entropieänderung über einen vollständigen reversiblen Zyklus exakt null sein (ΔS_ges = 0). Bei irreversiblen Kreisprozessen ist dagegen ΔS_ges > 0, niemals negativ, da dies dem zweiten Hauptsatz widerspräche." },
      { id: "yn1", type: "yesno", question: "Kann die Entropie eines abgeschlossenen Systems bei einem irreversiblen Prozess abnehmen?", correctAnswer: false, reasons: ["Nein, weil der 2. Hauptsatz ΔS ≥ 0 fordert; bei irreversiblen Prozessen gilt sogar ΔS > 0, eine Abnahme ist ausgeschlossen.", "Ja, weil sich Entropiezu- und -abnahmen in Teilsystemen bei irreversiblen Prozessen im statistischen Mittel gegenseitig ausgleichen können.", "Nein, weil die Entropie eines abgeschlossenen Systems grundsätzlich konstant bleibt, unabhängig vom betrachteten Prozess.", "Ja, weil Entropie als Zustandsgröße nur bei reversiblen Prozessen überhaupt eine physikalische Bedeutung besitzt."], correctReasonIndex: 0, explanation: "Der 2. Hauptsatz fordert für ein abgeschlossenes System ΔS ≥ 0, wobei die Gleichheit nur bei reversiblen Prozessen gilt; jeder irreversible Prozess erhöht die Entropie strikt (ΔS > 0), eine Abnahme ist demnach physikalisch ausgeschlossen." },
      { id: "natwiss-ueb-thermo3-q5", question: "Eine Maschine arbeitet zwischen 500 °C und 20 °C. Wie groß ist der maximale Carnot-Wirkungsgrad?", options: ["62 %, mit korrekter Kelvin-Umrechnung", "96 %, deutlich zu hoch angesetzt", "38 %, mit vertauschten Temperaturen gerechnet", "50 %, grob überschlagen ohne Kelvin-Umrechnung"], correctIndex: 0, explanation: "Nach Umrechnung in Kelvin (T_H = 773 K, T_C = 293 K) ergibt sich η_C = 1 − 293/773 = 1 − 0,379 ≈ 0,621 = 62 %. Ein Rechnen mit den Celsius-Werten statt Kelvin oder ein Vertauschen der Temperaturen würde zu den anderen, falschen Werten führen." },
      ...
      { id: "natwiss-ueb-thermo3-q8", question: "Ein Kühlschrank pumpt Wärme von innen (T_C) nach außen (T_H). Welche Mindestarbeit ist dafür nötig?", options: ["W = 0, als bräuchte es keine Arbeit", "W = Q_C·(T_H/T_C − 1), aus der idealen Leistungszahl", "W = Q_C, ohne Berücksichtigung der Temperaturen", "W = Q_H/η_C, eine andere Kombination der Größen"], correctIndex: 1, explanation: "Die ideale Leistungszahl der Kältemaschine ist COP = T_C/(T_H − T_C); daraus folgt für die Mindestarbeit W = Q_C/COP = Q_C·(T_H − T_C)/T_C = Q_C·(T_H/T_C − 1). Ohne Arbeitsaufwand (W = 0) könnte gemäß dem zweiten Hauptsatz keine Wärme von kalt nach warm gepumpt werden." },
      { id: "natwiss-ueb-thermo3-q9", question: "Was gilt beim isothermen Prozess (T = const.) des idealen Gases für die Entropieänderung?", options: ["ΔS = nCᵥ·ln(T₂/T₁), was eine Temperaturänderung voraussetzt", "ΔS = 0, als gäbe es keine Volumenänderung", "ΔS = Q/T = nR·ln(V₂/V₁), aus Q_rev/T", "ΔS ist bei diesem Prozess immer negativ"], correctIndex: 2, explanation: "Bei isotherm-reversibler Expansion wird die Wärme Q = nRT·ln(V₂/V₁) zugeführt; damit ergibt sich die Entropieänderung ΔS = Q_rev/T = nR·ln(V₂/V₁). Da ΔT = 0 ist, kann nCᵥ·ln(T₂/T₁) — die Formel für einen reinen Temperatursprung — hier nicht zutreffen, und ΔS ist bei Expansion (V₂ > V₁) sogar positiv, nicht negativ." },
