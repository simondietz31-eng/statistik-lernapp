const NATWISS_CHAPTER16_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Hängt das Druckverhältnis zweier verschiedener Gase im selben Tank bei gleicher Temperatur nur von der eingefüllten Masse ab, unabhängig von der Molmasse?", correctAnswer: false, reasons: ["Nein, weil p ∝ m/M gilt; bei gleichem Volumen und gleicher Temperatur hängt der Druck sowohl von der eingefüllten Masse als auch von der Molmasse des jeweiligen Gases ab.", "Ja, weil der Druck eines idealen Gases laut pV=nRT nur von der Masse und der Temperatur bestimmt wird, nicht von der Molmasse.", "Nein, weil der Druck ausschließlich von der Molmasse abhängt, die eingefüllte Masse spielt keine Rolle.", "Ja, weil sich unterschiedliche Molmassen bei gleicher Temperatur automatisch ausgleichen und keinen Einfluss auf den Druck haben."], correctReasonIndex: 0, explanation: "Aus pV = (m/M)RT folgt p ∝ m/M: Bei gleichem Volumen und gleicher Temperatur bestimmt das Verhältnis aus eingefüllter Masse m und Molmasse M des Gases den Druck – ein leichteres Gas (kleines M) erzeugt bei gleicher Masse einen höheren Druck als ein schwereres, da es mehr Mol enthält." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist die Wärmekapazität bei konstantem Druck Cp für ein Gas stets kleiner als bei konstantem Volumen Cv?", correctAnswer: false, reasons: ["Nein, weil nach der Mayer-Relation Cp = Cv + R stets Cp > Cv gilt – bei konstantem Druck muss das Gas zusätzlich Ausdehnungsarbeit leisten, wofür mehr Wärme pro Kelvin nötig ist.", "Ja, weil bei konstantem Druck weniger Freiheitsgrade zur Energieaufnahme zur Verfügung stehen als bei konstantem Volumen.", "Nein, weil Cp und Cv bei jedem idealen Gas exakt denselben Wert besitzen.", "Ja, weil bei konstantem Druck keine Arbeit verrichtet wird und daher weniger Wärme benötigt wird."], correctReasonIndex: 0, explanation: "Die Mayer-Relation Cp − Cv = R zeigt, dass Cp stets um genau R größer ist als Cv: Bei konstantem Druck muss das Gas zusätzlich zur Temperaturerhöhung noch Ausdehnungsarbeit gegen den Umgebungsdruck leisten, wofür mehr Wärme pro Kelvin aufgebracht werden muss als bei konstantem Volumen." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Kann die Entropie eines abgeschlossenen Systems bei einem irreversiblen Prozess abnehmen?", correctAnswer: false, reasons: ["Nein, weil der 2. Hauptsatz für abgeschlossene Systeme ΔS ≥ 0 fordert; bei irreversiblen Prozessen gilt sogar ΔS > 0, eine Abnahme ist ausgeschlossen.", "Ja, weil sich Entropiezu- und -abnahmen in Teilsystemen bei irreversiblen Prozessen im Mittel ausgleichen können.", "Nein, weil die Entropie eines abgeschlossenen Systems grundsätzlich konstant bleibt, unabhängig vom Prozess.", "Ja, weil Entropie nur bei reversiblen Prozessen überhaupt eine physikalische Bedeutung hat."], correctReasonIndex: 0, explanation: "Der 2. Hauptsatz fordert für ein abgeschlossenes System ΔS ≥ 0, wobei die Gleichheit nur bei reversiblen Prozessen gilt; jeder irreversible Prozess erhöht die Entropie strikt (ΔS > 0), eine Abnahme ist demnach physikalisch ausgeschlossen." },
