const KLR_CHAPTER2_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Nach welchem Kriterium werden Kosten in Personal-, Sach-, Kapital- und Fremdleistungskosten eingeteilt?", options: ["Zahlungswirksamkeit", "Betriebliche Funktion", "Art der Verrechnung", "Art der Einsatzgüter"], correctIndex: 3, explanation: "Personal-, Sach-, Kapitalkosten und Kosten für Fremdleistungen sowie Steuern/Gebühren/Beiträge werden nach der Art der eingesetzten Güter unterschieden." },
      { id: "q2", question: "Kosten der Beschaffung, Fertigung, des Vertriebs und der Verwaltung werden nach welchem Kriterium unterschieden?", options: ["Verhalten bei Beschäftigungsänderung", "Betriebliche Funktion", "Art der Einsatzgüter", "Herkunft der Einsatzgüter"], correctIndex: 1, explanation: "Dies ist die Einteilung nach betrieblichen Funktionsbereichen." },
      { id: "q3", question: "Was zeichnet Einzelkosten aus?", options: ["Sie sind einem Kostenträger, einer Kostenstelle oder einer Periode direkt zurechenbar", "Sie sind stets kalkulatorisch", "Sie können nur über einen Schlüssel verrechnet werden", "Sie sind immer fix"], correctIndex: 0, explanation: "Einzelkosten lassen sich ohne Schlüsselung direkt und eindeutig einem Bezugsobjekt zuordnen." },
      { id: "q4", question: "Was sind 'unechte Gemeinkosten'?", options: ["Eigentlich Einzelkosten, die aus Wirtschaftlichkeitsgründen wie Gemeinkosten behandelt werden", "Kosten, die nur in der Verwaltung anfallen", "Ein anderer Begriff für kalkulatorische Kosten", "Kosten, die niemals einem Kostenträger zugerechnet werden können"], correctIndex: 0, explanation: "Beispiel: wenige Milliliter Leim je Werkstück - theoretisch einzeln zurechenbar, aber aus Aufwandsgründen wie Gemeinkosten verrechnet." },
      { id: "q5", question: "Fixe Kosten sind dadurch gekennzeichnet, dass sie...", options: ["nur bei Nichtbeschäftigung anfallen", "sich proportional zur Beschäftigung verändern", "unabhängig von der Ausbringungsmenge (zumindest in einer Bandbreite) konstant bleiben", "ausschließlich kalkulatorisch sind"], correctIndex: 2, explanation: "Fixe Kosten wie Miete bleiben unabhängig von der Beschäftigung innerhalb einer relevanten Bandbreite konstant." },
      ...
      { id: "q7", question: "Kalkulatorische Abschreibungen und kalkulatorische Zinsen sind Beispiele für...", options: ["nicht ausgabegleiche (kalkulatorische) Kosten", "Einzelkosten", "ausgabegleiche Kosten", "primäre Kosten"], correctIndex: 0, explanation: "Ihnen steht keine unmittelbare Auszahlung in gleicher Höhe gegenüber, daher sind sie nicht ausgabegleich." },
      { id: "q8", question: "Beim FIFO-Verfahren wird unterstellt, dass...", options: ["der höchste Einstandspreis angesetzt wird", "die zuletzt beschafften Mengen zuerst verbraucht werden", "immer der Durchschnittspreis angesetzt wird", "die zuerst beschafften (ältesten) Mengen zuerst verbraucht werden"], correctIndex: 3, explanation: "FIFO = first in, first out: die ältesten Bestände werden zuerst verbraucht, ihre Preise fließen zuerst in die Kosten ein." },
      { id: "q9", question: "Warum ist LIFO bei anhaltender Inflation gegenüber FIFO oft vorzuziehen?", options: ["Weil LIFO unabhängig von den tatsächlichen Einstandspreisen rechnet", "Weil LIFO gesetzlich vorgeschrieben ist", "Weil LIFO immer zu niedrigeren Kosten führt", "Weil LIFO die aktuellen (höheren) Preise sofort in die Kosten einfließen lässt und so Scheingewinne vermeidet"], correctIndex: 3, explanation: "LIFO verrechnet die neuesten, bei Inflation höheren Preise zuerst und verhindert damit eine Bewertung des Verbrauchs zu veralteten, zu niedrigen Preisen." },
      { id: "q10", question: "Welche Aussage zur Materialbewertung ist korrekt?", options: ["FIFO und LIFO führen bei konstanten Einstandspreisen zu unterschiedlichen Verbrauchskosten", "FIFO und LIFO führen bei konstanten Einstandspreisen zum gleichen Ergebnis, unterscheiden sich aber bei schwankenden Preisen", "FIFO berücksichtigt ausschließlich den höchsten Einstandspreis", "LIFO ist nur bei fallenden Preisen definiert"], correctIndex: 1, explanation: "Bleiben die Einstandspreise konstant, spielt die Verbrauchsfolge keine Rolle; erst bei schwankenden Preisen unterscheiden sich FIFO und LIFO im Ergebnis." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Wie lautet die Formel für die lineare Abschreibung?", options: ["a = Anschaffungswert · Nutzungsdauer", "a = Anschaffungswert / Restwert", "a = Restwert / Nutzungsdauer", "a = (Anschaffungswert − Restwert) / Nutzungsdauer"], correctIndex: 3, explanation: "Der abzuschreibende Betrag (Anschaffungswert minus Restwert) wird gleichmäßig auf die Nutzungsdauer verteilt." },
      { id: "q2", question: "Bei der arithmetisch-degressiven Abschreibung fallen die Jahresbeträge...", options: ["gar nicht, sie bleiben konstant", "in gleichbleibenden Schritten (arithmetische Folge)", "exponentiell", "proportional zur tatsächlichen Leistung"], correctIndex: 1, explanation: "Arithmetisch-degressiv bedeutet, dass sich der Abschreibungsbetrag von Jahr zu Jahr um einen konstanten Betrag verringert." },
      { id: "q3", question: "Bei der geometrisch-degressiven Abschreibung wird der Prozentsatz angewendet auf...", options: ["den Wiederbeschaffungswert", "die geschätzte Gesamtleistung", "den jeweiligen Restbuchwert des Vorjahres", "den ursprünglichen Anschaffungswert"], correctIndex: 2, explanation: "Der feste Prozentsatz wird jedes Jahr erneut auf den zuletzt ermittelten Restbuchwert angewendet, daher der exponentiell fallende Verlauf." },
      { id: "q4", question: "Wie wird der Satz je Leistungseinheit bei der leistungsabhängigen Abschreibung berechnet?", options: ["Anschaffungswert · Nutzungsdauer", "Anschaffungswert / Restwert", "Restwert / geschätzte Gesamtleistung", "(Anschaffungswert − Restwert) / geschätzte Gesamtleistung"], correctIndex: 3, explanation: "Der abzuschreibende Betrag wird durch die insgesamt geschätzte Leistung geteilt, um einen Satz je Leistungseinheit zu erhalten." },
      { id: "q5", question: "Wann ist ein Methodenwechsel von geometrisch-degressiv zu linear sinnvoll?", options: ["Sobald der lineare Abschreibungsbetrag auf den Restbuchwert den geometrisch-degressiven Betrag erstmals übersteigt", "Nie, ein Wechsel ist unzulässig", "Erst im letzten Jahr der Nutzungsdauer", "Sofort im ersten Jahr"], correctIndex: 0, explanation: "Der Wechsel stellt sicher, dass der Restbuchwert am Ende der Nutzungsdauer vollständig abgeschrieben wird, da die rein geometrische Abschreibung den Wert nie exakt auf null bringt." },
      { id: "q6", question: "Warum wird bei der Bemessungsgrundlage im Zweifel der höhere Wert angesetzt?", options: ["Weil ein niedrigerer Wert rechnerisch nicht möglich ist", "Um sicherzustellen, dass genug Mittel für eine Wiederbeschaffung angesammelt werden", "Weil dies gesetzlich für die Handelsbilanz vorgeschrieben ist", "Um die Steuerlast zu erhöhen"], correctIndex: 1, explanation: "Eine zu niedrige Bemessungsgrundlage würde zu wenig Substanz für eine spätere Ersatzinvestition zurückhalten." },
      { id: "q7", question: "Warum sind progressive Abschreibungsmethoden in der Praxis unüblich?", options: ["Weil der Nutzen eines Anlageguts meist zu Beginn der Nutzungsdauer am höchsten ist und mit der Zeit abnimmt", "Weil sie immer zu negativen Restbuchwerten führen", "Weil sie gesetzlich verboten sind", "Weil sie nur bei leistungsabhängiger Abschreibung zulässig sind"], correctIndex: 0, explanation: "Ein mit der Zeit steigender Werteverzehr widerspricht dem typischen Nutzungsverlauf von Anlagegütern." },
      ...
      { id: "q9", question: "Bei welcher Abschreibungsmethode ist der Jahresbetrag über die gesamte Nutzungsdauer konstant, sofern die Nutzung konstant bleibt?", options: ["Lineare Abschreibung", "Progressive Abschreibung", "Arithmetisch-degressive Abschreibung", "Geometrisch-degressive Abschreibung"], correctIndex: 0, explanation: "Die lineare Abschreibung verteilt den abzuschreibenden Betrag gleichmäßig über alle Jahre der Nutzungsdauer." },
      { id: "q10", question: "Ein Anlagegut mit Anschaffungswert 50.000 € und Nutzungsdauer 5 Jahre wird linear abgeschrieben. Wie hoch ist der Jahresbetrag (Restwert 0 €)?", options: ["25.000 €", "5.000 €", "50.000 €", "10.000 €"], correctIndex: 3, explanation: "50.000 € / 5 Jahre = 10.000 € pro Jahr." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Was erfassen kalkulatorische Zinsen?", options: ["Nur den tatsächlich gezahlten Fremdkapitalzins", "Ausschließlich Bankgebühren", "Die Verzinsung des betriebsnotwendigen Kapitals, unabhängig von tatsächlichem Zinsaufwand", "Nur die Verzinsung des Umlaufvermögens"], correctIndex: 2, explanation: "Kalkulatorische Zinsen berücksichtigen auch den Opportunitätskostengedanken für das eingesetzte Eigenkapital, unabhängig von tatsächlich gezahlten Zinsen." },
      { id: "q2", question: "Ein fremdvermietetes, nicht selbst betrieblich genutztes Grundstück wird...", options: ["aus dem betriebsnotwendigen Vermögen ausgeschlossen", "immer ins betriebsnotwendige Vermögen einbezogen", "doppelt verzinst", "als Abzugskapital behandelt"], correctIndex: 0, explanation: "Da es nicht dem Betriebszweck dient, zählt es nicht zum betriebsnotwendigen Vermögen." },
      { id: "q3", question: "Ein unentgeltlich überlassenes, aber betrieblich genutztes Grundstück wird...", options: ["trotzdem ins betriebsnotwendige Vermögen einbezogen", "als Abzugskapital verrechnet", "ausgeschlossen, da es nichts gekostet hat", "nur zur Hälfte berücksichtigt"], correctIndex: 0, explanation: "Entscheidend ist die betriebliche Nutzung, nicht die Finanzierung - daher wird es trotzdem einbezogen." },
      { id: "q4", question: "Warum werden bei der Ermittlung des betriebsnotwendigen Vermögens meist Durchschnittswerte verwendet?", options: ["Um unterjährige Schwankungen von Anfangs- und Endwert zu glätten", "Weil Endwerte gesetzlich verboten sind", "Weil Anfangswerte immer ungenau sind", "Um Steuern zu sparen"], correctIndex: 0, explanation: "Der Durchschnitt aus Anfangs- und Endwert glättet unterjährige Veränderungen wie laufende Abschreibungen oder Bestandsänderungen." },
      { id: "q5", question: "Was zählt zum Abzugskapital?", options: ["Nur Bankkredite", "Alle Vermögensgegenstände des Anlagevermögens", "Zinslose Passivposten wie Kundenanzahlungen und Lieferantenverbindlichkeiten", "Eigenkapital und Rücklagen"], correctIndex: 2, explanation: "Abzugskapital sind zinslose Passivposten, für die kein eigenes Kapital eingesetzt werden musste." },
      ...
      { id: "q7", question: "Wie setzt sich der Eigenkapitalzinssatz beim Mischzinssatz typischerweise zusammen?", options: ["Er ist immer 0 %", "Aus dem Fremdkapitalzinssatz abzüglich eines Abschlags", "Aus dem tatsächlichen Bankzins", "Aus einem sicheren Basiszins zuzüglich eines Risikozuschlags"], correctIndex: 3, explanation: "Der Eigenkapitalzinssatz spiegelt die entgangene Anlagemöglichkeit wider und besteht aus Basiszins plus unternehmerischem Risikozuschlag." },
      { id: "q8", question: "Ein Unternehmen hat 20 % Eigenkapital zu 12 % und 80 % Fremdkapital zu 5 %. Wie hoch ist der Mischzinssatz?", options: ["17 %", "6,4 %", "8,5 %", "8,5 % ist falsch, richtig ist 6,4 %"], correctIndex: 1, explanation: "0,20·12% + 0,80·5% = 2,4% + 4% = 6,4%." },
      ...
      { id: "q10", question: "Welche Aussage zum betriebsnotwendigen Vermögen ist korrekt?", options: ["Es wird nie mit Durchschnittswerten berechnet", "Es ist identisch mit dem Abzugskapital", "Es umfasst alle dem Betriebszweck dienenden Vermögensgegenstände, einschließlich Umlaufvermögen", "Es umfasst ausschließlich das Anlagevermögen"], correctIndex: 2, explanation: "Betriebsnotwendiges Vermögen schließt sowohl betrieblich genutztes Anlagevermögen als auch Umlaufvermögen ein." }
    ]
  },
  {
    id: "kostenauflösung",
