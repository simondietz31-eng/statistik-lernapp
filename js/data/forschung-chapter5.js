const FORSCHUNG_CHAPTER5_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist das arithmetische Mittel bereits bei ordinalskalierten Daten (z. B. Schulnoten) sinnvoll berechenbar?", correctAnswer: false, reasons: ["Ja, weil Ordinaldaten bereits eine Rangfolge besitzen, die eine Summenbildung erlaubt", "Nein, weil die Berechnung des Mittelwerts gleich große Abstände zwischen den Werten voraussetzt, die bei Ordinaldaten fehlen", "Ja, weil der Mittelwert ab jedem beliebigen Skalenniveau berechenbar ist", "Nein, weil Ordinaldaten grundsätzlich keine sinnvolle Rangordnung zulassen"], correctReasonIndex: 1, explanation: "Das arithmetische Mittel erfordert Summenbildung, die gleich große Abstände voraussetzt — diese sind erst ab Intervallskala gegeben, nicht bei Ordinaldaten." },
