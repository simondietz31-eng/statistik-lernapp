const FORSCHUNG_CHAPTER4_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist bei intervallskalierten Daten die Aussage \"Wert A ist doppelt so groß wie Wert B\" zulässig?", correctAnswer: false, reasons: ["Ja, weil die gleich großen Abstände der Intervallskala solche Verhältnisaussagen ermöglichen", "Nein, weil der Intervallskala ein echter, absoluter Nullpunkt fehlt, wodurch Verhältnisaussagen sinnlos sind", "Ja, weil jede metrische Skala automatisch Verhältnisaussagen zulässt", "Nein, weil sich intervallskalierte Daten grundsätzlich nicht in eine Reihenfolge bringen lassen"], correctReasonIndex: 1, explanation: "Die Intervallskala hat zwar gleich große Abstände, aber keinen echten Nullpunkt (z. B. °C) — daher sind Verhältnisaussagen wie \"doppelt so groß\" nicht zulässig; das gilt erst ab Verhältnisskala." },
