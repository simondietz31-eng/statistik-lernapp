const FINV_CHAPTER6_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Berücksichtigen statische Investitionsrechenverfahren wie die Kostenvergleichsrechnung den Zeitpunkt einzelner Zahlungen explizit?", correctAnswer: false, reasons: ["Nein, weil sie meist mit Durchschnittswerten einer Periode arbeiten, ohne Zeitwerte einzubeziehen", "Ja, weil jedes statische Verfahren zwingend eine Ab- oder Aufzinsung der Zahlungen vornimmt", "Nein, weil statische Verfahren überhaupt keine Zahlungen, sondern nur Prozentsätze verwenden", "Ja, weil Kostenvergleichsrechnung und Kapitalwertmethode identisch aufgebaut sind"], correctReasonIndex: 0, explanation: "Statische Verfahren wie die Kostenvergleichsrechnung arbeiten mit Durchschnittswerten einer repräsentativen Periode und blenden den genauen Zeitpunkt einzelner Zahlungen aus — das unterscheidet sie von den dynamischen Verfahren, die Zeitwerte über Ab-/Aufzinsung berücksichtigen." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Führt ein Barwertvergleich zweier Investitionsalternativen bei gleichem Zinssatz zu einem anderen Vorteilhaftigkeitsergebnis als ein Endwertvergleich?", correctAnswer: false, reasons: ["Nein, weil beide Vergleiche bei korrekter Rechnung mit demselben Zinssatz zum gleichen Ergebnis führen", "Ja, weil der Barwertvergleich systematisch andere Alternativen bevorzugt als der Endwertvergleich", "Nein, weil ein Endwertvergleich in der Finanzmathematik grundsätzlich unzulässig ist", "Ja, weil nur der Barwertvergleich den Zeitwert des Geldes überhaupt berücksichtigt"], correctReasonIndex: 0, explanation: "Barwert- und Endwertvergleich sind bei gleichem Zinssatz rechnerisch äquivalent, solange beide Alternativen konsequent auf denselben Zeitpunkt bezogen werden — welche Vergleichsart gewählt wird, ändert die Vorteilhaftigkeitsaussage nicht." },
