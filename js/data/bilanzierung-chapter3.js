const BILANZIERUNG_CHAPTER3_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "q2", question: "Welche drei Hauptpositionen umfasst das Anlagevermögen nach § 266 Abs. 2 HGB?", options: ["Eigenkapital, Rückstellungen, Verbindlichkeiten","Immaterielle Vermögensgegenstände, Sachanlagen, Finanzanlagen","Vorräte, Forderungen, liquide Mittel","Umsatzerlöse, Materialaufwand, Personalaufwand"], correctIndex: 1, explanation: "Die Bilanzgliederung sieht genau diese drei Hauptgruppen für das Anlagevermögen vor." },
      { id: "q3", question: "Wie ist der derivative (entgeltlich erworbene) Geschäfts- oder Firmenwert handelsrechtlich zu behandeln?", options: ["Aktivierungspflicht mit anschließender planmäßiger Abschreibung","Aktivierungsverbot","Aktivierungswahlrecht ohne weitere Pflichten","Sofortige Verrechnung mit dem Eigenkapital"], correctIndex: 0, explanation: "Der derivative GoF gilt per Fiktion als Vermögensgegenstand mit Aktivierungspflicht (§ 246 Abs. 1 S. 4 HGB) und ist planmäßig abzuschreiben." },
      { id: "q4", question: "Wie ist der originäre (selbst geschaffene) Geschäfts- oder Firmenwert zu behandeln?", options: ["Nur steuerrechtlich aktivierungspflichtig","Aktivierungsverbot in Handels- und Steuerbilanz","Aktivierungswahlrecht analog zu Entwicklungskosten","Aktivierungspflicht wie beim derivativen GoF"], correctIndex: 1, explanation: "Für den originären GoF besteht ein strenges Aktivierungsverbot (§ 248 Abs. 2 HGB; § 5 Abs. 2 EStG), da kein objektivierbarer Erwerbsvorgang vorliegt." },
      { id: "q5", question: "Welche zwei Gruppen von Finanzanlagen lassen sich nach HGB grob unterscheiden?", options: ["Sachanlagen und immaterielle Vermögensgegenstände","Eigenkapital und Fremdkapital","Vorräte und Forderungen","Anteile/Beteiligungen (i. d. R. Daueranlagen) und Ausleihungen (schuldrechtliche Kapitalforderungen)"], correctIndex: 3, explanation: "Finanzanlagen umfassen einerseits Anteile/Beteiligungen (gesellschaftsrechtlich) und andererseits Ausleihungen (schuldrechtlich)." },
      { id: "q6", question: "Warum wird im Bilanzrecht so stark zwischen materiellem und immateriellem Anlagevermögen unterschieden?", options: ["Weil immaterielle Vermögensgegenstände steuerfrei sind","Der Unterschied hat keine bilanzrechtliche Relevanz","Weil nur Sachanlagen abgeschrieben werden dürfen","Weil für immaterielle Vermögensgegenstände strengere Aktivierungsregeln gelten (u. a. Aktivierungsverbote für selbst geschaffene Werte ohne objektivierbaren Erwerbsvorgang)"], correctIndex: 3, explanation: "Immaterielle Vermögensgegenstände ohne physische Substanz sind schwerer objektiv bewertbar; deshalb gelten besondere, teils strengere Aktivierungsregeln (Vorsichtsprinzip)." },
      { id: "q7", question: "Welche Unternehmen gelten nach § 271 Abs. 2 HGB als 'verbundene Unternehmen'?", options: ["Alle Kunden und Lieferanten eines Unternehmens","Nur börsennotierte Aktiengesellschaften","Mutter- oder Tochterunternehmen, die in einen Konzernabschluss nach § 290 HGB einzubeziehen sind","Alle Unternehmen derselben Branche"], correctIndex: 2, explanation: "§ 271 Abs. 2 HGB definiert verbundene Unternehmen über die Einbeziehungspflicht in den Konzernabschluss nach § 290 HGB." },
      { id: "q8", question: "Was ist unter 'geleisteten Anzahlungen' im Anlagevermögen zu verstehen?", options: ["Abschreibungsbeträge des laufenden Jahres","Erhaltene Zahlungen von Kunden","Rückzahlungen an Gesellschafter","Vorleistungen des Unternehmens auf noch schwebende Geschäfte im Zusammenhang mit Anlagegütern"], correctIndex: 3, explanation: "Geleistete Anzahlungen sind Vorleistungen auf im Übrigen noch schwebende Geschäfte, z. B. Anzahlungen auf eine bestellte, aber noch nicht gelieferte Maschine." },
      { id: "q9", question: "Nennen Sie ein Beispiel für nicht abnutzbares Anlagevermögen.", options: ["Ein unbebautes Grundstück","Ein Bürogebäude","Ein Firmenfahrzeug","Eine Produktionsmaschine"], correctIndex: 0, explanation: "Unbebaute Grundstücke, Beteiligungen und Wertpapiere des Anlagevermögens gelten typischerweise als nicht abnutzbares Anlagevermögen — im Gegensatz z. B. zu Gebäuden oder Maschinen." },
      { id: "q10", question: "Was unterscheidet Anlagevermögen grundlegend vom Umlaufvermögen?", options: ["Anlagevermögen ist zum dauernden Gebrauch bestimmt, Umlaufvermögen wird kurzfristig verbraucht, veräußert oder umgesetzt","Anlagevermögen ist immer wertvoller als Umlaufvermögen","Umlaufvermögen erscheint nicht in der Bilanz","Es gibt keinen bilanzrechtlichen Unterschied"], correctIndex: 0, explanation: "Die Zweckbestimmung ist entscheidend: dauernder Gebrauch (Anlagevermögen) versus kurzfristiger Verbrauch/Umsatz (Umlaufvermögen)." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Was sind laut § 253 Abs. 1 Satz 1 HGB Ausgangswert und Wertobergrenze für die Bewertung des Anlagevermögens?", options: ["Die Anschaffungs- oder Herstellungskosten (AHK)","Der Marktwert am Bilanzstichtag","Der geschätzte Veräußerungswert","Der Wiederbeschaffungswert"], correctIndex: 0, explanation: "Die AHK bilden nach § 253 Abs. 1 S. 1 HGB den Ausgangswert und die absolute Wertobergrenze der Bewertung." },
      { id: "q2", question: "Wodurch unterscheiden sich Anschaffungskosten von Herstellungskosten?", options: ["Anschaffungskosten dürfen nie aktiviert werden","Herstellungskosten gelten nur für immaterielle Vermögensgegenstände","Anschaffungskosten fallen beim Erwerb von Dritten an, Herstellungskosten bei der Eigenerstellung im Betrieb","Es gibt keinen inhaltlichen Unterschied"], correctIndex: 2, explanation: "AK entstehen beim Fremderwerb, HK bei der Eigenherstellung eines Vermögensgegenstandes." },
      { id: "q3", question: "Welche der folgenden Positionen ist eine Anschaffungspreisminderung?", options: ["Skonto","Grunderwerbsteuer","Transportkosten","Notargebühren"], correctIndex: 0, explanation: "Skonto (wie auch Rabatt und Boni) mindert den Anschaffungspreis; die anderen genannten Positionen sind Anschaffungsnebenkosten." },
      { id: "q4", question: "Zu welchen Anschaffungskosten zählen die Abbruchkosten für ein in Abbruchabsicht mit erworbenes Altgebäude?", options: ["Sie werden sofort erfolgswirksam als außerordentlicher Aufwand verbucht","Zu den Herstellungskosten des neuen Gebäudes","Zu den Anschaffungskosten des Grundstücks","Sie mindern das Eigenkapital direkt"], correctIndex: 2, explanation: "Da das Altgebäude von Anfang an beseitigt werden sollte, gehören die Abbruchkosten zu den Anschaffungsnebenkosten des Grundstücks." },
      { id: "q5", question: "Wie sind selbst geschaffene Entwicklungskosten handelsrechtlich zu behandeln?", options: ["Aktivierungspflicht","Aktivierungswahlrecht nach § 248 Abs. 2 S. 1 HGB","Sie dürfen nur in der Steuerbilanz erfasst werden","Aktivierungsverbot"], correctIndex: 1, explanation: "Für selbst geschaffene immaterielle Vermögensgegenstände wie Entwicklungskosten besteht ein Aktivierungswahlrecht." },
      { id: "q6", question: "Wie sind reine Forschungskosten zu behandeln, wenn sie sich von Entwicklungskosten trennen lassen?", options: ["Verteilung über 15 Jahre wie beim GoF","Aktivierungsverbot — sofortiger Aufwand","Aktivierungspflicht","Aktivierungswahlrecht wie bei Entwicklungskosten"], correctIndex: 1, explanation: "Forschungskosten unterliegen einem Aktivierungsverbot und sind sofort als Aufwand zu erfassen." },
      { id: "q7", question: "Welches Prinzip gilt beim Anlagevermögen für die Bewertung von Vermögensgegenständen (im Gegensatz zum Höchstwertprinzip bei Schulden)?", options: ["Das Stetigkeitsprinzip","Das Niederstwertprinzip","Das Fälligkeitsprinzip","Das Vollständigkeitsprinzip"], correctIndex: 1, explanation: "Für Vermögensgegenstände gilt das (beim Anlagevermögen gemilderte) Niederstwertprinzip, für Schulden das Höchstwertprinzip." },
      { id: "q8", question: "Was besagt das Imparitätsprinzip?", options: ["Gewinne und Verluste werden immer gleich behandelt","Es betrifft ausschließlich das Eigenkapital","Nur realisierte Verluste dürfen erfasst werden","Unrealisierte Verluste sind bereits bei Erkennbarkeit zu berücksichtigen, unrealisierte Gewinne nicht"], correctIndex: 3, explanation: "Das Imparitätsprinzip verlangt eine ungleiche ('imparitätische') Behandlung: Verluste antizipieren, Gewinne erst bei Realisation ausweisen." },
      { id: "q9", question: "Entspricht der Restbuchwert eines Vermögensgegenstandes immer seinem tatsächlichen Wert?", options: ["Nein, der Restbuchwert ist eine bilanzrechtliche Rechengröße und kann vom tatsächlichen Wert abweichen","Nur im ersten Jahr der Nutzung","Ja, per Definition immer","Nur bei Finanzanlagen ja"], correctIndex: 0, explanation: "Der Restbuchwert (AHK abzüglich kumulierter Abschreibungen) ist eine rechnerische Größe und muss nicht dem tatsächlichen Markt- oder Nutzwert entsprechen." },
      { id: "q10", question: "Welches Niederstwertprinzip gilt für das Umlaufvermögen?", options: ["Nur das Höchstwertprinzip","Das gemilderte Niederstwertprinzip","Das strenge Niederstwertprinzip","Kein Niederstwertprinzip"], correctIndex: 2, explanation: "Beim Umlaufvermögen gilt das strenge Niederstwertprinzip — jede Wertminderung, auch eine vorübergehende, ist zu berücksichtigen." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Was versteht man unter dem Begriff 'Abschreibung' im bilanzrechtlichen Sinn?", options: ["Die Bezahlung offener Verbindlichkeiten","Die Erhöhung des Eigenkapitals durch Gewinnthesaurierung","Die Ausschüttung von Dividenden an Aktionäre","Die systematische Erfassung des Werteverzehrs eines Vermögensgegenstandes durch Verminderung seines Buchwerts"], correctIndex: 3, explanation: "Abschreibung erfasst den Werteverzehr eines Vermögensgegenstandes, indem der Buchwert planmäßig oder außerplanmäßig gemindert wird." },
      { id: "q2", question: "Wie verläuft der jährliche Abschreibungsbetrag bei der linearen Abschreibung?", options: ["Er bleibt über die gesamte Nutzungsdauer konstant","Er richtet sich ausschließlich nach der Leistung","Er steigt von Jahr zu Jahr an","Er fällt geometrisch mit einem festen Prozentsatz"], correctIndex: 0, explanation: "Bei linearer Abschreibung ist der Jahresbetrag AHK/n über die gesamte Nutzungsdauer konstant." },
      { id: "q3", question: "Wie unterscheidet sich der Restbuchwertverlauf bei der geometrisch-degressiven im Vergleich zur linearen Abschreibung?", options: ["Der Buchwert steigt zunächst an","Der Buchwert bleibt konstant","Es gibt keinen Unterschied zur linearen Methode","Der Buchwert sinkt anfangs schneller und die Jahresbeträge fallen von Jahr zu Jahr"], correctIndex: 3, explanation: "Bei degressiver Abschreibung wird zunächst stärker abgeschrieben, die Jahresbeträge fallen dann kontinuierlich mit dem sinkenden Restbuchwert." },
      { id: "q4", question: "Was versteht man unter der Methodenfreiheit bei der Abschreibung, und wie ist sie beschränkt?", options: ["Innerhalb bestimmter gesetzlicher Grenzen darf grundsätzlich frei zwischen zulässigen Methoden gewählt werden, ein späterer beliebiger Wechsel ist aber durch den Grundsatz der Bewertungsstetigkeit eingeschränkt","Es gibt keinerlei Beschränkungen bei der Methodenwahl","Die Methode muss jährlich neu ausgelost werden","Methodenfreiheit gilt nur für immaterielle Vermögensgegenstände"], correctIndex: 0, explanation: "Die Wahl der Methode ist zunächst frei (innerhalb der zulässigen Verfahren), ein späterer Wechsel unterliegt jedoch dem Stetigkeitsgebot." },
      { id: "q5", question: "Was ist unter planmäßiger Abschreibung zu verstehen?", options: ["Eine rein steuerlich motivierte Sonderabschreibung","Eine einmalige, außerordentliche Wertminderung","Die vollständige Sofortabschreibung im Anschaffungsjahr","Die Verteilung der AHK nach einem im Voraus festgelegten Plan über die voraussichtliche Nutzungsdauer"], correctIndex: 3, explanation: "Planmäßige Abschreibung folgt einem im Voraus festgelegten Plan über die Nutzungsdauer und erfasst den normalen Werteverzehr." },
      { id: "q6", question: "Ist ein Wechsel der Abschreibungsmethode beliebig möglich?", options: ["Nur am Ende der Nutzungsdauer","Ja, jederzeit ohne Begründung","Nein, grundsätzlich gilt der Grundsatz der Bewertungsstetigkeit; ein Wechsel bedarf einer sachlichen Begründung","Nur bei immateriellen Vermögensgegenständen"], correctIndex: 2, explanation: "Der Grundsatz der Bewertungsstetigkeit (§ 252 Abs. 1 Nr. 6 HGB) schränkt einen beliebigen Methodenwechsel ein." },
      { id: "q7", question: "Welche Kombination zweier Abschreibungsmethoden ist systemimmanent vorgesehen?", options: ["Es gibt keine vorgesehene Kombination","Der gleichzeitige Einsatz von linearer und leistungsbezogener Abschreibung auf denselben Betrag","Der Wechsel von linear zu degressiv","Der Übergang von der geometrisch-degressiven zur linearen Abschreibung des Restwertes"], correctIndex: 3, explanation: "Der Übergang von degressiv zu linear (nicht umgekehrt) ist eine im System vorgesehene, gängige Kombination." },
      { id: "q8", question: "Können Abschreibungen auch rechtlich bedingt sein (neben technischen und wirtschaftlichen Ursachen)?", options: ["Rechtliche Ursachen betreffen nur das Umlaufvermögen","Nein, nur technische und wirtschaftliche Ursachen zählen","Rechtliche Ursachen führen nie zu einer Abschreibung","Ja, z. B. durch den zeitlichen Ablauf von Verträgen oder Schutzrechten wie Patenten und Lizenzen"], correctIndex: 3, explanation: "Der Ablauf von Verträgen, Patenten oder Lizenzen ist eine typische rechtliche Abschreibungsursache." },
      { id: "q9", question: "Welche Abschreibungsart führt zu gleich hohen planmäßigen Abschreibungsbeträgen über die gesamte Nutzungsdauer?", options: ["Die lineare Abschreibung","Die progressive Abschreibung","Die leistungsbezogene Abschreibung","Die geometrisch-degressive Abschreibung"], correctIndex: 0, explanation: "Nur die lineare Abschreibung erzeugt konstante Jahresbeträge (AHK/n)." },
      { id: "q10", question: "Welche zusätzliche Voraussetzung gilt für die steuerliche Zulässigkeit der Abschreibung nach Maßgabe der Leistung?", options: ["Es muss sich um ein bewegliches Wirtschaftsgut des Anlagevermögens handeln und die Leistungseinheiten müssen nachgewiesen werden können","Sie ist steuerlich generell nicht zugelassen","Sie ist ausschließlich bei immateriellen Vermögensgegenständen zulässig","Sie darf nur bei Gebäuden angewendet werden"], correctIndex: 0, explanation: "§ 7 Abs. 1 EStG verlangt ein bewegliches Wirtschaftsgut des Anlagevermögens und einen Nachweis der Leistungseinheiten." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Wann besteht handelsrechtlich eine Pflicht zur außerplanmäßigen Abschreibung des Anlagevermögens?", options: ["Bei jeder, auch nur vorübergehenden Wertminderung","Nur am Ende der Nutzungsdauer","Bei einer voraussichtlich dauernden Wertminderung (§ 253 Abs. 3 S. 5 HGB)","Nur bei Finanzanlagen"], correctIndex: 2, explanation: "Bei voraussichtlich dauernder Wertminderung besteht unabhängig von der Vermögensart eine Abschreibungspflicht." },
      { id: "q2", question: "Bei welcher Art von Anlagevermögen besteht auch bei nur vorübergehender Wertminderung ein Abschreibungswahlrecht?", options: ["Bei Finanzanlagen (§ 253 Abs. 3 S. 6 HGB)","Bei Sachanlagen","Bei immateriellen Vermögensgegenständen","Bei keiner Art von Anlagevermögen"], correctIndex: 0, explanation: "Nur bei Finanzanlagen ist eine außerplanmäßige Abschreibung auch bei einer voraussichtlich nicht dauernden Wertminderung zulässig (Wahlrecht)." },
      { id: "q3", question: "Was ist zu tun, wenn der Grund für eine außerplanmäßige Abschreibung später wegfällt?", options: ["Es passiert nichts, die Abschreibung bleibt endgültig bestehen","Der Vermögensgegenstand wird sofort aus der Bilanz entfernt","Der Vermögensgegenstand ist grundsätzlich bis max. zu den fortgeführten AHK zuzuschreiben (Wertaufholungsgebot)","Es entsteht automatisch ein neuer Geschäfts- oder Firmenwert"], correctIndex: 2, explanation: "§ 253 Abs. 5 HGB schreibt grundsätzlich eine Zuschreibung bis maximal zu den fortgeführten AHK vor." },
      { id: "q4", question: "Für welchen Vermögensgegenstand gilt ausnahmsweise ein Wertaufholungsverbot?", options: ["Für den derivativen Geschäfts- oder Firmenwert","Für geringwertige Wirtschaftsgüter","Für alle Finanzanlagen","Für Grundstücke"], correctIndex: 0, explanation: "§ 253 Abs. 5 S. 2 HGB sieht für den derivativen GoF ein Wertaufholungsverbot vor." },
      { id: "q5", question: "Welche Kriterien muss ein Wirtschaftsgut erfüllen, um als geringwertiges Wirtschaftsgut (GWG) zu gelten?", options: ["Es muss zwingend immateriell sein","Es muss ein Umlaufvermögensgegenstand sein","Abnutzbares, bewegliches, selbständig nutzbares Wirtschaftsgut des Anlagevermögens mit netto-AHK bis 800 €","Es darf keine Anschaffungsnebenkosten haben"], correctIndex: 2, explanation: "GWG sind abnutzbare, bewegliche, selbständig nutzbare Wirtschaftsgüter des AV mit netto-AHK bis 800 €." },
      { id: "q6", question: "Welches Wahlrecht besteht bei einem GWG mit netto-AHK zwischen 250,01 € und 800 €?", options: ["Nur Sammelposten über 10 Jahre","Sofortabschreibung, AfA nach Nutzungsdauer, oder Sammelposten mit linearer Abschreibung über 5 Jahre","Es besteht überhaupt kein Wahlrecht","Nur Sofortabschreibung, kein anderes Wahlrecht"], correctIndex: 1, explanation: "In dieser Wertklasse besteht ein dreifaches Wahlrecht: Sofortabschreibung, reguläre AfA oder Poolabschreibung über 5 Jahre." },
      { id: "q7", question: "Welche Anlagegüter müssen gar nicht als Anlagevermögen aktiviert, sondern dürfen sofort als Aufwand verbucht werden?", options: ["Anlagegüter mit netto-AHK bis 250 € (kleinwertige WG) sowie kurzlebige Anlagegüter mit ND i. d. R. nicht länger als ein Jahr","Alle Wirtschaftsgüter über 1.000 € netto","Nur immaterielle Vermögensgegenstände","Nur Finanzanlagen"], correctIndex: 0, explanation: "Kleinwertige WG bis 250 € und kurzlebige Anlagegüter dürfen sofort als Aufwand verbucht werden, ohne überhaupt aktiviert zu werden." },
      { id: "q8", question: "Nennen Sie ein Beispiel für eine Ursache einer außerplanmäßigen Abschreibung.", options: ["Der Ablauf der geplanten Nutzungsdauer laut AfA-Tabelle","Regelmäßige, planbare Alterung eines Gebäudes über die Nutzungsdauer","Eine bewusst gewählte lineare Abschreibungsmethode","Katastrophenverschleiß, z. B. durch ein unvorhergesehenes Schadensereignis"], correctIndex: 3, explanation: "Katastrophenverschleiß, versteckte Mängel oder ein dauerhaftes Fallen der Wiederbeschaffungspreise sind typische Ursachen für außerplanmäßige Abschreibungen." },
      { id: "q9", question: "Wie werden digitale Wirtschaftsgüter (z. B. Computerhardware) steuerrechtlich seit dem BMF-Schreiben von 2021/2022 behandelt?", options: ["Sie dürfen grundsätzlich nie abgeschrieben werden","Sie unterliegen einer Mindestnutzungsdauer von 20 Jahren","Es wird ihnen eine Nutzungsdauer von einem Jahr zugestanden, was faktisch einer Sofortabschreibung entspricht","Sie gelten automatisch als originärer Geschäfts- oder Firmenwert"], correctIndex: 2, explanation: "Die Finanzverwaltung erkennt für digitale Wirtschaftsgüter steuerlich eine Nutzungsdauer von einem Jahr an." },
      { id: "q10", question: "Gilt die steuerliche Sonderregel zur Nutzungsdauer digitaler Wirtschaftsgüter auch handelsrechtlich?", options: ["Nur bei Gebäuden","Ja, uneingeschränkt","Nur bei Finanzanlagen","Nein, handelsrechtlich ist (außer bei GWG) weiterhin die tatsächliche Nutzungsdauer laut AfA-Tabelle maßgeblich"], correctIndex: 3, explanation: "Handelsrechtlich gilt weiterhin die reguläre, tatsächliche Nutzungsdauer — die steuerliche Sonderregel wirkt sich dort nicht aus." }
    ]
  }
];
