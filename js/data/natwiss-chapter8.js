const NATWISS_CHAPTER8_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Hängt die innere Energie eines idealen Gases von seinem Volumen ab, solange die Temperatur konstant bleibt?", correctAnswer: false, reasons: ["Nein, weil beim idealen Gas U = n·C_V·T nur von T abhängt und bei konstanter Temperatur unverändert bleibt.", "Ja, weil sich bei größerem Volumen mehr Teilchen im System befinden und U dadurch automatisch ansteigt.", "Nein, weil die innere Energie eines idealen Gases unter allen Bedingungen grundsätzlich stets gleich null ist.", "Ja, weil eine Volumenänderung stets mit einer Druckänderung einhergeht, die U direkt beeinflusst."], correctReasonIndex: 0, explanation: "Für ein ideales Gas gilt U = n·C_V·T – die innere Energie hängt ausschließlich von der Temperatur ab, nicht vom Volumen oder Druck, da im idealen Gas keine Wechselwirkungsenergie zwischen den Teilchen existiert." },
