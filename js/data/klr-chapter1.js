const KLR_CHAPTER1_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Wie definieren Coenenberg/Fischer/Günther das Rechnungswesen?", options: ["Als System zur quantitativen Ermittlung, Aufbereitung und Darstellung von wirtschaftlichen Zuständen und Abläufen", "Als Instrument zur ausschließlichen Steuerbelastungsminimierung", "Als System zur qualitativen Bewertung von Mitarbeitermotivation", "Als reine Sammlung gesetzlicher Vorschriften zur Buchführung"], correctIndex: 0, explanation: "Die klassische Definition betont die quantitative Ermittlung, Aufbereitung und Darstellung wirtschaftlicher Zustände und Abläufe." },
      { id: "q2", question: "Was ergänzen erweiterte, modernere Definitionen von Rechnungswesen (z. B. nach Carnegie/Parker/Tsahuridu) gegenüber der klassischen, technischen Definition?", options: ["Nichts, sie sind inhaltlich identisch", "Soziale, moralische und Nachhaltigkeitsdimensionen sowie Stakeholder-Rechenschaftslegung", "Ausschließlich neue mathematische Berechnungsverfahren", "Eine Beschränkung auf rein steuerliche Aspekte"], correctIndex: 1, explanation: "Erweiterte Definitionen betonen zusätzlich soziale, moralische und Nachhaltigkeitsaspekte sowie die Rechenschaftslegung gegenüber Stakeholdern, nicht nur Shareholdern." },
      { id: "q3", question: "Welche Adressaten sind primär dem externen Rechnungswesen zuzuordnen?", options: ["Mitarbeiter und Abteilungsleiter", "Lieferanten, Fiskus, Anteilseigner und Gläubiger", "Ausschließlich der Vorstand", "Nur unternehmensinterne Controller"], correctIndex: 1, explanation: "Das externe Rechnungswesen richtet sich an außenstehende Adressaten wie Lieferanten, den Staat/Fiskus, Anteilseigner und Banken/Gläubiger." },
      { id: "q4", question: "Welche Adressaten sind primär dem internen Rechnungswesen zuzuordnen?", options: ["Lieferanten und Gewerkschaften", "Mitarbeiter, Geschäftsführung, Aufsichtsrat und Management", "Ausschließlich das Finanzamt", "Banken und sonstige Gläubiger"], correctIndex: 1, explanation: "Das interne Rechnungswesen (Betriebsbuchhaltung/KLR) dient vor allem unternehmensinternen Adressaten wie Mitarbeitern, Geschäftsführung, Aufsichtsrat und Management." },
      { id: "q5", question: "Welche drei Zwecke verfolgt das betriebswirtschaftliche Rechnungswesen?", options: ["Werbung, Vertrieb, Produktion", "Dokumentation, Planung, Kontrolle", "Besteuerung, Export, Import", "Marketing, Personal, Logistik"], correctIndex: 1, explanation: "Die drei zentralen Zwecke sind Dokumentation (Datenbasis), Planung (vorausschauende Zielgrößen) und Kontrolle (Soll-Ist-Vergleich)." },
      { id: "q6", question: "Wie hängen Dokumentation, Planung und Kontrolle zusammen?", options: ["Sie sind völlig unabhängig voneinander", "Die Dokumentation liefert die Datenbasis, die Planung legt vorausschauend Zielgrößen fest, die Kontrolle vergleicht im Nachhinein Soll und Ist", "Die Kontrolle findet immer vor der Planung statt", "Die Planung ersetzt die Dokumentation vollständig"], correctIndex: 1, explanation: "Dokumentation schafft die Datengrundlage, darauf aufbauend werden in der Planung Zielgrößen festgelegt, und die Kontrolle vergleicht danach die tatsächlichen mit den geplanten Werten." },
      { id: "q7", question: "Bei welchen Unternehmen hat der Dokumentationszweck des Rechnungswesens eine besonders hohe Bedeutung?", options: ["Bei kleinen Familienbetrieben ohne Fremdkapital", "Bei besonders regulierten und beaufsichtigten Unternehmen wie Banken und Versicherungen", "Bei Unternehmen ohne Mitarbeiter", "Bei rein internationalen Start-ups"], correctIndex: 1, explanation: "Regulierte Branchen wie Banken und Versicherungen unterliegen strengen Nachweispflichten gegenüber Aufsichtsbehörden, wodurch der Dokumentationszweck zusätzliches Gewicht erhält." },
      { id: "q8", question: "Welche drei Rechnungssysteme umfasst das betriebswirtschaftliche Rechnungswesen?", options: ["Bilanz- und Erfolgsrechnung, Kosten- und Leistungsrechnung, Sonderrechnungen", "Marketingrechnung, Personalrechnung, Exportrechnung", "Steuerrechnung, Zollrechnung, Lohnrechnung", "Nur die Kosten- und Leistungsrechnung"], correctIndex: 0, explanation: "Die drei Rechnungssysteme sind Bilanz-/Erfolgsrechnung, Kosten- und Leistungsrechnung (KLR) und Sonderrechnungen (z. B. Investitions-, Planungs-, Statistik- und Vergleichsrechnung)." },
      { id: "q9", question: "Welche Beispiele werden für in der Planung des internen Rechnungswesens festgelegte Größen genannt?", options: ["Nur Steuersätze", "Kosten, Erlöse, Mengen und Beschäftigung/Kapazitäten", "Ausschließlich Aktienkurse", "Nur die Anzahl der Aufsichtsratsmitglieder"], correctIndex: 1, explanation: "Im internen Rechnungswesen werden vorausschauend u. a. Kosten, Erlöse, Mengen sowie Beschäftigung und Kapazitäten geplant." },
      { id: "q10", question: "Welche Entwicklung wird im Zusammenhang mit wachsender Bedeutung von Nachhaltigkeit im Rechnungswesen beschrieben?", options: ["Ein reiner Rückzug auf finanzielle Kennzahlen", "Eine Ergänzung der klassischen finanziellen Sicht um ökologische und soziale Aspekte sowie eine Verschiebung hin zur Stakeholder-Perspektive", "Die vollständige Abschaffung der externen Rechnungslegung", "Eine ausschließliche Fokussierung auf Shareholder-Interessen"], correctIndex: 1, explanation: "Ökologische und soziale Kennzahlen (z. B. CO2-Emissionen, Frauenquote) ergänzen zunehmend die finanzielle Sicht, und der Fokus verschiebt sich von reiner Shareholder- zu einer Stakeholder-Perspektive." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Welche vier Begriffspaare bauen im Rechnungswesen aufeinander auf?", options: ["Einzahlung/Auszahlung, Einnahme/Ausgabe, Ertrag/Aufwand, Leistung/Kosten", "Gewinn/Verlust, Soll/Haben, Aktiva/Passiva, Ertrag/Kosten", "Umsatz/Gewinn, Kredit/Debit, Bilanz/GuV, Kosten/Erlöse", "Preis/Menge, Angebot/Nachfrage, Kosten/Nutzen, Soll/Ist"], correctIndex: 0, explanation: "Die vier aufeinander aufbauenden Begriffspaare sind Einzahlung/Auszahlung (Zahlungsmittelbestand), Einnahme/Ausgabe (Geldvermögen), Ertrag/Aufwand (Reinvermögen laut Bilanz) und Leistung/Kosten (betriebsnotwendiges Vermögen)." },
      { id: "q2", question: "Welche Fondsgröße verändert sich durch Einnahmen und Ausgaben?", options: ["Der Zahlungsmittelbestand", "Das Geldvermögen (Zahlungsmittel plus Forderungen minus Verbindlichkeiten)", "Das Reinvermögen laut Bilanz", "Das betriebsnotwendige Vermögen"], correctIndex: 1, explanation: "Einnahmen und Ausgaben verändern das Geldvermögen, das sich aus Zahlungsmitteln zuzüglich Forderungen abzüglich Verbindlichkeiten zusammensetzt." },
      ...
      { id: "q4", question: "Was ergibt sich aus Ertrag minus Aufwand nach HGB?", options: ["Der Cashflow der Periode", "Der Jahresüberschuss bzw. Jahresfehlbetrag", "Die Kostenüberdeckung", "Das betriebsnotwendige Vermögen"], correctIndex: 1, explanation: "Ertrag minus Aufwand ergibt laut handelsrechtlicher GuV den Jahresüberschuss (positiv) bzw. Jahresfehlbetrag (negativ)." },
      { id: "q5", question: "Welche drei Kriterien kennzeichnen Kosten nach Mumm (2007)?", options: ["Liquidität, Rentabilität, Wirtschaftlichkeit", "Verzehr, Sachzielbezogenheit und Bewertung des Verbrauchs", "Aktivierung, Passivierung, Abschreibung", "Planung, Kontrolle, Dokumentation"], correctIndex: 1, explanation: "Nach Mumm (2007) müssen für Kosten ein Verzehr vorliegen, dieser betriebszweckbezogen (sachzielbezogen) sein und bewertet werden können." },
      { id: "q6", question: "Warum sind kalkulatorische Zinsen auf das Eigenkapital immer Kosten, aber nie Aufwand?", options: ["Weil sie handelsrechtlich verboten sind", "Weil ihnen kein handelsrechtlicher Aufwand gegenübersteht, sie aber betriebszweckbezogen und bewertbar sind (Zusatzkosten)", "Weil sie nur bei Verlust anfallen", "Weil sie ausschließlich in der Bilanz erscheinen"], correctIndex: 1, explanation: "Das Handelsrecht kennt keinen Aufwand für die Verzinsung des Eigenkapitals, weshalb kalkulatorische Zinsen reine Zusatzkosten sind - Kosten ohne zugehörigen Aufwand." },
      { id: "q7", question: "Warum ist eine Spende Aufwand, aber keine Kosten?", options: ["Weil sie nicht bewertbar ist", "Weil ihr die Sachzielbezogenheit (Betriebszweckbezug) fehlt", "Weil kein Verzehr vorliegt", "Weil sie nur bei Kapitalgesellschaften vorkommt"], correctIndex: 1, explanation: "Eine Spende ist zwar handelsrechtlicher Aufwand, aber nicht betriebszweckbezogen und erfüllt damit nicht das Kriterium der Sachzielbezogenheit - sie zählt daher als neutraler Aufwand, nicht als Kosten." },
      { id: "q8", question: "Ein Unternehmen entnimmt Material aus dem eigenen Lager für die Produktion. Was trifft zu?", options: ["Es liegt eine Ausgabe und Auszahlung vor, aber keine Kosten", "Es liegen Kosten vor, aber keine Ausgabe oder Auszahlung, da diese bereits beim Einkauf stattfanden", "Es liegt weder Kosten noch Ausgabe vor", "Es liegt eine Auszahlung, aber kein Werteverzehr vor"], correctIndex: 1, explanation: "Der Materialverbrauch ist Werteverzehr und damit Kosten der laufenden Periode; die zugehörige Ausgabe/Auszahlung erfolgte bereits beim ursprünglichen Einkauf des Materials." },
      { id: "q9", question: "Was unterscheidet neutralen Aufwand von Zweckaufwand?", options: ["Neutraler Aufwand ist stets höher als Zweckaufwand", "Neutraler Aufwand ist Aufwand ohne zugehörige Kosten (nicht betriebszweckbezogen), Zweckaufwand ist zugleich Kosten (Grundkosten)", "Zweckaufwand kommt nur bei Personalkosten vor", "Es gibt keinen inhaltlichen Unterschied"], correctIndex: 1, explanation: "Neutraler Aufwand (z. B. Spenden) ist nicht betriebszweckbezogen und daher keine Kosten. Zweckaufwand ist deckungsgleich mit Kosten und wird auch als Grundkosten bezeichnet." },
      { id: "q10", question: "Wie unterscheiden sich Anderskosten und Zusatzkosten innerhalb der kalkulatorischen Kosten?", options: ["Anderskosten haben kein Aufwands-Gegenstück, Zusatzkosten schon", "Anderskosten weichen in der Höhe vom zugehörigen Aufwand ab (z. B. kalkulatorische Abschreibung), Zusatzkosten haben gar kein Aufwands-Gegenstück (z. B. kalkulatorische Zinsen auf Eigenkapital)", "Beide Begriffe sind synonym", "Anderskosten entstehen nur bei Dienstleistungsunternehmen"], correctIndex: 1, explanation: "Anderskosten stehen einem Aufwand gegenüber, weichen aber in der Höhe davon ab (z. B. kalkulatorische vs. bilanzielle Abschreibung); Zusatzkosten wie kalkulatorische Zinsen auf Eigenkapital haben überhaupt kein Aufwands-Gegenstück." }
    ]
  }
];
