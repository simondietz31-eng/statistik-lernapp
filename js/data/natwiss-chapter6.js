const NATWISS_CHAPTER6_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist Licht wie Schall eine Longitudinalwelle?", correctAnswer: false, reasons: ["Nein, weil Licht eine Transversalwelle ist – die Schwingung erfolgt senkrecht zur Ausbreitungsrichtung.", "Ja, weil grundsätzlich alle Wellen, die sich durch irgendein Medium ausbreiten, longitudinal schwingen müssen, egal welcher Art.", "Nein, weil sich Licht als elektromagnetische Welle im Vakuum überhaupt nicht ausbreiten kann, anders als der Schall.", "Ja, weil Licht wie Schall Materie zum Schwingen benötigt und daher longitudinal sein muss."], correctReasonIndex: 0, explanation: "Licht zählt zu den Transversalwellen (Schwingung senkrecht zur Ausbreitungsrichtung), während Schall eine Longitudinalwelle ist (Schwingung parallel zur Ausbreitungsrichtung) – beide Beispiele werden im Text explizit genannt." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Führt ein Gangunterschied von genau einer Wellenlänge (Δ = λ) zu destruktiver Interferenz?", correctAnswer: false, reasons: ["Nein, weil Δ = λ ein ganzzahliges Vielfaches der Wellenlänge ist und damit konstruktive, nicht destruktive Interferenz erzeugt.", "Ja, weil grundsätzlich jeder Gangunterschied, der ungleich null ist, automatisch zu einer vollständigen Auslöschung der Amplitude führt.", "Nein, weil bei Δ = λ die beiden Wellen exakt gegenphasig zueinander schwingen und sich dabei vollständig auslöschen.", "Ja, weil nur bei Δ = 0 konstruktive Interferenz auftritt und jeder andere Gangunterschied die Welle auslöscht."], correctReasonIndex: 0, explanation: "Konstruktive Interferenz tritt bei Δ = n·λ auf (n = 0, ±1, ±2, …), destruktive bei Δ = (n+½)·λ; Δ = λ entspricht n = 1 und ist somit konstruktiv, da beide Wellen dort wieder exakt gleichphasig schwingen." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Sind die festen Einspannpunkte einer beidseitig eingespannten Saite bei jeder Mode (Grundton und allen Obertönen) stets Wellenknoten?", correctAnswer: true, reasons: ["Ja, weil die festen Enden der Saite bei jeder Mode Knoten sind, da die Einspannung die Auslenkung dort stets auf null erzwingt.", "Nein, weil an den Rändern durch Reflexion der Welle immer die maximale mögliche Amplitude von 2A entsteht, unabhängig von der Mode.", "Nein, weil nur beim Grundton die Enden Knoten sind, während bei höheren Obertönen durch die Reflexion daraus Bäuche werden.", "Ja, weil Knoten grundsätzlich nur an den Rändern der Saite auftreten können, niemals in der Mitte."], correctReasonIndex: 0, explanation: "Da die Saite an beiden Enden fest eingespannt ist, muss die Auslenkung dort für jede erlaubte Mode (n = 1, 2, 3, …) null sein – die Enden sind also bei allen Harmonischen Knoten, nur Anzahl und Lage der inneren Bäuche und Knoten ändern sich mit n." },
