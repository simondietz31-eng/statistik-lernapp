const NATWISS_CHAPTER6_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist Licht wie Schall eine Longitudinalwelle?", correctAnswer: false, reasons: ["Nein, weil Licht zu den Transversalwellen zählt, bei denen die Schwingung senkrecht zur Ausbreitungsrichtung erfolgt – anders als Schall, das eine Longitudinalwelle ist.", "Ja, weil alle Wellen, die sich durch ein Medium ausbreiten, longitudinal schwingen.", "Nein, weil Licht sich im Vakuum überhaupt nicht ausbreiten kann.", "Ja, weil Licht wie Schall Materie zum Schwingen benötigt und daher longitudinal sein muss."], correctReasonIndex: 0, explanation: "Licht zählt zu den Transversalwellen (Schwingung senkrecht zur Ausbreitungsrichtung), während Schall eine Longitudinalwelle ist (Schwingung parallel zur Ausbreitungsrichtung) – beide Beispiele werden im Text explizit genannt." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Führt ein Gangunterschied von genau einer Wellenlänge (Δ = λ) zu destruktiver Interferenz?", correctAnswer: false, reasons: ["Nein, weil Δ = λ ein ganzzahliges Vielfaches der Wellenlänge (n = 1) ist, was laut Gangunterschieds-Kriterium konstruktive, nicht destruktive Interferenz erzeugt.", "Ja, weil jeder Gangunterschied ungleich null automatisch zu Auslöschung führt.", "Nein, weil bei Δ = λ die beiden Wellen exakt gegenphasig zueinander schwingen.", "Ja, weil nur bei Δ = 0 konstruktive Interferenz auftritt und jeder andere Gangunterschied die Welle auslöscht."], correctReasonIndex: 0, explanation: "Konstruktive Interferenz tritt bei Δ = n·λ auf (n = 0, ±1, ±2, …), destruktive bei Δ = (n+½)·λ; Δ = λ entspricht n = 1 und ist somit konstruktiv, da beide Wellen dort wieder exakt gleichphasig schwingen." },
