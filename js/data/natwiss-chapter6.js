const NATWISS_CHAPTER6_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Welche Wellenart transportiert Energie und Stoff?", options: ["Transversalwellen", "Longitudinalwellen", "Weder noch – Wellen transportieren nur Energie, keinen Stoff", "Beide Typen transportieren Energie und Stoff"], correctIndex: 2, explanation: "Wellen transportieren ausschließlich Energie (und Impuls), aber keinen Stoff." },
      { id: "q2", question: "Bei welcher Wellenart schwingt das Medium senkrecht zur Ausbreitungsrichtung?", options: ["Longitudinalwelle", "Transversalwelle", "Kompressionswelle", "Druckwelle"], correctIndex: 1, explanation: "Bei Transversalwellen (z. B. Seilwellen, Licht) ist die Schwingungsrichtung senkrecht zur Ausbreitung." },
      { id: "q3", question: "Eine Welle hat λ = 2 m und f = 5 Hz. Wie groß ist die Phasengeschwindigkeit?", options: ["0,4 m/s", "2,5 m/s", "10 m/s", "7 m/s"], correctIndex: 2, explanation: "c = λ · f = 2 m · 5 Hz = 10 m/s." },
      { id: "q4", question: "Was beschreibt die Wellenzahl k?", options: ["Die Anzahl der Schwingungen pro Sekunde", "Den räumlichen Abstand zweier Wellenberge", "Den Phasenhub pro Längeneinheit in rad/m", "Die Amplitude der Welle"], correctIndex: 2, explanation: "Die Wellenzahl k = 2π/λ gibt an, wie viel Phase (in Radiant) pro Meter durchlaufen wird." },
      { id: "q5", question: "Schall ist eine …", options: ["Transversalwelle", "Elektromagnetische Welle", "Longitudinalwelle", "Stehende Welle"], correctIndex: 2, explanation: "Schall ist eine Longitudinalwelle: die Luftmoleküle schwingen parallel zur Ausbreitungsrichtung (Kompressions- und Verdünnungszonen)." },
      { id: "q6", question: "Die Frequenz einer Welle wird verdoppelt (c konstant). Was passiert mit der Wellenlänge?", options: ["Sie verdoppelt sich", "Sie halbiert sich", "Sie bleibt gleich", "Sie vervierfacht sich"], correctIndex: 1, explanation: "λ = c/f → bei doppelter Frequenz halbiert sich die Wellenlänge (c = λ·f = const)." },
      { id: "q7", question: "Welche der folgenden Größen beschreibt die zeitliche Periodizität einer Welle?", options: ["Wellenlänge λ", "Wellenzahl k", "Periodendauer T", "Phasengeschwindigkeit c"], correctIndex: 2, explanation: "Die Periodendauer T = 1/f gibt die Zeit für eine vollständige Schwingung an." },
      { id: "q8", question: "Wie lautet die Wellengleichung?", options: ["∂y/∂t = c · ∂y/∂x", "∂²y/∂t² = c² · ∂²y/∂x²", "y = A · sin(kx)", "∂y/∂x = c · ∂y/∂t"], correctIndex: 1, explanation: "Die Wellengleichung lautet ∂²y/∂t² = c² · ∂²y/∂x² und ist eine lineare partielle Differentialgleichung 2. Ordnung." },
      { id: "q9", question: "Ein Sonargerät misst eine Laufzeit von 1,2 s (Hin- und Rückweg). Welche Tiefe entspricht das bei c = 1500 m/s?", options: ["900 m", "1800 m", "450 m", "1200 m"], correctIndex: 0, explanation: "d = c·Δt/2 = 1500·1,2/2 = 900 m." },
      { id: "q10", question: "Was ist die Amplitude einer Welle?", options: ["Die Ausbreitungsgeschwindigkeit", "Die maximale Auslenkung aus der Gleichgewichtslage", "Der Abstand zwischen zwei Wellenbergen", "Die Anzahl der Schwingungen pro Sekunde"], correctIndex: 1, explanation: "Die Amplitude A ist die maximale Auslenkung aus der Gleichgewichtslage; sie bestimmt die Energie der Welle." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Zwei Wellen treffen gleichphasig aufeinander. Was entsteht?", options: ["Destruktive Interferenz", "Konstruktive Interferenz", "Schwebung", "Resonanz"], correctIndex: 1, explanation: "Gleichphasige Überlagerung (Δφ = 0, 2π, …) führt zu konstruktiver Interferenz – die Amplituden addieren sich." },
      { id: "q2", question: "Welcher Gangunterschied führt zur destruktiven Interferenz?", options: ["Δ = n·λ", "Δ = (n+½)·λ", "Δ = 0", "Δ = 2·λ"], correctIndex: 1, explanation: "Destruktive Interferenz tritt auf wenn Δ = (n+½)·λ, also bei halbzahligen Vielfachen der Wellenlänge." },
      { id: "q3", question: "Was ist die Schwebungsfrequenz, wenn zwei Töne mit f₁ = 442 Hz und f₂ = 438 Hz gleichzeitig erklingen?", options: ["880 Hz", "440 Hz", "4 Hz", "2 Hz"], correctIndex: 2, explanation: "f_Schwebung = |f₁ − f₂| = |442 − 438| = 4 Hz." },
      { id: "q4", question: "Beim Doppler-Effekt: Was passiert wenn sich eine Schallquelle vom Beobachter entfernt?", options: ["Der Beobachter hört eine höhere Frequenz", "Der Beobachter hört eine niedrigere Frequenz", "Die Frequenz ändert sich nicht", "Die Amplitude nimmt zu"], correctIndex: 1, explanation: "Entfernt sich die Quelle, werden die Wellen 'auseinandergezogen' → größere Wellenlänge → niedrigere Frequenz für den Beobachter." },
      { id: "q5", question: "Das Superpositionsprinzip gilt für …", options: ["Alle physikalischen Phänomene", "Nur elektromagnetische Wellen", "Lineare Wellen", "Nur Schallwellen"], correctIndex: 2, explanation: "Das Superpositionsprinzip gilt für lineare Wellen, also wenn die Wellengleichung linear in der Amplitude ist." },
      { id: "q6", question: "Ein Gangunterschied von Δ = 2,5 · λ führt zu …", options: ["Konstruktiver Interferenz", "Destruktiver Interferenz", "Keiner Interferenz", "Schwebung"], correctIndex: 1, explanation: "Δ = 2,5λ = (2+½)λ ist ein halbzahliges Vielfaches → destruktive Interferenz." },
      { id: "q7", question: "Warum verwendet man Noise-Cancelling-Kopfhörer?", options: ["Sie verstärken den Schall", "Sie erzeugen einen gegenphasigen Schall zur destruktiven Interferenz", "Sie reflektieren Schallwellen", "Sie nutzen Resonanz"], correctIndex: 1, explanation: "Noise-Cancelling-Kopfhörer messen den Umgebungslärm und erzeugen ein genau gegenphasiges Signal – destruktive Interferenz löscht den Lärm aus." },
      { id: "q8", question: "Welche Frequenz hört ein ruhender Beobachter, wenn sich eine Quelle mit f = 500 Hz und v = c/2 nähert?", options: ["250 Hz", "500 Hz", "750 Hz", "1000 Hz"], correctIndex: 3, explanation: "f' = f · c/(c − c/2) = 500 · c/(c/2) = 500 · 2 = 1000 Hz." },
      { id: "q9", question: "Bei der Beugung von Wellen an einem Spalt ist die Beugung am stärksten wenn …", options: ["Die Spaltbreite viel größer als λ ist", "Die Spaltbreite viel kleiner als λ ist", "Die Spaltbreite in der Größenordnung von λ liegt", "Keine Beugung tritt auf"], correctIndex: 2, explanation: "Beugungseffekte treten am deutlichsten auf, wenn die Spaltbreite in der Größenordnung der Wellenlänge liegt." },
      { id: "q10", question: "Was zeigt das Doppelspaltexperiment?", options: ["Wellen können nur durch kleine Öffnungen treten", "Licht hat Wellencharakter (Interferenzmuster)", "Schall überträgt sich nicht im Vakuum", "Wellen können reflektiert werden"], correctIndex: 1, explanation: "Das Youngs Doppelspaltexperiment erzeugt ein Interferenzmuster (helle und dunkle Streifen) und beweist den Wellencharakter des Lichts." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Wie entsteht eine stehende Welle?", options: ["Durch eine Welle ohne Reflexion", "Durch Überlagerung zweier gegenläufiger Wellen gleicher Frequenz und Amplitude", "Durch destruktive Interferenz an einem Punkt", "Durch eine Welle mit variabler Frequenz"], correctIndex: 1, explanation: "Stehende Wellen entstehen durch Überlagerung einer einfallenden und einer reflektierten Welle (gegenläufig, gleiche Frequenz und Amplitude)." },
      { id: "q2", question: "Was sind Knoten bei stehenden Wellen?", options: ["Punkte maximaler Auslenkung", "Punkte immer verschwindender Auslenkung (y = 0)", "Punkte größter Energie", "Enden der Welle"], correctIndex: 1, explanation: "Knoten sind Punkte, an denen die Auslenkung immer null ist – sie bewegen sich nicht." },
      { id: "q3", question: "Eine Saite der Länge L = 1 m hat c = 300 m/s. Welche Grundfrequenz hat sie?", options: ["150 Hz", "300 Hz", "600 Hz", "75 Hz"], correctIndex: 0, explanation: "f₁ = c/(2L) = 300/(2·1) = 150 Hz." },
      { id: "q4", question: "Ein geschlossenes Rohr schwingt mit Grundfrequenz f₁ = 100 Hz. Welche Frequenzen sind anregbar?", options: ["100, 200, 300, 400 Hz", "100, 300, 500, 700 Hz", "200, 400, 600 Hz", "50, 100, 150 Hz"], correctIndex: 1, explanation: "Beim geschlossenen Rohr existieren nur ungerade Harmonische: f_n = (2n−1)·f₁, also 100, 300, 500, 700 Hz usw." },
      { id: "q5", question: "Wo liegt der Bauch der Grundschwingung einer beidseitig eingespannten Saite?", options: ["An beiden Enden", "Am linken Ende", "In der Mitte der Saite", "Am rechten Ende"], correctIndex: 2, explanation: "Bei der Grundschwingung liegt genau ein Bauch in der Mitte der Saite; die Enden sind Knoten (fest eingespannt)." },
      { id: "q6", question: "Wie viele Bäuche hat der 3. Oberton (n = 4) einer Saite?", options: ["1", "2", "3", "4"], correctIndex: 3, explanation: "Die n-te Mode hat n Bäuche. Der 3. Oberton entspricht n = 4, also 4 Bäuche." },
      { id: "q7", question: "Was passiert mit der Grundfrequenz, wenn die Saitenlänge halbiert wird (c konstant)?", options: ["Sie halbiert sich", "Sie verdoppelt sich", "Sie bleibt gleich", "Sie vervierfacht sich"], correctIndex: 1, explanation: "f₁ = c/(2L) → bei L/2 wird f₁' = c/(2·L/2) = c/L = 2f₁. Die Frequenz verdoppelt sich." },
      { id: "q8", question: "Ein offenes Rohr hat Länge L = 0,5 m (c = 340 m/s). Wie groß ist die Grundfrequenz?", options: ["170 Hz", "340 Hz", "680 Hz", "85 Hz"], correctIndex: 1, explanation: "f₁ = c/(2L) = 340/(2·0,5) = 340 Hz." },
      { id: "q9", question: "Warum können Orgelpfeifen verschiedene Töne erzeugen?", options: ["Weil sie verschiedene Materialien haben", "Weil Rohre verschiedener Länge verschiedene Eigenfrequenzen haben", "Weil die Windgeschwindigkeit variiert", "Weil verschiedene Gase verwendet werden"], correctIndex: 1, explanation: "Jede Orgelpfeife hat eine bestimmte Länge, die ihre Eigenfrequenz(en) bestimmt: f₁ = c/(2L) (offen) oder f₁ = c/(4L) (geschlossen)." },
      { id: "q10", question: "Wie viele Wellenlängen passen bei der Grundschwingung in eine beidseitig eingespannte Saite?", options: ["Eine ganze Wellenlänge", "Eine halbe Wellenlänge", "Zwei Wellenlängen", "Keine ganze Anzahl"], correctIndex: 1, explanation: "Bei der Grundschwingung (n = 1) gilt L = λ/2, also passt genau eine halbe Wellenlänge auf die Saite." }
    ]
  }
];
