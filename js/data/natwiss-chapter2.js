const NATWISS_CHAPTER2_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Was besagt das 1. Newtonsche Gesetz (Trägheitsprinzip)?", options: ["Kräfte lassen sich vektoriell addieren", "Zu jeder Kraft gibt es eine Gegenkraft", "Kraft ist Masse mal Beschleunigung", "Ein Körper bleibt in Ruhe oder gleichförmiger Bewegung, solange keine resultierende Kraft wirkt"], correctIndex: 3, explanation: "Das Trägheitsprinzip (Lex Prima) besagt: Ohne eine resultierende äußere Kraft ändert ein Körper weder seine Geschwindigkeit noch seine Bewegungsrichtung – Ruhe und gleichförmige Bewegung sind gleichberechtigte, kräftefreie Zustände. Die Antwort 'Kraft ist Masse mal Beschleunigung' beschreibt stattdessen das 2. Newtonsche Gesetz und die Aussage über Gegenkräfte das 3. Gesetz." },
      { id: "yn1", type: "yesno", question: "Ändert sich die Masse eines Körpers, wenn er vom Erdboden zum Mond gebracht wird?", correctAnswer: false, reasons: ["Nein, weil die Masse ortsunabhängig ist; die Gewichtskraft F_G = m·g ändert sich mit g.", "Ja, weil die Anziehungskraft des Mondes geringer ist und dadurch weniger Materie im Körper gebunden bleibt.", "Nein, weil die Gewichtskraft laut Definition überall im Universum konstant bleibt und sich die Masse anpasst.", "Ja, weil Masse und Gewichtskraft laut Definition stets proportional zueinander sind und sich gemeinsam ändern."], correctReasonIndex: 0, explanation: "Die Masse ist eine intrinsische, ortsunabhängige Eigenschaft (in kg), während die Gewichtskraft F_G = m·g vom lokalen g abhängt – auf dem Mond bleibt m gleich, nur F_G sinkt auf etwa ein Sechstel." },
      { id: "q2", question: "Welche Einheit hat die Kraft im SI-System?", options: ["kg/m²", "Newton (N) = kg·m/s²", "Joule (J)", "kg·m/s"], correctIndex: 1, explanation: "Aus dem 2. Newtonschen Gesetz F = m·a folgt für die Einheit [F] = kg·m/s², die als Newton (N) bezeichnet wird: 1 N erteilt einer Masse von 1 kg eine Beschleunigung von 1 m/s². Joule (J = N·m) ist die Einheit der Energie/Arbeit und kg·m/s die Einheit des Impulses – beide werden gern mit der Kraft verwechselt." },
      { id: "q3", question: "Was ist der Unterschied zwischen Masse und Gewichtskraft?", options: ["Gewichtskraft ist immer größer als die Masse", "Die Masse wird auf der Waage gemessen und ist standortabhängig", "Es gibt keinen Unterschied, beide sind gleich", "Masse ist in kg, Gewichtskraft in N. Die Masse ist konstant, die Gewichtskraft hängt von g ab"], correctIndex: 3, explanation: "Die Masse (in kg) ist eine intrinsische, standortunabhängige Eigenschaft des Körpers, während die Gewichtskraft F_G = m·g (in Newton) über die Ortsbeschleunigung g vom Aufenthaltsort abhängt – auf dem Mond ist F_G bei gleicher Masse etwa sechsmal kleiner als auf der Erde. Beide Größen als 'gleich' zu betrachten ist ein weit verbreiteter Alltagsirrtum, der sich schon an der unterschiedlichen Einheit (kg vs. N) widerlegen lässt." },
      { id: "q4", question: "Was beschreibt das 3. Newtonsche Gesetz (Actio = Reactio)?", options: ["Reibungskräfte sind stets gleich der Normalkraft", "Kräfte wirken paarweise: Kraft und Gegenkraft sind gleich groß und entgegengesetzt gerichtet", "Die Summe aller Kräfte ist null", "Ein Körper kann keine Kraft auf sich selbst ausüben"], correctIndex: 1, explanation: "Actio = Reactio besagt, dass jede Kraft, die Körper 1 auf Körper 2 ausübt, von einer gleich großen, aber entgegengesetzt gerichteten Kraft von Körper 2 auf Körper 1 begleitet wird: F₁₂ = –F₂₁. Wichtig ist, dass beide Kräfte an verschiedenen Körpern angreifen – sie heben sich deshalb nicht gegenseitig auf, wie es die Aussage 'Summe aller Kräfte ist null' fälschlich nahelegt." },
      { id: "q5", question: "Eine Kraft von 500 N wirkt auf einen 50 kg schweren Körper. Welche Beschleunigung erfährt er?", options: ["a = 25000 m/s²", "a = 50 m/s²", "a = 10 m/s²", "a = 0,1 m/s²"], correctIndex: 2, explanation: "Aus F = m·a folgt durch Umstellen a = F/m = 500 N / 50 kg = 10 m/s². Die Distraktoren entstehen durch typische Rechenfehler wie Multiplizieren statt Dividieren (25000 m/s²) oder Vertauschen von Zähler und Nenner (0,1 m/s²)." },
      { id: "q6", question: "Wirken auf einen ruhenden Körper zwei entgegengesetzte Kräfte F₁ = 100 N und F₂ = 60 N. Was passiert?", options: ["Beide Kräfte heben sich auf, da sie entgegengesetzt wirken", "Der Körper bleibt in Ruhe (Kräftegleichgewicht)", "Der Körper beschleunigt in Richtung der kleineren Kraft F₂", "Der Körper beschleunigt in Richtung der größeren Kraft F₁"], correctIndex: 3, explanation: "Nach dem Superpositionsprinzip ist die Gesamtkraft die vektorielle Summe: F_res = 100 N – 60 N = 40 N in Richtung von F₁. Da F_res ≠ 0 ist, liegt kein Kräftegleichgewicht vor – der Körper beschleunigt nach F = m·a in Richtung der größeren, nicht vollständig kompensierten Kraft." },
      { id: "q7", question: "Warum gleitet ein Körper auf einer Fläche weiter, wenn man aufhört zu schieben (solange Reibung vernachlässigt wird)?", options: ["Wegen des Trägheitsprinzips: ohne äußere Kraft ändert sich die Bewegung nicht", "Weil eine unsichtbare Restkraft noch nachwirkt", "Wegen der Schwerkraft, die hier horizontal wirkt", "Weil die Normalkraft den Körper vorwärtstreibt"], correctIndex: 0, explanation: "Nach dem 1. Newtonschen Gesetz behält ein Körper seinen Bewegungszustand bei, solange keine resultierende äußere Kraft wirkt. Ohne Reibung entfällt die einzige verzögernde Kraft, sodass die Geschwindigkeit konstant bleibt – es ist keine 'nachwirkende' Kraft nötig, um die Bewegung fortzusetzen, wie die zweite Option fälschlich unterstellt." },
      { id: "q8", question: "Wie wirkt Actio = Reactio beim Schwimmen? Eine Person stößt mit den Armen Wasser nach hinten.", options: ["Das Wasser drückt den Schwimmer nach vorne (Reaktionskraft)", "Das Wasser hat praktisch keine Wirkung auf den Schwimmer", "Die Trägheit des Wassers erzeugt eine Kraft nach hinten auf den Schwimmer", "Das Wasser zieht den Schwimmer stattdessen nach unten"], correctIndex: 0, explanation: "Der Schwimmer übt mit den Armen eine Kraft nach hinten auf das Wasser aus (Actio). Nach dem 3. Newtonschen Gesetz übt das Wasser eine gleich große, entgegengesetzte Kraft nach vorne auf den Schwimmer aus (Reactio) – dieser Rückstoß treibt ihn an, ganz analog zum Rückstoßprinzip einer Rakete." },
      { id: "q9", question: "Was versteht man unter einem Freikörperdiagramm (Kräftediagramm)?", options: ["Eine grafische Darstellung der Reibungskoeffizienten", "Eine Skizze, in der ein Körper isoliert und alle auf ihn wirkenden Kräfte als Pfeile eingezeichnet werden", "Ein Diagramm, das nur die Bewegungsbahn darstellt", "Ein Diagramm zur Darstellung der Energie als Funktion der Zeit"], correctIndex: 1, explanation: "Im Freikörperdiagramm wird der betrachtete Körper von seiner Umgebung gedanklich losgelöst und alle an ihm angreifenden Kräfte (Gewichtskraft, Normalkraft, Reibung, Seilkraft, …) werden als Vektorpfeile eingezeichnet. Es dient dazu, die Kräftebilanz F_ges = ΣF_i systematisch aufzustellen – anders als eine reine Bahnkurven- oder Energie-Zeit-Darstellung." },
      { id: "q10", question: "Ein Körper der Masse 2 kg hat auf der Erde eine Gewichtskraft von ca. 19,6 N. Wie groß ist seine Gewichtskraft auf dem Mond (g_Mond ≈ 1,62 m/s²)?", options: ["19,6 N (Masse und Gewichtskraft sind gleich)", "1,62 N", "3,24 N", "12,1 N"], correctIndex: 2, explanation: "F_G = m · g_Mond = 2 kg · 1,62 m/s² = 3,24 N. Die Masse bleibt überall im Universum konstant (2 kg), aber die Gewichtskraft skaliert direkt mit der lokalen Fallbeschleunigung – auf dem Mond ist sie mit g_Mond ≈ 1,62 m/s² nur rund ein Sechstel des Erdwerts." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Welche Aussage über Haft- und Gleitreibungskoeffizient ist richtig?", options: ["μ_G < μ_H (Haftreibung größer als Gleitreibung)", "μ_G = μ_H (beide sind exakt gleich groß)", "Es kommt immer auf das Material an, ein allgemeiner Vergleich ist unmöglich", "μ_G > μ_H (Gleitreibung größer als Haftreibung)"], correctIndex: 0, explanation: "In der Regel gilt μ_G < μ_H: Um einen ruhenden Körper überhaupt erst in Bewegung zu versetzen, muss die maximale Haftreibungskraft F_H ≤ μ_H·F_N überwunden werden, die stets größer ist als die anschließende Gleitreibungskraft F_R = μ_G·F_N. Deshalb 'ruckt' ein Körper beim Anschieben oft zunächst und gleitet danach leichter weiter." },
      { id: "q2", question: "Von was hängt die Gleitreibungskraft ab?", options: ["Von der Masse des Körpers, unabhängig von F_N", "Von der Momentangeschwindigkeit des Körpers", "Von der Größe der Kontaktfläche zwischen den Körpern", "Vom Gleitreibungskoeffizient μ_G und der Normalkraft F_N"], correctIndex: 3, explanation: "Nach F_R = μ_G · F_N hängt die Gleitreibungskraft nur vom Material (μ_G) und der senkrecht auf die Fläche drückenden Normalkraft F_N ab – nicht direkt von der Kontaktfläche oder der Geschwindigkeit, wie man intuitiv erwarten könnte. Größere Kontaktfläche verteilt zwar den Druck, ändert aber F_N und damit F_R im einfachen Coulombschen Reibungsmodell nicht." },
      { id: "q3", question: "Wie verhält sich die Gravitationskraft, wenn der Abstand r zwischen zwei Massen verdoppelt wird?", options: ["Sie wird viermal größer", "Sie wird viermal kleiner", "Sie halbiert sich exakt", "Sie bleibt unverändert"], correctIndex: 1, explanation: "Das Gravitationsgesetz F = G·m₁·m₂/r² enthält den Abstand quadratisch im Nenner. Bei Verdopplung von r wird r² vervierfacht, also F' = G·m₁·m₂/(2r)² = F/4 – die Kraft sinkt auf ein Viertel, nicht nur auf die Hälfte, wie man bei linearer statt quadratischer Abhängigkeit fälschlich annehmen könnte." },
      { id: "q4", question: "Was beschreibt das Hookesche Gesetz?", options: ["Die Reibungskraft ist proportional zur Normalkraft", "Die Gravitationskraft nimmt mit dem Quadrat des Abstands ab", "Die Luftwiderstandskraft ist proportional zur Geschwindigkeit", "Die Federkraft ist proportional zur Auslenkung: F = –k·x"], correctIndex: 3, explanation: "Das Hookesche Gesetz F = –k·x besagt, dass die Federkraft proportional zur Auslenkung x ist und stets entgegen der Auslenkungsrichtung wirkt (das Minuszeichen macht sie rücktreibend). Die anderen Optionen beschreiben andere Kraftgesetze aus demselben Kapitel: Reibung folgt F_R = μ·F_N, Gravitation dem 1/r²-Gesetz und Luftwiderstand einer Abhängigkeit von v², nicht von v." },
      { id: "yn1", type: "yesno", question: "Vervierfacht sich die Gravitationskraft zwischen zwei Massen, wenn beide Massen verdoppelt werden (Abstand r konstant)?", correctAnswer: true, reasons: ["Ja, weil F = G·m₁·m₂/r² proportional zum Produkt beider Massen ist und dieses sich bei Verdopplung vervierfacht.", "Nein, weil sich die Kraft nur verdoppelt, da sie linear von der Gesamtmasse beider Körper abhängt und nicht vom Produkt.", "Ja, weil sich der Abstand r zwischen den Massenschwerpunkten automatisch verringert, wenn die beteiligten Massen größer werden.", "Nein, weil die Gravitationskonstante G bei größeren Massen kleiner wird und den Effekt der Massenzunahme ausgleicht."], correctReasonIndex: 0, explanation: "F = G·m₁·m₂/r² enthält das Produkt der beiden Massen; verdoppelt man beide, wird das Produkt viermal so groß, also vervierfacht sich F bei konstantem r." },
      { id: "q5", question: "Ein Block liegt auf einer schiefen Ebene mit Winkel θ. Welche Kraftkomponente drückt den Block senkrecht auf die Fläche (Normalkraft)?", options: ["F_N = m·g·tan(θ)", "F_N = m·g", "F_N = m·g·cos(θ)", "F_N = m·g·sin(θ)"], correctIndex: 2, explanation: "Am schiefen Hang zerlegt man die Gewichtskraft m·g in zwei zueinander senkrechte Komponenten: Die zur Fläche senkrechte Komponente ist F_N = m·g·cos(θ), die hangparallele Komponente F_∥ = m·g·sin(θ). Bei θ = 0° (horizontale Fläche) ergibt cos(0°) = 1 korrekt F_N = m·g, was die Formel als Sonderfall bestätigt." },
      { id: "q6", question: "Die Gravitationskonstante G hat den Wert:", options: ["G = 9,81 m/s² (Erdbeschleunigung)", "G = 6,022·10²³ mol⁻¹ (Avogadro-Konstante)", "G = 6,674·10⁻¹¹ N·m²/kg²", "G = 3·10⁸ m/s (Lichtgeschwindigkeit)"], correctIndex: 2, explanation: "Die Gravitationskonstante beträgt G = 6,674·10⁻¹¹ N·m²/kg² und ist eine fundamentale Naturkonstante, die für jede Massenpaarung im Universum gilt. Sie darf nicht mit der ortsabhängigen Erdbeschleunigung g = 9,81 m/s² verwechselt werden, die sich erst aus G über g = G·M_Erde/R_Erde² ergibt." },
      { id: "q7", question: "Wovon hängt der Luftwiderstand F_L hauptsächlich ab?", options: ["Vom Quadrat der Geschwindigkeit: F_L ~ v²", "Nur von der Stirnfläche A, unabhängig von v", "Linear von der Geschwindigkeit: F_L ~ v", "Ausschließlich von der Masse des bewegten Körpers"], correctIndex: 0, explanation: "Nach F_L = ½·ρ·c_W·A·v² geht die Geschwindigkeit quadratisch in den Luftwiderstand ein. Bei doppelter Geschwindigkeit vervierfacht sich also F_L – ein wichtiger Grund, warum der Kraftstoffverbrauch bei hohen Autobahngeschwindigkeiten überproportional ansteigt, während eine bloß lineare Abhängigkeit diesen Effekt deutlich unterschätzen würde." },
      { id: "q8", question: "Warum ist es schwieriger, einen ruhenden Körper in Bewegung zu versetzen als ihn dann in Bewegung zu halten?", options: ["Weil die Trägheit des Körpers beim Anfahren plötzlich zunimmt", "Weil Reibung geschwindigkeitsabhängig ist und bei v = 0 maximal wird", "Weil beim Bewegen zusätzlich die Normalkraft ansteigt", "Weil der Haftreibungskoeffizient größer ist als der Gleitreibungskoeffizient"], correctIndex: 3, explanation: "Da μ_H > μ_G gilt, ist die maximale Haftreibungskraft, die beim Anfahren überwunden werden muss, größer als die Gleitreibungskraft während der Bewegung. Die Trägheit (Masse) und die Normalkraft F_N bleiben dabei unverändert – es ist allein der unterschiedliche Reibungskoeffizient, der den Unterschied verursacht." },
      { id: "q9", question: "Wie berechnet sich die Erdbeschleunigung g aus der Gravitationskonstante G?", options: ["g = G · M_Erde", "g = G · M_Erde / R_Erde²", "g = G / (M_Erde · R_Erde²)", "g = G · M_Erde / R_Erde"], correctIndex: 1, explanation: "Setzt man die Gewichtskraft m·g gleich der Gravitationskraft an der Erdoberfläche G·m·M_E/R_E², kürzt sich die Masse m des Körpers heraus und es bleibt g = G·M_E/R_E² ≈ 9,81 m/s². Die anderen Formeln entstehen durch das Weglassen oder falsche Platzieren des Radius-Quadrats." },
      { id: "q10", question: "Eine Feder (k = 500 N/m) hält einen 2 kg schweren Körper im Gleichgewicht. Um wie viel wird sie gedehnt?", options: ["x = 9,81 cm", "x = 25 cm", "x = 3,92 cm", "x = 2,5 cm"], correctIndex: 2, explanation: "Im Kräftegleichgewicht gilt Federkraft = Gewichtskraft: k·x = m·g, also x = m·g/k = (2·9,81)/500 ≈ 0,0392 m = 3,92 cm. Wer stattdessen g direkt als Zentimeterwert übernimmt (9,81 cm) oder die Masse vergisst zu multiplizieren (25 cm bzw. 2,5 cm), erhält eines der falschen Ergebnisse." }
    ]
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Wirkt die Corioliskraft auch auf einen Körper, der im rotierenden Bezugssystem ruht (v' = 0)?", correctAnswer: false, reasons: ["Nein, weil die Corioliskraft F_C = −2m·(ω×v') proportional zur Relativgeschwindigkeit v' ist – bei v' = 0 verschwindet sie.", "Ja, weil jede Rotation automatisch eine Corioliskraft auf alle Körper im System erzeugt, unabhängig von deren eigener Bewegung relativ zum System.", "Nein, weil die Corioliskraft nur bei sehr hohen Winkelgeschwindigkeiten ω spürbar auftritt und sonst vernachlässigbar klein ist.", "Ja, weil Zentrifugalkraft und Corioliskraft im rotierenden System stets gemeinsam und gleich groß wirken."], correctReasonIndex: 0, explanation: "Da F_C = −2m·(ω×v') von der Relativgeschwindigkeit v' des Körpers im rotierenden System abhängt, wirkt auf einen ruhenden Körper (v' = 0) keine Corioliskraft – wohl aber weiterhin die von v' unabhängige Zentrifugalkraft." },
