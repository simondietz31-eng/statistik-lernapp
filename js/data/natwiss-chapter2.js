const NATWISS_CHAPTER2_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ändert sich die Masse eines Körpers, wenn er vom Erdboden zum Mond gebracht wird?", correctAnswer: false, reasons: ["Nein, weil die Masse eine ortsunabhängige Eigenschaft des Körpers ist; nur die Gewichtskraft F_G = m·g ändert sich mit der Ortsbeschleunigung g.", "Ja, weil die Anziehungskraft des Mondes geringer ist und dadurch weniger Materie im Körper gebunden bleibt.", "Nein, weil die Gewichtskraft überall im Universum konstant ist und sich stattdessen die Masse anpasst.", "Ja, weil Masse und Gewichtskraft laut Definition stets proportional zueinander sind und sich gemeinsam ändern."], correctReasonIndex: 0, explanation: "Die Masse ist eine intrinsische, ortsunabhängige Eigenschaft (in kg), während die Gewichtskraft F_G = m·g vom lokalen g abhängt – auf dem Mond bleibt m gleich, nur F_G sinkt auf etwa ein Sechstel." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Vervierfacht sich die Gravitationskraft zwischen zwei Massen, wenn beide Massen verdoppelt werden (Abstand r konstant)?", correctAnswer: true, reasons: ["Ja, weil F = G·m₁·m₂/r² proportional zum Produkt beider Massen ist und dieses sich bei Verdopplung beider Massen vervierfacht.", "Nein, weil sich die Kraft nur verdoppelt, da sie linear von der Gesamtmasse abhängt.", "Ja, weil sich der Abstand r automatisch verringert, wenn die Massen größer werden.", "Nein, weil die Gravitationskonstante G bei größeren Massen kleiner wird und den Effekt ausgleicht."], correctReasonIndex: 0, explanation: "F = G·m₁·m₂/r² enthält das Produkt der beiden Massen; verdoppelt man beide, wird das Produkt viermal so groß, also vervierfacht sich F bei konstantem r." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Wirkt die Corioliskraft auch auf einen Körper, der im rotierenden Bezugssystem ruht (v' = 0)?", correctAnswer: false, reasons: ["Nein, weil die Corioliskraft F_C = −2m·(ω×v') proportional zur Relativgeschwindigkeit v' im rotierenden System ist – bei v' = 0 verschwindet sie.", "Ja, weil jede Rotation automatisch eine Corioliskraft auf alle Körper im System erzeugt, unabhängig von deren Bewegung.", "Nein, weil die Corioliskraft nur bei sehr hohen Winkelgeschwindigkeiten ω auftritt.", "Ja, weil Zentrifugalkraft und Corioliskraft im rotierenden System stets gemeinsam und gleich groß wirken."], correctReasonIndex: 0, explanation: "Da F_C = −2m·(ω×v') von der Relativgeschwindigkeit v' des Körpers im rotierenden System abhängt, wirkt auf einen ruhenden Körper (v' = 0) keine Corioliskraft – wohl aber weiterhin die von v' unabhängige Zentrifugalkraft." },
