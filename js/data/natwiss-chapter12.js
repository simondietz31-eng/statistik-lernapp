const NATWISS_CHAPTER12_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist der Zyklotronradius eines geladenen Teilchens im Magnetfeld unabhängig von seiner Masse?", correctAnswer: false, reasons: ["Nein, weil r = m·v/(|q|·B) direkt proportional zur Masse ist – ein schwereres Teilchen hat bei gleicher Geschwindigkeit einen größeren Bahnradius.", "Ja, weil die Lorentzkraft nur von Ladung, Geschwindigkeit und Magnetfeld abhängt, sodass die Masse für die Bahnkurve keine Rolle spielt.", "Nein, weil schwerere Teilchen nach gängiger Annahme automatisch eine proportional geringere Ladung q besitzen, sodass sich beide Effekte im Radius gegenseitig ausgleichen.", "Ja, weil alle geladenen Teilchen unabhängig von ihrer Masse im selben homogenen Magnetfeld stets denselben Zyklotronradius auf ihrer Kreisbahn durchlaufen."], correctReasonIndex: 0, explanation: "Der Zyklotronradius r = mv/(|q|B) hängt zwar über die Lorentzkraft von q ab, ist aber direkt proportional zur Masse m: Bei gleicher Geschwindigkeit v und gleichem B durchläuft ein schwereres Teilchen wegen seiner größeren Trägheit eine Kreisbahn mit größerem Radius." },
      { id: "q6", question: "Wie lautet die Kraft auf einen stromdurchflossenen Leiter im Magnetfeld?", options: ["F = I·L·B·sin(θ), die Kraft auf den stromdurchflossenen Leiter", "F = B²·L/I (quadratisch in B)", "F = q·v·B (Formel der Lorentzkraft)", "F = U·I/B (mit Leistung kombiniert)"], correctIndex: 0, explanation: "Der Lehrtext nennt für die Kraft auf einen stromdurchflossenen Leiter F = I·L·B·sin(θ), abgeleitet aus der Lorentzkraft für viele bewegte Ladungsträger. Die Formel q·v·B gilt dagegen für eine einzelne bewegte Ladung, nicht für einen Strom I durch einen Leiter der Länge L." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Nimmt das Magnetfeld eines geraden, unendlich langen Leiters mit dem Quadrat des Abstands ab (wie das elektrische Feld einer Punktladung)?", correctAnswer: false, reasons: ["Nein, weil B = μ₀I/(2πr) nur linear mit 1/r abfällt, nicht quadratisch wie das E-Feld einer Punktladung (E ∝ 1/r²).", "Ja, weil in der klassischen Elektrodynamik ausnahmslos alle fundamentalen Feldgesetze demselben 1/r²-Abstandsgesetz wie die Coulombkraft folgen.", "Nein, weil das Magnetfeld eines geraden, unendlich langen stromdurchflossenen Leiters überhaupt nicht vom radialen Abstand zum Leiter abhängt.", "Ja, weil Magnetfeld und elektrisches Feld als verwandte Erscheinungsformen exakt dieselbe Abstandsabhängigkeit haben müssen."], correctReasonIndex: 0, explanation: "Das Biot-Savart-Gesetz liefert für den geraden unendlichen Leiter B = μ₀I/(2πr) – eine 1/r-Abhängigkeit, im Unterschied zum 1/r²-Abstandsgesetz des elektrischen Feldes einer Punktladung; beide Felder folgen also unterschiedlichen Potenzgesetzen." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Erzeugt ein konstantes, zeitlich unveränderliches Magnetfeld durch eine ruhende Leiterschleife eine induzierte Spannung?", correctAnswer: false, reasons: ["Nein, weil U_ind = −N·dΦ/dt nur bei zeitlicher Änderung des Flusses eine Spannung liefert; bei konstantem B ist dΦ/dt = 0.", "Ja, weil jedes vorhandene Magnetfeld unabhängig von seiner zeitlichen Änderung automatisch eine Spannung induziert.", "Nein, weil eine ruhende Leiterschleife nach gängiger Fehlvorstellung grundsätzlich niemals einen von null verschiedenen magnetischen Fluss besitzen kann.", "Ja, weil die Windungszahl N allein schon ausreicht, um eine Spannung zu erzeugen, unabhängig vom Feldverlauf."], correctReasonIndex: 0, explanation: "Das Faradaysche Induktionsgesetz U_ind = −N·dΦ/dt zeigt, dass nur eine zeitliche Änderung des magnetischen Flusses eine Spannung induziert; ein konstantes Feld durch eine ruhende Schleife liefert dΦ/dt = 0 und damit keine induzierte Spannung, auch wenn der Fluss selbst ungleich null ist." },
      ...
      { id: "q4", question: "Wie groß ist die motionale EMF eines Stabs mit L = 1 m, v = 5 m/s, B = 2 T?", options: ["0,4 V, bei vertauschter Divisionsreihenfolge", "2,5 V, bei falscher Zuordnung der Größen", "5 V, ohne den Beitrag der Länge L", "10 V, mit B, L und v korrekt multipliziert"], correctIndex: 3, explanation: "Nach der Formel für motionale Induktion U_ind = B·L·v aus dem Lehrtext ergibt sich U = 2 T · 1 m · 5 m/s = 10 V. Die anderen Werte entstehen, wenn man einen der drei Faktoren B, L oder v beim Multiplizieren auslässt oder vertauscht." },
