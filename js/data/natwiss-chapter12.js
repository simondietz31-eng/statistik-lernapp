const NATWISS_CHAPTER12_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist der Zyklotronradius eines geladenen Teilchens im Magnetfeld unabhängig von seiner Masse?", correctAnswer: false, reasons: ["Nein, weil r = m·v/(|q|·B) direkt proportional zur Masse m ist – ein schwereres Teilchen hat bei gleicher Geschwindigkeit und gleichem Feld einen größeren Bahnradius.", "Ja, weil die Lorentzkraft nur von Ladung, Geschwindigkeit und Magnetfeld abhängt, sodass die Masse für die Bahnkurve keine Rolle spielt.", "Nein, weil schwerere Teilchen automatisch eine geringere Ladung q besitzen, was sich im Radius ausgleicht.", "Ja, weil alle geladenen Teilchen im selben Magnetfeld denselben Zyklotronradius durchlaufen."], correctReasonIndex: 0, explanation: "Der Zyklotronradius r = mv/(|q|B) hängt zwar über die Lorentzkraft von q ab, ist aber direkt proportional zur Masse m: Bei gleicher Geschwindigkeit v und gleichem B durchläuft ein schwereres Teilchen wegen seiner größeren Trägheit eine Kreisbahn mit größerem Radius." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Nimmt das Magnetfeld eines geraden, unendlich langen Leiters mit dem Quadrat des Abstands ab (wie das elektrische Feld einer Punktladung)?", correctAnswer: false, reasons: ["Nein, weil B = μ₀I/(2πr) für den geraden Leiter nur linear mit dem Kehrwert des Abstands abfällt, nicht quadratisch wie das elektrische Feld einer Punktladung (E ∝ 1/r²).", "Ja, weil alle Feldgesetze in der Elektrodynamik demselben 1/r²-Abstandsgesetz folgen.", "Nein, weil das Magnetfeld eines geraden Leiters überhaupt nicht vom Abstand abhängt.", "Ja, weil Magnetfeld und elektrisches Feld exakt dieselbe Abstandsabhängigkeit haben müssen."], correctReasonIndex: 0, explanation: "Das Biot-Savart-Gesetz liefert für den geraden unendlichen Leiter B = μ₀I/(2πr) – eine 1/r-Abhängigkeit, im Unterschied zum 1/r²-Abstandsgesetz des elektrischen Feldes einer Punktladung; beide Felder folgen also unterschiedlichen Potenzgesetzen." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Erzeugt ein konstantes, zeitlich unveränderliches Magnetfeld durch eine ruhende Leiterschleife eine induzierte Spannung?", correctAnswer: false, reasons: ["Nein, weil U_ind = −N·dΦ/dt nur bei einer zeitlichen Änderung des magnetischen Flusses eine Spannung liefert; bei konstantem B und ruhender Schleife ist dΦ/dt = 0.", "Ja, weil jedes vorhandene Magnetfeld unabhängig von seiner zeitlichen Änderung automatisch eine Spannung induziert.", "Nein, weil eine ruhende Leiterschleife grundsätzlich keinen magnetischen Fluss besitzen kann.", "Ja, weil die Windungszahl N allein schon ausreicht, um eine Spannung zu erzeugen, unabhängig vom Feldverlauf."], correctReasonIndex: 0, explanation: "Das Faradaysche Induktionsgesetz U_ind = −N·dΦ/dt zeigt, dass nur eine zeitliche Änderung des magnetischen Flusses eine Spannung induziert; ein konstantes Feld durch eine ruhende Schleife liefert dΦ/dt = 0 und damit keine induzierte Spannung, auch wenn der Fluss selbst ungleich null ist." },
