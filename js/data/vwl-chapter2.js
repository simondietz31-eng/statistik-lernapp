const VWL_CHAPTER2_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Was kennzeichnet einen Wettbewerbsmarkt (Polypol)?", options: ["Viele Anbieter und viele Nachfrager mit homogenen Produkten, keiner kann den Preis beeinflussen","Ein einziger Anbieter setzt den Preis fest","Nur ein Nachfrager trifft auf viele Anbieter","Wenige Anbieter mit hoher Marktmacht"], correctIndex: 0, explanation: "Im Polypol gibt es viele Anbieter und Nachfrager mit identischen Produkten; alle sind Preisnehmer." },
      { id: "q2", question: "Welche Marktform liegt vor, wenn nur ein Verkäufer den Marktpreis festsetzen kann?", options: ["Monopol","Monopolistische Konkurrenz","Oligopol","Polypol"], correctIndex: 0, explanation: "Ein Monopol besteht aus nur einem Verkäufer, der mangels Wettbewerb den Preis selbst bestimmen kann." },
      ...
      { id: "q4", question: "Was besagt das Gesetz der Nachfrage?", options: ["Ein Preisanstieg führt c.p. zu einem Rückgang der nachgefragten Menge","Nachfrage ist unabhängig vom Preis","Nachfrage hängt nur vom Angebot ab","Ein Preisanstieg führt c.p. zu einem Anstieg der nachgefragten Menge"], correctIndex: 0, explanation: "Das Gesetz der Nachfrage besagt, dass unter sonst gleichen Bedingungen ein Preisanstieg die nachgefragte Menge senkt." },
      { id: "q5", question: "Welche Steigung hat die Nachfragekurve typischerweise?", options: ["Unendlich","Konstant Null","Positiv","Negativ"], correctIndex: 3, explanation: "Weil steigende Preise die Nachfragemenge senken, verläuft die Nachfragekurve fallend, also mit negativer Steigung." },
      { id: "q6", question: "Wodurch entsteht eine reine Bewegung entlang der Nachfragekurve (statt einer Verschiebung)?", options: ["Eine Änderung der Bevölkerungsgröße","Eine Änderung des Einkommens","Eine Änderung der Vorlieben der Konsumenten","Eine Änderung des Preises des betrachteten Gutes selbst"], correctIndex: 3, explanation: "Nur eine Preisänderung des betrachteten Gutes selbst führt zu einer Bewegung entlang der unveränderten Nachfragekurve." },
      { id: "q7", question: "Wie wirkt sich ein Einkommensanstieg bei einem inferioren Gut auf die Nachfrage aus?", options: ["Die Nachfrage bleibt konstant","Die Nachfrage steigt","Die Nachfrage sinkt","Die Nachfragekurve wird zur Angebotskurve"], correctIndex: 2, explanation: "Bei einem inferioren Gut sinkt die Nachfrage, wenn das Einkommen steigt." },
      { id: "q8", question: "Zwei Güter sind Substitute, wenn ...", options: ["ein sinkender Preis des einen Gutes die Nachfrage nach dem anderen Gut erhöht","beide Güter denselben Preis haben","beide Güter immer gemeinsam konsumiert werden","ein sinkender Preis des einen Gutes die Nachfrage nach dem anderen Gut verringert"], correctIndex: 3, explanation: "Substitute sind Güter, bei denen ein sinkender Preis des einen Gutes die Nachfrage nach dem anderen Gut verringert." },
      { id: "q9", question: "Zwei Güter sind komplementär, wenn ...", options: ["sie identische Produkte sind","ein sinkender Preis des einen Gutes die Nachfrage nach dem anderen Gut erhöht","sie nie gemeinsam gekauft werden","ein sinkender Preis des einen Gutes die Nachfrage nach dem anderen Gut verringert"], correctIndex: 1, explanation: "Komplementäre Güter zeichnen sich dadurch aus, dass ein sinkender Preis des einen Gutes die Nachfrage nach dem anderen Gut erhöht." },
      { id: "q10", question: "Wie ergibt sich die Marktnachfragekurve aus den individuellen Nachfragekurven?", options: ["Durch vertikale Addition der individuellen Kurven","Durch Subtraktion der individuellen Kurven","Durch horizontale Addition der individuellen Kurven","Durch Multiplikation der individuellen Kurven"], correctIndex: 2, explanation: "Die Marktnachfragekurve ergibt sich grafisch aus der horizontalen Addition aller individuellen Nachfragekurven." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Was besagt das Gesetz des Angebots?", options: ["Die angebotene Menge sinkt c.p. mit steigendem Preis","Die angebotene Menge steigt c.p. mit steigendem Preis","Das Angebot entspricht immer der Nachfrage","Das Angebot ist unabhängig vom Preis"], correctIndex: 1, explanation: "Nach dem Gesetz des Angebots steigt die angebotene Menge unter sonst gleichen Bedingungen mit dem Preis." },
      { id: "q2", question: "Welche Steigung hat die Angebotskurve typischerweise?", options: ["Nicht definierbar","Positiv","Null","Negativ"], correctIndex: 1, explanation: "Da die angebotene Menge mit dem Preis steigt, hat die Angebotskurve eine positive Steigung." },
      { id: "q3", question: "Welcher Faktor verschiebt die Angebotskurve NICHT, sondern führt nur zu einer Bewegung entlang ihr?", options: ["Eine Änderung der Anzahl der Anbieter","Technologischer Fortschritt","Eine Preisänderung des betrachteten Gutes selbst","Eine Änderung der Inputpreise"], correctIndex: 2, explanation: "Nur eine Preisänderung des betrachteten Gutes selbst bewirkt eine Bewegung entlang der unveränderten Angebotskurve." },
      { id: "q4", question: "Wo liegt das Marktgleichgewicht grafisch?", options: ["Am niedrigsten Punkt der Angebotskurve","Am linken Rand des Diagramms","Am höchsten Punkt der Nachfragekurve","Am Schnittpunkt von Angebots- und Nachfragekurve"], correctIndex: 3, explanation: "Das Marktgleichgewicht liegt am Schnittpunkt von Angebots- und Nachfragekurve." },
      { id: "q5", question: "Was passiert bei einem Angebotsüberschuss (Preis über dem Gleichgewichtspreis)?", options: ["Die Nachfragekurve verschwindet","Anbieter erhöhen ihre Preise weiter","Der Markt bleibt dauerhaft im Ungleichgewicht","Anbieter senken ihre Preise, um den Absatz zu stimulieren"], correctIndex: 3, explanation: "Bei einem Angebotsüberschuss senken Anbieter ihre Preise, um den Absatz zu stimulieren, wodurch sich der Markt zum Gleichgewicht hin bewegt." },
      ...
      { id: "q7", question: "Was ist der erste Schritt bei der Analyse, wie sich ein Ereignis auf das Marktgleichgewicht auswirkt?", options: ["Den alten Gleichgewichtspreis löschen","Die neue Gleichgewichtsmenge berechnen","Die Steigung der Kurven verändern","Entscheiden, ob das Ereignis die Angebots- und/oder die Nachfragekurve beeinflusst"], correctIndex: 3, explanation: "Zuerst muss geklärt werden, ob ein Ereignis die Angebots- oder die Nachfragekurve (oder beide) betrifft." },
      { id: "q8", question: "Wie verändert ein Nachfrageanstieg bei konstantem Angebot das Marktgleichgewicht?", options: ["Höherer Preis, höhere Menge","Höherer Preis, niedrigere Menge","Preis und Menge bleiben unverändert","Niedrigerer Preis, höhere Menge"], correctIndex: 0, explanation: "Ein Nachfrageanstieg bei konstantem Angebot führt zu einem höheren Gleichgewichtspreis und einer höheren Gleichgewichtsmenge." },
      { id: "q9", question: "Wie verändert ein Angebotsrückgang bei konstanter Nachfrage das Marktgleichgewicht?", options: ["Niedrigerer Preis, niedrigere Menge","Höherer Preis, höhere Menge","Preis und Menge bleiben unverändert","Höherer Preis, niedrigere Menge"], correctIndex: 3, explanation: "Ein Angebotsrückgang bei konstanter Nachfrage führt zu einem höheren Gleichgewichtspreis, aber einer niedrigeren Gleichgewichtsmenge." },
      { id: "q10", question: "Was ist laut Vorlesung ein zentraler Treiber der gestiegenen Mietpreise in deutschen Ballungsräumen auf der Angebotsseite?", options: ["Ein starker Anstieg der Zinsen für Eigentumswohnungen","Ein Rückgang der Zuwanderung","Eine Neubaukrise und Regulierung, die die Marktanpassung hemmen (z. B. Mietendeckel)","Ein Überangebot an Mietwohnungen"], correctIndex: 2, explanation: "Auf der Angebotsseite stagniert oder sinkt das Angebot an Mietwohnungen wegen der Neubaukrise und hemmender Regulierung wie Mietendeckeln." }
    ]
  }
];
