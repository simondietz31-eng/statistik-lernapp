const VWL_CHAPTER8_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Was bezeichnet Inflation?", options: ["Eine Erhöhung der Zinssätze","Einen Rückgang des allgemeinen Preisniveaus","Einen Anstieg des allgemeinen Preisniveaus einer Volkswirtschaft","Einen Anstieg der Arbeitslosigkeit"], correctIndex: 2, explanation: "Inflation bezeichnet einen Anstieg des allgemeinen Preisniveaus einer Volkswirtschaft." },
      { id: "q2", question: "Wie nennt man ein negatives Inflationsniveau, also sinkende Preise?", options: ["Disinflation","Rezession","Stagflation","Deflation"], correctIndex: 3, explanation: "Ein negatives Preisniveauwachstum, also sinkende Preise, wird als Deflation bezeichnet." },
      { id: "q3", question: "Was misst der Verbraucherpreisindex (VPI)?", options: ["Nur die Immobilienpreise","Die Preisveränderungen der Güter und Dienstleistungen eines typischen Haushalts","Die Zinssätze der Banken","Die Erzeugerpreise der Industrie"], correctIndex: 1, explanation: "Der VPI misst die Preisveränderungen der Güter und Dienstleistungen, die ein typischer Haushalt konsumiert." },
      { id: "q4", question: "Wie oft wird der VPI in Deutschland berechnet?", options: ["Wöchentlich","Nur alle fünf Jahre","Einmal jährlich","Monatlich"], correctIndex: 3, explanation: "Der Verbraucherpreisindex wird monatlich vom Statistischen Bundesamt berechnet." },
      { id: "q5", question: "Welchen Wert hat der VPI per Definition im gewählten Basisjahr?", options: ["0","1","1000","100"], correctIndex: 3, explanation: "Der VPI wird im Basisjahr auf den Wert 100 gesetzt; alle anderen Jahre werden relativ dazu berechnet." },
      { id: "q6", question: "Wie berechnet sich die Inflationsrate aus dem VPI?", options: ["VPI Jahr 2 geteilt durch VPI Jahr 1","(VPI Jahr 2 − VPI Jahr 1) / VPI Jahr 1 × 100","VPI Jahr 1 minus VPI Jahr 2","VPI Jahr 2 minus VPI Jahr 1"], correctIndex: 1, explanation: "Die Inflationsrate ergibt sich aus der prozentualen Veränderung des VPI: (VPI Jahr 2 − VPI Jahr 1) / VPI Jahr 1 × 100." },
      { id: "q7", question: "Welche Komponenten werden bei der Kerninflationsrate typischerweise ausgeklammert?", options: ["Energie und Nahrungsmittel","Bildung und Gesundheit","Nur Immobilienpreise","Wohnkosten und Versicherungen"], correctIndex: 0, explanation: "Die Kerninflationsrate klammert die besonders volatilen Preiskomponenten Energie und Nahrungsmittel aus." },
      { id: "q8", question: "Warum wird der Warenkorb des VPI laufend aktualisiert?", options: ["Weil der VPI sonst nicht mehr existieren würde","Weil ältere Güter automatisch teurer werden","Damit er weiterhin widerspiegelt, was Konsumenten aktuell tatsächlich kaufen","Weil das Statistische Bundesamt dazu gesetzlich einmal im Jahrhundert verpflichtet ist"], correctIndex: 2, explanation: "Der Warenkorb wird aktualisiert, damit er ein realistisches Bild des aktuellen Konsumverhaltens abbildet." },
      { id: "q9", question: "Welches Beispiel wird in der Vorlesung für ein neu in den Warenkorb aufgenommenes Gut genannt?", options: ["Espressomaschinen","Schallplatten","Schreibmaschinen","Kutschen"], correctIndex: 0, explanation: "Espressomaschinen (ebenso wie Smartphones und Fitness-Tracker) wurden neu in den Warenkorb aufgenommen." },
      { id: "q10", question: "Wie viele Einzelpreise werden laut Vorlesung monatlich für die Berechnung des VPI in Deutschland erhoben?", options: ["Etwa 30.000","Etwa 3 Millionen","Etwa 300.000","Etwa 3.000"], correctIndex: 2, explanation: "Für die Berechnung des VPI werden laut Vorlesung monatlich rund 300.000 Einzelpreise erhoben." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Warum sind Geldbeträge aus unterschiedlichen Zeitpunkten ohne Weiteres nicht direkt vergleichbar?", options: ["Weil Zinssätze immer konstant sind","Weil der VPI nur einmal berechnet wird","Weil sich Währungen ständig ändern","Weil sich das allgemeine Preisniveau über die Zeit verändert"], correctIndex: 3, explanation: "Weil sich das allgemeine Preisniveau über die Zeit verändert, hat derselbe Geldbetrag zu unterschiedlichen Zeitpunkten unterschiedliche Kaufkraft." },
      { id: "q2", question: "Wie rechnet man einen historischen Geldbetrag auf die heutige Kaufkraft um?", options: ["Man addiert einfach die Inflationsrate in Prozentpunkten","Man multipliziert ihn mit dem nominalen Zinssatz","Man multipliziert ihn mit dem Verhältnis der Preisniveaus (heute zu damals)","Man dividiert ihn durch die Anzahl der Jahre"], correctIndex: 2, explanation: "Man skaliert den historischen Betrag mit dem Verhältnis des heutigen zum damaligen Preisniveau." },
      { id: "q3", question: "Was ist der nominale Zinssatz?", options: ["Ein rein historischer Wert","Immer null Prozent","Der üblicherweise ausgewiesene Zinssatz, z. B. ein Bankzinssatz","Der um Inflation bereinigte Zinssatz"], correctIndex: 2, explanation: "Der nominale Zinssatz ist der Zinssatz, der üblicherweise angegeben wird, ohne Bereinigung um Inflation." },
      { id: "q4", question: "Was ist der reale Zinssatz?", options: ["Der um die Auswirkungen der Inflation bereinigte Zinssatz","Der von der Zentralbank vorgegebene Leitzins","Der Zinssatz auf Fremdwährungskonten","Der Zinssatz vor Steuern"], correctIndex: 0, explanation: "Der reale Zinssatz ist der um die Inflation bereinigte Zinssatz und misst den tatsächlichen Kaufkraftgewinn." },
      { id: "q5", question: "Wie berechnet sich der reale Zinssatz näherungsweise?", options: ["Inflationsrate minus nominaler Zinssatz","Nominaler Zinssatz minus Inflationsrate","Nominaler Zinssatz plus Inflationsrate","Nominaler Zinssatz mal Inflationsrate"], correctIndex: 1, explanation: "Der reale Zinssatz ergibt sich näherungsweise als nominaler Zinssatz minus Inflationsrate." },
      { id: "q6", question: "Bei 2 % Nominalzins und 6 % Inflation: Wie hoch ist der reale Zinssatz näherungsweise?", options: ["+4 %","0 %","−4 %","+8 %"], correctIndex: 2, explanation: "2 % − 6 % = −4 %: Trotz positivem Nominalzins verliert das Vermögen real an Kaufkraft." },
      { id: "q7", question: "Was bedeutet ein negativer realer Zinssatz für ein verzinstes Vermögen?", options: ["Das Vermögen wächst nominal und real","Das Vermögen schrumpft auch nominal","Es gibt keine Auswirkung auf die Kaufkraft","Das Vermögen wächst nominal, verliert aber real an Kaufkraft"], correctIndex: 3, explanation: "Bei negativem realem Zinssatz wächst das Vermögen zwar nominal, verliert aber real an Kaufkraft, weil die Inflation den nominalen Ertrag übersteigt." },
      { id: "q8", question: "Welche zwei Ereignisse werden in der Vorlesung als zentrale Auslöser des jüngsten Inflationsschubs genannt?", options: ["Die Euro-Einführung und die deutsche Wiedervereinigung","Das Ende der Corona-Pandemie und der Beginn des Ukraine-Kriegs","Die Finanzkrise 2008 und der Brexit","Die Ölkrise der 1970er-Jahre"], correctIndex: 1, explanation: "Der jüngste Inflationsschub wird auf das Ende der Corona-Pandemie (aufgestaute Nachfrage) und den Beginn des Ukraine-Kriegs (Energieverknappung) zurückgeführt." },
      { id: "q9", question: "Welcher Faktor auf der Angebotsseite hat die Produktion während des jüngsten Inflationsschubs gehemmt?", options: ["Zu niedrige Nachfrage","Ein Überangebot an Rohstoffen","Zu hohe Zinssätze von Beginn an","Lieferengpässe und demografisch bedingte Engpässe am Arbeitsmarkt"], correctIndex: 3, explanation: "Lieferengpässe und Engpässe am Arbeitsmarkt (u. a. demografisch bedingt) hemmten die Produktion, während die Nachfrage bereits wieder anzog." },
      { id: "q10", question: "Wie reagierte die Geldpolitik laut Vorlesung auf den jüngsten Inflationsschub?", options: ["Mit keinerlei Reaktion","Mit einer weiteren Senkung der Zinsen","Mit deutlichen Zinserhöhungen","Mit einer vollständigen Abschaffung des Euro"], correctIndex: 2, explanation: "Die Geldpolitik reagierte auf den Inflationsschub in der Folge mit deutlichen Zinserhöhungen, um die Inflation wieder unter Kontrolle zu bringen." }
    ]
  }
];
