const FINV_CHAPTER7_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Führt geometrische Verzinsung (Zinseszins) über eine Laufzeit von 2,5 Jahren bei positivem Zins zu einem höheren Endwert als lineare Verzinsung?", correctAnswer: true, reasons: ["Ja, weil bereits angefallene Zinsen bei Zinseszins selbst mitverzinst werden.", "Nein, weil lineare und geometrische Verzinsung bei jeder Laufzeit stets identische Endwerte liefern.", "Nein, weil Zinseszins nur bei Laufzeiten unter einem Jahr überhaupt einen Unterschied macht.", "Ja, weil bei Zinseszins grundsätzlich ein höherer Zinssatz angewendet wird als bei linearer Verzinsung."], correctReasonIndex: 0, explanation: "Wie im Tom-Beispiel gezeigt (2.153,39 € statt 2.150 €), führt der Zinseszinseffekt bei mehrjährigen Laufzeiten zu einem etwas höheren Endwert, weil bereits gutgeschriebene Zinsen selbst mitverzinst werden — bei linearer Verzinsung bleibt dagegen stets nur das Ausgangskapital verzinst." },
      ...
      { id: "q6", question: "Welche Größe lässt sich NICHT direkt aus der Formel Kₙ = K₀·(1+n·i) berechnen?", options: ["Der anfängliche Barwert K₀ einer Zahlung", "Der zugrunde liegende Zinssatz i", "Die vereinbarte Laufzeit n in Jahren", "Der Aktienkurs am Bilanzstichtag"], correctIndex: 3, explanation: "Die Formel verknüpft ausschließlich Anfangskapital K₀, Zinssatz i, Laufzeit n und Endwert Kₙ — jede dieser vier Größen lässt sich bei Kenntnis der übrigen drei berechnen. Der Aktienkurs hat mit dieser rein zinsbezogenen Formel nichts zu tun." },
      { id: "q7", question: "Ein Kredit über 500.000 € kostet für 30 Tage 2.500 € Zinsen. Wie hoch ist der lineare Jahreszinssatz?", options: ["3 %", "5 %", "10 %", "6 %"], correctIndex: 3, explanation: "i = Zinsen/(K₀·Tage/360) = 2.500/(500.000·30/360) = 2.500/41.666,67 = 0,06 = 6 % — die 30-Tage-Zinsen werden auf einen vollen Jahreszinssatz hochgerechnet." },
      { id: "q8", question: "Was passiert bei linearer Verzinsung mit bereits angefallenen Zinsen im Vergleich zur Zinseszinsrechnung?", options: ["Sie werden ebenfalls verzinst wie beim Zinseszins", "Sie werden verdoppelt", "Sie werden NICHT mitverzinst — kein Zinseszins", "Sie verschwinden vollständig"], correctIndex: 2, explanation: "Der zentrale Unterschied zur Zinseszinsrechnung: bei linearer Verzinsung werden bereits angefallene Zinsen nicht selbst wieder verzinst, weshalb die lineare Formel in der Praxis meist nur für unterjährige Zeiträume verwendet wird." },
      { id: "q9", question: "K₀ = 10.000 €, i = 5 %, n = 3 Jahre (linear). Wie hoch ist Kₙ?", options: ["11.576,25 €", "10.500 €", "11.500 €", "15.000 €"], correctIndex: 2, explanation: "Kₙ = 10.000·(1+3·0,05) = 10.000·1,15 = 11.500 € — bei linearer Verzinsung wird nur das ursprüngliche Kapital verzinst, nicht (wie bei 11.576,25 € über die geometrische Formel) zusätzlich die bereits angefallenen Zinsen." },
      { id: "q10", question: "Warum ist die Formel Kₙ = K₀·(1+n·i) für sehr lange Laufzeiten (viele Jahre) unrealistisch bzw. unüblich?", options: ["Weil die zugrunde liegende Formel schlicht mathematisch fehlerhaft ist", "Weil über mehrjährige Laufzeiten Zinseszins-Effekte relevant werden und dann meist Zinseszinsrechnung verwendet wird", "Weil diese Formel ausschließlich für Aktienanlagen anwendbar ist", "Weil diese Formel ausschließlich für negative Zinssätze gültig ist"], correctIndex: 1, explanation: "Für Laufzeiten über einem Jahr werden in der Praxis meist Zinseszins-Effekte berücksichtigt, da bereits erwirtschaftete Zinsen selbst wieder verzinst werden — dafür wird dann die geometrische Zinseszinsrechnung (Kapitel 8) statt der linearen Formel verwendet." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Wie werden zwei Zahlungsalternativen mit unterschiedlicher Fälligkeit korrekt verglichen?", options: ["Durch Ab-/Aufzinsung auf einen gemeinsamen Zeitpunkt", "Nur durch den höheren Betrag, unabhängig von der Frist", "Durch direkten Vergleich der Nominalbeträge", "Gar nicht, ein Vergleich ist unmöglich"], correctIndex: 0, explanation: "Da Zahlungen zu unterschiedlichen Zeitpunkten wegen des Zeitwerts des Geldes nicht direkt vergleichbar sind, müssen beide Beträge zunächst auf einen gemeinsamen Zeitpunkt ab- oder aufgezinst werden — erst dann ist ein fairer Vergleich möglich." },
      { id: "q2", question: "Bei einem Barwertvergleich: Welche Alternative ist bei sonst gleichen Voraussetzungen vorteilhafter (günstiger für den Zahler)?", options: ["Die Alternative mit dem höheren Barwert", "Die Alternative mit dem niedrigeren Barwert", "Barwerte sagen nichts über Vorteilhaftigkeit aus", "Immer die nominal höhere Zahlung"], correctIndex: 1, explanation: "Für den Zahler entspricht ein niedrigerer Barwert einer geringeren heutigen Kostenbelastung — deshalb ist die Alternative mit dem niedrigeren Barwert die günstigere, unabhängig vom nominalen Betrag." },
      { id: "yn1", type: "yesno", question: "Ist bei einem Barwertvergleich zweier Zahlungsalternativen diejenige mit dem niedrigeren Barwert für den Zahler die günstigere?", correctAnswer: true, reasons: ["Ja, weil ein niedrigerer Barwert einer geringeren heutigen Kostenbelastung entspricht.", "Nein, weil ausschließlich der nominale Zahlungsbetrag über die Vorteilhaftigkeit entscheidet.", "Nein, weil bei einem Barwertvergleich immer die spätere Zahlung automatisch günstiger ist.", "Ja, weil der höhere Barwert stets den geringeren Nominalbetrag widerspiegelt."], correctReasonIndex: 0, explanation: "Für den Zahler bedeutet ein niedrigerer Barwert eine geringere heutige Kostenbelastung, weshalb die Alternative mit dem niedrigeren Barwert die finanziell günstigere ist — unabhängig vom nominalen Betrag oder der Fälligkeit." },
      { id: "q3", question: "Was bedeutet 'gleichwertige Alternativen' im Kontext des Barwertvergleichs?", options: ["Beide Alternativen haben exakt denselben Nominalbetrag", "Beide Alternativen stammen vom exakt selben Anbieter", "Beide Alternativen haben exakt dieselbe Laufzeit", "Ihre Barwerte sind beim betrachteten Zinssatz identisch"], correctIndex: 3, explanation: "Gleichwertigkeit bedeutet, dass die Barwerte (äquivalent auch die Endwerte) beider Alternativen bei einem bestimmten Zinssatz — dem Gleichgewichtszins — exakt identisch sind, unabhängig von Nominalbetrag oder Laufzeit für sich genommen." },
      { id: "q4", question: "Im Gastronomie-Equipment-Beispiel: Welche Alternative ist bei 6 % Verzinsung günstiger?", options: ["Beide sind exakt gleich teuer", "Alternative 1 (4.500 € nach 30 Tagen)", "Das lässt sich ohne mehr Daten nicht bestimmen", "Alternative 2 (4.542,50 € nach 90 Tagen)"], correctIndex: 3, explanation: "Bei 6 % ist der Barwert von Alternative 2 (≈4.475,37 €) niedriger als der von Alternative 1 (≈4.477,61 €) — obwohl der Nominalbetrag höher ist, überwiegt der Vorteil der späteren Fälligkeit." },
      { id: "q5", question: "Wie hoch ist ungefähr der Gleichgewichtszins im Gastronomie-Equipment-Beispiel?", options: ["10 %", "15 %", "5,69 %", "1,5 %"], correctIndex: 2, explanation: "Setzt man die Barwertformeln beider Alternativen gleich und löst nach i auf, ergibt sich ein Gleichgewichtszins von ca. 5,69 % — bei diesem Zins wären beide Zahlungsalternativen exakt wertgleich." },
      { id: "q6", question: "Was passiert, wenn der tatsächliche Zinssatz UNTER dem Gleichgewichtszins liegt (im Gastronomie-Beispiel)?", options: ["Alternative 2 bleibt immer günstiger, unabhängig vom Zins", "Es lässt sich nichts dazu sagen", "Alternative 1 wird günstiger", "Beide werden automatisch gleich teuer"], correctIndex: 2, explanation: "Unterhalb des Gleichgewichtszinses von 5,69 % kehrt sich die Vorteilhaftigkeit um: Der Zinsvorteil der späteren Fälligkeit von Alternative 2 reicht dann nicht mehr aus, um ihren höheren Nominalbetrag auszugleichen — Alternative 1 wird günstiger." },
      { id: "q7", question: "Warum ist ein Endwertvergleich zum selben Ergebnis wie ein Barwertvergleich gekommen (im Beispiel)?", options: ["Das war reiner Zufall speziell in diesem Beispiel", "Weil hier zufällig kein Zinssatz verwendet wurde", "Weil beide Verfahren bei konsistenter Anwendung mathematisch äquivalent sind", "Endwertvergleiche sind grundsätzlich unzulässig"], correctIndex: 2, explanation: "Bar- und Endwertvergleich sind bei gleichem Zinssatz und konsequentem Bezug auf denselben Zeitpunkt mathematisch äquivalent — sie liefern immer dieselbe Vorteilhaftigkeitsaussage, egal welcher Bezugszeitpunkt gewählt wird." },
      { id: "q8", question: "Welche Formel nutzt man, um den Gleichgewichtszins zwischen zwei Zahlungsalternativen zu bestimmen?", options: ["Der Gleichgewichtszins beträgt in jedem Fall immer 0 %", "Man addiert einfach die beiden Nominalbeträge", "Man verwendet dafür ausschließlich die Zinseszinsformel", "Man setzt die beiden Barwertformeln gleich und löst nach i auf"], correctIndex: 3, explanation: "Durch Gleichsetzen der Barwertformeln beider Alternativen und Auflösen nach dem Zinssatz i erhält man denjenigen Zins, bei dem beide Alternativen exakt gleichwertig sind." },
      { id: "q9", question: "Zwei Zahlungsalternativen: A = 1.000 € nach 60 Tagen, B = 1.010 € nach 120 Tagen. Bei sehr hohem Zinssatz — welche Tendenz zeigt sich für die Vorteilhaftigkeit von B (spätere, aber höhere Zahlung)?", options: ["B wird bei hohem Zins tendenziell relativ günstiger", "A wird bei jedem Zinssatz immer günstiger bleiben", "Der Zinssatz hat überhaupt keinen Einfluss auf die Vorteilhaftigkeit", "B wird bei hohem Zins immer automatisch ungünstiger"], correctIndex: 0, explanation: "Je höher der Zins, desto stärker wird eine spätere Zahlung beim Barwertvergleich abgezinst — bei ausreichend hohem Zins kann die später fällige, nominal etwas höhere Zahlung B dadurch relativ günstiger werden als die frühere Zahlung A." },
      { id: "q10", question: "Was ist der Standardansatz zum Vergleich von Finanzierungsalternativen laut Vorlesung?", options: ["Ein Vergleich nur über die Laufzeit", "Der Barwertvergleich", "Der Vergleich der Nominalwerte ohne Verzinsung", "Ein rein qualitativer Vergleich ohne Berechnung"], correctIndex: 1, explanation: "In der Praxis wird meist der Barwertvergleich als Standardmethode verwendet, da alle Zahlungen dabei auf den heutigen Zeitpunkt bezogen und so direkt miteinander vergleichbar werden." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Wie hoch ist der effektive Zins, dem der Ratenaufschlag von 2 % im Versicherungsbeispiel entspricht?", options: ["16 %", "8,16 %", "2 %", "4 %"], correctIndex: 1, explanation: "Setzt man die Barwerte von Einmalzahlung und Ratenzahlung gleich und löst nach i auf, ergibt sich ein impliziter Zinssatz von ca. 8,16 % p.a. — der 2%ige Aufschlag pro Halbjahr entspricht also effektiv einer deutlich höheren Jahresverzinsung." },
      { id: "q2", question: "Wann ist die Ratenzahlung mit Aufschlag (statt Einmalzahlung) finanziell vorteilhaft?", options: ["Immer, unabhängig vom aktuellen Marktzins", "Nur dann, wenn der Marktzins exakt 0 % beträgt", "Wenn der am Markt erzielbare Zins höher ist als der implizite Zins des Aufschlags", "Nie, Ratenzahlung ist grundsätzlich immer die schlechtere Wahl"], correctIndex: 2, explanation: "Nur wenn der am Kapitalmarkt tatsächlich erzielbare Zins den impliziten Zins des Ratenaufschlags übersteigt, lohnt es sich, den zurückgehaltenen Betrag stattdessen anzulegen statt sofort in voller Höhe zu zahlen." },
      { id: "q3", question: "Was bedeutet 'vorschüssige' Zahlung?", options: ["Eine Zahlung genau in der Mitte der jeweiligen Periode", "Eine Zahlung, die im Rechenmodell praktisch niemals erfolgt", "Zahlung am Anfang der jeweiligen (Teil-)Periode", "Eine Zahlung am Ende der jeweiligen Periode"], correctIndex: 2, explanation: "Vorschüssig bedeutet, dass die Zahlung jeweils zu Beginn der (Teil-)Periode erfolgt (z. B. Monatsanfang) — im Gegensatz zur nachschüssigen Zahlung am Periodenende, die dadurch kürzer verzinst wird." },
      { id: "q4", question: "Welche Formel gilt für den Endwert einer vorschüssigen Mehrfachzahlung (Rate r, m Teilperioden)?", options: ["Endwert = r·(m + (m+1)/2·i)", "Endwert = r·(m + (m−1)/2·i)", "Endwert = r/(m·i)", "Endwert = r·m·i"], correctIndex: 0, explanation: "Bei vorschüssiger Zahlung wird jede Rate ab Periodenbeginn verzinst, daher lautet die Formel r·(m + (m+1)/2·i) — mit dem Term (m+1)/2 statt (m−1)/2, der die um eine Teilperiode längere Verzinsung gegenüber der nachschüssigen Variante widerspiegelt." },
      { id: "q5", question: "Welche Formel gilt für den Endwert einer nachschüssigen Mehrfachzahlung?", options: ["Endwert = r·(m + (m+1)/2·i)", "Endwert = r·(m−1)·i", "Endwert = r·m²·i", "Endwert = r·(m + (m−1)/2·i)"], correctIndex: 3, explanation: "Bei nachschüssiger Zahlung erfolgt jede Rate erst am Ende der Teilperiode und wird daher eine Teilperiode kürzer verzinst als bei vorschüssiger Zahlung — das drückt sich im Term (m−1)/2 statt (m+1)/2 aus." },
      { id: "q6", question: "Ist der Endwert bei vorschüssiger oder nachschüssiger Zahlung bei sonst gleichen Bedingungen höher?", options: ["Das hängt überhaupt nicht von der Zahlungsweise ab", "Bei vorschüssiger Zahlung", "Bei nachschüssiger Zahlung", "Beide sind in jedem Fall exakt identisch"], correctIndex: 1, explanation: "Da vorschüssige Raten jeweils bereits ab Periodenbeginn verzinst werden, also eine Teilperiode länger als bei nachschüssiger Zahlung, ergibt sich bei sonst gleichen Bedingungen ein höherer Endwert." },
      { id: "q7", question: "Tom zahlt monatlich 100 € vorschüssig bei 6 % p.a. ein (m=12). Wie lautet der korrekte Formelansatz?", options: ["100/(12·0,06)", "100·(12 + 11/2·0,06)", "100·12·0,06", "100·(12 + 13/2·0,06)"], correctIndex: 3, explanation: "Bei vorschüssiger Zahlung gilt Endwert = r·(m + (m+1)/2·i), hier also 100·(12 + 13/2·0,06) — der Term 13/2 ergibt sich aus (m+1)/2 mit m=12." },
      { id: "yn1", type: "yesno", question: "Ist der Endwert einer vorschüssigen monatlichen Ratenzahlung bei sonst gleichen Bedingungen höher als bei nachschüssiger Zahlung derselben Rate?", correctAnswer: true, reasons: ["Ja, weil vorschüssige Raten jeweils eine Teilperiode länger verzinst werden als nachschüssige.", "Nein, weil beide Zahlungsweisen mathematisch stets exakt denselben Endwert ergeben.", "Nein, weil nachschüssige Zahlungen wegen der späteren Fälligkeit stärker verzinst werden.", "Ja, weil bei vorschüssiger Zahlung grundsätzlich ein höherer Zinssatz angesetzt wird."], correctReasonIndex: 0, explanation: "Vorschüssige Raten werden bereits ab Periodenbeginn verzinst, also eine Teilperiode länger als bei nachschüssiger Zahlung — deshalb ist der Endwert bei vorschüssiger Zahlung stets etwas höher, wie die Formeln r·(m+(m+1)/2·i) gegenüber r·(m+(m−1)/2·i) zeigen." },
      { id: "q8", question: "Was ist die Methode zur Beurteilung von Ratenzahlungsangeboten mit Aufschlag?", options: ["Ausschließlich eine subjektive Einschätzung ohne konkrete Rechnung", "Barwerte beider Varianten gleichsetzen und impliziten Zinssatz ermitteln", "Ratenzahlung grundsätzlich sofort ablehnen, ohne zu rechnen", "Ausschließlich die reinen Nominalbeträge addieren"], correctIndex: 1, explanation: "Man setzt die Barwerte von Einmalzahlung und Ratenzahlung gleich und löst nach dem Zinssatz i auf — der so ermittelte implizite Zins des Aufschlags lässt sich dann mit dem tatsächlich am Markt erzielbaren Zins vergleichen." },
      { id: "q9", question: "Welcher Faktor bestimmt maßgeblich, ob sich eine Ratenzahlung mit Aufschlag lohnt?", options: ["Der Vergleich des impliziten Aufschlagszinses mit dem realen Marktzins", "Ausschließlich die reine Anzahl der Vertragsjahre", "Ausschließlich der Name des jeweiligen Versicherers", "Ausschließlich die absolute Höhe des Aufschlags in Euro"], correctIndex: 0, explanation: "Entscheidend ist der Vergleich zwischen dem impliziten Zins des Ratenaufschlags und dem Zins, den man mit dem zurückgehaltenen Betrag tatsächlich am Kapitalmarkt erzielen könnte — nicht Vertragslaufzeit, Anbietername oder die absolute Höhe des Aufschlags allein." },
      { id: "q10", question: "Bei m=1 (nur eine Zahlung pro Periode) — was ergibt die Formel für vorschüssig und nachschüssig jeweils?", options: ["Die Formeln sind rechnerisch nur für m > 12 definiert", "Beide Formeln ergeben bei m=1 stets exakt null", "Nur die vorschüssige Formel ist bei m=1 überhaupt definiert", "Beide ergeben denselben Endwert wie bei einer Einzelzahlung r·(1+i) bzw. r"], correctIndex: 3, explanation: "Bei m=1 vereinfacht sich die vorschüssige Formel zu r·(1+i) und die nachschüssige zu r·1 = r — genau das Ergebnis, das man für eine einzige Zahlung am Perioden-Anfang bzw. -Ende erwarten würde." }
    ]
  }
];
