const VWL_CHAPTER12_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "q2", question: "Welche Art von Experiment ist in der Ökonomie besonders selten, weil sie auf einem historischen Zufall beruht?", options: ["Laborexperimente", "Natürliche Experimente", "Gedankenexperimente", "Simulationen"], correctIndex: 1, explanation: "Natürliche Experimente sind seltene, durch historischen Zufall entstehende Situationen, die sich ökonomisch wie ein Experiment auswerten lassen." },
      { id: "q3", question: "Was zeigt ein Punkt außerhalb der Produktionsmöglichkeitenkurve?", options: ["Eine effiziente Produktion", "Eine mit den aktuellen Ressourcen nicht erreichbare Kombination", "Arbeitslosigkeit", "Wirtschaftswachstum"], correctIndex: 1, explanation: "Ein Punkt außerhalb der Kurve ist mit den aktuell verfügbaren Ressourcen nicht erreichbar." },
      { id: "q4", question: "Was unterscheidet 'Falken' und 'Tauben' im Raketen-Brot-Beispiel?", options: ["Sie liegen auf unterschiedlichen Produktionsmöglichkeitenkurven", "Sie bevorzugen unterschiedliche Punkte auf derselben Kurve", "Nur die Falken produzieren effizient", "Nur die Tauben produzieren effizient"], correctIndex: 1, explanation: "Beide Parteien bevorzugen unterschiedliche, aber jeweils effiziente Punkte auf derselben Produktionsmöglichkeitenkurve." },
      { id: "q5", question: "Was ist Kausalität?", options: ["Ein reiner statistischer Zusammenhang ohne Wirkungsrichtung", "Eine Ursache-Wirkungs-Beziehung: Ein Faktor wirkt auf einen anderen", "Ein Synonym für Korrelation", "Ein Begriff nur aus der Physik"], correctIndex: 1, explanation: "Kausalität bezeichnet eine echte Ursache-Wirkungs-Beziehung, bei der ein Faktor auf einen anderen wirkt." },
      { id: "q6", question: "Warum ist der kausale Effekt des Mindestlohns auf die Beschäftigung schwer nachzuweisen?", options: ["Weil der Mindestlohn nie verändert wird", "Weil gleichzeitig andere Faktoren (z. B. Konjunktur) die Beschäftigung beeinflussen können", "Weil es keine Arbeitslosenstatistik gibt", "Weil der Mindestlohn keinen Effekt haben kann"], correctIndex: 1, explanation: "Ohne geeignete Vergleichsgruppe lässt sich der reine Effekt des Mindestlohns kaum von anderen gleichzeitig wirkenden Störfaktoren trennen." },
      { id: "q7", question: "Was ist ein Beispiel für ein natürliches Experiment in der VWL?", options: ["Eine kontrollierte Laborstudie mit Studierenden", "Eine plötzliche Politikänderung, die zwei ähnliche Regionen unterschiedlich betrifft", "Eine reine Simulation am Computer", "Eine willkürlich gewählte Zufallsstichprobe ohne Kontext"], correctIndex: 1, explanation: "Ein natürliches Experiment nutzt eine durch historischen Zufall entstandene Situation, z. B. eine Politikänderung mit unterschiedlicher regionaler Betroffenheit, um kausale Effekte abzuschätzen." },
      { id: "q8", question: "Ein Punkt innerhalb der Produktionsmöglichkeitenkurve zeigt an, dass...", options: ["...die Volkswirtschaft ihre Ressourcen nicht voll ausschöpft", "...die Volkswirtschaft wächst", "...der Punkt nicht erreichbar ist", "...es keine Opportunitätskosten gibt"], correctIndex: 0, explanation: "Ein Punkt innerhalb der Kurve zeigt eine ineffiziente Nutzung der Ressourcen, z. B. durch Arbeitslosigkeit oder ungenutzte Kapazitäten." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Welche Marktform liegt bei vielen Anbietern und Nachfragern mit nahezu identischen Produkten vor?", options: ["Monopol", "Polypol", "Oligopol", "Monopolistische Konkurrenz"], correctIndex: 1, explanation: "Viele Anbieter/Nachfrager mit nahezu identischen Produkten kennzeichnen ein Polypol." },
      { id: "q2", question: "Wie verschiebt sich die Nachfragekurve nach einem inferioren Gut, wenn das Einkommen steigt?", options: ["Nach rechts", "Nach links", "Sie bleibt unverändert", "Sie wird zur Angebotskurve"], correctIndex: 1, explanation: "Bei einem inferioren Gut sinkt die Nachfrage mit steigendem Einkommen, die Kurve verschiebt sich nach links." },
      { id: "q3", question: "Zwei Güter A und B sind Substitute, wenn ein sinkender Preis von A...", options: ["...die Nachfrage nach B erhöht", "...die Nachfrage nach B verringert", "...keinen Effekt auf B hat", "...den Preis von B automatisch senkt"], correctIndex: 1, explanation: "Substitute sind Güter, bei denen ein sinkender Preis des einen Gutes die Nachfrage nach dem anderen Gut verringert." },
      { id: "q4", question: "Im Autofahrer-Beispiel: Wie hoch ist die berechnete implizite Bewertung einer Stunde Zeit?", options: ["4,80 € pro Stunde", "24 € pro Stunde", "9,60 € pro Stunde", "100 € pro Stunde"], correctIndex: 1, explanation: "Die Ersparnis von 4,80 € geteilt durch die zusätzliche Fahrzeit von 0,2 Stunden ergibt einen impliziten Zeitwert von 24 € pro Stunde." },
      { id: "q5", question: "Bei q = 1.600 − 300p und q = 1.400 + 700p: Welche Gleichung ist die Nachfragefunktion?", options: ["q = 1.600 − 300p, weil sie fallend im Preis ist", "q = 1.400 + 700p, weil sie steigend im Preis ist", "Beide sind Nachfragefunktionen", "Keine der beiden ist eine Nachfragefunktion"], correctIndex: 0, explanation: "Die im Preis fallende Funktion q = 1.600 − 300p entspricht dem Gesetz der Nachfrage und ist daher die Nachfragefunktion." },
      { id: "q6", question: "Wie hoch ist der berechnete Gleichgewichtspreis im Beispiel q = 1.600 − 300p, q = 1.400 + 700p?", options: ["p* = 0,2", "p* = 2", "p* = 20", "p* = 200"], correctIndex: 0, explanation: "Aus 1.600 − 300p = 1.400 + 700p folgt 200 = 1.000p, also p* = 0,2." },
      { id: "q7", question: "Wie hoch ist die berechnete Gleichgewichtsmenge im selben Beispiel?", options: ["q* = 1.540", "q* = 1.600", "q* = 200", "q* = 1.000"], correctIndex: 0, explanation: "Eingesetzt in die Nachfragefunktion: q* = 1.600 − 300 × 0,2 = 1.540." },
      { id: "q8", question: "Warum lohnt sich für den Autofahrer die langsamere Fahrweise nur, wenn ihm eine Stunde Zeit weniger als 24 € wert ist?", options: ["Weil die Kraftstoffersparnis genau 24 € pro eingesparter Stunde beträgt", "Weil das Benzin sonst zu billig wäre", "Weil er sonst schneller fahren müsste", "Weil 24 € der gesetzliche Mindestlohn ist"], correctIndex: 0, explanation: "Die berechnete implizite Zeitbewertung liegt bei 24 €/Stunde; ist ihm eine Stunde mehr wert, lohnt sich das Zeitsparen (schnelleres Fahren) trotz höherer Kosten." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Wie hoch ist die berechnete Preiselastizität der Nachfrage für Geschäftsreisende im Beispiel (Preis 200→250, Menge 2.000→1.900)?", options: ["0,2", "1,33", "2,0", "5,0"], correctIndex: 0, explanation: "5 % Mengenrückgang geteilt durch 25 % Preisanstieg ergibt eine Preiselastizität von 0,2 (unelastisch)." },
      { id: "q2", question: "Wie hoch ist die berechnete Preiselastizität der Nachfrage für Urlaubsreisende im selben Beispiel (Menge 600→400)?", options: ["0,2", "≈1,33", "0,4", "10,0"], correctIndex: 1, explanation: "33,3 % Mengenrückgang geteilt durch 25 % Preisanstieg ergibt eine Preiselastizität von rund 1,33 (elastisch)." },
      { id: "q3", question: "Warum ist die Nachfrage von Geschäftsreisenden unelastischer als die von Urlaubsreisenden?", options: ["Weil Geschäftsreisen meist notwendig und kaum verschiebbar sind", "Weil Geschäftsreisende ärmer sind", "Weil es für Geschäftsreisen keine Nachfragekurve gibt", "Weil Urlaubsreisende immer denselben Preis zahlen"], correctIndex: 0, explanation: "Geschäftsreisen sind meist beruflich notwendig und lassen sich schwer verschieben oder vermeiden, daher reagiert die Nachfrage kaum auf den Preis." },
      { id: "q4", question: "Bei einer Preiselastizität von 0,4 und gewünschter Mengensenkung um 20 %: Um wie viel Prozent muss der Preis steigen?", options: ["8 %", "20 %", "50 %", "80 %"], correctIndex: 2, explanation: "20 % ÷ 0,4 = 50 % nötige Preissteigerung." },
      { id: "q5", question: "Von 4 € ausgehend: Wie hoch wäre der neue Zigarettenpreis nach einer 50%igen Preiserhöhung?", options: ["4,50 €", "5,00 €", "6,00 €", "8,00 €"], correctIndex: 2, explanation: "Eine 50%ige Erhöhung von 4 € entspricht +2 €, also einem neuen Preis von 6 €." },
      { id: "q6", question: "Warum haben Teenager laut empirischen Studien eine höhere Preiselastizität bei Zigaretten als Erwachsene?", options: ["Weil sie mehr Einkommen haben", "Weil sie ein geringeres Budget haben und meist noch weniger stark abhängig sind", "Weil sie den Preis nicht kennen", "Weil sie ausschließlich online einkaufen"], correctIndex: 1, explanation: "Ein geringeres verfügbares Budget und eine noch nicht so verfestigte Abhängigkeit machen Teenager preissensibler." },
      { id: "q7", question: "Wie hoch ist der prozentuale Preisaufschlag durch den CO2-Preis im Diesel-Beispiel (0,18 € bei 2,30 € Grundpreis)?", options: ["Etwa 7,8 %", "Etwa 18 %", "Etwa 60 %", "Etwa 2,3 %"], correctIndex: 0, explanation: "0,18 € geteilt durch 2,30 € ergibt einen Preisaufschlag von rund 7,8 %." },
      { id: "q8", question: "Warum fällt der Rückgang der Dieselnachfrage durch den CO2-Preis kurzfristig typischerweise geringer aus als langfristig?", options: ["Weil die kurzfristige Preiselastizität meist niedriger ist als die langfristige", "Weil der CO2-Preis kurzfristig höher ist", "Weil es keine langfristige Elastizität gibt", "Weil Diesel kurzfristig günstiger wird"], correctIndex: 0, explanation: "Kurzfristig können Konsumenten kaum auf andere Fahrzeuge oder Verkehrsmittel ausweichen, daher ist die kurzfristige Preiselastizität meist niedriger als die langfristige." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Wie verläuft das Grenzprodukt der Arbeit im StaubWeg-Beispiel?", options: ["Es steigt zunächst, erreicht ein Maximum und sinkt dann", "Es sinkt kontinuierlich von Anfang an", "Es ist konstant", "Es steigt kontinuierlich"], correctIndex: 0, explanation: "Das Grenzprodukt steigt zunächst (20, 30, 40) und sinkt danach kontinuierlich (30, 20, 10, 5) — ein Maximum bei der dritten Arbeitskraft." },
      { id: "q2", question: "Wie hoch sind die durchschnittlichen Gesamtkosten bei 120 Staubsaugern (Gesamtkosten 600 €)?", options: ["3,00 €", "5,00 €", "6,00 €", "12,00 €"], correctIndex: 1, explanation: "600 € geteilt durch 120 Stück ergibt durchschnittliche Gesamtkosten von 5,00 €." },
      { id: "q3", question: "In welchem Verhältnis stehen Grenzprodukt und Grenzkosten zueinander?", options: ["Sie verlaufen parallel: hohes Grenzprodukt = hohe Grenzkosten", "Sie verlaufen spiegelbildlich: hohes Grenzprodukt = niedrige Grenzkosten", "Es gibt keinen Zusammenhang", "Grenzkosten sind immer null"], correctIndex: 1, explanation: "Die Grenzkosten ergeben sich als Lohn geteilt durch das Grenzprodukt; ein hohes Grenzprodukt bedeutet daher niedrige Grenzkosten und umgekehrt." },
      { id: "q4", question: "Bei welcher ungefähren Fotomenge liegen im Fotografen-Beispiel die minimalen Durchschnittskosten?", options: ["Bei 100 Fotos", "Bei 300 Fotos", "Bei etwa 600 Fotos", "Bei 700 Fotos"], correctIndex: 2, explanation: "Die Durchschnittskosten je Foto sind bei rund 600 Fotos am geringsten (ca. 7,17 €), bevor sie danach wieder leicht steigen." },
      { id: "q5", question: "Wie hoch sind die Grenzkosten je Foto beim Übergang von 200 auf 300 Fotos (Kostenanstieg um 300 €)?", options: ["1,00 € je Foto", "3,00 € je Foto", "9,00 € je Foto", "30,00 € je Foto"], correctIndex: 1, explanation: "300 € zusätzliche Kosten geteilt durch 100 zusätzliche Fotos ergibt Grenzkosten von 3,00 € je Foto." },
      { id: "q6", question: "Für K(q) = 100 + 10q + q²: Wie lautet die Grenzkostenfunktion?", options: ["GK(q) = 100 + 10q", "GK(q) = 10 + 2q", "GK(q) = 10q + q²", "GK(q) = 2q"], correctIndex: 1, explanation: "Die Ableitung von K(q) = 100 + 10q + q² nach q ergibt GK(q) = 10 + 2q." },
      { id: "q7", question: "Wie hoch sind Grenz- und Durchschnittskosten bei q = 10 für K(q) = 100 + 10q + q²?", options: ["GK = 20, DK = 20", "GK = 30, DK = 30", "GK = 10, DK = 30", "GK = 30, DK = 10"], correctIndex: 1, explanation: "GK(10) = 10 + 2×10 = 30 und DK(10) = 100/10 + 10 + 10 = 30 — beide sind bei q = 10 identisch." },
      { id: "q8", question: "Warum liegt das Betriebsoptimum genau dort, wo Grenzkosten und Durchschnittskosten übereinstimmen?", options: ["Das ist reiner Zufall in diesem Beispiel", "Weil die Grenzkostenkurve die Durchschnittskostenkurve immer in deren Minimum schneidet", "Weil Grenzkosten und Durchschnittskosten immer identisch sind", "Weil das Betriebsoptimum keine mathematische Bedeutung hat"], correctIndex: 1, explanation: "Es ist ein allgemeiner mathematischer Zusammenhang: Die Grenzkostenkurve schneidet die u-förmige Durchschnittskostenkurve stets in deren Minimum, dem Betriebsoptimum." }
    ]
  },
  {
    ...
    quiz: [
      ...
      { id: "q2", question: "Wie hoch ist der Gleichgewichtspreis im selben Beispiel?", options: ["p* ≈ 46,67", "p* = 20", "p* = 100", "p* = 80"], correctIndex: 0, explanation: "Eingesetzt in die Angebotsfunktion: p* = 20 + 80/3 ≈ 46,67." },
      { id: "q3", question: "Was passiert, wenn die Regierung einen Höchstpreis von 40 einführt (unter dem Gleichgewichtspreis von ≈46,67)?", options: ["Es ändert sich nichts, weil der Höchstpreis nicht bindend ist", "Es entsteht eine Güterknappheit, weil die angebotene Menge unter der nachgefragten liegt", "Die gehandelte Menge steigt über die Gleichgewichtsmenge", "Der Höchstpreis erhöht die Gesamtwohlfahrt"], correctIndex: 1, explanation: "Da der Höchstpreis unter dem Gleichgewichtspreis liegt, ist er bindend; bei p=40 übersteigt die nachgefragte Menge (30) die angebotene Menge (20), es entsteht eine Knappheit." },
      { id: "q4", question: "Was passiert mit der Gesamtwohlfahrt durch den bindenden Höchstpreis im Beispiel?", options: ["Sie steigt", "Sie sinkt (Wohlfahrtsverlust)", "Sie bleibt exakt gleich", "Sie wird null"], correctIndex: 1, explanation: "Die Gesamtwohlfahrt sinkt von rund 1.066,67 auf 1.000, ein Wohlfahrtsverlust von rund 66,67, weil weniger als die effiziente Menge gehandelt wird." },
      { id: "q5", question: "Wie wirken sich zusätzliche ukrainische Weizenexporte auf den Weizenpreis in Polen und der Slowakei aus?", options: ["Der Preis steigt, weil die Nachfrage steigt", "Der Preis sinkt, weil sich die Angebotskurve nach rechts verschiebt", "Der Preis bleibt konstant", "Es gibt keinen Effekt auf den Weizenmarkt"], correctIndex: 1, explanation: "Zusätzliches Angebot verschiebt die Angebotskurve nach rechts, wodurch der Gleichgewichtspreis sinkt." },
      { id: "q6", question: "Was passiert mit der Produzentenrente einheimischer Weizenbauern durch die zusätzlichen Importe?", options: ["Sie steigt eindeutig", "Sie sinkt tendenziell durch die zusätzliche Konkurrenz und den niedrigeren Preis", "Sie bleibt unverändert", "Sie wird automatisch subventioniert"], correctIndex: 1, explanation: "Der niedrigere Weizenpreis durch zusätzliche Importe senkt tendenziell die Produzentenrente der einheimischen Landwirte." },
      { id: "q7", question: "Warum steigt die Konsumentenrente eindeutig, wenn sinkende Produktionskosten die Angebotskurve nach rechts verschieben?", options: ["Weil Konsumenten sowohl weniger zahlen als auch mehr konsumieren können", "Weil die Nachfragekurve sich verschiebt", "Weil die Produzentenrente automatisch sinkt", "Weil der Preis konstant bleibt"], correctIndex: 0, explanation: "Ein niedrigerer Preis bei gleichzeitig höherer Menge erhöht die Konsumentenrente eindeutig." },
      { id: "q8", question: "Warum ist die Verlosung von Champions-League-Tickets möglicherweise nicht ökonomisch effizient?", options: ["Weil Tickets nicht notwendigerweise an Personen mit der höchsten Zahlungsbereitschaft gehen", "Weil Verlosungen grundsätzlich illegal sind", "Weil es keine Nachfrage nach Tickets gibt", "Weil der Ticketpreis zu hoch ist"], correctIndex: 0, explanation: "Effizienz erfordert, dass Güter an jene mit der höchsten Zahlungsbereitschaft gehen; eine zufällige Verlosung erfüllt dieses Kriterium nicht notwendigerweise." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Wie viele Einheiten muss die Gesamtverschmutzung der drei Unternehmen im Zertifikat-Beispiel gesenkt werden?", options: ["40 Einheiten", "80 Einheiten", "120 Einheiten", "200 Einheiten"], correctIndex: 1, explanation: "Ausgehend von 200 Einheiten (70+80+50) auf ein Ziel von 120 Einheiten müssen insgesamt 80 Einheiten vermieden werden." },
      { id: "q2", question: "Welches Unternehmen vermeidet im kosteneffizienten Gleichgewicht am meisten?", options: ["Beton AG (höchste Vermeidungskosten)", "Chemie AG (niedrigste Vermeidungskosten)", "Asbest AG", "Alle vermeiden gleich viel"], correctIndex: 1, explanation: "Chemie AG hat mit 10 €/Einheit die niedrigsten Vermeidungskosten und vermeidet daher zuerst und am meisten (ihre volle Verschmutzung von 50 Einheiten)." },
      { id: "q3", question: "Welches Unternehmen kauft im Gleichgewicht Zertifikate zu?", options: ["Chemie AG", "Asbest AG", "Beton AG (höchste Vermeidungskosten, vermeidet nicht)", "Keines"], correctIndex: 2, explanation: "Beton AG hat die höchsten Vermeidungskosten (25 €/Einheit) und vermeidet daher nicht, sondern kauft die fehlenden Zertifikate von Chemie AG." },
      { id: "q4", question: "Wie hoch sind die gesamten Vermeidungskosten mit handelbaren Zertifikaten im Beispiel?", options: ["600 €", "1.100 €", "1.700 €", "1.975 €"], correctIndex: 1, explanation: "Chemie AG: 500 € (50×10), Asbest AG: 600 € (30×20), Beton AG: 0 € — Summe 1.100 €." },
      { id: "q5", question: "Wie hoch wären die Gesamtkosten ohne Zertifikatehandel (jedes Unternehmen reduziert eigenständig auf 40 Einheiten)?", options: ["1.100 €", "1.700 €", "2.000 €", "500 €"], correctIndex: 1, explanation: "Asbest AG 600 € + Beton AG 1.000 € + Chemie AG 100 € = 1.700 € ohne Handel." },
      { id: "q6", question: "Wie viel spart der Handel mit Zertifikaten in diesem Beispiel gegenüber der Lösung ohne Handel?", options: ["0 €", "300 €", "600 €", "1.700 €"], correctIndex: 2, explanation: "1.700 € (ohne Handel) minus 1.100 € (mit Handel) ergibt eine Einsparung von 600 €." },
      { id: "q7", question: "Warum ist die steuerliche Absetzbarkeit von Spenden ein Beispiel für einen staatlichen Anreiz zu privaten Lösungen bei Externalitäten?", options: ["Weil sie Spenden komplett verbietet", "Weil sie die effektiven Kosten des Spendens senkt und dadurch mehr private Bereitstellung positiver Externalitäten fördert", "Weil sie eine direkte Regulierung ist", "Weil sie nur für Unternehmen gilt"], correctIndex: 1, explanation: "Die Absetzbarkeit senkt die Kosten des Spendens und fördert dadurch private (statt staatlich regulierte) Lösungen für positive Externalitäten." },
      { id: "q8", question: "Welche Art von Externalität könnte ein großes Musikfestival für Anwohner einer Kleinstadt zusätzlich zu negativen Effekten auch erzeugen?", options: ["Ausschließlich negative Effekte sind möglich", "Positive Effekte durch zusätzliche lokale Wirtschaftsaktivität und Bekanntheit", "Gar keine Externalitäten", "Nur staatliche Subventionseffekte"], correctIndex: 1, explanation: "Neben negativen Effekten (Lärm, Vermüllung) kann ein Festival auch positive Externalitäten erzeugen, z. B. durch zusätzliche Gastronomieumsätze und überregionale Bekanntheit der Stadt." }
    ]
  }
];
