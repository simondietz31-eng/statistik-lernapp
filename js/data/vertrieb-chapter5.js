const VERTRIEB_CHAPTER5_TOPICS = [
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        solution: "Der Merksatz ordnet den drei Preisfindungsansätzen jeweils eine spezifische Information zu: Die Kostenorientierung liefert die Preisuntergrenze, die zur Kostendeckung mindestens nötig ist. Die Wettbewerbsorientierung liefert das am Markt übliche Preisniveau, an dem sich Kunden bereits orientieren. Die Kundenorientierung liefert dagegen die maximal mögliche Preishöhe, die aus der individuellen Zahlungsbereitschaft der Kunden abgeleitet werden kann. Ein durchdachter Preis berücksichtigt idealerweise alle drei Perspektiven."
      }
    ],
    quiz: [
      { id: "q1", question: "Was beschreibt die Preisdurchsetzung im Unterschied zur Preisfindung?", options: ["Die Höhe der Herstellkosten", "Ob der berechnete Preis tatsächlich am Markt erzielt wird", "Wie ein Preis berechnet wird", "Die Anzahl der Wettbewerber im Markt"], correctIndex: 1, explanation: "Preisfindung ist die Berechnungsmethode, Preisdurchsetzung betrifft die Frage, ob der Preis am Markt tatsächlich erzielt wird." },
      { id: "q2", question: "Wie hoch ist der realisierte Preis im B2B-Geschäft laut Vorlesung häufig im Vergleich zum Listenpreis, nach Abzug von Rabatten und Konditionen?", options: ["Etwa 50 %", "Etwa 100 %", "Etwa 90 %", "Etwa 10 %"], correctIndex: 0, explanation: "Im B2B-Geschäft beträgt der realisierte Preis nach Rabatten/Boni/Konditionen oft nur rund 50 % des Listenpreises." },
      { id: "q3", question: "Welches ist KEINER der drei genannten Erfolgsfaktoren der Preisdurchsetzung?", options: ["Maximale Produktvielfalt", "Preisdisziplin", "Professionelle Marktanalyse", "Professionelle Umsetzung"], correctIndex: 0, explanation: "Die drei Erfolgsfaktoren sind professionelle Marktanalyse, professionelle Umsetzung und Preisdisziplin." },
      { id: "q4", question: "Als was wird der Preis im Vertrieb charakterisiert?", options: ["Als ausschließlich kostenbezogene Größe", "Als reines Marketinginstrument ohne Gewinnwirkung", "Als irrelevanter Faktor", "Als der größte Hebel, nach oben wie nach unten"], correctIndex: 3, explanation: "Der Preis wird als größter Hebel beschrieben, der Gewinn sowohl steigern als auch vernichten kann." },
      { id: "q5", question: "Wie wird der Preis bei der Kostenorientierung berechnet?", options: ["Preis = maximale Zahlungsbereitschaft der Kunden", "Preis = Umsatz des Vorjahres", "Preis = Herstellkosten + Marge", "Preis = Ø Wettbewerbspreis ± Auf-/Abschlag"], correctIndex: 2, explanation: "Bei der Kostenorientierung ergibt sich der Preis aus Herstellkosten plus Marge." },
      { id: "q6", question: "Was ist ein zentraler methodischer Nachteil der Kostenorientierung?", options: ["Ein Zirkelschluss, da die für die Kostenumlage angenommene Menge eigentlich vom Preis abhängt", "Sie berücksichtigt nur Wettbewerbspreise", "Sie erfordert aufwendige Kundenbefragungen", "Sie ist zu teuer in der Erhebung"], correctIndex: 0, explanation: "Die angenommene Absatzmenge zur Kostenumlage hängt eigentlich vom noch zu bestimmenden Preis ab — ein Zirkelschluss." },
      { id: "q7", question: "Welcher Vorteil wird der Wettbewerbsorientierung zugeschrieben?", options: ["Maximale Ausschöpfung der Zahlungsbereitschaft", "Kunden zahlen diesen Preis erwiesenermaßen, einfach und schnell zu ermitteln", "Keine Datenerhebung notwendig", "Garantierte Kostendeckung"], correctIndex: 1, explanation: "Wettbewerbsorientierte Preise sind einfach, schnell und kostengünstig zu ermitteln, und Kunden zahlen sie bereits nachweislich." },
      { id: "q8", question: "Welcher Nachteil ist typisch für die Kundenorientierung bei der Preisfindung?", options: ["Sie ist immer günstiger als andere Methoden", "Eine valide Datengrundlage ist schwer zu ermitteln und die Erhebung ist kostenintensiv", "Keine Garantie für Kostendeckung", "Sie nutzt die Zahlungsbereitschaft nicht aus"], correctIndex: 1, explanation: "Bei der Kundenorientierung ist eine echte Datengrundlage schwer zu ermitteln, meist nur über hypothetische Befragungen, und die Erhebung ist teuer." },
      { id: "q9", question: "Welcher Preisfindungsansatz führt laut Vorlesung am ehesten zu Ertragsmaximierung?", options: ["Wettbewerbsorientierung", "Kostenorientierung", "Kundenorientierung", "Keiner der drei Ansätze"], correctIndex: 2, explanation: "Die Kundenorientierung zielt auf die maximale Zahlungsbereitschaft und ermöglicht dadurch Ertragsmaximierung." },
      { id: "q10", question: "Was liefert laut Merksatz die Kostenorientierung?", options: ["Nichts Relevantes", "Was maximal möglich wäre", "Was am Markt üblich ist", "Was mindestens benötigt wird"], correctIndex: 3, explanation: "Die Kosten sagen, was mindestens zur Kostendeckung gebraucht wird." }
    ]
  },
  {
    ...
    exercises: [
      {
        ...
        solution: "\"Zu teuer\" misst den Preis, ab dem der Befragte das Produkt für zu teuer hält und nicht mehr kaufen würde. \"Teuer\" misst den Preis, den der Befragte als teuer, aber noch gerade akzeptabel empfindet. \"Günstig\" misst den Preis, den der Befragte als günstig empfindet. \"Zu günstig\" misst den Preis, ab dem beim Befragten Qualitätszweifel aufkommen, weil das Produkt zu billig erscheint."
      },
      {
      ...
      },
      {
        ...
        solution: "Aufsteigend sortiert: 1,50 / 2,00 / 2,00 / 2,20 / 2,50 / 3,00 / 3,00 / 3,50 / 4,50 / 5,00 (€). Die kumulierten Prozentanteile in 10-%-Schritten lauten: bei 1,50 € → 10 %, bei 2,00 € → 20 % bzw. 30 % (da der Wert doppelt vorkommt), bei 2,20 € → 40 %, bei 2,50 € → 50 %, bei 3,00 € → 60 % bzw. 70 % (Wert doppelt), bei 3,50 € → 80 %, bei 4,50 € → 90 % und bei 5,00 € → 100 %."
      },
      {
      ...
      },
      {
        ...
        solution: "Die Kurven \"zu teuer\" und \"zu günstig\" schneiden sich zwischen den Preispunkten 1,20 € und 1,50 €. Durch lineare Interpolation zwischen diesen beiden Punkten ergibt sich ein optimaler Preis (Penetrationspreis) von rund 1,35 €. An diesem Preispunkt ist der Kaufwiderstand am geringsten, das heißt, hier liegt das Absatzmaximum. Dieser Preis eignet sich daher besonders als kurzfristiger Preis, etwa zur Marktdurchdringung bei einem Markteintritt (Penetrationsstrategie), weniger als dauerhafter, langfristiger Preis."
      }
    ],
    quiz: [
      { id: "q1", question: "Wie viele Preispunkte werden in der Van-Westendorp-Methode pro Befragtem erhoben?", options: ["Fünf", "Drei", "Vier", "Zwei"], correctIndex: 2, explanation: "Es werden vier Preispunkte erhoben: zu teuer, teuer, günstig und zu günstig." },
      { id: "q2", question: "Was misst die Preisfrage \"zu günstig\"?", options: ["Den Preis, ab dem der Befragte nicht mehr kaufen würde", "Den Preis, ab dem beim Befragten Qualitätszweifel aufkommen", "Den Preis, den der Befragte als fair empfindet", "Den durchschnittlichen Wettbewerbspreis"], correctIndex: 1, explanation: "'Zu günstig' misst den Preis, ab dem der Befragte an der Qualität zu zweifeln beginnt." },
      { id: "q3", question: "Welche Reihenfolge der typischen Preisniveaus ist korrekt?", options: ["günstig < zu günstig < teuer < zu teuer", "zu teuer < teuer < günstig < zu günstig", "teuer < zu teuer < zu günstig < günstig", "zu günstig < günstig < teuer < zu teuer"], correctIndex: 3, explanation: "Die korrekte Reihenfolge lautet: zu günstig < günstig < teuer < zu teuer." },
      { id: "q4", question: "Wie wird der Indifferenzpreis bestimmt?", options: ["Als niedrigster erhobener Wert", "Als Mittelwert aller vier Kurven", "Als Schnittpunkt von 'zu teuer' und 'zu günstig'", "Als Schnittpunkt von 'teuer' und 'günstig'"], correctIndex: 3, explanation: "Der Indifferenzpreis ist der Schnittpunkt der beiden inneren Kurven 'teuer' und 'günstig'." },
      { id: "q5", question: "Wie wird der optimale Preis (Penetrationspreis) bestimmt?", options: ["Als Median aller Werte", "Als Schnittpunkt von 'teuer' und 'günstig'", "Als höchster erhobener Wert", "Als Schnittpunkt von 'zu teuer' und 'zu günstig'"], correctIndex: 3, explanation: "Der optimale Preis ist der Schnittpunkt der äußeren Kurven 'zu teuer' und 'zu günstig'." },
      { id: "q6", question: "Für welchen Einsatzzweck eignet sich der Indifferenzpreis besonders?", options: ["Als kurzfristiger Preis beim Markteintritt", "Als langfristiger Preis", "Er hat keinen praktischen Einsatzzweck", "Nur für Rabattaktionen"], correctIndex: 1, explanation: "Der Indifferenzpreis eignet sich als langfristiger Preis, da ihn die Mehrheit als fair empfindet." },
      { id: "q7", question: "Für welchen Einsatzzweck eignet sich der optimale Preis (Penetrationspreis) besonders?", options: ["Nur für den B2B-Vertrieb", "Als dauerhafter Standardpreis", "Als kurzfristiger Preis, z. B. beim Markteintritt (Penetration)", "Er wird nie tatsächlich eingesetzt"], correctIndex: 2, explanation: "Der optimale Preis markiert den geringsten Kaufwiderstand und eignet sich als kurzfristiger Penetrationspreis." },
      { id: "q8", question: "Bei den gegebenen Beispieldaten (n = 10) liegt der Indifferenzpreis zwischen welchen beiden Preispunkten?", options: ["Zwischen 1,50 € und 1,75 €", "Zwischen 1,20 € und 1,50 €", "Zwischen 3,00 € und 3,50 €", "Zwischen 0,50 € und 0,80 €"], correctIndex: 0, explanation: "Der Indifferenzpreis (Schnittpunkt 'teuer'/'günstig') liegt im Beispiel zwischen 1,50 € und 1,75 € und beträgt interpoliert rund 1,69 €." },
      { id: "q9", question: "Bei den gegebenen Beispieldaten (n = 10) liegt der optimale Preis zwischen welchen beiden Preispunkten?", options: ["Zwischen 4,50 € und 5,00 €", "Zwischen 1,20 € und 1,50 €", "Zwischen 1,50 € und 1,75 €", "Zwischen 2,00 € und 2,50 €"], correctIndex: 1, explanation: "Der optimale Preis (Schnittpunkt 'zu teuer'/'zu günstig') liegt im Beispiel zwischen 1,20 € und 1,50 € und beträgt interpoliert rund 1,35 €." },
      { id: "q10", question: "Wie wird bei n = 10 Befragten die kumulierte Häufigkeitsverteilung für jede Kategorie gebildet?", options: ["In 10-%-Schritten nach aufsteigender Sortierung der Werte", "In 25-%-Schritten", "In 100-%-Schritten", "Zufällig, ohne feste Schrittweite"], correctIndex: 0, explanation: "Bei n = 10 Befragten werden nach aufsteigender Sortierung die kumulierten Prozentanteile in 10-%-Schritten gebildet." }
    ]
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        solution: "Reaktanz entsteht, wenn der Preis-Leistungs-Zusammenhang für den Kunden nicht nachvollziehbar ist, die Preisdifferenzierung also wie reine Ausnutzung der individuellen bzw. situativen Zahlungsbereitschaft wirkt. Im Beispiel erhält der Kunde exakt dieselbe Leistung (identisches Zimmer) wie sonst auch, zahlt dafür aber ein Vielfaches — ohne erkennbaren Mehrwert. Dies wird vom Kunden häufig als unfair empfunden und kann zu Widerstand (Reaktanz) sowie langfristig zum Verlust dieses Kunden führen, selbst wenn er kurzfristig den überhöhten Preis zahlt, weil er keine Alternative hat."
      }
    ],
    quiz: [
      { id: "q1", question: "Woran orientiert sich der Preis bei der Preisdifferenzierung anstelle eines objektivierten Leistungsniveaus?", options: ["An der individuellen Preisbereitschaft des Kunden", "Ausschließlich am niedrigsten Wettbewerbspreis", "An der Reihenfolge der Bestellungen", "Ausschließlich an den Herstellkosten"], correctIndex: 0, explanation: "Preisdifferenzierung setzt den Preis anhand der individuellen Preisbereitschaft des Kunden statt eines objektivierten Leistungsniveaus." },
      { id: "q2", question: "Welcher Pigou-Grad schöpft die individuelle Preisbereitschaft jedes einzelnen Kunden ab, z. B. bei Auktionen?", options: ["2. Grad", "3. Grad", "1. Grad", "4. Grad"], correctIndex: 2, explanation: "Preisdifferenzierung 1. Grades (perfekte Preisdifferenzierung) schöpft die individuelle Preisbereitschaft jedes Kunden ab." },
      { id: "q3", question: "Welcher Pigou-Grad liegt bei Mengenrabatt-Staffeln vor?", options: ["3. Grad", "2. Grad", "1. Grad", "Keiner der drei Grade"], correctIndex: 1, explanation: "Mengenbezogene Preise mit Selbstselektion über die Abnahmemenge entsprechen dem 2. Grad." },
      { id: "q4", question: "Welcher Pigou-Grad liegt bei Studierendenrabatten vor?", options: ["1. Grad", "2. Grad", "0. Grad", "3. Grad"], correctIndex: 3, explanation: "Preisdifferenzierung nach beobachtbaren Kundengruppen wie Studierendenstatus entspricht dem 3. Grad." },
      { id: "q5", question: "Welche der folgenden ist KEINE der sieben Implementierungsformen nach Diller/Herrmann?", options: ["Preisbündelung", "Räumliche Preisdifferenzierung", "Preisdifferenzierung nach Aktienkurs", "Zeitliche Preisdifferenzierung"], correctIndex: 2, explanation: "Die sieben Formen sind Mehr-Personen-, leistungs-, mengen-, personsbezogene, räumliche, zeitliche Preisdifferenzierung sowie Preisbündelung." },
      { id: "q6", question: "Zu welchem Kapitel des Kurses gehören die vertieften Details zur Preisbündelung?", options: ["Kapitel 6", "Kapitel 5", "Kapitel 7", "Kapitel 4"], correctIndex: 0, explanation: "Die Details zur Preisbündelung als Implementierungsform der Preisdifferenzierung werden in Kapitel 6 vertieft." },
      { id: "q7", question: "Welches ist KEINES der sechs genannten Differenzierungskriterien?", options: ["Kundenmerkmale", "Kaufmenge", "Firmenlogo-Farbe", "Vertriebskanäle"], correctIndex: 2, explanation: "Die sechs Kriterien sind Kundenmerkmale, Regionen, Produkt-/Serviceeigenschaften, Vertriebskanäle, Zeit und Kaufmenge." },
      { id: "q8", question: "Welches Kriterium kann ein Kunde typischerweise am schnellsten selbst frei wählen?", options: ["Seine Wohnregion", "Sein Geburtsjahr", "Seinen Studierendenstatus", "Die Kaufmenge"], correctIndex: 3, explanation: "Die Kaufmenge kann der Kunde bei jeder Transaktion frei und kurzfristig selbst wählen, im Gegensatz zu z. B. Wohnregion oder Studierendenstatus." },
      { id: "q9", question: "Wann entsteht bei Preisdifferenzierung das Risiko der Reaktanz?", options: ["Nur bei mengenbezogener Preisdifferenzierung", "Wenn der Preis-Leistungs-Zusammenhang für den Kunden nicht nachvollziehbar ist", "Wenn der Preis immer gleich hoch ist", "Wenn Kunden gar keine Preise vergleichen können"], correctIndex: 1, explanation: "Reaktanz entsteht, wenn Kunden den Preis-Leistungs-Zusammenhang nicht nachvollziehen können und die Differenzierung als reine Ausnutzung wahrnehmen." },
      { id: "q10", question: "Was ist eine mögliche langfristige Folge von Reaktanz beim Kunden?", options: ["Kundenverlust", "Erhöhte Markentreue", "Keine Auswirkung", "Automatische Preisakzeptanz"], correctIndex: 0, explanation: "Reaktanz kann zu Widerstand und langfristig zum Verlust des betroffenen Kunden führen." }
    ]
  }
];
