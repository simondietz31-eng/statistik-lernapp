const NATWISS_CHAPTER5_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Hängt die Periodendauer T eines mathematischen Pendels von der Masse des Pendelkörpers ab?", correctAnswer: false, reasons: ["Nein, weil T = 2π√(l/g) nur von l und g abhängt – die Masse kürzt sich aus der Bewegungsgleichung heraus.", "Ja, weil eine schwerere Pendelmasse mehr Trägheit besitzt und dadurch spürbar langsamer schwingt als eine leichte.", "Nein, weil die Masse durch die Federkonstante k automatisch vollständig kompensiert wird und keinen Einfluss mehr hat.", "Ja, weil sich bei größerer Masse auch die rücktreibende Kraft proportional ändert und damit die Periodendauer beeinflusst."], correctReasonIndex: 0, explanation: "Beim mathematischen Pendel kürzt sich die Masse in der Bewegungsgleichung heraus, sodass T = 2π√(l/g) nur von der Pendellänge l und g abhängt, nicht von m – anders als beim Federpendel, bei dem T = 2π√(m/k) sehr wohl von m abhängt." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Findet beim Kriechfall (δ > ω₀) noch eine periodische Schwingung mit messbaren Nulldurchgängen der Auslenkung statt?", correctAnswer: false, reasons: ["Nein, weil die Lösung im Kriechfall nur aus zwei abklingenden Exponentialtermen ohne oszillierenden Anteil besteht.", "Ja, weil auch im Kriechfall die gedämpfte Kreisfrequenz ω_d = √(ω₀² − δ²) noch eine reale, messbare Schwingung erzeugt.", "Nein, weil im Kriechfall die Auslenkung sofort und ohne jede Zeitverzögerung auf den Wert null zurückspringt.", "Ja, weil jede Dämpfung per Definition eine abklingende, aber weiterhin periodische Schwingung mit Nulldurchgängen erzeugt."], correctReasonIndex: 0, explanation: "Für δ > ω₀ wird der Term unter der Wurzel in ω_d = √(ω₀² − δ²) negativ, sodass keine reelle Schwingungsfrequenz mehr existiert; die allgemeine Lösung besteht dann aus zwei reinen Exponential-Abklingtermen ohne Nulldurchgänge einer Schwingung." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Tritt bei der Magnetresonanztomographie (MRT) die stärkste Signalantwort auf, wenn die Frequenz des Hochfrequenzpulses exakt der Lamorfrequenz der Protonen entspricht?", correctAnswer: true, reasons: ["Ja, weil dann die Resonanzbedingung Ω = ω₀ erfüllt ist und die Protonen die Energie maximal effizient aufnehmen.", "Nein, weil die Signalstärke im MRT ausschließlich von der Stärke des Magnetfelds B₀ abhängt, nicht von der Pulsfrequenz.", "Ja, weil bei jeder beliebigen Pulsfrequenz automatisch Resonanz mit den Protonen im Gewebe auftritt.", "Nein, weil Protonen unabhängig von der eingestrahlten Frequenz stets exakt dieselbe Energiemenge aufnehmen."], correctReasonIndex: 0, explanation: "Die Lamorfrequenz f_L = γ/(2π)·B₀ ist die Eigenfrequenz der Protonenpräzession im Magnetfeld; nur bei Resonanz (Pulsfrequenz = f_L) wird Energie effizient von den Protonen aufgenommen, was das messbare MRT-Signal erzeugt." },
