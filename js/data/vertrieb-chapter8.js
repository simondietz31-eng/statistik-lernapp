const VERTRIEB_CHAPTER8_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist ein vom Kunden geäußerter Einwand laut Merksatz gleichzusetzen mit einer endgültigen Ablehnung?", correctAnswer: false, reasons: ["Nein, weil ein Einwand laut Merksatz eine Bitte um mehr Information oder Sicherheit ist.", "Ja, weil jeder Einwand automatisch das sofortige Ende des Verkaufsgesprächs bedeutet.", "Nein, weil Einwände ausschließlich bei unerfahrenen Verkäufern überhaupt auftreten.", "Ja, weil ein Einwand denselben Effekt wie ein 'Nein' auf eine geschlossene Gegenfrage hat."], correctReasonIndex: 0, explanation: "Der Merksatz 'Ein Einwand ist kein Neinsagen' verdeutlicht, dass ein Einwand meist Ausdruck eines offenen Informations- oder Sicherheitsbedarfs ist, den der Verkäufer gezielt adressieren kann - keine endgültige Ablehnung." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "q2", question: "Welche Grundregel gilt laut Vorlesung für den Einsatz von Lust- und Schmerzfaktor im Verkauf?", options: ["Man sollte ausschließlich über den Schmerzfaktor verkaufen", "Beide Faktoren dürfen niemals kombiniert werden", "Der Schmerzfaktor darf nur bei Neukunden eingesetzt werden", "So lange wie möglich über positive Emotionen verkaufen"], correctIndex: 3, explanation: "Die Grundregel besagt, dass so lange wie möglich über den Lustfaktor verkauft werden soll und der Schmerzfaktor erst bei Bedarf zum Einsatz kommt." },
      ...
      { id: "yn1", type: "yesno", question: "Empfiehlt die Vorlesung, möglichst immer zuerst über den Schmerzfaktor statt über den Lustfaktor zu verkaufen?", correctAnswer: false, reasons: ["Nein, weil laut Grundregel so lange wie möglich über positive Emotionen (Lustfaktor) verkauft werden soll.", "Ja, weil der Schmerzfaktor in jeder Branche grundsätzlich wirksamer ist als der Lustfaktor.", "Nein, weil geistige Brandstiftung ausschließlich in der Bedarfsanalysephase eingesetzt wird.", "Ja, weil positive Emotionen laut Vorlesung keinerlei Kaufmotivation erzeugen."], correctReasonIndex: 0, explanation: "Die Grundregel besagt, dass ein Verkäufer so lange wie möglich über positive Emotionen bzw. Lust-Faktoren verkaufen und erst bei Bedarf zur Schmerzgrenze wechseln sollte - Ausnahmen bilden nur wenige Branchen wie bestimmte Finanzdienstleistungen." },
      ...
      { id: "q9", question: "Welche Vorbereitungshilfsmittel werden für den Einsatz der geistigen Brandstiftung empfohlen?", options: ["Nur eine Preisliste der eigenen Produkte", "Ausschließlich Kundenreferenzen sammeln", "10 eigene Stärken, 10 Konkurrenzschwächen und eine Checkliste", "Nur die eigene Verkaufsstatistik der letzten Jahre"], correctIndex: 2, explanation: "Empfohlen wird, 10 eigene Stärken und 10 Konkurrenzschwächen zu notieren, daraus Vorteile/Nachteile abzuleiten und eine Checkliste zu entwickeln." },
