const KLR_CHAPTER3_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Welche Aussage über Vorkostenstellen (Hilfskostenstellen) trifft zu?", options: ["Sie werden im BAB nie mit Gemeinkosten belastet, weil sie keine eigenen Kosten verursachen", "Sie liefern Leistungen nur innerbetrieblich an andere Kostenstellen", "Sie existieren nur in Handelsunternehmen, nicht in Industriebetrieben", "Ihre Kosten fließen direkt in die Kalkulation der verkauften Produkte ein"], correctIndex: 1, explanation: "Vorkostenstellen wie die Energiezentrale oder die Kantine erbringen ihre Leistungen laut Lehrtext nur innerbetrieblich für andere Kostenstellen, nicht direkt für die am Markt verkauften Produkte. Die Aussage, ihre Kosten flössen direkt in die Kalkulation ein, beschreibt dagegen gerade die Endkostenstellen und verwechselt damit die beiden Kostenstellenarten." },
      { id: "q2", question: "Welche der folgenden Kostenstellen ist typischerweise eine Endkostenstelle (Hauptkostenstelle)?", options: ["Fertigung", "Reparaturwerkstatt", "Energiezentrale", "Kantine"], correctIndex: 0, explanation: "Fertigung ist eine Endkostenstelle, weil ihre Gemeinkosten unmittelbar über den Fertigungsgemeinkosten-Zuschlagssatz in die Kalkulation der Produkte einfließen. Reparaturwerkstatt, Energiezentrale und Kantine sind dagegen typische Vorkostenstellen, die nur innerbetrieblich für andere Kostenstellen leisten und daher zunächst über die innerbetriebliche Leistungsverrechnung verrechnet werden müssen." },
      { id: "yn1", type: "yesno", question: "Fließen die Gemeinkosten von Vorkostenstellen direkt in die Kalkulation der Produkte ein?", correctAnswer: false, reasons: ["Ja, weil jede Kostenstelle im BAB unmittelbar Zuschlagssätze für die Kalkulation liefert.", "Nein, weil Vorkostenstellen nur innerbetrieblich an andere Kostenstellen liefern und ihre Kosten erst über die innerbetriebliche Leistungsverrechnung an Endkostenstellen weitergegeben werden.", "Ja, weil Vorkostenstellen ausschließlich Einzelkosten verursachen.", "Nein, weil Vorkostenstellen grundsätzlich keine Gemeinkosten verursachen."], correctReasonIndex: 1, explanation: "Nur Endkostenstellen (z. B. Fertigung, Vertrieb) fließen direkt in die Kalkulation ein; Vorkostenstellen wie die Energiezentrale müssen ihre Kosten erst über die innerbetriebliche Leistungsverrechnung an die Endkostenstellen weitergeben." },
      { id: "q3", question: "Welcher Verteilungsschlüssel eignet sich am besten für kalkulatorische Abschreibungen?", options: ["Verbrauchsverhältnis der Kostenstellen", "Mitarbeiterzahl je Kostenstelle", "Anschaffungswert der Anlagen", "Fläche in Quadratmetern je Kostenstelle"], correctIndex: 2, explanation: "Kalkulatorische Abschreibungen sollen den Werteverzehr der genutzten Anlagen widerspiegeln, deshalb schlägt der Lehrtext ausdrücklich den Anschaffungswert der in der jeweiligen Kostenstelle eingesetzten Anlagen als Verteilungsschlüssel vor. Mitarbeiterzahl oder Fläche haben dagegen keinen unmittelbaren Bezug zum Wert der Maschinen und würden Abschreibungen verursachungswidrig verteilen." },
      { id: "q4", question: "Wie lautet die Formel für den Materialgemeinkosten-Zuschlagssatz?", options: ["Materialeinzelkosten / Material-Gemeinkosten", "Material-Gemeinkosten / Herstellkosten", "Material-Gemeinkosten / Materialeinzelkosten", "Material-Gemeinkosten / Fertigungsstunden"], correctIndex: 2, explanation: "Der Materialgemeinkosten-Zuschlagssatz setzt laut Formel im Lehrtext die Material-Gemeinkosten der Materialstelle ins Verhältnis zu den Materialeinzelkosten, meist ausgedrückt in Prozent. Die erste Antwortoption vertauscht Zähler und Nenner und würde damit einen inhaltlich falschen, viel zu niedrigen Zuschlagssatz liefern." },
      { id: "q5", question: "In welcher Einheit wird der Fertigungsgemeinkosten-Zuschlagssatz meist angegeben?", options: ["Als Betrag je Fertigungsstunde (€/h)", "In Prozent der Herstellkosten der Fertigungsstellen", "In Prozent der Materialeinzelkosten der Materialstelle", "Als Betrag je beschäftigtem Mitarbeiter der Kostenstelle"], correctIndex: 0, explanation: "Laut BAB-Formel wird der Fertigungsgemeinkosten-Zuschlagssatz auf die Beschäftigungsstunden der jeweiligen Fertigungsstelle bezogen und deshalb meist als Betrag je Stunde (€/h) ausgewiesen, anders als die prozentualen Zuschlagssätze für Material sowie Verwaltung und Vertrieb. Eine Angabe je Mitarbeiter würde nur die Personalstärke, nicht den Fertigungsaufwand widerspiegeln." },
      { id: "q6", question: "Wie wird der Verwaltungs- und Vertriebsgemeinkosten-Zuschlagssatz berechnet?", options: ["Herstellkosten / Verwaltungs-/Vertriebs-Gemeinkosten", "Verwaltungs-/Vertriebs-Gemeinkosten / Materialeinzelkosten", "Verwaltungs-/Vertriebs-Gemeinkosten / Herstellkosten", "Verwaltungs-/Vertriebs-Gemeinkosten / Fertigungsstunden"], correctIndex: 2, explanation: "Der Verwaltungs- und Vertriebsgemeinkosten-Zuschlagssatz bezieht laut Lehrtext die jeweiligen Gemeinkosten auf die Herstellkosten der Fertigungsstellen, üblicherweise in Prozent. Eine Bezugsgröße wie Materialeinzelkosten oder Fertigungsstunden würde diese Kosten nicht sachgerecht abbilden, da Verwaltung und Vertrieb mit der eigentlichen Fertigung nicht unmittelbar zusammenhängen." },
      { id: "q7", question: "Eine Fertigungsstelle hat Gemeinkosten von 120.000 € bei 6.000 Fertigungsstunden. Wie hoch ist der Fertigungsgemeinkosten-Zuschlagssatz?", options: ["10 €/h", "20 €/h", "200 €/h", "2 €/h"], correctIndex: 1, explanation: "Der Fertigungsgemeinkosten-Zuschlagssatz ergibt sich aus Fertigungs-Gemeinkosten geteilt durch die Fertigungsstunden: 120.000 € / 6.000 h = 20 €/h. Die Antwort 200 €/h entsteht durch einen Kommafehler, während 2 €/h und 10 €/h auf einer falsch herum bzw. mit falschem Faktor durchgeführten Division beruhen." },
      { id: "q8", question: "Warum eignet sich die Mitarbeiterzahl nicht als Verteilungsschlüssel für Energiekosten?", options: ["Weil der Energieverbrauch primär vom Maschineneinsatz abhängt, nicht von der Mitarbeiterzahl", "Weil Energiekosten grundsätzlich nichts mit einzelnen Kostenstellen zu tun haben", "Weil Energiekosten in der Kostenrechnung immer als reine Einzelkosten gelten", "Weil die Mitarbeiterzahl als Verteilungsschlüssel gesetzlich nicht zulässig ist"], correctIndex: 0, explanation: "Der Energieverbrauch hängt laut Lehrtext vom tatsächlichen bzw. geschätzten Verbrauch der Maschinen und Anlagen einer Kostenstelle ab, nicht von der Anzahl der dort beschäftigten Mitarbeiter - anders als etwa bei Gehältern, wo die Mitarbeiterzahl der passende Schlüssel ist. Die übrigen Optionen sind sachlich falsch, da Energiekosten sehr wohl kostenstellenbezogene Gemeinkosten sind, die im BAB verteilt werden." },
      { id: "q9", question: "Materialgemeinkosten betragen 50.000 €, Materialeinzelkosten 250.000 €. Wie hoch ist der Materialgemeinkosten-Zuschlagssatz?", options: ["50 %", "5 %", "10 %", "20 %"], correctIndex: 3, explanation: "Der Materialgemeinkosten-Zuschlagssatz berechnet sich als Material-Gemeinkosten geteilt durch Materialeinzelkosten: 50.000 € / 250.000 € = 0,20 = 20 %. Die Antwort 50 % entspricht dem doppelten, 5 % und 10 % einem Zehntel bzw. der Hälfte des korrekten Werts - typische Fehler bei falscher Kommaverschiebung." },
      { id: "q10", question: "Was ist der Zweck des Betriebsabrechnungsbogens (BAB)?", options: ["Die vollständige Buchung sämtlicher Umsatzerlöse und Zahlungseingänge aus den im Geschäftsjahr verkauften Fertigerzeugnissen", "Die Erfassung der Einzelkosten je Produkt in der Kostenträgerstückrechnung", "Die Ermittlung des Gewinns je Kostenträger am Ende der Abrechnungsperiode", "Die verursachungsgerechte Verteilung der Gemeinkosten auf die Kostenstellen und Ermittlung von Zuschlagssätzen für die Kalkulation"], correctIndex: 3, explanation: "Der BAB verteilt laut Lehrtext die gesamten Gemeinkosten verursachungsgerecht auf die Kostenstellen und ermittelt daraus die Zuschlagssätze (Material, Fertigung, Verwaltung/Vertrieb), die für die spätere Kalkulation benötigt werden. Die Buchung von Umsatzerlösen oder die Ermittlung des Gewinns je Kostenträger sind Aufgaben anderer Rechnungen, nicht des BAB." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Welches Verfahren berücksichtigt Leistungsbeziehungen zwischen den Vorkostenstellen überhaupt nicht?", options: ["Stufenleiterverfahren", "Anbauverfahren", "Mathematisches Verfahren", "Keines der drei Verfahren"], correctIndex: 1, explanation: "Das Anbauverfahren betrachtet laut Lehrtext jede Vorkostenstelle isoliert und verrechnet ihre Kosten nur direkt auf die Endkostenstellen - Leistungsbeziehungen zwischen den Vorkostenstellen selbst bleiben dabei vollständig unberücksichtigt. Das macht es zwar sehr einfach zu rechnen, aber zugleich zum ungenauesten der drei Verfahren, da reale Leistungsverflechtungen ignoriert werden." },
      { id: "q2", question: "Wann liefert das Stufenleiterverfahren exakt dasselbe Ergebnis wie das mathematische Verfahren?", options: ["Immer, unabhängig von den tatsächlichen Leistungsbeziehungen zwischen allen Kostenstellen", "Wenn es keine echten gegenseitigen Verflechtungen zwischen den Vorkostenstellen gibt", "Nur wenn alle Vorkostenstellen exakt gleich hohe primäre Gemeinkosten aufweisen", "Nie, da nur das mathematische Verfahren exakte Ergebnisse liefert"], correctIndex: 1, explanation: "Ohne echte Rückleistungen zwischen den Vorkostenstellen wird bei geeigneter Reihenfolge keine Leistungsbeziehung vernachlässigt, sodass das Ergebnis laut Lehrtext exakt ist. Liegen dagegen echte gegenseitige Verflechtungen vor, hängt das Ergebnis von der gewählten Reihenfolge ab und weicht vom mathematischen Verfahren leicht ab." },
      { id: "q3", question: "Was passiert beim Stufenleiterverfahren mit Rückleistungen an eine bereits abgerechnete Vorkostenstelle?", options: ["Sie werden vernachlässigt", "Sie werden automatisch zum mathematischen Verfahren", "Sie werden doppelt verrechnet", "Sie erhöhen den Verrechnungssatz der bereits abgerechneten Stelle nachträglich"], correctIndex: 0, explanation: "Beim Stufenleiterverfahren erhält eine bereits abgerechnete Vorkostenstelle laut Lehrtext keine Kosten mehr von später abgerechneten Vorkostenstellen - Rückleistungen an bereits abgerechnete Stellen werden also bewusst vernachlässigt, um die Rechnung zu vereinfachen. Genau darin liegt die Vereinfachung, die das Verfahren bei echten Verflechtungen ungenauer macht als das mathematische Verfahren." },
      { id: "q4", question: "Warum gibt es beim Stufenleiterverfahren bei echten gegenseitigen Verflechtungen keine eindeutig 'richtige' Reihenfolge?", options: ["Weil das Verfahren ausschließlich bei genau zwei Vorkostenstellen mit einer einzigen Leistungsbeziehung überhaupt angewendet werden kann", "Weil gesetzlich eine feste alphabetische Reihenfolge der Kostenstellen vorgeschrieben ist", "Weil die Reihenfolge der Abrechnung keinen Einfluss auf das rechnerische Endergebnis hat", "Weil das Ergebnis je nach Reihenfolge unterschiedlich ausfällt und keine Reihenfolge alle Verflechtungen vollständig abbildet"], correctIndex: 3, explanation: "Bei echten gegenseitigen Verflechtungen wird in jeder Reihenfolge zwangsläufig eine Richtung der Leistungsbeziehung vernachlässigt, weshalb es laut Lehrtext keine eindeutig 'richtige' Reihenfolge gibt - das Ergebnis fällt je nach Wahl der Reihenfolge leicht anders aus. Man wählt die Reihenfolge deshalb so, dass die vernachlässigte Rückleistung möglichst gering ausfällt, statt eine perfekte Lösung zu suchen." },
      { id: "q5", question: "Welches Verfahren löst ein simultanes Gleichungssystem, um alle gegenseitigen Verflechtungen exakt zu berücksichtigen?", options: ["Nur das Anbauverfahren", "Nur das Stufenleiterverfahren", "Keines der drei Verfahren", "Das mathematische Verfahren"], correctIndex: 3, explanation: "Nur das mathematische (Gleichungs-)Verfahren stellt laut Lehrtext für jede Vorkostenstelle eine Gleichung auf, die alle gegenseitigen Verflechtungen simultan berücksichtigt, und löst dieses Gleichungssystem. Dadurch liefert es auch bei zyklischer Verflechtung stets das einzig korrekte Ergebnis, allerdings mit höherem Rechenaufwand als Anbau- oder Stufenleiterverfahren." },
      { id: "q6", question: "Warum gilt das Anbauverfahren als am ungenauesten der drei Verfahren?", options: ["Weil es Leistungsbeziehungen zwischen den Vorkostenstellen komplett ignoriert", "Weil es systematisch negative Verrechnungssätze für alle Kostenstellen erzeugt", "Weil es primäre Gemeinkosten grundsätzlich falsch berechnet und verteilt", "Weil es ausschließlich für reine Dienstleistungsunternehmen anwendbar ist"], correctIndex: 0, explanation: "Da beim Anbauverfahren sämtliche innerbetrieblichen Lieferungen zwischen den Vorkostenstellen ignoriert und die Kosten jeder Stelle nur isoliert direkt auf die Endkostenstellen verrechnet werden, bleiben reale Leistungsverflechtungen völlig unberücksichtigt. Genau das macht die Verteilung laut Lehrtext am wenigsten verursachungsgerecht und damit am ungenauesten." },
      { id: "q7", question: "Im Beispiel mit der Energiezentrale (100.000 € primäre Kosten, 1.000 kWh Gesamtabgabe): Wie hoch ist ihr Verrechnungssatz?", options: ["10 €/kWh", "0,1 €/kWh", "100 €/kWh", "1.000 €/kWh"], correctIndex: 2, explanation: "Der Verrechnungssatz einer Vorkostenstelle ergibt sich aus ihren gesamten Kosten geteilt durch die abgegebene Leistungsmenge: 100.000 € / 1.000 kWh = 100 €/kWh. Die anderen Werte entstehen durch typische Kommafehler bei der Division und würden die nachfolgend verrechneten Fertigungs- und Verwaltungskosten um den Faktor 10 bzw. 1.000 verfälschen." },
      { id: "q8", question: "Nach welchem Kriterium sollte man beim Stufenleiterverfahren die Reihenfolge der Vorkostenstellen festlegen, wenn echte Verflechtungen vorliegen?", options: ["Immer nach der absoluten Höhe der primären Gemeinkosten je Vorkostenstelle", "Nach dem Alphabet der jeweiligen Kostenstellennamen im BAB", "So, dass die vernachlässigte Rückleistung möglichst gering ausfällt", "Zufällig, da die gewählte Reihenfolge keinerlei Einfluss auf das Ergebnis hat"], correctIndex: 2, explanation: "Da bei echten Verflechtungen ohnehin immer eine Richtung der Rückleistung vernachlässigt wird, empfiehlt der Lehrtext, die Reihenfolge so zu wählen, dass gerade diese vernachlässigte Rückleistung möglichst gering ausfällt. So bleibt der durch die Vereinfachung entstehende Fehler klein, auch wenn keine Reihenfolge das Ergebnis exakt macht wie beim mathematischen Verfahren." },
      { id: "q9", question: "Wie verhält sich das Stufenleiterverfahren im Vergleich zum Anbauverfahren hinsichtlich der Genauigkeit, wenn echte Verflechtungen vorliegen?", options: ["Es ist stets ungenauer, da die Berechnung komplizierter ist", "Beide Verfahren sind in jedem Fall exakt gleich genau", "Das Stufenleiterverfahren ist ausschließlich bei genau zwei Kostenstellen überhaupt anwendbar", "Es ist i.d.R. genauer, da es einen Teil der Verflechtungen berücksichtigt"], correctIndex: 3, explanation: "Weil das Stufenleiterverfahren zumindest einen Teil der tatsächlichen Leistungsverflechtungen berücksichtigt - anders als das Anbauverfahren, das sie komplett ignoriert -, ist es laut Lehrtext in der Praxis in der Regel deutlich genauer. Es gilt deshalb als der gängige Kompromiss zwischen Genauigkeit und Rechenaufwand, auch wenn es wegen der Reihenfolgeabhängigkeit nicht ganz exakt ist." },
      { id: "q10", question: "Liefern sich Heizwerk und Kantine gegenseitig Leistungen (echte Verflechtung), was gilt dann für das Ergebnis des Stufenleiterverfahrens?", options: ["Es entspricht in jedem Fall automatisch dem mathematischen Verfahren", "Es ist immer exakt, völlig unabhängig von der gewählten Reihenfolge", "Es bleibt bei jeder Reihenfolge nur eine Näherung, da eine Richtung der Verflechtung vernachlässigt wird", "Es ist ausschließlich dann exakt, wenn beide Vorkostenstellen genau gleich hohe primäre Gemeinkosten aufweisen"], correctIndex: 2, explanation: "Bei einer echten gegenseitigen Verflechtung wie zwischen Heizwerk und Kantine kann das Stufenleiterverfahren immer nur eine der beiden Lieferrichtungen berücksichtigen, da eine der Stellen zuerst abgerechnet wird und danach keine Rückleistung mehr empfängt. Das Ergebnis bleibt deshalb bei jeder Reihenfolge nur eine Näherung an das exakte Ergebnis des mathematischen Verfahrens." },
      { id: "yn1", type: "yesno", question: "Liefert das Stufenleiterverfahren bei echten gegenseitigen Verflechtungen zwischen Vorkostenstellen immer exakt dasselbe Ergebnis wie das mathematische Verfahren?", correctAnswer: false, reasons: ["Ja, weil beide Verfahren auf denselben primären Gemeinkosten aufbauen.", "Nein, weil beim Stufenleiterverfahren bei echten Verflechtungen immer eine Richtung der Rückleistung vernachlässigt wird.", "Ja, weil das Stufenleiterverfahren ebenfalls ein simultanes Gleichungssystem löst.", "Nein, weil das Stufenleiterverfahren nur bei genau zwei Kostenstellen anwendbar ist."], correctReasonIndex: 1, explanation: "Bei echten gegenseitigen Verflechtungen kann das Stufenleiterverfahren immer nur eine Lieferrichtung berücksichtigen, da die zuerst abgerechnete Stelle keine Rückleistung mehr erhält - nur das mathematische Verfahren liefert dann das exakte Ergebnis." }
    ]
  }
];
