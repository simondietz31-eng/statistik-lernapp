const KLR_CHAPTER3_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Welche Aussage über Vorkostenstellen (Hilfskostenstellen) trifft zu?", options: ["Sie liefern Leistungen ausschließlich innerbetrieblich an andere Kostenstellen", "Ihre Kosten fließen direkt in die Kalkulation der verkauften Produkte ein", "Sie existieren nur in Handelsunternehmen", "Sie werden im BAB nie mit Gemeinkosten belastet"], correctIndex: 0, explanation: "Vorkostenstellen wie Energiezentrale oder Kantine erbringen Leistungen nur für andere Kostenstellen, nicht direkt für den Markt." },
      { id: "q2", question: "Welche der folgenden Kostenstellen ist typischerweise eine Endkostenstelle (Hauptkostenstelle)?", options: ["Energiezentrale", "Kantine", "Fertigung", "Reparaturwerkstatt"], correctIndex: 2, explanation: "Fertigung ist eine Endkostenstelle, deren Gemeinkosten unmittelbar in die Produktkalkulation einfließen." },
      { id: "q3", question: "Welcher Verteilungsschlüssel eignet sich am besten für kalkulatorische Abschreibungen?", options: ["Mitarbeiterzahl", "Anschaffungswert der Anlagen", "Verbrauchsverhältnis", "Fläche in Quadratmetern"], correctIndex: 1, explanation: "Abschreibungen hängen vom Wert der genutzten Anlagen ab, daher ist der Anschaffungswert der passende Schlüssel." },
      { id: "q4", question: "Wie lautet die Formel für den Materialgemeinkosten-Zuschlagssatz?", options: ["Material-Gemeinkosten / Materialeinzelkosten", "Material-Gemeinkosten / Herstellkosten", "Materialeinzelkosten / Material-Gemeinkosten", "Material-Gemeinkosten / Fertigungsstunden"], correctIndex: 0, explanation: "Der Materialgemeinkosten-Zuschlagssatz setzt die Material-Gemeinkosten ins Verhältnis zu den Materialeinzelkosten." },
      { id: "q5", question: "In welcher Einheit wird der Fertigungsgemeinkosten-Zuschlagssatz meist angegeben?", options: ["In Prozent der Materialeinzelkosten", "Als Betrag je Fertigungsstunde (€/h)", "Als Betrag je Mitarbeiter", "In Prozent der Herstellkosten"], correctIndex: 1, explanation: "Fertigungsgemeinkosten werden üblicherweise auf die Beschäftigungsstunden der jeweiligen Fertigungsstelle bezogen, also in €/h." },
      { id: "q6", question: "Wie wird der Verwaltungs- und Vertriebsgemeinkosten-Zuschlagssatz berechnet?", options: ["Verwaltungs-/Vertriebs-Gemeinkosten / Herstellkosten", "Verwaltungs-/Vertriebs-Gemeinkosten / Materialeinzelkosten", "Herstellkosten / Verwaltungs-/Vertriebs-Gemeinkosten", "Verwaltungs-/Vertriebs-Gemeinkosten / Fertigungsstunden"], correctIndex: 0, explanation: "Der Zuschlagssatz bezieht die Verwaltungs- und Vertriebsgemeinkosten auf die Herstellkosten der Fertigungsstellen." },
      ...
      { id: "q8", question: "Warum eignet sich die Mitarbeiterzahl nicht als Verteilungsschlüssel für Energiekosten?", options: ["Weil Energiekosten nichts mit Kostenstellen zu tun haben", "Weil der Energieverbrauch eher vom Maschineneinsatz als von der Mitarbeiterzahl abhängt", "Weil Energiekosten immer Einzelkosten sind", "Weil die Mitarbeiterzahl gesetzlich nicht als Schlüssel erlaubt ist"], correctIndex: 1, explanation: "Der Energieverbrauch hängt vom Maschinenpark und dessen Nutzung ab, nicht von der Kopfzahl der Mitarbeiter." },
      { id: "q9", question: "Materialgemeinkosten betragen 50.000 €, Materialeinzelkosten 250.000 €. Wie hoch ist der Materialgemeinkosten-Zuschlagssatz?", options: ["5 %", "10 %", "20 %", "50 %"], correctIndex: 2, explanation: "50.000 € / 250.000 € = 0,20 = 20 %." },
      { id: "q10", question: "Was ist der Zweck des Betriebsabrechnungsbogens (BAB)?", options: ["Die verursachungsgerechte Verteilung der Gemeinkosten auf die Kostenstellen und Ermittlung von Zuschlagssätzen für die Kalkulation", "Die Erfassung der Einzelkosten je Produkt", "Die Ermittlung des Gewinns je Kostenträger", "Die Buchung der Umsatzerlöse"], correctIndex: 0, explanation: "Der BAB verteilt Gemeinkosten auf Kostenstellen und liefert die Zuschlagssätze, die für die spätere Kalkulation benötigt werden." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Welches Verfahren berücksichtigt Leistungsbeziehungen zwischen den Vorkostenstellen überhaupt nicht?", options: ["Anbauverfahren", "Stufenleiterverfahren", "Mathematisches Verfahren", "Keines der drei Verfahren"], correctIndex: 0, explanation: "Das Anbauverfahren verrechnet jede Vorkostenstelle isoliert nur direkt auf die Endkostenstellen." },
      ...
      { id: "q3", question: "Was passiert beim Stufenleiterverfahren mit Rückleistungen an eine bereits abgerechnete Vorkostenstelle?", options: ["Sie werden doppelt verrechnet", "Sie werden vernachlässigt", "Sie werden automatisch zum mathematischen Verfahren", "Sie erhöhen den Verrechnungssatz der bereits abgerechneten Stelle nachträglich"], correctIndex: 1, explanation: "Eine bereits abgerechnete Vorkostenstelle bekommt keine späteren Rückleistungen mehr zugerechnet - das ist die Vereinfachung des Verfahrens." },
      { id: "q4", question: "Warum gibt es beim Stufenleiterverfahren bei echten gegenseitigen Verflechtungen keine eindeutig 'richtige' Reihenfolge?", options: ["Weil das Ergebnis je nach Reihenfolge unterschiedlich ausfällt und keine Reihenfolge alle Verflechtungen vollständig abbildet", "Weil die Reihenfolge keinen Einfluss auf das Ergebnis hat", "Weil das Verfahren nur mit genau zwei Vorkostenstellen funktioniert", "Weil gesetzlich eine alphabetische Reihenfolge vorgeschrieben ist"], correctIndex: 0, explanation: "Bei echten Verflechtungen wird immer eine der beiden Richtungen der Verflechtung vernachlässigt - je nach Reihenfolge eine andere." },
      { id: "q5", question: "Welches Verfahren löst ein simultanes Gleichungssystem, um alle gegenseitigen Verflechtungen exakt zu berücksichtigen?", options: ["Anbauverfahren", "Stufenleiterverfahren", "Mathematisches Verfahren", "Keines"], correctIndex: 2, explanation: "Das mathematische (Gleichungs-)Verfahren berücksichtigt alle Verflechtungen simultan und liefert dadurch immer das exakte Ergebnis." },
      { id: "q6", question: "Warum gilt das Anbauverfahren als am ungenauesten der drei Verfahren?", options: ["Weil es primäre Gemeinkosten falsch berechnet", "Weil es Leistungsbeziehungen zwischen den Vorkostenstellen komplett ignoriert und nur direkt auf Endkostenstellen verrechnet", "Weil es nur für Dienstleistungsunternehmen anwendbar ist", "Weil es negative Verrechnungssätze erzeugt"], correctIndex: 1, explanation: "Da sämtliche innerbetrieblichen Lieferungen zwischen den Vorkostenstellen ignoriert werden, ist die Verteilung am wenigsten verursachungsgerecht." },
      { id: "q7", question: "Im Beispiel mit der Energiezentrale (100.000 € primäre Kosten, 1.000 kWh Gesamtabgabe): Wie hoch ist ihr Verrechnungssatz?", options: ["10 €/kWh", "100 €/kWh", "1.000 €/kWh", "0,1 €/kWh"], correctIndex: 1, explanation: "100.000 € / 1.000 kWh = 100 €/kWh." },
      { id: "q8", question: "Nach welchem Kriterium sollte man beim Stufenleiterverfahren die Reihenfolge der Vorkostenstellen festlegen, wenn echte Verflechtungen vorliegen?", options: ["Nach dem Alphabet der Kostenstellennamen", "So, dass die vernachlässigte Rückleistung möglichst gering ausfällt", "Immer nach der Höhe der primären Kosten", "Zufällig, da die Reihenfolge keinen Einfluss hat"], correctIndex: 1, explanation: "Ziel ist es, den durch die Vernachlässigung entstehenden Fehler möglichst klein zu halten." },
      { id: "q9", question: "Wie verhält sich das Stufenleiterverfahren im Vergleich zum Anbauverfahren hinsichtlich der Genauigkeit, wenn echte Verflechtungen vorliegen?", options: ["Es ist ungenauer, da es komplizierter ist", "Es ist i.d.R. genauer, weil es zumindest einen Teil der Verflechtungen berücksichtigt", "Beide sind exakt gleich genau", "Das Stufenleiterverfahren ist nur bei genau zwei Kostenstellen anwendbar"], correctIndex: 1, explanation: "Das Stufenleiterverfahren berücksichtigt zumindest einen Teil der Leistungsbeziehungen und ist daher meist genauer als das Anbauverfahren." },
      { id: "q10", question: "Liefern sich Heizwerk und Kantine gegenseitig Leistungen (echte Verflechtung), was gilt dann für das Ergebnis des Stufenleiterverfahrens?", options: ["Es bleibt bei jeder Reihenfolge nur eine Näherung, da eine Richtung der gegenseitigen Verflechtung stets vernachlässigt wird", "Es ist immer exakt, unabhängig von der Reihenfolge", "Es entspricht automatisch dem mathematischen Verfahren", "Es ist nur bei genau gleich hohen primären Kosten beider Stellen exakt"], correctIndex: 0, explanation: "Bei echter gegenseitiger Verflechtung kann das Stufenleiterverfahren immer nur eine Richtung der Lieferung berücksichtigen - eine wird je nach Reihenfolge vernachlässigt." }
    ]
  }
];
