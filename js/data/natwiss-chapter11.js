const NATWISS_CHAPTER11_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Verdoppelt sich der Widerstand eines Drahtes, wenn sowohl seine Länge als auch sein Durchmesser verdoppelt werden?", correctAnswer: false, reasons: ["Nein, weil sich bei doppelter Länge und doppeltem Durchmesser die Querschnittsfläche A ∝ d² vervierfacht, während R nur linear mit L wächst – insgesamt halbiert sich R = ρL/A.", "Ja, weil sich Länge und Durchmesser jeweils verdoppeln und sich die Effekte einfach addieren, sodass R sich verdoppelt.", "Nein, weil der Widerstand bei gleichzeitiger Skalierung von Länge und Durchmesser stets konstant bleibt.", "Ja, weil der spezifische Widerstand ρ bei größeren Drahtabmessungen automatisch ansteigt."], correctReasonIndex: 0, explanation: "R = ρL/A mit A = π(d/2)²; bei L' = 2L und d' = 2d wird A' = 4A, sodass R' = ρ·2L/(4A) = R/2 – der Widerstand halbiert sich, weil die quadratische Zunahme der Querschnittsfläche die lineare Zunahme der Länge überkompensiert." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist der Gesamtwiderstand einer Parallelschaltung stets größer als der größte beteiligte Einzelwiderstand?", correctAnswer: false, reasons: ["Nein, weil der Gesamtwiderstand einer Parallelschaltung durch 1/R_p = 1/R₁ + 1/R₂ + … stets kleiner ist als der kleinste beteiligte Einzelwiderstand, nicht größer als der größte.", "Ja, weil sich bei Parallelschaltung die Widerstandswerte addieren, ähnlich wie bei einer Reihenschaltung.", "Nein, weil der Gesamtwiderstand einer Parallelschaltung immer exakt gleich dem größten Einzelwiderstand ist.", "Ja, weil zusätzliche parallele Widerstände den Strom stärker behindern und den Gesamtwiderstand dadurch erhöhen."], correctReasonIndex: 0, explanation: "Bei einer Parallelschaltung addieren sich die Kehrwerte der Widerstände, wodurch R_p stets kleiner ist als der kleinste Einzelwiderstand – jeder zusätzliche parallele Pfad bietet dem Strom eine weitere Möglichkeit zu fließen und senkt den Gesamtwiderstand." },
