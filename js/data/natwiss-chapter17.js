const NATWISS_CHAPTER17_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Hängt das elektrische Potenzial φ = kQ/r einer Punktladung nur vom Abstand r ab, unabhängig von der Richtung zur Ladung?", correctAnswer: true, reasons: ["Ja, weil φ = kQ/r nur den Betrag des Abstands r enthält; zwei Punkte mit demselben Abstand zur Ladung haben unabhängig von ihrer Richtung dasselbe Potenzial.", "Nein, weil das Potenzial wie die Coulombkraft ein Vektor ist und daher auch von der Richtung zur Ladung abhängt.", "Ja, weil das Potenzial einer Punktladung überall im Raum denselben konstanten Wert besitzt.", "Nein, weil sich das Potenzial nur entlang der Verbindungsachse zwischen zwei Punkten sinnvoll definieren lässt."], correctReasonIndex: 0, explanation: "φ = kQ/r ist eine skalare Größe, die nur vom Betrag des Abstands r abhängt, nicht von der Richtung – deshalb ist der Potenzialunterschied zwischen zwei Punkten mit gleichen Abständen d₁ und d₂ zur Ladung stets gleich, egal ob sie auf derselben Achse liegen oder nicht (vgl. Aufgabe 41.7b)." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Vervierfacht sich die in einem Kondensator gespeicherte Energie, wenn die Spannung U verdoppelt wird (bei konstanter Kapazität C)?", correctAnswer: true, reasons: ["Ja, weil W = ½CU² quadratisch von der Spannung abhängt; bei doppelter Spannung vervierfacht sich die gespeicherte Energie, nicht nur verdoppelt sie sich.", "Nein, weil sich die Energie wie die Ladung Q = CU nur linear mit der Spannung verdoppelt.", "Ja, weil sich bei doppelter Spannung automatisch auch die Kapazität C verdoppelt und beide Effekte sich addieren.", "Nein, weil die gespeicherte Energie unabhängig von der angelegten Spannung stets konstant bleibt."], correctReasonIndex: 0, explanation: "W = ½CU² hängt quadratisch von U ab; bei konstanter Kapazität C führt eine Verdopplung der Spannung zu einer Vervierfachung der Energie (Faktor 2² = 4) – im Unterschied zur Ladung Q = CU, die sich bei doppelter Spannung nur linear verdoppelt." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Hängt die Größe der induzierten Spannung U_ind nur vom Endwert des Magnetfelds B ab, nicht von der Geschwindigkeit seiner Änderung?", correctAnswer: false, reasons: ["Nein, weil U_ind = −N·dΦ/dt von der zeitlichen Änderungsrate des Flusses abhängt; bei gleichem Endwert von B, aber unterschiedlich schneller Änderung, ergeben sich unterschiedliche induzierte Spannungen.", "Ja, weil die induzierte Spannung ausschließlich vom Endwert des Magnetfelds B bestimmt wird, unabhängig von der Zeitdauer der Änderung.", "Nein, weil U_ind nur von der Windungszahl N abhängt, nicht vom Magnetfeld selbst.", "Ja, weil sich bei jeder Flussänderung automatisch dieselbe induzierte Spannung ergibt, unabhängig von Δt."], correctReasonIndex: 0, explanation: "Aus U_ind = −N·ΔΦ/Δt folgt, dass dieselbe Flussänderung ΔΦ bei kürzerer Zeitdauer Δt eine größere induzierte Spannung erzeugt; nicht der Endwert von B allein, sondern die Geschwindigkeit seiner Änderung bestimmt U_ind." },
