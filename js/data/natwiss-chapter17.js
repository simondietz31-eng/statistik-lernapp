const NATWISS_CHAPTER17_TOPICS = [
  {
    ...
    quiz: [
      { id: "natwiss-ueb-elektrostatik-q1", question: "Wie skaliert die Coulombkraft mit dem Abstand r?", options: ["F ∝ r, linear statt quadratisch", "F ∝ 1/r³, mit falscher Potenz", "F ∝ 1/r, ohne Quadrierung", "F ∝ 1/r², das Coulombsche Gesetz"], correctIndex: 3, explanation: "Das Coulombgesetz F = kQ₁Q₂/r² zeigt ein quadratisches Abstandsgesetz, analog zur Gravitation — verdoppelt sich der Abstand, sinkt die Kraft auf ein Viertel, nicht nur auf die Hälfte." },
      { id: "natwiss-ueb-elektrostatik-q2", question: "Was ist die Coulombkonstante k in SI-Einheiten?", options: ["k = 9·10⁹ Vm/As, die Coulomb-Konstante", "k = 1,6·10⁻¹⁹ C, das ist stattdessen die Elementarladung", "k = 6,67·10⁻¹¹ Nm²/kg², das ist die Gravitationskonstante", "k = 8,85·10⁻¹² As/(Vm), das ist ε₀ selbst"], correctIndex: 0, explanation: "Die Coulombkonstante k = 1/(4πε₀) ≈ 8,99·10⁹ N·m²/C² ≈ 9·10⁹ Vm/As ergibt sich als Kehrwert von 4π mal der elektrischen Feldkonstante ε₀, nicht als ε₀ selbst. Die anderen Werte sind reale, aber andere Naturkonstanten." },
      { id: "natwiss-ueb-elektrostatik-q3", question: "Wie hängt das elektrische Potenzial einer Punktladung vom Abstand r ab?", options: ["φ bleibt für jeden Abstand konstant", "φ ∝ 1/r, das Potenzial einer Punktladung", "φ ∝ r, linear statt mit Kehrwert", "φ ∝ 1/r², wie die Kraft statt des Potenzials"], correctIndex: 1, explanation: "Aus φ = kQ/r folgt eine 1/r-Abhängigkeit — das Potenzial fällt also langsamer ab als die Kraft, die mit 1/r² abnimmt, weil das Potenzial das Wegintegral der Feldstärke ist und dabei eine Potenz von r 'gewinnt'." },
      ...
      { id: "yn1", type: "yesno", question: "Hängt das elektrische Potenzial φ = kQ/r einer Punktladung nur vom Abstand r ab, unabhängig von der Richtung zur Ladung?", correctAnswer: true, reasons: ["Ja, weil φ = kQ/r nur den Betrag von r enthält; Punkte mit gleichem Abstand haben unabhängig von der Richtung dasselbe Potenzial.", "Nein, weil das Potenzial wie die Coulombkraft ein Vektor ist und daher auch von der Richtung zur Ladung abhängt, nicht nur vom Betrag.", "Ja, weil das Potenzial einer Punktladung überall im Raum denselben konstanten Wert besitzt, unabhängig vom Abstand.", "Nein, weil sich das Potenzial nur entlang der Verbindungsachse zwischen zwei Punkten sinnvoll definieren lässt, sonst nicht."], correctReasonIndex: 0, explanation: "φ = kQ/r ist eine skalare Größe, die nur vom Betrag des Abstands r abhängt, nicht von der Richtung – deshalb ist der Potenzialunterschied zwischen zwei Punkten mit gleichen Abständen d₁ und d₂ zur Ladung stets gleich, egal ob sie auf derselben Achse liegen oder nicht (vgl. Aufgabe 41.7b)." },
  ...
  },
  {
    ...
    quiz: [
      { id: "natwiss-ueb-kondensatoren-q1", question: "Was ist die Kapazität eines Plattenkondensators?", options: ["C = ε₀·d/A, mit vertauschtem Zähler und Nenner", "C = U/Q, mit vertauschtem Zähler und Nenner", "C = Q·U, als Produkt statt Quotient", "C = ε_r·ε₀·A/d, die Plattenkondensator-Formel"], correctIndex: 3, explanation: "Die Kapazität C = ε_r·ε₀·A/d steigt mit größerer Plattenfläche A (mehr Raum für Ladung) und sinkt mit größerem Plattenabstand d (schwächere Feldwirkung). Die Definitionsgleichung C = Q/U (nicht U/Q) liefert dasselbe Ergebnis über die tatsächlich gespeicherte Ladung." },
      ...
      { id: "natwiss-ueb-kondensatoren-q6", question: "An zwei parallel geschalteten Kondensatoren (C₁ = 3 μF, C₂ = 6 μF) liegt U = 10 V. Wie groß ist die Gesamtladung?", options: ["20 μC, mit falscher Kapazitätsaddition", "90 nC, um drei Zehnerpotenzen zu klein", "90 μC, korrekt aus C und U berechnet", "30 μC, mit fehlerhafter Multiplikation"], correctIndex: 2, explanation: "Bei Parallelschaltung addieren sich die Kapazitäten direkt, C_ges = C₁ + C₂ = 9 μF, sodass die Gesamtladung Q = C_ges·U = 9 μF · 10 V = 90 μC beträgt — auf die korrekte Einheit (μC statt nC) muss dabei geachtet werden." },
      { id: "yn1", type: "yesno", question: "Vervierfacht sich die in einem Kondensator gespeicherte Energie, wenn die Spannung U verdoppelt wird (bei konstanter Kapazität C)?", correctAnswer: true, reasons: ["Ja, weil W = ½CU² quadratisch von U abhängt; bei doppelter Spannung vervierfacht sich die gespeicherte Energie.", "Nein, weil sich die Energie wie die Ladung Q = CU nur linear mit der Spannung verdoppelt, nicht quadratisch mit U².", "Ja, weil sich bei doppelter Spannung automatisch auch die Kapazität C verdoppelt und sich beide Effekte multiplikativ addieren.", "Nein, weil die gespeicherte Energie unabhängig von der angelegten Spannung stets konstant bleibt, solange C fest ist."], correctReasonIndex: 0, explanation: "W = ½CU² hängt quadratisch von U ab; bei konstanter Kapazität C führt eine Verdopplung der Spannung zu einer Vervierfachung der Energie (Faktor 2² = 4) – im Unterschied zur Ladung Q = CU, die sich bei doppelter Spannung nur linear verdoppelt." },
      ...
      { id: "natwiss-ueb-kondensatoren-q9", question: "Wie groß ist das elektrische Feld im Plattenkondensator (Abstand d, Spannung U)?", options: ["E = ε₀U/d, mit unnötigem Faktor ε₀", "E = d/U, mit vertauschtem Zähler und Nenner", "E = U/d, die Feldstärke im Plattenkondensator", "E = U·d, als Produkt statt Quotient"], correctIndex: 2, explanation: "Im homogenen Feld eines idealen Plattenkondensators gilt E = U/d, da die Spannung als Wegintegral U = E·d über den konstanten Abstand definiert ist. Die Feldkonstante ε₀ geht dabei nicht in diese direkte Beziehung ein, sondern nur in die Kapazitätsformel." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Hängt die Größe der induzierten Spannung U_ind nur vom Endwert des Magnetfelds B ab, nicht von der Geschwindigkeit seiner Änderung?", correctAnswer: false, reasons: ["Nein, weil U_ind = −N·dΦ/dt von der Änderungsrate des Flusses abhängt, nicht vom Endwert von B allein.", "Ja, weil die induzierte Spannung ausschließlich vom Endwert des Magnetfelds B bestimmt wird, unabhängig von der Zeitdauer der Änderung.", "Nein, weil U_ind nur von der Windungszahl N und der Spulenfläche abhängt, nicht vom Magnetfeld B selbst oder dessen zeitlicher Änderung.", "Ja, weil sich bei jeder Flussänderung automatisch dieselbe induzierte Spannung ergibt, unabhängig von der Zeitspanne Δt, solange die Windungszahl N konstant bleibt."], correctReasonIndex: 0, explanation: "Aus U_ind = −N·ΔΦ/Δt folgt, dass dieselbe Flussänderung ΔΦ bei kürzerer Zeitdauer Δt eine größere induzierte Spannung erzeugt; nicht der Endwert von B allein, sondern die Geschwindigkeit seiner Änderung bestimmt U_ind." },
      ...
      { id: "natwiss-ueb-stromkreis-q10", question: "Wie lautet die elektrische Leistung P in einem Widerstand R bei Strom I?", options: ["P = U/I, mit vertauschtem Zähler und Nenner", "P = I²R, die elektrische Verlustleistung", "P = IR², mit falscher Quadrierung", "P = U·R, ohne Bezug zum Strom"], correctIndex: 1, explanation: "Aus P = U·I und dem Ohmschen Gesetz U = IR folgt äquivalent P = I²R = U²/R — die drei Formen sind ineinander umrechenbar, je nachdem, welche Größen bekannt sind. Entscheidend ist, dass der Strom quadratisch eingeht, nicht der Widerstand." }
    ]
  }
];
