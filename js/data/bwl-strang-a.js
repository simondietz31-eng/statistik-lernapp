const BWL_STRANG_A_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Haben sekundäre Geschäftsprozesse laut Text einen direkten Marktbezug?", correctAnswer: false, reasons: ["Nein, weil sekundäre Prozesse interne Kunden bedienen und keinen direkten Marktbezug haben", "Ja, weil sekundäre Prozesse laut Definition unmittelbaren Kundennutzen erzeugen", "Nein, weil sekundäre Prozesse grundsätzlich nicht wertschöpfend sind", "Ja, weil jeder Prozess im Unternehmen zwangsläufig Marktbezug besitzt"], correctReasonIndex: 0, explanation: "Sekundäre Prozesse (Führungs- und Unterstützungsprozesse) bedienen interne Kunden und haben daher keinen direkten Marktbezug - im Gegensatz zu primären Geschäftsprozessen." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Erarbeiten Mitarbeitende bei der 'harten Tour' (Bombenwurf) die Lösung gemeinsam im Team?", correctAnswer: false, reasons: ["Nein, weil bei der harten Tour die Lösung exklusiv von der Unternehmensleitung erarbeitet wird", "Ja, weil beide Verbesserungsstrategien laut Text auf breiter Teambeteiligung beruhen", "Nein, weil die harte Tour ausschließlich auf externen Beratern basiert", "Ja, weil die Mitarbeitenden bei der harten Tour den gesamten Veränderungsprozess selbst steuern"], correctReasonIndex: 0, explanation: "Die harte Tour (Revolution/'Bombenwurf') stellt alles radikal infrage und wird exklusiv von der Leitung erarbeitet - das Gegenteil der sanften Tour, bei der Teams gemeinsam Lösungen entwickeln." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Führt mehr Detaillierung in einem Prozessmodell laut Detaillierungsdilemma automatisch zu mehr Klarheit?", correctAnswer: false, reasons: ["Nein, weil mehr Detaillierung zwar für Simulation/Software nötig ist, aber zulasten von Klarheit und Wirtschaftlichkeit geht", "Ja, weil detailliertere Modelle laut GoM-Grundsätzen immer verständlicher sind", "Nein, weil Detaillierung in Prozessmodellen grundsätzlich verboten ist", "Ja, weil Klarheit ausschließlich vom Detaillierungsgrad abhängt und von keinen anderen Faktoren"], correctReasonIndex: 0, explanation: "Das Detaillierungsdilemma beschreibt genau diesen Zielkonflikt: mehr Details helfen bei Simulation und Kostenplanung, verschlechtern aber Klarheit und Wirtschaftlichkeit." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Erfolgt die Beurteilung eines Prozesses laut Text unabhängig vom Wettbewerb?", correctAnswer: false, reasons: ["Nein, weil für jeden Prozess eine Kundenalternative existiert und die Beurteilung daher relativ zum Wettbewerb erfolgt", "Ja, weil interne Sollwerte allein für die Bewertung ausreichen", "Nein, weil Prozessbemessung ausschließlich gesetzlich vorgeschriebene Kennzahlen nutzt", "Ja, weil Wettbewerber keinen Einfluss auf die Kundenwahrnehmung haben"], correctReasonIndex: 0, explanation: "Die Beurteilung erfolgt immer relativ zum Wettbewerb, da Kunden jederzeit zu einer Alternative wechseln können." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Trägt ein Process Owner Weisungsbefugnis wie eine klassische, hierarchische Führungskraft?", correctAnswer: false, reasons: ["Nein, weil der Process Owner das Team durch Selbstabstimmung statt durch Weisung koordiniert", "Ja, weil der Process Owner formal höchste Weisungsbefugnis über alle Abteilungen besitzt", "Nein, weil der Process Owner keinerlei Verantwortung für den Prozess trägt", "Ja, weil klassische Hierarchien im Business Reengineering vollständig erhalten bleiben"], correctReasonIndex: 0, explanation: "Der Process Owner trägt Gesamtverantwortung, koordiniert aber durch Selbstabstimmung des Teams statt durch klassische Weisung." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist Prozessmanagement laut Vorlesung besonders gut geeignet, um eine Kostenführerschaftsstrategie zu unterstützen?", correctAnswer: false, reasons: ["Nein, weil Kostenführerschaft primär auf Skaleneffekten beruht, während Prozessmanagement Koordinationskosten reduziert", "Ja, weil Prozessmanagement laut Text gezielt Skaleneffekte und Fixkostendegression erzeugt", "Nein, weil Prozessmanagement ausschließlich für Fokussierungsstrategien geeignet ist", "Ja, weil Kostenführerschaft und Prozessmanagement laut Text denselben Hebel nutzen"], correctReasonIndex: 0, explanation: "Prozessmanagement ist eher für Differenzierung geeignet, da es Koordinationskosten senkt statt Fixkostendegression durch Skaleneffekte zu erzeugen wie bei Kostenführerschaft." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Reicht das bloße Vorhandensein wertvoller Ressourcen aus, um eine Kernkompetenz zu begründen?", correctAnswer: false, reasons: ["Nein, weil Ressourcen allenfalls eine notwendige, aber keine hinreichende Bedingung für Kompetenzen sind", "Ja, weil jede wertvolle Ressource automatisch zur Kernkompetenz wird", "Nein, weil Ressourcen laut Text überhaupt keinen Einfluss auf Kompetenzen haben", "Ja, weil Kernkompetenzen ausschließlich durch physikalische Ressourcen entstehen"], correctReasonIndex: 0, explanation: "Erst eine erfolgskritische, unternehmensspezifische Kombination mit Marktbezug macht aus Ressourcen eine Kernkompetenz - das bloße Vorhandensein reicht nicht." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Wird Gesundheit laut Gesamtfazit primär durch individuelle Verhaltensangebote an Mitarbeitende bestimmt?", correctAnswer: false, reasons: ["Nein, weil Gesundheit primär durch Management-/Planungsentscheidungen auf der Dispositionsebene entsteht", "Ja, weil individuelle Verhaltensangebote laut Fazit der zentrale Hebel für Gesundheit sind", "Nein, weil Gesundheit laut Text ausschließlich vom Zufall abhängt", "Ja, weil Dispositionsentscheidungen laut Fazit keinerlei Einfluss auf Gesundheit haben"], correctReasonIndex: 0, explanation: "Laut Gesamtfazit entsteht Gesundheit primär durch dispositive Management-/Planungsentscheidungen, nicht durch nachgelagerte individuelle Verhaltensangebote." },
