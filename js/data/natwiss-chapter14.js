const NATWISS_CHAPTER14_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Hängt die Zeit zum Aufholen eines Vorsprungs beim Überholen nur von der Differenzgeschwindigkeit Δv der beiden Fahrzeuge ab, nicht von ihren Absolutgeschwindigkeiten?", correctAnswer: true, reasons: ["Ja, weil sich die Aufholzeit aus t = Δx/Δv berechnet, wobei nur die Differenzgeschwindigkeit Δv eingeht, nicht die Absolutgeschwindigkeiten.", "Nein, weil das schnellere Fahrzeug allein durch seine hohe Absolutgeschwindigkeit den Vorsprung unabhängig von Δv schneller aufholt.", "Ja, weil beim Überholvorgang grundsätzlich nur die langsamere Geschwindigkeit für die Berechnung der Zeit relevant ist.", "Nein, weil die Aufholzeit nach gängiger Fehlvorstellung stets von der Summe beider Absolutgeschwindigkeiten abhängt, niemals von deren Differenz."], correctReasonIndex: 0, explanation: "Die Aufholzeit ergibt sich aus t = Δx/Δv, wobei Δv = v_schnell − v_langsam die relative Annäherungsgeschwindigkeit ist; zwei Fahrzeuge mit 80/110 km/h holen den Vorsprung genauso schnell auf wie zwei Fahrzeuge mit 20/50 km/h, solange Δv = 30 km/h gleich bleibt." },
      { id: "natwiss-ueb-kinematik-q6", question: "Ein Körper fällt aus der Ruhe. Nach t = 3 s, wie weit ist er gefallen (g = 10 m/s²)?", options: ["15 m, ohne den Faktor ½", "90 m, ohne Quadrierung der Zeit", "45 m, mit Faktor ½ und t² korrekt berechnet", "30 m, mit fehlerhafter Quadrierung"], correctIndex: 2, explanation: "Für den freien Fall aus der Ruhe gilt s = ½·g·t² = ½·10·3² = ½·10·9 = 45 m. Sowohl der Faktor ½ als auch die Quadrierung der Zeit sind entscheidend für das korrekte Ergebnis." },
      { id: "natwiss-ueb-kinematik-q7", question: "Bei einem Überholvorgang ist die Relativgeschwindigkeit 30 km/h. Wie lange dauert es, einen Vorsprung von 60 km aufzuholen?", options: ["1 h, bei zu niedrig angesetzter Zeit", "2 h, aus Δx/Δv berechnet", "0,5 h, deutlich zu kurz gerechnet", "3 h, deutlich zu lang gerechnet"], correctIndex: 1, explanation: "Die Aufholzeit ergibt sich aus t = Δx/Δv = 60 km / 30 km/h = 2 h — der Vorsprung wird durch die Relativgeschwindigkeit geteilt, nicht durch eine der Absolutgeschwindigkeiten." },
      { id: "natwiss-ueb-kinematik-q8", question: "Was ist die Kreisfrequenz ω bei 15000 U/min?", options: ["1571 rad/s, aus n und 2π berechnet", "15000 rad/s, ohne Umrechnung in rad/s", "78,5 rad/s, bei falscher Zeiteinheit", "250 rad/s, ohne den Faktor 2π"], correctIndex: 0, explanation: "Zunächst wird die Drehzahl auf Umdrehungen pro Sekunde umgerechnet, n = 15000/60 = 250 1/s, dann mit 2π multipliziert: ω = 2π·250 ≈ 1571 rad/s. Beide Umrechnungsschritte (Zeiteinheit und Faktor 2π) müssen dabei berücksichtigt werden." },
      { id: "natwiss-ueb-kinematik-q9", question: "Aus der Ruhe beschleunigt: v₀ = 0, a = 5 m/s². Welche Geschwindigkeit nach t = 4 s?", options: ["40 m/s, bei falscher Multiplikation", "10 m/s, deutlich zu niedrig", "20 m/s, aus v=v₀+at berechnet", "5 m/s, ohne Berücksichtigung der Zeit"], correctIndex: 2, explanation: "Aus v = v₀ + a·t folgt mit v₀ = 0 direkt v = 5 m/s² · 4 s = 20 m/s. Die Zeit geht hier linear ein, nicht quadratisch wie beim zurückgelegten Weg." },
      { id: "natwiss-ueb-kinematik-q10", question: "Welche kinematische Gleichung gilt für den zurückgelegten Weg bei gleichmäßig beschleunigter Bewegung aus der Ruhe?", options: ["s = ½·a·t², die Weg-Zeit-Formel aus der Ruhe", "s = a·t, ohne Zeitquadrat", "s = v²/a, eine andere kinematische Beziehung", "s = v·t, was konstante Geschwindigkeit voraussetzt"], correctIndex: 0, explanation: "Aus der allgemeinen Weg-Zeit-Gleichung s = v₀·t + ½·a·t² folgt für v₀ = 0 direkt s = ½·a·t². Die Formel s = v·t gilt dagegen nur bei konstanter Geschwindigkeit ohne Beschleunigung." }
    ]
  },
  {
    ...
    quiz: [
      ...
      { id: "natwiss-ueb-dynamik-q7", question: "Welche Bedingung gilt für einen Körper im Kräftegleichgewicht?", options: ["ΣF = m, als fehlerhafte Gleichsetzung", "ΣF ≠ 0, was gerade kein Gleichgewicht wäre", "ΣF = 0, die Gleichgewichtsbedingung", "a ≠ 0, was Beschleunigung bedeuten würde"], correctIndex: 2, explanation: "Kräftegleichgewicht bedeutet, dass sich alle angreifenden Kräfte zu null summieren, ΣF = 0, woraus nach F = ma zwingend a = 0 folgt. Der Körper bleibt dann entweder in Ruhe oder bewegt sich gleichförmig geradlinig weiter." },
      ...
      { id: "yn1", type: "yesno", question: "Ist bei der Kurvenüberhöhung (tan θ = v²/(rg)) für höhere Geschwindigkeiten ein größerer Überhöhungswinkel nötig (gleicher Radius, keine Seitenreibung)?", correctAnswer: true, reasons: ["Ja, weil tan θ = v²/(rg) quadratisch mit v wächst; eine schneller befahrene Kurve benötigt daher einen größeren Überhöhungswinkel, ohne Seitenreibung.", "Nein, weil der erforderliche Überhöhungswinkel laut vereinfachter Betrachtung ausschließlich vom Kurvenradius abhängt und die Geschwindigkeit dabei überhaupt keine Rolle spielt.", "Ja, weil bei höherer Geschwindigkeit nach gängiger Annahme automatisch mehr Seitenreibung zur Verfügung steht, die dann einen größeren Überhöhungswinkel erfordert.", "Nein, weil sich der erforderliche Winkel bei höherer Geschwindigkeit nach dieser Vorstellung sogar verringert, damit der Wagen bei der Kurvenfahrt nicht abhebt."], correctReasonIndex: 0, explanation: "Da tan θ = v²/(rg) quadratisch von v abhängt, braucht eine schneller befahrene Kurve bei gleichem Radius einen größeren Überhöhungswinkel, damit die Normalkraftkomponente allein die nötige Zentripetalkraft liefert, ohne dass Seitenreibung nötig wird." },
      { id: "natwiss-ueb-dynamik-q9", question: "Eine Kugel dringt mit a = 2·10⁶ m/s² in ein Medium ein. Wie viel g-Beschleunigung ist das (g ≈ 10 m/s²)?", options: ["200 g, um zwei Zehnerpotenzen zu niedrig", "200 000 g, aus a/g richtig berechnet", "2000 g, um eine Zehnerpotenz zu niedrig", "20 000 g, um eine Zehnerpotenz zu niedrig"], correctIndex: 1, explanation: "Das Verhältnis a/g = 2·10⁶/10 = 2·10⁵ = 200 000 zeigt, dass die Kugel eine 200 000-fache Erdbeschleunigung erfährt — eine extreme, aber für Aufprallvorgänge typische Größenordnung. Rechenfehler bei den Zehnerpotenzen führen leicht zu den anderen, jeweils zu kleinen Werten." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "natwiss-ueb-energie-q2", question: "Was ist das Trägheitsmoment einer dünnen Scheibe (Masse m, Radius R) bzgl. der Symmetrieachse?", options: ["J = ½mR², das Trägheitsmoment der Scheibe", "J = mR²/4, wie bei einem dünnen Stab", "J = mR², wie bei einem dünnen Ring", "J = 2mR²/3, wie bei einer Hohlkugel"], correctIndex: 0, explanation: "Für eine massive Scheibe bzw. einen Vollzylinder gilt J = ½mR², weil die Masse über den gesamten Radius verteilt ist, nicht nur am Rand konzentriert. Ein dünner Ring hätte dagegen J = mR², da dort die gesamte Masse am Rand sitzt." },
      { id: "natwiss-ueb-energie-q3", question: "Wie lautet der Steinersche Satz (Parallelachsensatz)?", options: ["J = J_S / md², als Division statt Addition", "J = J_S − md², mit falschem Vorzeichen", "J = J_S + md², der Steinersche Satz", "J = J_S · md, als Produkt statt Summe"], correctIndex: 2, explanation: "Der Steinersche Satz J = J_S + md² verschiebt das Trägheitsmoment von der Schwerpunktachse J_S auf eine parallele Achse im Abstand d, wobei stets ein positiver Zusatzterm md² addiert wird — das Trägheitsmoment um eine Achse abseits des Schwerpunkts ist also immer größer als J_S selbst." },
      ...
      { id: "yn1", type: "yesno", question: "Bleibt die mechanische Energie eines Achterbahnwagens im Looping konstant, wenn man Reibung vernachlässigt?", correctAnswer: true, reasons: ["Ja, weil ohne Reibung nur die konservative Schwerkraft wirkt und E_kin + E_pot = mgh + ½mv² während der Fahrt konstant bleibt.", "Nein, weil die Normalkraft der Schienen laut gängiger Fehlvorstellung ständig zusätzliche Energie auf den Wagen überträgt und ihn dadurch beschleunigt.", "Ja, weil die mechanische Energie im Looping periodisch abnimmt und erst am Scheitelpunkt der Kreisbahn wieder auf ihren ursprünglichen Ausgangswert ansteigt.", "Nein, weil im Looping durch die Kreisbewegung stets zusätzliche Rotationsenergie entsteht, die die Gesamtenergie erhöht."], correctReasonIndex: 0, explanation: "Die Normalkraft der Schienen steht immer senkrecht zur Bewegungsrichtung und verrichtet daher keine Arbeit; ohne Reibung bleibt somit E_kin + E_pot = const, wie es zur Berechnung der Geschwindigkeit am Scheitelpunkt des Loopings genutzt wird." },
      ...
      { id: "natwiss-ueb-energie-q9", question: "Bei einem Looping (Radius r) muss die Minimalgeschwindigkeit am Scheitelpunkt v_min betragen:", options: ["v_min = √(2gr), mit zusätzlichem Faktor 2", "v_min = √(g/r), mit vertauschtem Zähler und Nenner", "v_min = 0, als triviale Untergrenze", "v_min = √(gr), im Grenzfall F_N = 0"], correctIndex: 3, explanation: "Am Scheitelpunkt liefern Gewichtskraft und Normalkraft gemeinsam die Zentripetalkraft. Im Grenzfall F_N = 0 gilt mv²/r = mg, woraus v_min = √(gr) folgt — sinkt die Geschwindigkeit darunter, verliert der Wagen den Kontakt zur Schiene, bevor er den Scheitelpunkt erreicht." },
