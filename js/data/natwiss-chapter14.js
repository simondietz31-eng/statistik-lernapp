const NATWISS_CHAPTER14_TOPICS = [
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist bei der Kurvenüberhöhung (tan θ = v²/(rg)) für höhere Geschwindigkeiten ein größerer Überhöhungswinkel nötig (gleicher Radius, keine Seitenreibung)?", correctAnswer: true, reasons: ["Ja, weil tan θ = v²/(rg) mit dem Quadrat der Geschwindigkeit wächst; eine schneller befahrene Kurve mit demselben Radius benötigt daher einen größeren Überhöhungswinkel, um ohne Seitenreibung auszukommen.", "Nein, weil der erforderliche Überhöhungswinkel ausschließlich vom Kurvenradius abhängt, nicht von der Geschwindigkeit.", "Ja, weil bei höherer Geschwindigkeit automatisch mehr Reibung zur Verfügung steht, die einen größeren Winkel erfordert.", "Nein, weil sich der Winkel bei höherer Geschwindigkeit sogar verringert, damit der Wagen nicht abhebt."], correctReasonIndex: 0, explanation: "Da tan θ = v²/(rg) quadratisch von v abhängt, braucht eine schneller befahrene Kurve bei gleichem Radius einen größeren Überhöhungswinkel, damit die Normalkraftkomponente allein die nötige Zentripetalkraft liefert, ohne dass Seitenreibung nötig wird." },
