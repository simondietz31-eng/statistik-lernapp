const FORSCHUNG_CHAPTER6_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist der Interquartilsabstand (IQR) stärker anfällig für Ausreißer als die Spannweite?", correctAnswer: false, reasons: ["Ja, weil der IQR ebenso wie die Spannweite direkt aus den Extremwerten berechnet wird", "Nein, weil der IQR nur die mittleren 50 % der Daten betrachtet und Extremwerte kaum Einfluss haben", "Ja, weil die Spannweite grundsätzlich robuster gegenüber Ausreißern ist als der IQR", "Nein, weil beide Streuungsmaße rechnerisch identisch definiert sind"], correctReasonIndex: 1, explanation: "Die Spannweite basiert allein auf dem größten und kleinsten Wert und reagiert daher stark auf Ausreißer. Der IQR betrachtet nur die mittleren 50 % der Daten und ist robuster." },
