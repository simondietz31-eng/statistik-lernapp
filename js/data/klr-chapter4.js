const KLR_CHAPTER4_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Müssen das Umsatzkostenverfahren und das Gesamtkostenverfahren bei korrekter Rechnung zum selben Betriebsergebnis führen?", correctAnswer: true, reasons: ["Ja, weil beide Verfahren dieselbe wirtschaftliche Realität nur aus unterschiedlichem Blickwinkel abbilden und Mengenunterschiede korrekt erfassen.", "Nein, weil das Gesamtkostenverfahren stets zu einem höheren Ergebnis führt.", "Ja, weil beide Verfahren identische Formeln verwenden und keine Bestandsveränderung berücksichtigen.", "Nein, weil nur das Umsatzkostenverfahren Verwaltungs- und Vertriebskosten einbezieht."], correctReasonIndex: 0, explanation: "Das UKV rechnet mit der Absatzmenge, das GKV mit der Produktionsmenge und gleicht die Differenz über die Bestandsveränderung aus - bei korrekter Rechnung ergibt sich daher zwangsläufig dasselbe Betriebsergebnis." },
  ...
  },
  {
    ...
    quiz: [
      { id: "yn1", type: "yesno", question: "Sollte bei sinkendem aktuellem Wiederbeschaffungspreis einer Maschine automatisch der niedrigere Wert als Bemessungsgrundlage für die Abschreibung angesetzt werden?", correctAnswer: false, reasons: ["Ja, weil dies den aktuellen Marktwert am genauesten widerspiegelt.", "Nein, weil im Zweifel der höhere Wert (meist die historischen Anschaffungskosten) angesetzt wird, um die Substanzerhaltung sicherzustellen.", "Ja, weil die Kostenrechnung gesetzlich zur Verwendung von Marktwerten verpflichtet ist.", "Nein, weil der Restwert dann automatisch auf null sinkt."], correctReasonIndex: 1, explanation: "Aus Vorsichtsgründen wird im Zweifel der höhere Wert angesetzt, damit genug Substanz für eine spätere Wiederbeschaffung zurückgehalten wird - ein niedrigerer Wert würde die Kapitalbindung unterschätzen." },
