const KLR_CHAPTER4_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "q3", question: "Welche Kostenart wird bei der Zuschlagskalkulation dem Kostenträger direkt zugerechnet, ohne über einen Zuschlagssatz verteilt zu werden?", options: ["Verwaltungsgemeinkosten", "Vertriebsgemeinkosten", "Gemeinkosten", "Einzelkosten wie Materialeinzelkosten und Fertigungslöhne"], correctIndex: 3, explanation: "Einzelkosten lassen sich verursachungsgerecht direkt zurechnen und werden deshalb unverändert übernommen, nicht über Zuschlagssätze verteilt." },
      ...
      { id: "q5", question: "In welcher Fertigungssituation wird die Äquivalenzziffernkalkulation angewendet?", options: ["Bei völlig unterschiedlichen Einzelprodukten ohne gemeinsamen Fertigungsprozess", "Nur wenn keine Gemeinkosten anfallen", "Bei der Sortenfertigung, also mehreren sehr ähnlichen Produktvarianten desselben Fertigungsprozesses", "Nur bei Dienstleistungen"], correctIndex: 2, explanation: "Die Äquivalenzziffernkalkulation eignet sich für Sorten, die sich nur in Größe, Ausstattung oder Aufwand unterscheiden, aber denselben Prozess durchlaufen." },
      { id: "q6", question: "Welche Äquivalenzziffer erhält die Standard- bzw. Basissorte?", options: ["100", "1", "0", "Die Äquivalenzziffer der teuersten Sorte"], correctIndex: 1, explanation: "Die Basissorte dient als Bezugsgröße und erhält per Definition die Äquivalenzziffer 1." },
      ...
      { id: "q8", question: "Ein Produkt hat Materialeinzelkosten von 50 € und einen Materialgemeinkostenzuschlagssatz von 20%. Wie hoch sind die Materialgemeinkosten?", options: ["5,00 €", "50,00 €", "10,00 €", "20,00 €"], correctIndex: 2, explanation: "Materialgemeinkosten = 20% von 50 € = 10,00 €." },
      ...
      { id: "q10", question: "Warum führen Umsatzkosten- und Gesamtkostenverfahren bei korrekter Rechnung zum selben Betriebsergebnis?", options: ["Weil sie zufällig ähnliche Zahlen verwenden", "Weil beide Verfahren identische Formeln verwenden", "Weil beide dieselbe wirtschaftliche Realität nur aus unterschiedlichem Blickwinkel (absatz- bzw. produktionsorientiert) abbilden und Mengenunterschiede jeweils korrekt berücksichtigen", "Weil das Gesamtkostenverfahren die Bestandsveränderung ignoriert"], correctIndex: 2, explanation: "Der Unterschied liegt nur darin, an welcher Stelle Produktions-/Absatzmengenunterschiede erfasst werden - implizit beim UKV, explizit über die Bestandsveränderung beim GKV." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Wie wird die kalkulatorische Abschreibung im Rahmen der Maschinenstundensatzrechnung berechnet?", options: ["(Anschaffungskosten − Restwert) / Nutzungsdauer", "Anschaffungskosten × kalkulatorischer Zinssatz", "(Anschaffungskosten + Restwert) / Nutzungsdauer", "Anschaffungskosten / Nutzungsdauer"], correctIndex: 0, explanation: "Die Abschreibung verteilt den Werteverzehr (Anschaffungskosten abzüglich Restwert) gleichmäßig auf die Nutzungsdauer." },
      { id: "q2", question: "Wie werden die kalkulatorischen Zinsen nach der Durchschnittswertmethode berechnet?", options: ["Restwert × kalkulatorischer Zinssatz", "((Anschaffungskosten + Restwert) / 2) × kalkulatorischer Zinssatz", "(Anschaffungskosten − Restwert) × kalkulatorischer Zinssatz", "Anschaffungskosten × kalkulatorischer Zinssatz"], correctIndex: 1, explanation: "Die Durchschnittswertmethode verzinst den durchschnittlich gebundenen Kapitalwert, also den Mittelwert aus Anschaffungskosten und Restwert." },
      { id: "q3", question: "Wie berechnen sich die maschinenabhängigen Energiekosten?", options: ["Strompreis [€/kWh] / Maschinenlaufstunden", "Leistungsaufnahme [kW] × Strompreis [€/kWh] × Maschinenlaufstunden pro Jahr", "Leistungsaufnahme [kW] / Strompreis [€/kWh]", "Nutzungsdauer × Strompreis"], correctIndex: 1, explanation: "Der Energieverbrauch ergibt sich aus Leistungsaufnahme, Strompreis und tatsächlicher Laufzeit der Maschine." },
