const VWL_CHAPTER3_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Was misst die Preiselastizität der Nachfrage?", options: ["Die absolute Änderung der Nachfragemenge in Stück","Die Änderung des Angebots bei einer Einkommensänderung","Die prozentuale Mengenänderung der Nachfrage bei einer Preisänderung um ein Prozent","Den Gleichgewichtspreis eines Marktes"], correctIndex: 2, explanation: "Die Preiselastizität der Nachfrage ist definiert als prozentuale Mengenänderung der Nachfrage bei einer Preisänderung um ein Prozent." },
      { id: "q2", question: "Wie wird die Preiselastizität der Nachfrage nach gängiger Konvention angegeben?", options: ["Nur als Prozentsatz ohne Bezug zum Preis","Als absoluter (positiver) Wert","Als Verhältnis von Angebot zu Nachfrage","Immer als negativer Wert"], correctIndex: 1, explanation: "Obwohl der Quotient wegen der gegenläufigen Preis-Mengen-Reaktion rechnerisch negativ wäre, wird die Preiselastizität der Nachfrage üblicherweise als absoluter Wert angegeben." },
      { id: "q3", question: "Wie hoch ist die Preiselastizität bei vollkommen unelastischer Nachfrage?", options: ["0","Genau 1","Nicht definierbar","Größer als 1"], correctIndex: 0, explanation: "Bei vollkommen unelastischer Nachfrage reagiert die Menge überhaupt nicht auf Preisänderungen, die Preiselastizität ist 0." },
      { id: "q4", question: "Wann spricht man von elastischer Nachfrage?", options: ["Wenn die Nachfrage konstant bleibt","Wenn die Preiselastizität kleiner als 1 ist","Wenn die Preiselastizität größer als 1 ist","Wenn die Preiselastizität genau 1 ist"], correctIndex: 2, explanation: "Bei elastischer Nachfrage reagiert die Nachfragemenge überproportional stark auf Preisänderungen, die Preiselastizität ist größer als 1." },
      { id: "q5", question: "Welcher der folgenden Faktoren erhöht tendenziell die Preiselastizität der Nachfrage nach einem Gut?", options: ["Wenige verfügbare Substitute","Ein sehr eng definiertes lebensnotwendiges Gut ohne Alternativen","Ein kurzer Zeithorizont","Eine steigende Anzahl enger Substitute"], correctIndex: 3, explanation: "Je mehr enge Substitute für ein Gut verfügbar sind, desto leichter können Konsumenten bei einer Preiserhöhung ausweichen, was die Preiselastizität erhöht." },
      { id: "q6", question: "Warum ist die Nachfrage nach einem eng definierten Gut (z. B. 'Butter') typischerweise elastischer als nach einem weit gefassten Gut (z. B. 'Lebensmittel')?", options: ["Weil eng definierte Güter immer teurer sind","Weil es für eng definierte Güter mehr Substitute gibt","Weil eng definierte Güter nie Luxusgüter sind","Weil weit gefasste Güter keine Nachfragekurve haben"], correctIndex: 1, explanation: "Für eng definierte Güter existieren mehr nahe Substitute (z. B. Margarine für Butter), wodurch die Nachfrage elastischer reagiert." },
      { id: "q7", question: "Was misst die Kreuzpreiselastizität der Nachfrage?", options: ["Die Reaktion des Preises auf eine Mengenänderung","Die Reaktion des Angebots auf eine Preisänderung","Die Reaktion der Nachfrage nach Gut A auf eine Preisänderung von Gut B","Die Reaktion der Nachfrage auf eine Einkommensänderung"], correctIndex: 2, explanation: "Die Kreuzpreiselastizität der Nachfrage misst die prozentuale Veränderung der Nachfrage nach Gut A bei einer Preisänderung von Gut B um ein Prozent." },
      { id: "q8", question: "Welches Vorzeichen hat die Einkommenselastizität der Nachfrage bei einem inferioren Gut?", options: ["Negativ","Immer Null","Immer größer als 1","Positiv"], correctIndex: 0, explanation: "Bei einem inferioren Gut sinkt die Nachfrage mit steigendem Einkommen, die Einkommenselastizität ist daher negativ." },
      { id: "q9", question: "Was misst die Preiselastizität des Angebots?", options: ["Die prozentuale Veränderung der Nachfrage bei einer Preisänderung um ein Prozent","Die absolute Änderung des Gleichgewichtspreises","Das Verhältnis von Angebot zu Nachfrage im Gleichgewicht","Die prozentuale Veränderung des Angebots bei einer Preisänderung um ein Prozent"], correctIndex: 3, explanation: "Die Preiselastizität des Angebots misst die prozentuale Veränderung der angebotenen Menge bei einer Preisänderung um ein Prozent." },
      { id: "q10", question: "Wie hoch lag der CO2-Preis in Deutschland laut Vorlesung bei seiner Einführung 2021?", options: ["55–65 € je Tonne","880 € je Tonne","300 € je Tonne","25 € je Tonne"], correctIndex: 3, explanation: "Bei Einführung 2021 lag der CO2-Preis in Deutschland auf Heizöl, Erdgas und Kraftstoffe bei 25 € je Tonne CO2; aktuell liegt er bei 55–65 € je Tonne." }
    ]
  }
];
