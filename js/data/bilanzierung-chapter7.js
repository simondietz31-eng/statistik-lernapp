const BILANZIERUNG_CHAPTER7_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Welchen Zweck hat die Bildung von aktiven und passiven Rechnungsabgrenzungsposten?", options: ["Sie erhöhen ausschließlich das ausgewiesene Eigenkapital","Sie dienen der periodengerechten Erfolgsermittlung, indem Zahlung und zugehöriger Aufwand/Ertrag der richtigen Periode zugeordnet werden","Sie dienen der Bewertung von Vorräten","Sie ersetzen die Umsatzsteuervoranmeldung"], correctIndex: 1, explanation: "RAP sorgen dafür, dass eine bereits erfolgte Zahlung nicht sofort, sondern erst in der Periode erfolgswirksam wird, der sie wirtschaftlich zuzurechnen ist." },
      { id: "q2", question: "Was unterscheidet einen Rechnungsabgrenzungsposten von einer sonstigen Forderung bzw. Verbindlichkeit?", options: ["Es gibt keinen Unterschied, beide Begriffe sind synonym","RAP betreffen nur Beträge über 10.000 €","Sonstige Forderungen/Verbindlichkeiten dürfen nur von Kapitalgesellschaften gebildet werden","Beim RAP ist die Zahlung bereits erfolgt und der Erfolg tritt erst später ein (transitorisch); bei sonstigen Forderungen/Verbindlichkeiten ist der Erfolg bereits eingetreten und die Zahlung steht noch aus (antizipativ)"], correctIndex: 3, explanation: "RAP = transitorische Posten (Zahlung vor Erfolg). Sonstige Forderungen/Verbindlichkeiten = antizipative Posten (Erfolg vor Zahlung)." },
      { id: "q3", question: "Wie definiert § 250 Abs. 1 HGB den aktiven Rechnungsabgrenzungsposten?", options: ["Jede noch nicht bezahlte Rechnung","Einnahmen vor dem Abschlussstichtag, die Ertrag für die Zeit danach darstellen","Ausgaben vor dem Abschlussstichtag, soweit sie Aufwand für eine bestimmte Zeit nach diesem Tag darstellen","Ausgaben nach dem Abschlussstichtag für Aufwand des Vorjahres"], correctIndex: 2, explanation: "§ 250 Abs. 1 HGB: aktiver RAP = vor dem Stichtag geleistete Ausgabe, die Aufwand für eine Zeit nach dem Stichtag darstellt." },
      { id: "q4", question: "Wie definiert § 250 Abs. 2 HGB den passiven Rechnungsabgrenzungsposten?", options: ["Jede noch nicht eingegangene Forderung","Einnahmen nach dem Abschlussstichtag für Erträge des Vorjahres","Ausgaben vor dem Abschlussstichtag für künftigen Aufwand","Einnahmen vor dem Abschlussstichtag, soweit sie Ertrag für eine bestimmte Zeit nach diesem Tag darstellen"], correctIndex: 3, explanation: "§ 250 Abs. 2 HGB: passiver RAP = vor dem Stichtag vereinnahmte Einnahme, die Ertrag für eine Zeit nach dem Stichtag darstellt." },
      { id: "q5", question: "Was versteht man unter einem Disagio als aktivem RAP „besonderer Art\", und wie ist es zu behandeln?", options: ["Es besteht eine Aktivierungspflicht ohne Abschreibung","Es besteht ein Aktivierungsverbot","Es ist zwingend sofort in voller Höhe als Aufwand zu erfassen","Es handelt sich um ein Aktivierungswahlrecht mit Abschreibungsgebot über die Laufzeit der zugehörigen Verbindlichkeit (§ 250 Abs. 3 HGB)"], correctIndex: 3, explanation: "Das Disagio darf als aktiver RAP angesetzt werden (Wahlrecht) und ist dann über die Laufzeit der Verbindlichkeit abzuschreiben (§ 250 Abs. 3 HGB)." },
      { id: "q6", question: "Am 30.12. wird die Miete für einen Verkaufsraum für die nächsten 6 Monate im Voraus überwiesen. Wie ist dieser Betrag zum 31.12. zu bilanzieren?", options: ["Als Rückstellung","Als aktiver Rechnungsabgrenzungsposten","Als sonstige Verbindlichkeit","Als passiver Rechnungsabgrenzungsposten"], correctIndex: 1, explanation: "Ausgabe vor dem Stichtag für Aufwand nach dem Stichtag → aktiver RAP." },
      { id: "q7", question: "Am 1. Dezember erhält ein Unternehmen 50 € für die Vermietung einer Garage, die den Januar des neuen Jahres betreffen. Wie ist dieser Betrag zu bilanzieren?", options: ["Als sonstige Forderung","Als Rückstellung","Als aktiver Rechnungsabgrenzungsposten","Als passiver Rechnungsabgrenzungsposten"], correctIndex: 3, explanation: "Einnahme vor dem Stichtag für Ertrag nach dem Stichtag → passiver RAP." },
      { id: "q8", question: "Ein Teil der Fertigungslöhne für Dezember kann erst im Januar ausgezahlt werden. Wie ist dieser Betrag zum 31.12. auszuweisen?", options: ["Als sonstige Verbindlichkeit","Gar nicht, da noch keine Zahlung erfolgt ist","Als passiver Rechnungsabgrenzungsposten","Als aktiver Rechnungsabgrenzungsposten"], correctIndex: 0, explanation: "Der Aufwand ist bereits im Dezember angefallen, nur die Zahlung steht noch aus → antizipativer Posten, sonstige Verbindlichkeit." },
      { id: "q9", question: "Ein Vermieter stellt am Abschlussstichtag fest, dass der Mieter die Dezembermiete für vermietete Räume noch nicht überwiesen hat. Wie ist dieser Betrag aus Sicht des Vermieters zu bilanzieren?", options: ["Als aktiver Rechnungsabgrenzungsposten","Als passiver Rechnungsabgrenzungsposten","Als sonstige Forderung (Vermögensgegenstand)","Als Rückstellung"], correctIndex: 2, explanation: "Der Ertrag (Dezembermiete) ist bereits angefallen, die Einzahlung steht noch aus → antizipativer Posten, sonstige Forderung." },
      { id: "q10", question: "Aus einem noch nicht entschiedenen Rechtsstreit mit einem Lieferanten kann im ungünstigsten Fall eine Zahlungsverpflichtung erwachsen. Wie ist dies zu bilanzieren?", options: ["Als Rückstellung, da Bestehen und Höhe der Verpflichtung ungewiss sind","Als sonstige Verbindlichkeit","Als aktiver Rechnungsabgrenzungsposten","Als passiver Rechnungsabgrenzungsposten"], correctIndex: 0, explanation: "Ungewisse Verbindlichkeiten dem Grunde und/oder der Höhe nach werden als Rückstellung erfasst, nicht als RAP oder sonstige Verbindlichkeit." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Wodurch entstehen temporäre Differenzen, die zu latenten Steuern führen?", options: ["Durch dauerhaft nicht abzugsfähige Betriebsausgaben","Durch unterschiedliche Wertansätze von Vermögensgegenständen/Schulden in Handels- und Steuerbilanz, die sich künftig wieder ausgleichen","Durch die Wahl der Abschreibungsmethode allein, unabhängig von der Steuerbilanz","Durch Unterschiede zwischen Brutto- und Nettoumsatz"], correctIndex: 1, explanation: "Temporäre Differenzen entstehen durch abweichende, aber künftig wieder ausgleichende Wertansätze zwischen Handels- und Steuerbilanz." },
      { id: "q2", question: "Wann entsteht eine aktive latente Steuer im Zusammenhang mit einem Vermögensgegenstand?", options: ["Wenn der Handelsbilanzwert kleiner ist als der Steuerbilanzwert","Wenn beide Werte identisch sind","Wenn der Handelsbilanzwert größer ist als der Steuerbilanzwert","Niemals bei Vermögensgegenständen, nur bei Schulden"], correctIndex: 0, explanation: "H.Bil.-Wert des Vermögens < St.B.-Wert des Vermögens → aktive latente Steuer." },
      { id: "q3", question: "Wann entsteht eine passive latente Steuer im Zusammenhang mit einem Vermögensgegenstand?", options: ["Wenn der Handelsbilanzwert größer ist als der Steuerbilanzwert","Wenn beide Werte identisch sind","Niemals bei Vermögensgegenständen, nur bei Schulden","Wenn der Handelsbilanzwert kleiner ist als der Steuerbilanzwert"], correctIndex: 0, explanation: "H.Bil.-Wert des Vermögens > St.B.-Wert des Vermögens → passive latente Steuer." },
      { id: "q4", question: "Wann entsteht eine aktive latente Steuer im Zusammenhang mit einer Schuld?", options: ["Nie, bei Schulden entstehen nur passive latente Steuern","Wenn keine Schuld in der Steuerbilanz existiert","Wenn der Handelsbilanzwert der Schuld größer ist als der Steuerbilanzwert","Wenn der Handelsbilanzwert der Schuld kleiner ist als der Steuerbilanzwert"], correctIndex: 2, explanation: "H.Bil.-Wert der Schulden > St.B.-Wert der Schulden → aktive latente Steuer." },
      { id: "q5", question: "Wann entsteht eine passive latente Steuer im Zusammenhang mit einer Schuld?", options: ["Wenn beide Werte identisch sind","Nie, bei Schulden entstehen nur aktive latente Steuern","Wenn der Handelsbilanzwert der Schuld kleiner ist als der Steuerbilanzwert","Wenn der Handelsbilanzwert der Schuld größer ist als der Steuerbilanzwert"], correctIndex: 2, explanation: "H.Bil.-Wert der Schulden < St.B.-Wert der Schulden → passive latente Steuer." },
      { id: "q6", question: "Wie ist der Ansatz aktiver latenter Steuern nach § 274 Abs. 1 S. 2 HGB geregelt?", options: ["Als Aktivierungswahlrecht","Als Aktivierungspflicht","Es gibt dazu keine gesetzliche Regelung","Als Aktivierungsverbot"], correctIndex: 0, explanation: "Für aktive latente Steuern besteht ein Aktivierungswahlrecht gem. § 274 Abs. 1 Satz 2 HGB." },
      { id: "q7", question: "Wie ist der Ansatz passiver latenter Steuern nach § 274 Abs. 1 S. 1 HGB geregelt?", options: ["Nur auf Antrag beim Finanzamt","Als Passivierungswahlrecht","Als Passivierungsverbot","Als Passivierungspflicht"], correctIndex: 3, explanation: "Für passive latente Steuern besteht eine Passivierungspflicht gem. § 274 Abs. 1 Satz 1 HGB." },
      { id: "q8", question: "Was drückt eine aktive latente Steuer wirtschaftlich aus?", options: ["Eine künftige Steuerbelastung","Eine dauerhaft entfallende Steuerpflicht","Eine künftige Steuerentlastung","Eine bereits gezahlte, zu erstattende Steuer"], correctIndex: 2, explanation: "Aktive latente Steuern repräsentieren eine künftige Steuerentlastung." },
      { id: "q9", question: "Was drückt eine passive latente Steuer wirtschaftlich aus?", options: ["Eine künftige Steuerbelastung","Eine dauerhaft entfallende Steuerpflicht","Eine bereits gezahlte, zu erstattende Steuer","Eine künftige Steuerentlastung"], correctIndex: 0, explanation: "Passive latente Steuern repräsentieren eine künftige Steuerbelastung." },
      { id: "q10", question: "Für welche Unternehmen gelten die Regelungen zu latenten Steuern nach § 274 HGB im Jahresabschluss?", options: ["Für alle Unternehmen unabhängig von der Rechtsform, verpflichtend ohne Ausnahme","Für Kapitalgesellschaften","Nur für Personengesellschaften ohne Kapitalgesellschaftsbeteiligung","Nur für Einzelunternehmen"], correctIndex: 1, explanation: "§ 274 HGB regelt den Ansatz latenter Steuern für Kapitalgesellschaften im handelsrechtlichen Jahresabschluss." }
    ]
  }
];
