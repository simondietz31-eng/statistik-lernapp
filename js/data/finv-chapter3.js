const FINV_CHAPTER3_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Verstößt die Finanzierung einer Maschine mit 10 Jahren Nutzungsdauer durch einen täglich kündbaren Kontokorrentkredit gegen die Fristenkongruenz?", correctAnswer: true, reasons: ["Ja, weil die kurze Kapitalüberlassungsdauer nicht zur langen Kapitalbindungsdauer der Investition passt.", "Nein, weil Kontokorrentkredite grundsätzlich niemals gekündigt werden dürfen.", "Nein, weil die Fristenkongruenz ausschließlich für Eigenkapital gilt.", "Ja, weil für Maschineninvestitionen gesetzlich zwingend nur Eigenkapital zulässig ist."], correctReasonIndex: 0, explanation: "Die Fristenkongruenz verlangt, dass die Kapitalüberlassungsdauer zur Nutzungsdauer der Investition passt; ein täglich kündbarer Kredit für eine 10-jährige Investition erfüllt das nicht und birgt ein Refinanzierungsrisiko." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Wirkt der Leverage-Effekt positiv auf die Eigenkapitalrendite, wenn die Gesamtkapitalrendite r_GK unter dem Fremdkapitalzinssatz r_FK liegt?", correctAnswer: false, reasons: ["Ja, weil ein hoher Verschuldungsgrad die Eigenkapitalrendite grundsätzlich immer erhöht.", "Nein, weil die Differenz (r_GK − r_FK) dann negativ wird und der Hebel die Eigenkapitalrendite senkt statt sie zu erhöhen.", "Ja, weil Fremdkapitalzinsen in diesem Fall steuerlich vollständig erstattet werden.", "Nein, weil Fremdkapital in diesem Fall automatisch in Eigenkapital umgewandelt wird."], correctReasonIndex: 1, explanation: "Liegt r_GK unter r_FK, wird die Renditedifferenz in der Leverage-Formel negativ; der Verschuldungsgrad verstärkt diesen negativen Effekt, sodass die Eigenkapitalrendite unter r_GK sinkt — der Hebel wirkt also negativ, nicht positiv." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Werden Fremdkapitalkosten im WACC mit dem Faktor (1−s) multipliziert, weil Fremdkapitalzinsen steuerlich absetzbar sind?", correctAnswer: true, reasons: ["Nein, weil Eigenkapitalkosten grundsätzlich stets höher als Fremdkapitalkosten sind.", "Ja, weil das Tax Shield die effektiven Fremdkapitalkosten durch die steuerliche Absetzbarkeit der Zinsen senkt.", "Nein, weil der Unternehmenssteuersatz im WACC überhaupt keine Rolle spielt.", "Ja, weil auch Eigenkapitalkosten wie Fremdkapitalzinsen steuerlich absetzbar sind."], correctReasonIndex: 1, explanation: "Fremdkapitalzinsen mindern als Betriebsausgabe den zu versteuernden Gewinn, wodurch die tatsächlichen Kosten des Fremdkapitals niedriger als der Nominalzins sind; dieses Tax Shield wird im WACC durch den Faktor (1−s) abgebildet." },
