const VWL_CHAPTER13_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Bedeutet ein steigendes nominales BIP zwangsläufig, dass eine Volkswirtschaft mehr Güter produziert hat?", correctAnswer: false, reasons: ["Nein, weil ein Anstieg auch allein durch höhere Preise ohne Mengenwachstum entstehen kann", "Ja, weil das nominale BIP ausschließlich Mengenänderungen misst", "Ja, weil Preise im nominalen BIP bereits vollständig herausgerechnet sind", "Nein, weil das nominale BIP grundsätzlich unabhängig von Preisen berechnet wird"], correctReasonIndex: 0, explanation: "Nein: Wie das Schlaraffenland-Beispiel für 2024/2025 zeigt, kann das nominale BIP allein durch Preissteigerungen wachsen, obwohl die produzierten Mengen unverändert bleiben." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Überschätzt ein statischer Warenkorb des VPI tendenziell die tatsächlichen Lebenshaltungskosten, wenn Konsumenten nach einem Preisrückgang stärker zu günstigeren Gütern wechseln?", correctAnswer: true, reasons: ["Ja, weil der feste Warenkorb das veränderte Kaufverhalten nicht abbildet und so den Substitutionseffekt ignoriert", "Nein, weil der VPI den Warenkorb bei jeder Preisänderung automatisch neu gewichtet", "Nein, weil Substitutionseffekte die gemessenen Lebenshaltungskosten stets unterschätzen", "Ja, weil neue Güter grundsätzlich sofort in den Warenkorb aufgenommen werden"], correctReasonIndex: 0, explanation: "Ja: Der Substitutionsbias entsteht, weil der VPI einen festen Warenkorb unterstellt, während Konsumenten in Wirklichkeit stärker zu relativ günstiger gewordenen Gütern wie den Tablet-PCs wechseln." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Kann die EZB die umlaufende Geldmenge verringern, indem sie Wertpapiere an Geschäftsbanken verkauft?", correctAnswer: true, reasons: ["Ja, weil beim Verkauf Geld von der Wirtschaft zur Zentralbank zurückfließt und so die umlaufende Geldmenge sinkt", "Nein, weil Wertpapierverkäufe die Geldmenge grundsätzlich nicht beeinflussen", "Nein, weil die Geldmenge ausschließlich über Steuererhöhungen gesteuert wird", "Ja, weil dadurch automatisch neue Banknoten gedruckt werden"], correctReasonIndex: 0, explanation: "Ja: Verkauft die EZB Wertpapiere im Rahmen von Offenmarktgeschäften, fließt Geld von den Geschäftsbanken zur Zentralbank zurück, wodurch sich die umlaufende Geldmenge verringert (kontraktive Geldpolitik)." },
