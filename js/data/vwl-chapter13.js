const VWL_CHAPTER13_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Wie hoch ist das nominale BIP des Schlaraffenlands im Jahr 2023 (100 l Milch à 1 €, 50 l Honig à 2 €)?", options: ["150", "200", "250", "300"], correctIndex: 1, explanation: "1×100 + 2×50 = 100 + 100 = 200." },
      { id: "q2", question: "Wie hoch ist das nominale BIP 2025 (200 l Milch à 2 €, 100 l Honig à 4 €)?", options: ["400", "600", "800", "1.000"], correctIndex: 2, explanation: "2×200 + 4×100 = 400 + 400 = 800." },
      { id: "q3", question: "Wie hoch ist das reale BIP 2025, bewertet zu Preisen von 2024?", options: ["400", "600", "800", "1.000"], correctIndex: 0, explanation: "Bei unveränderten Mengen (200 l Milch, 100 l Honig) zu 2024er-Preisen (1 €, 2 €): 1×200 + 2×100 = 400." },
      { id: "q4", question: "Wie hoch ist der BIP-Deflator für 2025 (nominales BIP 800, reales BIP 400)?", options: ["50", "100", "150", "200"], correctIndex: 3, explanation: "BIP-Deflator = 800/400 × 100 = 200." },
      { id: "q5", question: "Was zeigt ein BIP-Deflator von 100 für das Jahr 2024 an?", options: ["Eine Verdopplung der Preise", "Keine Preisveränderung gegenüber dem Vorjahr", "Eine Deflation von 100 %", "Einen Produktionsrückgang"], correctIndex: 1, explanation: "Ein unveränderter Deflator von 100 zeigt an, dass sich das Preisniveau gegenüber dem Vorjahr nicht verändert hat." },
      { id: "q6", question: "Warum ist der materielle Wohlstand im Schlaraffenland 2024 und 2025 trotz unterschiedlichem nominalem BIP gleich hoch?", options: ["Weil die produzierten Mengen an Milch und Honig in beiden Jahren identisch sind", "Weil das nominale BIP falsch berechnet wurde", "Weil es keinen Unterschied zwischen nominal und real gibt", "Weil die Bevölkerung geschrumpft ist"], correctIndex: 0, explanation: "Die tatsächlich verfügbare Gütermenge (200 l Milch, 100 l Honig) ist 2024 und 2025 identisch; der Anstieg des nominalen BIP beruht ausschließlich auf Preissteigerungen." },
      { id: "q7", question: "Welche allgemeine Lehre lässt sich aus dem Schlaraffenland-Beispiel für Wohlstandsvergleiche ziehen?", options: ["Man sollte stets das nominale BIP verwenden", "Man sollte für Wohlstandsvergleiche das reale statt des nominalen BIP heranziehen", "BIP-Vergleiche sind grundsätzlich nicht möglich", "Der BIP-Deflator ist irrelevant"], correctIndex: 1, explanation: "Da das nominale BIP auch reine Preiseffekte enthält, muss man für echte Wohlstandsvergleiche das reale (preisbereinigte) BIP verwenden." },
      { id: "q8", question: "Was bedeutet es für eine Volkswirtschaft, wenn das reale BIP über zwei Jahre konstant bleibt, das nominale BIP aber stark steigt?", options: ["Die Produktionsmenge hat sich real erhöht", "Der Anstieg beruht ausschließlich auf Inflation, nicht auf zusätzlicher Produktion", "Es liegt eine Deflation vor", "Es gibt keinen Unterschied zu einem realen Wachstum"], correctIndex: 1, explanation: "Steigt nur das nominale, nicht aber das reale BIP, liegt der gesamte Anstieg an gestiegenen Preisen (Inflation), nicht an mehr produzierten Gütern." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Welches Messproblem des VPI illustriert die Erfindung des iPhones?", options: ["Das Problem neuer Güter, die sich nicht ohne Weiteres in eine historische Preisreihe einordnen lassen", "Das Substitutionsbias-Problem", "Ein reiner Rechenfehler-Problem", "Es gibt kein Messproblem in diesem Fall"], correctIndex: 0, explanation: "Neue Güter wie das iPhone stiften Nutzen, der sich erst mit Verzögerung im VPI niederschlägt, wenn sie in den Warenkorb aufgenommen werden." },
      { id: "q2", question: "Welches Messproblem illustriert die Einführung des Einparkassistenten?", options: ["Das Problem unberücksichtigter Qualitätsverbesserungen", "Das Problem fehlender Verbraucherpreise", "Ein reiner Übersetzungsfehler", "Das Problem negativer Preise"], correctIndex: 0, explanation: "Ein Teil der Preissteigerung eines Autos mit Einparkassistent ist eine Qualitätsverbesserung, keine reine Inflation — wird das nicht korrekt bereinigt, überschätzt der VPI die tatsächliche Teuerung." },
      { id: "q3", question: "Welches Messproblem illustriert die Zunahme von Tablet-Käufen nach einem Preisrückgang?", options: ["Das Substitutionsbias-Problem eines statischen Warenkorbs", "Das Problem der Golddeckung", "Ein Rechenfehler bei der Elastizität", "Das Problem der Kerninflationsrate"], correctIndex: 0, explanation: "Ein fester Warenkorb bildet nicht ab, dass Konsumenten stärker zu relativ günstiger gewordenen Gütern wechseln, was die gemessenen Lebenshaltungskosten verzerren kann." },
      { id: "q4", question: "Um wie viel Prozent ist der Zeitungspreis von 1970 bis 2025 gestiegen (von 0,10 $ auf 3,00 $)?", options: ["Um 300 %", "Um 809 %", "Um 2.900 %", "Um 30 %"], correctIndex: 2, explanation: "Der Anstieg um 2,90 $ entspricht bei einem Ausgangswert von 0,10 $ einer Steigerung um 2.900 %." },
      { id: "q5", question: "Um wie viel Prozent ist der Stundenlohn von 1970 bis 2025 gestiegen (von 3,30 $ auf 30,00 $)?", options: ["Um 809 %", "Um 2.900 %", "Um 100 %", "Um 30 %"], correctIndex: 0, explanation: "Der Anstieg um 26,70 $ entspricht bei einem Ausgangswert von 3,30 $ einer Steigerung um rund 809 %." },
      { id: "q6", question: "Wie viele Minuten musste ein Arbeiter 1970 für eine Zeitung arbeiten?", options: ["Etwa 1,8 Minuten", "Etwa 6 Minuten", "Etwa 30 Minuten", "Etwa 60 Minuten"], correctIndex: 0, explanation: "Bei 0,055 $ pro Minute (3,30 $/Std.) und einem Zeitungspreis von 0,10 $ ergeben sich rund 1,8 Minuten." },
      { id: "q7", question: "Wie viele Minuten musste ein Arbeiter 2025 für eine Zeitung arbeiten?", options: ["Etwa 1,8 Minuten", "6 Minuten", "18 Minuten", "60 Minuten"], correctIndex: 1, explanation: "Bei 0,50 $ pro Minute (30 $/Std.) und einem Zeitungspreis von 3,00 $ ergeben sich genau 6 Minuten." },
      { id: "q8", question: "Ist die Kaufkraft der Arbeiter, gemessen in Zeitungen, zwischen 1970 und 2025 gestiegen oder gesunken?", options: ["Gestiegen, weil der Lohn absolut stärker gestiegen ist", "Gesunken, weil der Zeitungspreis prozentual stärker gestiegen ist als der Lohn", "Unverändert geblieben", "Nicht bestimmbar"], correctIndex: 1, explanation: "Weil der Zeitungspreis (2.900 %) viel stärker gestiegen ist als der Lohn (809 %), musste 2025 deutlich länger gearbeitet werden, um sich eine Zeitung zu leisten — die Kaufkraft in Zeitungen gemessen ist gesunken." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Welche drei Funktionen erfüllt Geld?", options: ["Zahlungsmittel, Recheneinheit, Wertaufbewahrungsmittel", "Zahlungsmittel, Steuerbasis, Exportgut", "Recheneinheit, Sparanreiz, Handelsware", "Wertaufbewahrungsmittel, Zollgut, Importgut"], correctIndex: 0, explanation: "Geld erfüllt die drei Funktionen Zahlungsmittel, Recheneinheit und Wertaufbewahrungsmittel." },
      { id: "q2", question: "Was bedeutet die Unabhängigkeit der EZB?", options: ["Sie kann Geldpolitik ohne politische Weisungen selbstständig betreiben", "Sie untersteht direkt der Bundesregierung", "Sie muss jede Entscheidung vom EU-Parlament genehmigen lassen", "Sie darf keine geldpolitischen Entscheidungen treffen"], correctIndex: 0, explanation: "Unabhängigkeit bedeutet, dass die EZB ihre Geldpolitik selbstständig und ohne politische Weisungen durchführen kann." },
      { id: "q3", question: "Was ist das vorrangige Ziel der EZB?", options: ["Maximales Wirtschaftswachstum", "Preisstabilität (mittelfristig rund 2 % Inflation)", "Ein niedriger Euro-Wechselkurs", "Direkte Staatsfinanzierung"], correctIndex: 1, explanation: "Das vorrangige Ziel der EZB ist die Sicherung der Preisstabilität, konkretisiert als mittelfristige Inflationsrate von rund 2 %." },
      { id: "q4", question: "Wie kann die EZB die Geldmenge über Offenmarktgeschäfte erhöhen?", options: ["Durch den Verkauf von Wertpapieren", "Durch den Ankauf von Wertpapieren von Geschäftsbanken", "Durch die Erhebung von Steuern", "Durch die Festlegung des Wechselkurses"], correctIndex: 1, explanation: "Kauft die EZB Wertpapiere an, fließt Geld in die Wirtschaft, wodurch die Geldmenge steigt." },
      { id: "q5", question: "Wie kann die EZB die Geldmenge über Offenmarktgeschäfte verringern?", options: ["Durch den Ankauf von Wertpapieren", "Durch den Verkauf von Wertpapieren an die Wirtschaft", "Durch Zinssenkungen", "Durch höhere Staatsausgaben"], correctIndex: 1, explanation: "Verkauft die EZB Wertpapiere, fließt Geld von der Wirtschaft zur Zentralbank zurück, wodurch die Geldmenge sinkt." },
      { id: "q6", question: "Welche zwei zusätzlichen Instrumente kann die EZB neben Offenmarktgeschäften nutzen, um die Geldmenge zu beeinflussen?", options: ["Steuererhöhungen und Exportquoten", "Leitzinsänderungen und Anleihekaufprogramme", "Preisdeckelungen und Lohnstopps", "Zollsätze und Handelsembargos"], correctIndex: 1, explanation: "Neben Offenmarktgeschäften kann die EZB über Leitzinsänderungen (z. B. Einlage-/Spitzenrefinanzierungsfazilität) und gezielte Anleihekaufprogramme wirken." },
      { id: "q7", question: "Welche Quelle bietet sich laut Vorlesung an, um den Zusammenhang zwischen Geldmenge M3, Zinsen und Inflation empirisch zu untersuchen?", options: ["Zeitreihen der Bundesbank zu M3, Tagesgeldzinsen und VPI", "Ausschließlich private Finanzblogs", "Nur historische Zeitungsartikel", "Es gibt keine geeigneten Datenquellen"], correctIndex: 0, explanation: "Die Bundesbank stellt Zeitreihen zur Geldmenge M3, zu Tagesgeldzinsen und zur VPI-Entwicklung bereit, mit denen sich ein solcher Zusammenhang untersuchen lässt." },
      { id: "q8", question: "Warum lässt sich die Frage 'Erhöht oder verringert die EZB aktuell die Geldmenge?' nicht allgemeingültig, sondern nur zeitpunktbezogen beantworten?", options: ["Weil die EZB nie ihre Politik ändert", "Weil sich die geldpolitische Ausrichtung im Zeitverlauf je nach Konjunktur- und Inflationslage ändert", "Weil es keine geldpolitischen Instrumente gibt", "Weil die Frage keinen ökonomischen Sinn ergibt"], correctIndex: 1, explanation: "Die geldpolitische Ausrichtung (expansiv oder kontraktiv) hängt von der jeweils aktuellen Konjunktur- und Inflationslage ab und ändert sich im Zeitverlauf, weshalb eine aktuelle Einschätzung stets die jeweils neuesten EZB-Daten erfordert." }
    ]
  }
];
