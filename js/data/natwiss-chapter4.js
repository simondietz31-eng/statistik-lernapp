const NATWISS_CHAPTER4_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Haben alle Punkte einer starren rotierenden Scheibe dieselbe Winkelgeschwindigkeit ω, aber unterschiedliche Bahngeschwindigkeiten v, je nach Abstand r zur Achse?", correctAnswer: true, reasons: ["Ja, weil v = r·ω gilt: Alle Punkte der starren Scheibe teilen dieselbe Winkelgeschwindigkeit ω, aber die Bahngeschwindigkeit wächst linear mit dem Abstand r zur Achse.", "Nein, weil v für alle Punkte einer starren Scheibe gleich groß ist, unabhängig vom Abstand zur Achse.", "Ja, weil ω selbst vom Abstand r abhängt und mit größerem r ansteigt.", "Nein, weil nur die Winkelbeschleunigung α, nicht die Winkelgeschwindigkeit ω, vom Radius abhängt."], correctReasonIndex: 0, explanation: "Da v = r·ω, haben alle Punkte einer starren rotierenden Scheibe dieselbe Winkelgeschwindigkeit ω, aber unterschiedliche Bahngeschwindigkeiten – je weiter außen ein Punkt liegt, desto größer ist v." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Bleibt das Trägheitsmoment eines Körpers unverändert, wenn man die Drehachse parallel zur Schwerpunktachse verschiebt?", correctAnswer: false, reasons: ["Nein, weil nach dem Steinerschen Satz I = I_S + m·d² das Trägheitsmoment bei paralleler Verschiebung der Achse um den Term m·d² zunimmt.", "Ja, weil das Trägheitsmoment eine reine Materialeigenschaft ist und nicht von der Lage der Drehachse abhängt.", "Nein, weil sich bei jeder Achsverschiebung automatisch auch die Masse des Körpers ändert.", "Ja, weil der Steinersche Satz nur für Drehachsen durch den Schwerpunkt gültig ist."], correctReasonIndex: 0, explanation: "Der Steinersche Satz I = I_S + m·d² zeigt, dass sich das Trägheitsmoment bei Verschiebung der Drehachse parallel zur Schwerpunktachse um m·d² erhöht – je weiter die Achse vom Schwerpunkt entfernt ist, desto größer wird I." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Bleibt die Rotationsenergie einer Eisläuferin konstant, wenn sie durch Heranziehen der Arme ihr Trägheitsmoment verringert (kein äußeres Drehmoment)?", correctAnswer: false, reasons: ["Nein, weil E_rot = L²/(2I) bei konstantem Drehimpuls L mit sinkendem I zunimmt – die Eisläuferin leistet beim Heranziehen der Arme Arbeit gegen die Zentrifugalkraft, die die Rotationsenergie erhöht.", "Ja, weil sowohl Drehimpuls als auch Rotationsenergie bei fehlendem äußeren Drehmoment stets gemeinsam erhalten bleiben.", "Nein, weil sich beim Heranziehen der Arme automatisch auch die Masse der Eisläuferin verringert.", "Ja, weil die Erhöhung von ω durch die Verringerung von I exakt kompensiert wird, sodass E_rot unverändert bleibt."], correctReasonIndex: 0, explanation: "Da L = I·ω erhalten bleibt, aber E_rot = ½I·ω² = L²/(2I) invers proportional zu I ist, steigt die Rotationsenergie, wenn I sinkt – die dafür nötige Energie liefert die Eisläuferin selbst durch die Muskelarbeit beim Heranziehen der Arme." },
