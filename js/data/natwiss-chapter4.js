const NATWISS_CHAPTER4_TOPICS = [
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Bleibt das Trägheitsmoment eines Körpers unverändert, wenn man die Drehachse parallel zur Schwerpunktachse verschiebt?", correctAnswer: false, reasons: ["Nein, weil nach dem Steinerschen Satz I = I_S + m·d² das Trägheitsmoment um den Term m·d² zunimmt.", "Ja, weil das Trägheitsmoment eine reine Materialeigenschaft ist und nicht von der Lage der Drehachse abhängt.", "Nein, weil sich bei jeder Achsverschiebung automatisch auch die Masse und Dichteverteilung des Körpers ändert.", "Ja, weil der Steinersche Satz nur für Drehachsen durch den Schwerpunkt gültig ist und außerhalb davon nicht anwendbar ist."], correctReasonIndex: 0, explanation: "Der Steinersche Satz I = I_S + m·d² zeigt, dass sich das Trägheitsmoment bei Verschiebung der Drehachse parallel zur Schwerpunktachse um m·d² erhöht – je weiter die Achse vom Schwerpunkt entfernt ist, desto größer wird I." },
