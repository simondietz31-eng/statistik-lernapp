    ...
    quiz: [
      {
        ...
        options: ["rad/s", "U/min", "m/s", "rad/s²"],
        correctIndex: 0,
        explanation: "Die Winkelgeschwindigkeit ω wird in rad/s (Radiant pro Sekunde) angegeben. U/min ist die Einheit der Drehzahl n, m/s ist die der Bahngeschwindigkeit, und rad/s² ist die der Winkelbeschleunigung."
      },
      {
        id: "q2",
        question: "Wie lautet die Formel zur Umrechnung von Drehzahl n (in U/min) in Winkelgeschwindigkeit ω (in rad/s)?",
        options: ["ω = n / 60", "ω = 2π · n / 60", "ω = 2π · n", "ω = π · n / 30"],
        correctIndex: 1,
        explanation: "Die korrekte Formel lautet ω = 2π · n / 60. Eine Umdrehung entspricht 2π rad, und der Faktor 1/60 rechnet von Minuten in Sekunden um."
      },
      {
        id: "q3",
        question: "Ein Punkt auf einem Rad mit r = 0,5 m rotiert mit ω = 10 rad/s. Wie groß ist seine Bahngeschwindigkeit v?",
        options: ["10 m/s", "0,05 m/s", "5 m/s", "50 m/s"],
        correctIndex: 2,
        explanation: "v = r · ω = 0,5 m · 10 rad/s = 5 m/s. Die Bahngeschwindigkeit ist das Produkt aus Radius und Winkelgeschwindigkeit."
      },
      {
        id: "q4",
        question: "Was besagt die Rollbedingung (kein Schlupf)?",
        options: [
          "Die Bahngeschwindigkeit des Mittelpunkts ist gleich ω · r",
          "Die Bahngeschwindigkeit des Mittelpunkts ist null",
          "Die Winkelbeschleunigung ist null",
          "Die Winkelbeschleunigung ist gleich v · r"
        ],
        correctIndex: 0,
        explanation: "Die Rollbedingung lautet v_Mittelpunkt = ω · r. Sie gilt, solange das rollende Objekt nicht schleudert (kein Schlupf). Der Berührungspunkt mit dem Untergrund hat dann die Geschwindigkeit null."
      },
      {
        id: "q5",
        question: "Welchem Winkel in Radiant entspricht eine vollständige Umdrehung (360°)?",
        options: ["π rad ≈ 3,14 rad", "2π rad ≈ 6,28 rad", "360 rad", "1 rad"],
        correctIndex: 1,
        explanation: "Eine vollständige Umdrehung entspricht 2π ≈ 6,28 Radiant. Das Bogenmaß ergibt sich aus dem Verhältnis Bogenlänge zu Radius: Für einen vollen Kreis ist die Bogenlänge gleich dem Umfang 2πr, also φ = 2πr / r = 2π."
      },
      {
        id: "q6",
        question: "Ein Rad dreht sich gleichmäßig mit ω = 5 rad/s. Welchen Winkel überstreicht es in t = 4 s?",
        options: ["5 rad", "20 rad", "1,25 rad", "80 rad"],
        correctIndex: 1,
        explanation: "Bei gleichmäßiger Rotation (α = 0) gilt φ = ω · t = 5 rad/s · 4 s = 20 rad."
      },
      {
        id: "q7",
        question: "Welche Gleichung beschreibt den überstrichenen Winkel bei gleichmäßig beschleunigter Rotation, wenn der Start aus der Ruhe erfolgt (φ₀ = 0, ω₀ = 0)?",
        options: ["φ = α · t", "φ = 2 · α · t²", "φ = ½ · α · t²", "φ = α · t²"],
        correctIndex: 2,
        explanation: "Analog zur linearen Gleichung s = ½ · a · t² gilt für die Rotation φ = ½ · α · t². Diese Formel ergibt sich durch zweifache Integration der konstanten Winkelbeschleunigung α."
      },
      {
        id: "q8",
        question: "Was ist das rotatorische Analogon zum linearen Weg s?",
        options: ["Der Winkel φ", "Die Winkelgeschwindigkeit ω", "Die Winkelbeschleunigung α", "Der Radius r"],
        correctIndex: 0,
        explanation: "In der Analogie zwischen Translation und Rotation entspricht der Drehwinkel φ dem linearen Weg s. Weiter gilt: ω ↔ v und α ↔ a."
      },
      {
        id: "q9",
        question: "Wie groß ist die Drehzahl n in U/min, wenn ω = 20π rad/s beträgt?",
        options: ["1200 U/min", "300 U/min", "600 U/min", "200 U/min"],
        correctIndex: 2,
        explanation: "n = ω · 60 / (2π) = 20π · 60 / (2π) = 20 · 30 = 600 U/min."
      },
      {
        id: "q10",
        question: "Wie verhält sich die Tangentialbeschleunigung a_t zu Radius r und Winkelbeschleunigung α?",
        options: ["a_t = α / r", "a_t = r · α", "a_t = r² · α", "a_t = r · ω"],
        correctIndex: 1,
        explanation: "Die Tangentialbeschleunigung berechnet sich zu a_t = r · α. Analog gilt für die Bahngeschwindigkeit v = r · ω. Beide Formeln verknüpfen rotatorische mit translatorischen Größen über den Radius."
      }
    ]
  },
  {
    ...
    quiz: [
      {
        id: "q1",
        question: "Welche Formel gilt für das Trägheitsmoment einer Vollscheibe (Vollzylinder) bezüglich der Symmetrieachse?",
        options: ["I = m · r²", "I = ½ · m · r²", "I = (2/5) · m · r²", "I = (1/12) · m · r²"],
        correctIndex: 1,
        explanation: "Für eine Vollscheibe oder einen Vollzylinder gilt I = ½ · m · r². Der Hohlzylinder hat I = m · r² (höher, weil alle Masse am Rand liegt), und die Vollkugel hat I = (2/5) · m · r²."
      },
      {
        id: "q2",
        question: "Wovon hängt das Trägheitsmoment eines Körpers ab?",
        options: [
          "Nur von der Gesamtmasse des Körpers",
          "Nur vom äußeren Radius des Körpers",
          "Von der Massenverteilung relativ zur Drehachse",
          "Von der Winkelgeschwindigkeit"
        ],
        correctIndex: 2,
        explanation: "Das Trägheitsmoment hängt von der Massenverteilung relativ zur Drehachse ab: I = ∫r²dm. Massen weit von der Achse entfernt tragen quadratisch stärker bei als nahe Massen."
      },
      {
        id: "q3",
        question: "Was besagt der Steinersche Satz (Parallelachsentheorem)?",
        options: [
          "I_S = I − m · d²",
          "I = I_S · m · d",
          "I = I_S / (m · d²)",
        ...
        correctIndex: 3,
        explanation: "Der Steinersche Satz lautet I = I_S + m · d², wobei I_S das Trägheitsmoment um die Schwerpunktachse und d der Abstand der neuen (parallelen) Achse vom Schwerpunkt ist."
      },
      {
        id: "q4",
        question: "Welcher der folgenden Körper hat bei gleicher Masse m und gleichem Außenradius r das größte Trägheitsmoment bezüglich der Symmetrieachse?",
        options: ["Vollkugel (I = 2/5 · m · r²)", "Vollzylinder (I = 1/2 · m · r²)", "Hohlzylinder, dünnwandig (I = m · r²)", "Alle drei sind gleich"],
        correctIndex: 2,
        explanation: "Der dünnwandige Hohlzylinder hat das größte Trägheitsmoment I = m · r², weil seine gesamte Masse am äußersten Rand liegt. Vollzylinder (½mr²) und Vollkugel (2/5 · mr²) haben jeweils einen Teil ihrer Masse näher an der Achse."
      },
      {
        id: "q5",
        question: "Wie lautet die Formel für die rotatorische kinetische Energie?",
        options: ["E_rot = ½ · I · ω²", "E_rot = I · ω", "E_rot = ½ · m · v²", "E_rot = I · ω²"],
        correctIndex: 0,
        explanation: "Die rotatorische kinetische Energie lautet E_rot = ½ · I · ω², analog zur translatorischen E_kin = ½ · m · v². Dabei nimmt I die Rolle der Masse und ω die Rolle der Geschwindigkeit ein."
      },
      {
        id: "q6",
        question: "Ein Schwungrad dreht doppelt so schnell (ω → 2ω). Um welchen Faktor ändert sich die gespeicherte Rotationsenergie?",
        options: ["Faktor 4", "Faktor 2", "Faktor 8", "Faktor 1 (keine Änderung)"],
        correctIndex: 0,
        explanation: "Da E_rot = ½ · I · ω² und ω quadratisch eingeht, führt eine Verdopplung von ω zu E_neu = ½ · I · (2ω)² = 4 · ½ · I · ω² = 4 · E_rot. Die Energie vervierfacht sich."
      },
      {
        id: "q7",
        question: "Wie lautet das Trägheitsmoment eines dünnen Stabs der Masse m und Länge l bezüglich einer Achse durch sein Ende?",
        options: ["I = (1/12) · m · l²", "I = (1/3) · m · l²", "I = (1/2) · m · l²", "I = m · l²"],
        correctIndex: 1,
        explanation: "Für den dünnen Stab gilt durch das Ende: I = (1/3) · m · l². Durch den Schwerpunkt (Mitte) gilt I = (1/12) · m · l². Der Unterschied entspricht dem Steinerschen Anteil m · (l/2)²."
      },
      {
        id: "q8",
        question: "Ein Körper hat I_S = 0,1 kg·m² (durch Schwerpunkt). Die Drehachse wird um d = 0,2 m verschoben, Masse m = 5 kg. Wie groß ist das neue Trägheitsmoment I?",
        options: ["0,1 kg·m²", "0,5 kg·m²", "0,2 kg·m²", "0,3 kg·m²"],
        correctIndex: 3,
        explanation: "Mit dem Steinerschen Satz: I = I_S + m · d² = 0,1 + 5 · (0,2)² = 0,1 + 5 · 0,04 = 0,1 + 0,2 = 0,3 kg·m²."
      },
      {
        id: "q9",
        question: "Warum erreicht eine Vollscheibe beim Rollen die untere Kante einer schiefen Ebene früher als ein Hohlzylinder (gleiche Masse, gleicher Radius)?",
        options: [
          "Weil die Vollscheibe mehr Masse besitzt",
          "Weil der Hohlzylinder mehr Gleitreibung erzeugt",
          "Weil die Vollscheibe ein kleineres Trägheitsmoment hat und weniger Energie in Rotation fließt",
          "Es gibt keinen Unterschied zwischen den beiden Körpern"
        ],
        correctIndex: 2,
        explanation: "Bei der Vollscheibe (I = ½mr²) fließt weniger Energie in die Rotation als beim Hohlzylinder (I = mr²). Daher steht bei der Vollscheibe mehr Energie für die Translationsbewegung zur Verfügung, und sie wird schneller."
      },
      {
        id: "q10",
        question: "Die Masse eines Körpers verdoppelt sich bei unveränderter Geometrie und Achse. Wie verändert sich sein Trägheitsmoment?",
        options: ["Es vervierfacht sich", "Es bleibt gleich", "Es halbiert sich", "Es verdoppelt sich"],
        correctIndex: 3,
        explanation: "Da I = ∫r²dm und die Massenverteilung proportional zur Gesamtmasse ist, verdoppelt sich das Trägheitsmoment bei Verdopplung der Masse (gleiche Form und Achse)."
      }
    ]
  },
  {
    ...
    quiz: [
      {
        id: "q1",
        question: "Wie lautet der Betrag des Drehmoments M, das eine Kraft F im Abstand r von der Achse unter dem Winkel θ erzeugt?",
        options: ["M = r · F · sin(θ)", "M = r · F · cos(θ)", "M = r / (F · sin(θ))", "M = F / (r · sin(θ))"],
        correctIndex: 0,
        explanation: "Der Betrag des Drehmoments ist M = r · F · sin(θ), wobei θ der Winkel zwischen Hebelarm und Kraftrichtung ist. Maximal ist M bei θ = 90° (Kraft senkrecht zum Hebelarm)."
      },
      {
        id: "q2",
        question: "Wie lautet das 2. Newtonsche Gesetz für die Rotationsbewegung?",
        options: ["L = I · ω", "M = I · α", "P = M · ω", "W = M · φ"],
        correctIndex: 1,
        explanation: "Das rotatorische Analogon zu F = m · a lautet M = I · α. Das Drehmoment M bewirkt eine Winkelbeschleunigung α, die umso kleiner ist, je größer das Trägheitsmoment I ist."
      },
      {
        id: "q3",
        question: "Wann bleibt der Drehimpuls L eines Systems erhalten?",
        options: [
          "Wenn das Trägheitsmoment konstant bleibt",
          "Wenn die Winkelgeschwindigkeit konstant bleibt",
          "Wenn kein resultierendes äußeres Drehmoment wirkt (ΣM_ext = 0)",
          "Wenn die Rotationsenergie konstant bleibt"
        ],
        correctIndex: 2,
        explanation: "Der Drehimpuls L = I · ω ist erhalten, wenn kein äußeres Drehmoment angreift. Analog bleibt der Linearimpuls p erhalten, wenn keine äußere Kraft wirkt (Newtonsches Trägheitsgesetz)."
      },
      {
        id: "q4",
        question: "Welche Einheit hat der Drehimpuls L?",
        options: ["N · m", "kg · m² / s", "W", "kg · m / s"],
        correctIndex: 1,
        explanation: "L = I · ω hat die Einheit [kg·m²] · [rad/s] = kg·m²/s. Diese Einheit entspricht auch J·s (Joule mal Sekunde) und ist identisch mit der Einheit des Wirkungsquantums ħ."
      },
      {
        id: "q5",
        question: "Wie lautet die Formel für die von einem Drehmoment M bei einer Winkeldrehung φ verrichtete Arbeit?",
        options: ["W = M · ω", "W = M / φ", "W = M · φ", "W = I · ω²"],
        correctIndex: 2,
        explanation: "Analog zu W = F · s (translatorisch) gilt rotatorisch W = M · φ. Dabei muss M und φ konsistente Vorzeichen haben (gleiches Drehsinn → positive Arbeit)."
      },
      {
        id: "q6",
        question: "Eine Eisläuferin halbiert ihr Trägheitsmoment durch Heranziehen der Arme. Was passiert mit ihrer Winkelgeschwindigkeit?",
        options: [
          "Sie halbiert sich (Impulserhaltung)",
          "Sie bleibt gleich (kein äußeres Drehmoment)",
          "Sie verdoppelt sich (Drehimpulserhaltung)",
          "Sie vervierfacht sich (Energieerhaltung)"
        ],
        correctIndex: 2,
        explanation: "Wegen der Drehimpulserhaltung (L = I · ω = const) gilt: Wenn I auf die Hälfte sinkt, verdoppelt sich ω. Die Eisläuferin dreht sich also doppelt so schnell."
      },
      {
        id: "q7",
        question: "Wie lautet die Formel für die Rotationsleistung P?",
        options: ["P = M / ω", "P = I · α", "P = M · φ", "P = M · ω"],
        correctIndex: 3,
        explanation: "Die Rotationsleistung berechnet sich zu P = M · ω, analog zu P = F · v in der Translationsbewegung. Damit lässt sich z. B. die Motorleistung aus Drehmoment und Drehzahl bestimmen."
      },
      {
        id: "q8",
        question: "Bei welchem Winkel θ zwischen Hebelarm und Kraft ist das Drehmoment am größten?",
        options: ["θ = 0° (parallel)", "θ = 45°", "θ = 180° (antiparallel)", "θ = 90° (senkrecht)"],
        correctIndex: 3,
        explanation: "M = r · F · sin(θ) ist maximal bei θ = 90°, da sin(90°) = 1. Bei θ = 0° oder 180° (Kraft parallel zum Hebelarm) ist das Drehmoment null, da sin(0°) = sin(180°) = 0."
      },
      {
        id: "q9",
        question: "Eine Scheibe (I = 0,4 kg·m²) soll mit α = 5 rad/s² beschleunigt werden. Welches Drehmoment wird benötigt?",
        options: ["0,08 N·m", "0,8 N·m", "2 N·m", "8 N·m"],
        correctIndex: 2,
        explanation: "M = I · α = 0,4 kg·m² · 5 rad/s² = 2 N·m."
      },
      {
        id: "q10",
        question: "Welche Aussage über den Drehimpuls L = I · ω ist korrekt?",
        options: [
          "L ist immer konstant, unabhängig von äußeren Kräften",
          "L ändert sich, wenn die Rotationsenergie konstant bleibt",
          "L = dM/dt, d. h. der Drehimpuls ist die zeitliche Ableitung des Drehmoments",
          "Wenn ΣM_ext = 0, bleibt L = I · ω konstant (Drehimpulserhaltungssatz)"
        ],
        correctIndex: 3,
        explanation: "Der Drehimpulserhaltungssatz besagt: Wenn kein äußeres Drehmoment wirkt (ΣM_ext = 0), bleibt L = I · ω = const. Es gilt zudem dL/dt = M (nicht umgekehrt)."
      }
    ]
  }
];
