const FINV_CHAPTER10_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist der Rentenendwert bei vorschüssiger Zahlung stets höher als bei nachschüssiger Zahlung (bei sonst gleichen Parametern)?", correctAnswer: true, reasons: ["Ja, weil vorschüssige Zahlungen jeweils eine Periode länger verzinst werden als nachschüssige.", "Nein, weil beide Zahlungsweisen bei gleicher Rate stets denselben Endwert ergeben.", "Ja, weil nachschüssige Zahlungen grundsätzlich überhaupt nicht verzinst werden.", "Nein, weil vorschüssige Zahlungen tatsächlich eine Periode kürzer verzinst werden."], correctReasonIndex: 0, explanation: "Da jede vorschüssige Rate am Periodenanfang statt am Periodenende gezahlt wird, wirkt sie eine Periode länger verzinst, wodurch der vorschüssige Rentenendwert stets um den Faktor (1+i) höher ausfällt als der nachschüssige." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Bleibt beim Ratenkredit die Gesamtzahlung (Zins plus Tilgung) über die gesamte Laufzeit konstant?", correctAnswer: false, reasons: ["Ja, weil Zins und Tilgung beim Ratenkredit beide konstant gehalten werden.", "Nein, weil die Zinsen auf die sinkende Restschuld berechnet werden und dadurch die Gesamtzahlung im Zeitverlauf sinkt.", "Ja, weil sich Tilgungs- und Zinsanteil gegenseitig immer exakt ausgleichen.", "Nein, weil die Tilgungsrate beim Ratenkredit von Jahr zu Jahr steigt."], correctReasonIndex: 1, explanation: "Beim Ratenkredit ist nur die Tilgungsrate konstant; da die Zinsen auf die sinkende Restschuld berechnet werden, sinkt die Gesamtzahlung (Zins plus Tilgung) von Jahr zu Jahr." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Wird bei der Annuitätenmethode derselbe Annuitätenfaktor verwendet wie beim Annuitätenkredit?", correctAnswer: true, reasons: ["Ja, weil beide denselben Annuitätenfaktor nutzen, um einen Barwert in eine gleichbleibende Zahlungsreihe umzurechnen.", "Nein, weil die Annuitätenmethode einen eigenen, vom Zinssatz unabhängigen Faktor verwendet.", "Ja, weil beide Verfahren ausschließlich zur Berechnung steuerlicher Abgaben dienen.", "Nein, weil der Annuitätenkredit grundsätzlich ohne jede Verzinsung berechnet wird."], correctReasonIndex: 0, explanation: "Annuitätenmethode und Annuitätenkredit nutzen denselben mathematischen Mechanismus (den Annuitätenfaktor (1+i)^n·i/((1+i)^n−1)), um einen Barwert in eine konstante Zahlungsreihe umzurechnen — nur die wirtschaftliche Interpretation unterscheidet sich." },
