const NATWISS_CHAPTER15_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist die Beschleunigung einer harmonischen Schwingung x(t) = A·cos(ωt) am Nulldurchgang (x = 0) maximal?", correctAnswer: false, reasons: ["Nein, weil a = −ω²x proportional zu x ist; am Nulldurchgang (x = 0) ist die Beschleunigung null, maximal wird sie an den Umkehrpunkten (x = ±A).", "Ja, weil die Geschwindigkeit am Nulldurchgang maximal ist und die Beschleunigung stets denselben zeitlichen Verlauf wie die Geschwindigkeit hat, nur phasenverschoben.", "Nein, weil die Beschleunigung bei einer harmonischen Schwingung grundsätzlich konstant und ortsunabhängig ist, ähnlich wie beim freien Fall.", "Ja, weil a = ω²A für jeden Zeitpunkt der Schwingung als fester Betrag gilt, unabhängig von der momentanen Auslenkung x."], correctReasonIndex: 0, explanation: "Aus a(t) = −ω²x(t) folgt, dass die Beschleunigung proportional zur momentanen Auslenkung ist – am Nulldurchgang (x = 0) verschwindet sie, während sie an den Umkehrpunkten (x = ±A, wo v = 0 ist) ihren Maximalwert a_max = ω²A erreicht." },
      { id: "natwiss-ueb-schwingungen-q4", question: "Wie lautet die Eigenfrequenz eines mathematischen Pendels?", options: ["f = 1/(2π)·√(l/g), mit vertauschtem Zähler und Nenner", "f = 1/(2π)·√(g/l), die Fadenpendel-Formel", "f = 1/(2π)·√(k/m), die Formel des Federpendels", "f = √(g·l)/(2π), ohne Kehrwertbildung unter der Wurzel"], correctIndex: 1, explanation: "Für kleine Auslenkwinkel gilt f = 1/(2π)·√(g/l) — die Frequenz hängt nur von der Fallbeschleunigung g und der Pendellänge l ab, nicht von der Masse. Das unterscheidet das Pendel deutlich vom Federpendel, dessen Frequenz von Federkonstante k und Masse m abhängt." },
  ...
  },
  {
    ...
    quiz: [
      { id: "natwiss-ueb-wellen-q1", question: "Wie hängt die Wellengeschwindigkeit auf einem Seil von der Zugspannung ab?", options: ["c ∝ F_T², quadratisch statt mit Wurzel", "Sie ist von der Zugspannung unabhängig", "c ∝ F_T, linear statt mit Wurzel", "c ∝ √F_T, die Wellengeschwindigkeit auf der Saite"], correctIndex: 3, explanation: "Aus c = √(F_T/μ) folgt, dass die Wellengeschwindigkeit nur mit der Quadratwurzel der Zugspannung wächst: eine Verdopplung von F_T erhöht c lediglich um den Faktor √2, nicht um den Faktor 2 oder 4." },
      { id: "natwiss-ueb-wellen-q2", question: "Bei einer stehenden Welle auf einem beidseitig eingespannten Seil der Länge L: Was ist die längste mögliche Wellenlänge?", options: ["λ_max = L, ohne den Faktor 2", "λ_max = 4L, um den Faktor 2 zu groß", "λ_max = 2L, die Grundschwingung", "λ_max = L/2, als Kehrwert statt Vielfaches"], correctIndex: 2, explanation: "Bei der Grundschwingung passt genau eine halbe Wellenlänge auf die Seillänge L, sodass λ₁ = 2L die längste mögliche stehende Welle ist — kürzere Wellenlängen (Oberschwingungen) erfüllen dagegen λ_n = 2L/n mit n = 2, 3, ...." },
      { id: "natwiss-ueb-wellen-q3", question: "Wie sind Phasendifferenz Δφ und örtlicher Abstand Δx verknüpft?", options: ["Δφ = 2π·Δx/λ, die Phasendifferenz", "Δφ = Δx·f, mit Frequenz statt Wellenlänge", "Δφ = λ/Δx, als Kehrwert vertauscht", "Δφ = Δx/λ, ohne den Faktor 2π"], correctIndex: 0, explanation: "Über die Wellenzahl k = 2π/λ gilt Δφ = k·Δx = (2π/λ)·Δx: Je größer der örtliche Abstand relativ zur Wellenlänge, desto größer die Phasendifferenz. Der Faktor 2π darf dabei nicht vergessen werden." },
      { id: "yn1", type: "yesno", question: "Hängt die Wellengeschwindigkeit auf einem gespannten Seil von der Amplitude der Welle ab?", correctAnswer: false, reasons: ["Nein, weil c = √(F_T/μ) nur von Zugspannung F_T und Massendichte μ abhängt, nicht von der Amplitude.", "Ja, weil eine größere Amplitude mehr Energie transportiert und dadurch die Welle automatisch schneller läuft, ähnlich wie bei mehr Impuls.", "Nein, weil die Wellengeschwindigkeit auf einem Seil grundsätzlich unveränderlich und materialunabhängig ist, unabhängig von F_T und μ.", "Ja, weil sich bei größerer Amplitude auch die effektive Zugspannung F_T im Seil erhöht und die Welle dadurch beschleunigt."], correctReasonIndex: 0, explanation: "Die Formel c = √(F_T/μ) enthält nur die Zugspannung und die Massendichte des Seils – die Amplitude beeinflusst zwar die transportierte Leistung (P ∝ A²), nicht aber die Ausbreitungsgeschwindigkeit der Welle selbst." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "natwiss-ueb-wellen2-q4", question: "Zwei Wellen gleicher Amplitude A überlagern sich mit Δφ = π (destruktiv). Wie groß ist die Amplitude der Resultante?", options: ["2A, wie bei konstruktiver Interferenz", "√2·A, wie bei einer 90°-Phasenverschiebung", "0, bei vollständiger Auslöschung", "A, als bliebe alles unverändert"], correctIndex: 2, explanation: "Bei einer Phasendifferenz von π (180°) schwingen beide Wellen exakt gegenphasig, sodass sie sich zu jedem Zeitpunkt vollständig gegenseitig auslöschen: A_res = A − A = 0. Bei Δφ = 0 hingegen würden sich die Amplituden zu 2A addieren." },
      { id: "natwiss-ueb-wellen2-q5", question: "Was ist die Wellenzahl k?", options: ["k = ω/c², mit fälschlich quadriertem c", "k = λ/c, eine andere physikalische Größe", "k = 2πf, das ist stattdessen die Kreisfrequenz ω", "k = 2π/λ, die Wellenzahl"], correctIndex: 3, explanation: "Die Wellenzahl k = 2π/λ misst, wie viele Radiant Phase pro Längeneinheit durchlaufen werden, mit Einheit rad/m. Sie ist damit das räumliche Gegenstück zur Kreisfrequenz ω = 2πf, die die zeitliche Phasenänderung beschreibt." },
      { id: "natwiss-ueb-wellen2-q6", question: "Welche Schwebungsfrequenz ergibt sich aus zwei Tönen mit f₁ = 440 Hz und f₂ = 443 Hz?", options: ["441,5 Hz, der Mittelwert der beiden Frequenzen", "883 Hz, die Summe der beiden Frequenzen", "3 Hz, die Betragsdifferenz der Frequenzen", "1 Hz, deutlich zu niedrig"], correctIndex: 2, explanation: "Die Schwebungsfrequenz ist der Betrag der Differenz beider Frequenzen, f_s = |f₁ − f₂| = |440 − 443| = 3 Hz — nicht ihr Mittelwert oder ihre Summe, die stattdessen ganz andere akustische Größen beschreiben würden." },
      { id: "yn1", type: "yesno", question: "Liegen benachbarte Knoten und Bäuche einer stehenden Welle stets im Abstand λ/4 zueinander?", correctAnswer: true, reasons: ["Ja, weil Knoten bei x = n·λ/2 und Bäuche bei x = (2n+1)·λ/4 liegen; benachbarte Knoten und Bäuche haben stets den Abstand λ/4.", "Nein, weil Knoten und Bäuche bei einer stehenden Welle stets im Abstand einer vollen Wellenlänge λ zueinander liegen, ähnlich wie bei fortlaufenden Wellen.", "Ja, weil sich Knoten und Bäuche bei jeder Welle unabhängig von der Wellenlänge in einem konstanten Abstand von genau 1 m zueinander befinden.", "Nein, weil der Abstand zwischen Knoten und Bauch von der Amplitude A der Welle abhängt, nicht von der Wellenlänge λ selbst."], correctReasonIndex: 0, explanation: "Aus den Positionsformeln x_Knoten = n·λ/2 und x_Bauch = (2n+1)·λ/4 ergibt sich für benachbarte Knoten und Bäuche stets ein Abstand von λ/4 – unabhängig von der Amplitude, die nur die Größe der Auslenkung an den Bäuchen bestimmt, nicht deren Position." },
