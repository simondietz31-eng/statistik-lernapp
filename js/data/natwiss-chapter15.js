const NATWISS_CHAPTER15_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist die Beschleunigung einer harmonischen Schwingung x(t) = A·cos(ωt) am Nulldurchgang (x = 0) maximal?", correctAnswer: false, reasons: ["Nein, weil a = −ω²x proportional zur Auslenkung x ist; am Nulldurchgang (x = 0) ist daher auch die Beschleunigung null, während sie an den Umkehrpunkten (x = ±A) maximal wird.", "Ja, weil die Geschwindigkeit am Nulldurchgang maximal ist und die Beschleunigung stets denselben Verlauf wie die Geschwindigkeit hat.", "Nein, weil die Beschleunigung bei einer harmonischen Schwingung grundsätzlich konstant und ortsunabhängig ist.", "Ja, weil a = ω²A für jeden Zeitpunkt der Schwingung gilt, unabhängig von der momentanen Auslenkung."], correctReasonIndex: 0, explanation: "Aus a(t) = −ω²x(t) folgt, dass die Beschleunigung proportional zur momentanen Auslenkung ist – am Nulldurchgang (x = 0) verschwindet sie, während sie an den Umkehrpunkten (x = ±A, wo v = 0 ist) ihren Maximalwert a_max = ω²A erreicht." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Hängt die Wellengeschwindigkeit auf einem gespannten Seil von der Amplitude der Welle ab?", correctAnswer: false, reasons: ["Nein, weil c = √(F_T/μ) nur von der Zugspannung F_T und der linearen Massendichte μ des Seils abhängt, nicht von der Amplitude der Welle.", "Ja, weil eine größere Amplitude mehr Energie transportiert und dadurch automatisch schneller läuft.", "Nein, weil die Wellengeschwindigkeit auf einem Seil grundsätzlich unveränderlich und materialunabhängig ist.", "Ja, weil sich bei größerer Amplitude auch die effektive Zugspannung F_T im Seil erhöht."], correctReasonIndex: 0, explanation: "Die Formel c = √(F_T/μ) enthält nur die Zugspannung und die Massendichte des Seils – die Amplitude beeinflusst zwar die transportierte Leistung (P ∝ A²), nicht aber die Ausbreitungsgeschwindigkeit der Welle selbst." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Liegen benachbarte Knoten und Bäuche einer stehenden Welle stets im Abstand λ/4 zueinander?", correctAnswer: true, reasons: ["Ja, weil Knoten bei x = n·λ/2 und Bäuche bei x = (2n+1)·λ/4 liegen; der Abstand zwischen einem Knoten und dem jeweils benachbarten Bauch beträgt somit stets genau λ/4.", "Nein, weil Knoten und Bäuche bei einer stehenden Welle stets im Abstand einer vollen Wellenlänge λ zueinander liegen.", "Ja, weil sich Knoten und Bäuche bei jeder Welle unabhängig von der Wellenlänge in konstantem Abstand von 1 m befinden.", "Nein, weil der Abstand zwischen Knoten und Bauch von der Amplitude A der Welle abhängt, nicht von λ."], correctReasonIndex: 0, explanation: "Aus den Positionsformeln x_Knoten = n·λ/2 und x_Bauch = (2n+1)·λ/4 ergibt sich für benachbarte Knoten und Bäuche stets ein Abstand von λ/4 – unabhängig von der Amplitude, die nur die Größe der Auslenkung an den Bäuchen bestimmt, nicht deren Position." },
