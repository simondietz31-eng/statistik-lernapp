const NATWISS_CHAPTER9_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Was besagt die Clausius-Formulierung des 2. Hauptsatzes?", options: ["Energie bleibt erhalten", "Wärme kann nicht spontan von kalt nach warm fließen", "Kein Prozess hat 100 % Wirkungsgrad", "Entropie bleibt konstant"], correctIndex: 1, explanation: "Clausius: Wärme fließt spontan nur von warm nach kalt – die Umkehrung (kalt nach warm) erfordert äußere Arbeit." },
      { id: "q2", question: "Was ist der maximale theoretische Wirkungsgrad einer Wärmekraftmaschine?", options: ["100 %", "< 100 % (abhängig von den Temperaturen)", "50 %", "Unbegrenzt"], correctIndex: 1, explanation: "Der 2. Hauptsatz verbietet η = 100 %. Das theoretische Maximum ist der Carnot-Wirkungsgrad η_C = 1 − T_C/T_H." },
      { id: "q3", question: "Was ist eine Wärmepumpe?", options: ["Eine Maschine, die Wärme vernichtet", "Eine umgekehrte Wärmekraftmaschine: pumpt mit Arbeit Wärme von kalt nach warm", "Eine Maschine, die nur mit Solarenergie betrieben wird", "Ein Gerät zur Messung von Wärme"], correctIndex: 1, explanation: "Eine Wärmepumpe verwendet äußere Arbeit (z. B. Strom), um Wärme von einem kalten auf ein warmes Reservoir zu transportieren (Kühlschrank, Heizungswärmepumpe)." },
      { id: "q4", question: "Was ist die Leistungszahl (COP) einer Kältemaschine?", options: ["COP = Q_H / W", "COP = W / Q_C", "COP = Q_C / W", "COP = η"], correctIndex: 2, explanation: "Leistungszahl der Kältemaschine: COP_kalt = Q_C / W (entzogene Wärme pro aufgewendeter Arbeit)." },
      { id: "q5", question: "Welche Aussage ist FALSCH über den 2. Hauptsatz?", options: ["Alle realen Wärmekraftmaschinen haben η < 100 %", "Wärme fließt spontan von warm nach kalt", "Energie bleibt in jedem Prozess erhalten (das ist der 1. Hauptsatz)", "Ein Perpetuum Mobile zweiter Art ist unmöglich"], correctIndex: 2, explanation: "Energieerhaltung ist der 1. Hauptsatz, nicht der 2. Hauptsatz. Der 2. Hauptsatz beschränkt die Richtung von Prozessen." },
      { id: "q6", question: "Welchen Wirkungsgrad hat eine Maschine, die aus 600 J Wärme 200 J Arbeit gewinnt?", options: ["33 %", "25 %", "50 %", "67 %"], correctIndex: 0, explanation: "η = W/Q_H = 200/600 = 1/3 ≈ 33 %." },
      { id: "q7", question: "Eine Kältemaschine hat COP = 3 und verbraucht 100 W. Wie viel Wärme entzieht sie dem Kühlraum?", options: ["300 W", "100 W", "400 W", "33 W"], correctIndex: 0, explanation: "COP = Q_C/W → Q_C = COP · W = 3 · 100 W = 300 W." },
      { id: "q8", question: "Warum können natürliche Prozesse nicht rückwärts ablaufen (z. B. Rauch zieht sich wieder in den Schornstein)?", options: ["Weil Energie dabei verloren geht", "Weil der 2. Hauptsatz Prozesse auf jene mit wachsender Entropie beschränkt", "Weil Materie sich nicht selbst organisieren kann", "Weil das gegen den 1. Hauptsatz verstoßen würde"], correctIndex: 1, explanation: "Irreversible Prozesse (Diffusion, Wärmeleitung, Reibung) laufen nur in Richtung steigender Gesamtentropie ab – das ist der Kern des 2. Hauptsatzes." },
      { id: "q9", question: "Was unterscheidet einen reversiblen von einem irreversiblen Prozess?", options: ["Reversible Prozesse verletzen den 1. Hauptsatz", "Reversible Prozesse laufen ohne Entropieerzeugung ab und können rückwärts laufen", "Irreversible Prozesse setzen keine Energie frei", "Reversible Prozesse sind immer adiabatisch"], correctIndex: 1, explanation: "Reversible (umkehrbare) Prozesse sind idealisierte Grenzfälle ohne Irreversibilitäten; reale Prozesse sind immer irreversibel (Entropie nimmt zu)." },
      { id: "q10", question: "Wärme Q_H = 1000 J, Q_C = 400 J. Wie groß ist der Wirkungsgrad?", options: ["60 %", "40 %", "25 %", "100 %"], correctIndex: 0, explanation: "η = 1 − Q_C/Q_H = 1 − 400/1000 = 0,6 = 60 %." }
    ]
  },
  {
    id: "natwiss-entropie",
    ...
    quiz: [
      { id: "q1", question: "Was misst die Entropie?", options: ["Die gespeicherte Wärme", "Den Grad der Unordnung / die Anzahl möglicher Mikrozustände", "Die innere Energie", "Die Temperatur des Systems"], correctIndex: 1, explanation: "Entropie ist ein Maß für die Unordnung: S = k_B·ln(Ω) nach Boltzmann." },
      { id: "q2", question: "Wie lautet die thermodynamische Definition der Entropieänderung?", options: ["dS = dQ · T", "dS = dQ_rev / T", "dS = dU / T", "dS = dW / T"], correctIndex: 1, explanation: "dS = dQ_rev / T (für reversiblen Prozess). Die Entropieänderung ist Wärme durch Temperatur." },
      { id: "q3", question: "Was gilt für die Gesamtentropie bei einem irreversiblen Prozess?", options: ["ΔS_gesamt = 0", "ΔS_gesamt < 0", "ΔS_gesamt > 0", "ΔS_gesamt kann jedes Vorzeichen haben"], correctIndex: 2, explanation: "2. Hauptsatz: Bei irreversiblen (realen) Prozessen nimmt die Gesamtentropie immer zu (ΔS_gesamt > 0)." },
      { id: "q4", question: "Wasser gefriert bei 0 °C. Die Entropie des Wassers …", options: ["nimmt zu", "nimmt ab", "bleibt konstant", "wird negativ"], correctIndex: 1, explanation: "Beim Gefrieren (Flüssig → Fest) werden die Moleküle geordneter – die Entropie nimmt ab. Die Abwärme an die Umgebung erhöht die Entropie der Umgebung um mindestens denselben Betrag." },
      { id: "q5", question: "Was sagt Boltzmanns Formel S = k_B·ln(Ω)?", options: ["S ist proportional zur Temperatur", "Je mehr Mikrozustände Ω möglich sind, desto größer ist die Entropie", "Entropie ist eine Energie", "S hängt nur von der Energie ab"], correctIndex: 1, explanation: "Boltzmanns Formel verbindet Makroskopie (S) mit der Mikroskopie (Ω = Anzahl möglicher Mikrozustände) – der Grundstein der statistischen Thermodynamik." },
      { id: "q6", question: "Bei welchem Prozess bleibt die Entropie des Universums konstant?", options: ["Reibungsprozess", "Wärmeleitung", "Idealem reversibler Prozess", "Gasdiffusion"], correctIndex: 2, explanation: "Nur bei ideal reversiblen Prozessen gilt ΔS_Universum = 0. Alle realen Prozesse sind irreversibel (ΔS > 0)." },
      { id: "q7", question: "Ein Stein fällt und trifft den Boden (Reibungswärme entsteht). Was passiert mit der Entropie?", options: ["Sie bleibt konstant (Energie erhalten)", "Sie nimmt ab", "Sie nimmt zu", "Sie wird negativ"], correctIndex: 2, explanation: "Kinetische Energie wird in Wärme umgewandelt → erhöhte Unordnung der Moleküle → die Entropie steigt." },
      { id: "q8", question: "Wie groß ist ΔS, wenn Q = 500 J reversibel bei T = 250 K zugeführt werden?", options: ["2 J/K", "0,5 J/K", "125 J/K", "250 J/K"], correctIndex: 0, explanation: "ΔS = Q/T = 500/250 = 2 J/K." },
      { id: "q9", question: "Warum kehren Diffusionsprozesse (z. B. Farbstoff im Wasser) nicht spontan um?", options: ["Weil das gegen den 1. Hauptsatz verstößt", "Weil die Gesamtentropie dabei sinken würde, was der 2. Hauptsatz verbietet", "Weil keine Energie zur Verfügung steht", "Weil der Druck zu niedrig ist"], correctIndex: 1, explanation: "Die Rückdiffusion würde die Anzahl der Mikrozustände drastisch verringern (ΔS < 0). Das ist statistisch nahezu unmöglich und vom 2. Hauptsatz verboten." },
      { id: "q10", question: "Was ist die 'Entropieänderung des Universums' bei einem spontanen irreversiblen Prozess?", options: ["Null", "Negativ", "Positiv", "Unbestimmt"], correctIndex: 2, explanation: "2. Hauptsatz: Jeder spontane (irreversible) Prozess erhöht die Gesamtentropie des Universums: ΔS_gesamt > 0." }
    ]
  },
  {
    id: "natwiss-carnot",
    ...
    quiz: [
      { id: "q1", question: "Wovon hängt der Carnot-Wirkungsgrad ab?", options: ["Vom verwendeten Arbeitsmedium (Luft, Wasser, …)", "Nur von den absoluten Temperaturen T_H und T_C", "Von der Leistung der Maschine", "Von der Reibung im Zylinder"], correctIndex: 1, explanation: "η_C = 1 − T_C/T_H hängt ausschließlich von den Temperaturen T_H und T_C (in Kelvin) ab." },
      { id: "q2", question: "Welche Aussage macht der Carnot-Satz?", options: ["Alle Maschinen haben denselben Wirkungsgrad", "Reversible Maschinen zwischen gleichen Reservoirs haben denselben (maximalen) Wirkungsgrad", "Irreversible Maschinen sind effizienter", "Der Carnot-Prozess hat η = 100 %"], correctIndex: 1, explanation: "Carnots Theorem: Alle reversiblen Wärmekraftmaschinen zwischen gleichen Reservoirs haben denselben Wirkungsgrad η_C; irreversible haben weniger." },
      { id: "q3", question: "T_H = 500 K, T_C = 250 K. Wie groß ist η_C?", options: ["25 %", "50 %", "75 %", "100 %"], correctIndex: 1, explanation: "η_C = 1 − 250/500 = 1 − 0,5 = 50 %." },
      { id: "q4", question: "Aus welchen 4 Teilprozessen besteht der Carnot-Kreisprozess?", options: ["2 Adiabaten + 2 Isochoren", "2 Isothermen + 2 Adiabaten", "2 Isobaren + 2 Isochoren", "4 Adiabaten"], correctIndex: 1, explanation: "Carnot-Prozess: isotherme Expansion (T_H) → adiabatische Expansion → isotherme Kompression (T_C) → adiabatische Kompression (zurück zu T_H)." },
      { id: "q5", question: "Wie verbessert man den Carnot-Wirkungsgrad am einfachsten?", options: ["T_C erhöhen", "T_H erhöhen und/oder T_C senken", "Mehr Arbeitsmittel verwenden", "Schneller arbeiten"], correctIndex: 1, explanation: "η_C = 1 − T_C/T_H: Größeres T_H oder kleineres T_C erhöht η_C. Deshalb arbeiten moderne Kraftwerke mit möglichst hohen Dampftemperaturen." },
      { id: "q6", question: "Ein Kühlschrank mit T_H = 20 °C und T_C = 5 °C: Was ist der maximale Carnot-COP für die Kühlung?", options: ["18,5", "9,3", "1,07", "4,6"], correctIndex: 0, explanation: "T_H = 293 K, T_C = 278 K. COP_kalt = T_C/(T_H−T_C) = 278/(293−278) = 278/15 ≈ 18,5." },
      { id: "q7", question: "Was ist der Unterschied zwischen Wirkungsgrad η und Leistungszahl COP?", options: ["Es gibt keinen Unterschied", "η gilt für Wärmekraftmaschinen (W/Q_H), COP für Wärmepumpen/Kältemaschinen (Q/W)", "COP < 1, η > 1", "η wird nur in Kelvin angegeben"], correctIndex: 1, explanation: "η = W/Q_H < 1 für Wärmekraftmaschinen. COP = Q/W kann > 1 sein – bei Wärmepumpen liefert man mehr Wärme als man elektrische Arbeit einsetzt." },
      { id: "q8", question: "Welcher der folgenden Kreisprozesse ist im Automobil-Benzinmotor am ehesten realisiert?", options: ["Carnot-Prozess", "Rankine-Prozess", "Otto-Prozess", "Stirling-Prozess"], correctIndex: 2, explanation: "Benzinmotoren folgen näherungsweise dem Otto-Kreisprozess (isochore Verbrennung und Wärmeabgabe)." },
      { id: "q9", question: "Warum ist η_C = 100 % prinzipiell unmöglich (außer bei T_C = 0 K)?", options: ["Wegen Reibungsverlusten", "Weil immer Q_C > 0 abgegeben werden muss (2. Hauptsatz)", "Weil Energie verloren geht", "Wegen des idealen Gasgesetzes"], correctIndex: 1, explanation: "Der 2. Hauptsatz (Kelvin-Planck) verbietet vollständige Umwandlung von Wärme in Arbeit – immer muss Q_C > 0 an ein kälteres Reservoir abgegeben werden." },
      { id: "q10", question: "Carnot-COP einer Wärmepumpe bei T_H = 400 K und T_C = 200 K?", options: ["1", "2", "0,5", "4"], correctIndex: 1, explanation: "COP_WP = T_H/(T_H−T_C) = 400/(400−200) = 400/200 = 2." }
    ]
  }
];
