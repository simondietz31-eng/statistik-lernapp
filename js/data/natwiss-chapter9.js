const NATWISS_CHAPTER9_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Kann eine perfekt reibungsfreie Wärmekraftmaschine einen Wirkungsgrad von η = 100 % erreichen?", correctAnswer: false, reasons: ["Nein, weil selbst eine reibungsfreie, ideale Maschine laut Kelvin-Planck-Formulierung stets einen Teil der aufgenommenen Wärme als Q_C an ein kälteres Reservoir abgeben muss.", "Ja, weil Reibung die einzige Ursache für Wirkungsgradverluste in Wärmekraftmaschinen ist.", "Nein, weil η = 100 % nur bei sehr hohen Temperaturen T_H unmöglich wird, bei niedrigen T_H aber erreichbar ist.", "Ja, weil der 1. Hauptsatz jede beliebige Umwandlung von Wärme in Arbeit erlaubt, solange Energie erhalten bleibt."], correctReasonIndex: 0, explanation: "Der 2. Hauptsatz verbietet in der Kelvin-Planck-Formulierung die vollständige Umwandlung von Wärme in Arbeit in einem Kreisprozess – selbst eine ideale, reibungsfreie Maschine muss stets Abwärme Q_C an ein kälteres Reservoir abgeben, daher bleibt η immer kleiner als 100 %." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Kann eine reale, irreversible Wärmekraftmaschine zwischen denselben zwei Reservoirs einen höheren Wirkungsgrad erreichen als eine Carnot-Maschine?", correctAnswer: false, reasons: ["Nein, weil der Carnot-Wirkungsgrad laut Carnots Theorem die absolute Obergrenze für jede Maschine zwischen denselben beiden Temperaturen darstellt; irreversible Maschinen erreichen stets einen geringeren Wirkungsgrad.", "Ja, weil reale Maschinen durch technische Optimierung den theoretischen Carnot-Grenzwert grundsätzlich übertreffen können.", "Nein, weil reale Maschinen grundsätzlich gar keine Arbeit verrichten können.", "Ja, weil Irreversibilitäten wie Reibung den Wirkungsgrad einer Maschine zusätzlich erhöhen."], correctReasonIndex: 0, explanation: "Carnots Theorem legt fest, dass der Wirkungsgrad des reversiblen Carnot-Prozesses die theoretische Obergrenze für jede Maschine zwischen denselben Temperaturen T_H und T_C ist; Irreversibilitäten wie Reibung senken den erreichbaren Wirkungsgrad stets unter η_C." },
