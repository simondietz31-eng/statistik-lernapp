const NATWISS_CHAPTER9_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Kann eine perfekt reibungsfreie Wärmekraftmaschine einen Wirkungsgrad von η = 100 % erreichen?", correctAnswer: false, reasons: ["Nein, weil selbst eine reibungsfreie Maschine laut Kelvin-Planck stets Wärme als Q_C abgeben muss.", "Ja, weil Reibung die einzige mögliche Ursache für Wirkungsgradverluste in jeder Art von Wärmekraftmaschine ist, unabhängig vom Prozess.", "Nein, weil η = 100 % nur bei sehr hohen Temperaturen T_H unmöglich wird, bei niedrigen T_H aber erreichbar ist.", "Ja, weil der 1. Hauptsatz jede beliebige Umwandlung von Wärme in Arbeit erlaubt, solange Energie erhalten bleibt."], correctReasonIndex: 0, explanation: "Der 2. Hauptsatz verbietet in der Kelvin-Planck-Formulierung die vollständige Umwandlung von Wärme in Arbeit in einem Kreisprozess – selbst eine ideale, reibungsfreie Maschine muss stets Abwärme Q_C an ein kälteres Reservoir abgeben, daher bleibt η immer kleiner als 100 %." },
      { id: "q3", question: "Was ist eine Wärmepumpe?", options: ["Eine Maschine, die ausschließlich mit Solarenergie betrieben werden kann", "Ein reines Messgerät zur Bestimmung von Wärmemengen", "Eine Maschine, die überschüssige Wärme dauerhaft vernichtet", "Eine umgekehrte Wärmekraftmaschine, die Wärme von kalt nach warm pumpt"], correctIndex: 3, explanation: "Eine Wärmepumpe verwendet äußere Arbeit (z. B. Strom), um Wärme von einem kalten auf ein warmes Reservoir zu transportieren (Kühlschrank, Heizungswärmepumpe)." },
      ...
      { id: "q8", question: "Warum können natürliche Prozesse nicht rückwärts ablaufen (z. B. Rauch zieht sich wieder in den Schornstein)?", options: ["Weil das gegen den Energieerhaltungssatz verstoßen würde", "Weil der 2. Hauptsatz nur wachsende Entropie zulässt", "Weil Materie sich prinzipiell nicht selbst organisieren kann", "Weil dabei angeblich Energie verloren gehen würde"], correctIndex: 1, explanation: "Irreversible Prozesse (Diffusion, Wärmeleitung, Reibung) laufen nur in Richtung steigender Gesamtentropie ab – das ist der Kern des 2. Hauptsatzes." },
      { id: "q9", question: "Was unterscheidet einen reversiblen von einem irreversiblen Prozess?", options: ["Irreversible Prozesse setzen grundsätzlich keine Energie frei", "Reversible Prozesse verletzen angeblich den 1. Hauptsatz", "Reversible Prozesse laufen ohne Entropieerzeugung ab, irreversible nicht", "Reversible Prozesse sind stets zwingend adiabatisch"], correctIndex: 2, explanation: "Reversible (umkehrbare) Prozesse sind idealisierte Grenzfälle ohne Irreversibilitäten; reale Prozesse sind immer irreversibel (Entropie nimmt zu)." },
  ...
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Was misst die Entropie?", options: ["Den Grad der Unordnung eines Systems", "Die aktuelle Temperatur des Systems", "Die im System gespeicherte Wärmemenge", "Die gesamte innere Energie des Systems"], correctIndex: 0, explanation: "Entropie ist ein Maß für die Unordnung bzw. die Anzahl möglicher Mikrozustände: S = k_B·ln(Ω) nach Boltzmann. Temperatur, Wärme und innere Energie sind eigenständige Zustandsgrößen, die davon zu unterscheiden sind." },
      ...
      { id: "q5", question: "Was sagt Boltzmanns Formel S = k_B·ln(Ω)?", options: ["Mehr mögliche Mikrozustände Ω bedeuten größere Entropie", "Die Entropie ist eine Form von Energie", "S hängt ausschließlich von der Energie des Systems ab", "S ist stets direkt proportional zur Temperatur"], correctIndex: 0, explanation: "Boltzmanns Formel verbindet Makroskopie (S) mit der Mikroskopie (Ω = Anzahl möglicher Mikrozustände) – der Grundstein der statistischen Thermodynamik." },
      { id: "yn1", type: "yesno", question: "Bleibt die Entropie des Universums bei jedem realen (irreversiblen) Prozess konstant?", correctAnswer: false, reasons: ["Nein, weil bei jedem irreversiblen Prozess die Entropie des Universums laut 2. Hauptsatz zunimmt.", "Ja, weil Entropie eine Erhaltungsgröße wie die Energie ist und sich in keinem denkbaren Prozess jemals verändert, egal welcher Art.", "Nein, weil die Entropie bei realen Prozessen immer abnimmt, da bei jeder Umwandlung zwangsläufig Ordnung verloren geht.", "Ja, weil sich Entropiezunahmen und -abnahmen in Teilsystemen bei jedem Prozess exakt gegenseitig aufheben."], correctReasonIndex: 0, explanation: "Nur bei idealisierten reversiblen Prozessen bleibt ΔS_gesamt = 0; jeder reale, irreversible Prozess erhöht die Gesamtentropie des Universums (ΔS_gesamt > 0), was den Kern des 2. Hauptsatzes ausmacht." },
      ...
      { id: "q9", question: "Warum kehren Diffusionsprozesse (z. B. Farbstoff im Wasser) nicht spontan um?", options: ["Weil dafür angeblich keine Energie zur Verfügung steht", "Weil dabei die Gesamtentropie sinken würde, was verboten ist", "Weil das gegen den 1. Hauptsatz verstoßen würde", "Weil der Umgebungsdruck dafür zu niedrig wäre"], correctIndex: 1, explanation: "Die Rückdiffusion würde die Anzahl der Mikrozustände drastisch verringern (ΔS < 0). Das ist statistisch nahezu unmöglich und vom 2. Hauptsatz verboten." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "q2", question: "Welche Aussage macht der Carnot-Satz?", options: ["Der Carnot-Prozess erreicht angeblich einen Wirkungsgrad von η = 100 %", "Reversible Maschinen zwischen gleichen Reservoirs teilen denselben Wirkungsgrad", "Alle Maschinen haben unabhängig vom Prozess denselben Wirkungsgrad", "Irreversible Maschinen sind grundsätzlich effizienter als reversible"], correctIndex: 1, explanation: "Carnots Theorem: Alle reversiblen Wärmekraftmaschinen zwischen gleichen Reservoirs haben denselben Wirkungsgrad η_C; irreversible haben weniger." },
      { id: "yn1", type: "yesno", question: "Kann eine reale, irreversible Wärmekraftmaschine zwischen denselben zwei Reservoirs einen höheren Wirkungsgrad erreichen als eine Carnot-Maschine?", correctAnswer: false, reasons: ["Nein, weil der Carnot-Wirkungsgrad die absolute Obergrenze für jede Maschine zwischen denselben Temperaturen ist.", "Ja, weil reale Maschinen durch technische Optimierung den theoretischen Carnot-Grenzwert grundsätzlich übertreffen können, wenn die Bauweise stimmt.", "Nein, weil reale Maschinen aufgrund innerer Reibungsverluste grundsätzlich überhaupt keine nutzbare Arbeit verrichten können.", "Ja, weil Irreversibilitäten wie Reibung den nutzbaren Wirkungsgrad einer realen Maschine zusätzlich erhöhen."], correctReasonIndex: 0, explanation: "Carnots Theorem legt fest, dass der Wirkungsgrad des reversiblen Carnot-Prozesses die theoretische Obergrenze für jede Maschine zwischen denselben Temperaturen T_H und T_C ist; Irreversibilitäten wie Reibung senken den erreichbaren Wirkungsgrad stets unter η_C." },
      ...
      { id: "q7", question: "Was ist der Unterschied zwischen Wirkungsgrad η und Leistungszahl COP?", options: ["Es besteht zwischen beiden Größen kein echter Unterschied", "η wird angeblich ausschließlich in Kelvin angegeben", "η gilt für Wärmekraftmaschinen, COP für Wärmepumpen/Kältemaschinen", "Es gilt stets COP < 1 und gleichzeitig η > 1"], correctIndex: 2, explanation: "η = W/Q_H < 1 für Wärmekraftmaschinen. COP = Q/W kann > 1 sein – bei Wärmepumpen liefert man mehr Wärme als man elektrische Arbeit einsetzt." },
