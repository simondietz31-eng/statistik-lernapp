const BILANZIERUNG_CHAPTER8_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Was ist der Zweck der Gewinn- und Verlustrechnung?", options: ["Feststellung des aktuellen Marktwerts des gesamten Unternehmens","Ermittlung von Jahresüberschuss/-fehlbetrag und Ausweis der Ergebnisquellen","Ermittlung des Vermögens- und Kapitalbestands zu einem Stichtag","Berechnung der Umsatzsteuerschuld eines Geschäftsjahres"], correctIndex: 1, explanation: "Die GuV dient der Ermittlung des Jahresüberschusses bzw. Jahresfehlbetrags sowie dem Ausweis der Quellen, aus denen sich das Ergebnis zusammensetzt. Anders als die Bilanz, die als Zeitpunktrechnung nur den Vermögens- und Kapitalbestand zeigt, erklärt die GuV als Zeitraumrechnung, wie sich das Eigenkapital durch die laufende Geschäftstätigkeit verändert hat." },
      { id: "q2", question: "Welche Aussage zur GuV trifft zu?", options: ["Sie ist ein eigenständiger Bestandteil des Lageberichts","Sie ist genau wie die Bilanz eine reine Zeitpunktrechnung","Sie ist ausschließlich eine Finanzplanungsrechnung","Sie ist eine Zeitraumrechnung: Erträge ./. Aufwendungen"], correctIndex: 3, explanation: "Während die Bilanz eine Zeitpunktrechnung ist und den Vermögens- und Kapitalbestand zu einem Stichtag zeigt, ist die GuV eine Zeitraumrechnung: Sie stellt Erträge und Aufwendungen eines Geschäftsjahres gegenüber. Sie ist weder Teil des Lageberichts noch eine reine Finanzplanungsrechnung." },
      { id: "q3", question: "Für welche Rechtsform gilt nach § 242 Abs. 2 HGB nur die einfache Pflicht zur Gegenüberstellung von Aufwendungen und Erträgen, ohne weitere Gliederungsvorschrift?", options: ["Börsennotierte Aktiengesellschaften","Personengesellschaften ohne PublG-Pflicht","Konzerne mit ausländischen Tochtergesellschaften","Ausnahmslos alle großen Kapitalgesellschaften"], correctIndex: 1, explanation: "§ 242 Abs. 2 HGB verlangt vom Kaufmann für den Schluss jedes Geschäftsjahres lediglich eine Gegenüberstellung der Aufwendungen und Erträge. Darüber hinausgehende Gliederungs- oder Ansatzvorschriften bestehen nur für Personengesellschaften ohne PublG-Pflicht nicht; Kapitalgesellschaften unterliegen dagegen den detaillierten Vorgaben der §§ 275 ff. HGB." },
      { id: "q4", question: "Wo sind die detaillierten GuV-Gliederungsvorschriften für Kapitalgesellschaften geregelt?", options: ["§§ 275 ff. HGB","§ 5 EStG","§ 266 HGB","§ 242 Abs. 2 HGB"], correctIndex: 0, explanation: "Während für Personengesellschaften ohne PublG-Pflicht nur die einfache Vorgabe des § 242 Abs. 2 HGB gilt, unterliegen Kapitalgesellschaften der detaillierten Regelung in §§ 275 ff. HGB, die Gliederung, Ausweis und Mindestinhalt der GuV genau vorschreiben. § 266 HGB betrifft dagegen die Bilanzgliederung, § 5 EStG die steuerliche Gewinnermittlung." },
      { id: "yn1", type: "yesno", question: "Dürfen Kapitalgesellschaften ihre GuV wahlweise in Kontoform aufstellen?", correctAnswer: false, reasons: ["Ja, weil das HGB beide Formen für Kapitalgesellschaften gleichberechtigt zur Wahl stellt.", "Nein, weil die Kontoform seit dem BilMoG vollständig aus dem HGB gestrichen wurde.", "Ja, weil nur Personengesellschaften an die Staffelform gebunden sind.", "Nein, weil für Kapitalgesellschaften die Staffelform wegen der größeren Transparenz zwingend vorgeschrieben ist."], correctReasonIndex: 3, explanation: "Für Kapitalgesellschaften ist wegen der größeren Transparenz zwingend die Staffelform vorgeschrieben (§ 275 HGB); die Kontoform ist ihnen nicht erlaubt, auch wenn sie als Darstellungsform grundsätzlich weiterhin existiert." },
      { id: "q5", question: "Welche Ausweisform der GuV ist für Kapitalgesellschaften zwingend vorgeschrieben?", options: ["Freie Form nach Wahl der Geschäftsleitung","Staffelform (Berichtsform)","Kontoform","Tabellenform nach IFRS"], correctIndex: 1, explanation: "Die Staffelform (Berichtsform) ist eine einspaltige, listenförmige Darstellung, bei der Erträge und Aufwendungen fortlaufend zu Zwischenergebnissen saldiert werden. Sie ist für Kapitalgesellschaften wegen der dadurch erreichten größeren Transparenz zwingend vorgeschrieben — anders als die traditionelle, zweiseitige Kontoform oder eine freie Formwahl." },
      { id: "q6", question: "Was besagt das Bruttoprinzip nach § 246 Abs. 2 Satz 1 HGB?", options: ["Grundsätzlich keine Saldierung von Erträgen und Aufwendungen","Nur Bruttogewinne dürfen ausgeschüttet werden","Es betrifft ausschließlich die Bewertung des Anlagevermögens","Alle Beträge sind zwingend inklusive Umsatzsteuer auszuweisen"], correctIndex: 0, explanation: "Nach § 246 Abs. 2 Satz 1 HGB gilt grundsätzlich das Bruttoprinzip: Erträge und Aufwendungen dürfen nicht miteinander saldiert werden, da eine Nettorechnung das wahre Erfolgsbild verdecken würde. Es betrifft weder speziell das Anlagevermögen noch die Umsatzsteuer oder die Ausschüttungsfähigkeit von Gewinnen." },
      { id: "q7", question: "In welchem Fall lässt das HGB seit dem BilMoG (2010) eine Saldierungspflicht zu?", options: ["Bei Vermögensgegenständen zur Erfüllung von Altersversorgungsschulden","Bei sämtlichen Umsatzerlösen ohne jede Ausnahme","Bei ausnahmslos allen Finanzanlagen des Unternehmens","Nur bei außerplanmäßigen Abschreibungen auf Sachanlagen"], correctIndex: 0, explanation: "Seit der BilMoG-Reform (2010) besteht gem. § 246 Abs. 2 Satz 2 HGB in wenigen Fällen sogar eine Saldierungspflicht, insbesondere bei Vermögensgegenständen (z. B. Wertpapieren), die ausschließlich der Erfüllung von Schulden aus Altersversorgungsverpflichtungen dienen — nicht bei Umsatzerlösen, Finanzanlagen allgemein oder Abschreibungen." },
      { id: "q8", question: "Was unterscheidet das Gesamtkostenverfahren (GKV) grundsätzlich vom Umsatzkostenverfahren (UKV)?", options: ["GKV und UKV führen stets zu unterschiedlichen Jahresüberschüssen","Das UKV berücksichtigt grundsätzlich keine Umsatzerlöse","Das UKV ist ausschließlich für Personengesellschaften zulässig","Das GKV gliedert nach Aufwandsarten, das UKV nach Funktionsbereichen"], correctIndex: 3, explanation: "Das GKV stellt Aufwendungen nach Aufwandsarten dar (z. B. Material-, Personalaufwand) und berücksichtigt Bestandsveränderungen explizit; das UKV gliedert die Aufwendungen dagegen nach betrieblichen Funktionsbereichen (Herstellung, Vertrieb, Verwaltung). Beide Verfahren sind nach § 275 Abs. 1 HGB zulässig und führen stets zum gleichen Jahresüberschuss." },
      { id: "q9", question: "Wie ist die GuV bei kleinen und mittelgroßen Kapitalgesellschaften grundsätzlich zu gliedern?", options: ["Nach GKV oder UKV, ggf. mit gekürztem Schema","Ausschließlich nach den internationalen IFRS-Vorschriften","Völlig frei nach den GoB, ohne jedes feste Schema","Ausschließlich in der traditionellen Kontoform"], correctIndex: 0, explanation: "(Kleinst-,) kleine und mittelgroße Kapitalgesellschaften dürfen nach § 275 i. V. m. § 276 HGB das GKV oder UKV anwenden, wobei ein (stark) gekürztes Schema zulässig ist. Weder eine völlig freie GoB-Gestaltung noch IFRS noch die zwingende Kontoform treffen für diese Größenklasse zu." },
      { id: "q10", question: "Welche Rechtsgrundlage regelt die GuV für Personengesellschaften/Einzelunternehmen, die dem Publizitätsgesetz (PublG) unterliegen?", options: ["§ 242 Abs. 2 HGB ohne weitere Vorgaben","Ausschließlich das Aktiengesetz","§ 320 HGB","§ 275 HGB i. V. m. § 5 Abs. 1 PublG"], correctIndex: 3, explanation: "Personengesellschaften/Einzelunternehmen, die dem PublG unterliegen, müssen die GuV abweichend von der einfachen Vorgabe des § 242 Abs. 2 HGB nach § 275 HGB i. V. m. § 5 Abs. 1 PublG aufstellen (GKV oder UKV) — das Aktiengesetz und § 320 HGB sind hierfür nicht die maßgebliche Rechtsgrundlage." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Nach welcher HGB-Vorschrift ist die Gliederung des Gesamtkostenverfahrens (GKV) geregelt?", options: ["§ 266 HGB","§ 275 Abs. 2 HGB","§ 275 Abs. 3 HGB","§ 246 HGB"], correctIndex: 1, explanation: "§ 275 Abs. 2 HGB gibt das Schema für das Gesamtkostenverfahren vor, während § 275 Abs. 3 HGB das UKV-Schema regelt. § 266 HGB betrifft dagegen die Bilanzgliederung und § 246 HGB die allgemeinen Ansatzvorschriften — beide sind hier nicht einschlägig." },
      { id: "q2", question: "Nach welcher HGB-Vorschrift ist die Gliederung des Umsatzkostenverfahrens (UKV) geregelt?", options: ["§ 275 Abs. 2 HGB","§ 268 HGB","§ 275 Abs. 3 HGB","§ 276 HGB"], correctIndex: 2, explanation: "§ 275 Abs. 3 HGB gibt das Schema für das Umsatzkostenverfahren vor, während § 275 Abs. 2 HGB das GKV-Schema regelt. § 268 HGB betrifft die Ergebnisverwendung und § 276 HGB die größenabhängigen Erleichterungen — beide sind hier nicht einschlägig." },
      { id: "q3", question: "Welcher Zwischensaldo markiert im GKV- wie im UKV-Schema den Übergang vom operativen zum finanzwirtschaftlichen Bereich?", options: ["Betriebsergebnis","Jahresüberschuss","Rohergebnis","Gesamtleistung"], correctIndex: 0, explanation: "Beide Schemata unterscheiden sich nur im operativen Teil (bis zum Betriebsergebnis); der anschließende Teil (Finanzergebnis, Steuern, Jahresüberschuss) ist bei beiden Verfahren identisch aufgebaut. Das Betriebsergebnis ist damit der letzte rein operative Zwischensaldo, bevor das Finanzergebnis hinzukommt." },
      { id: "q4", question: "Wie heißt der erste Zwischensaldo im UKV nach Abzug der Herstellungskosten der zur Erzielung der Umsatzerlöse erbrachten Leistungen?", options: ["Bruttoergebnis vom Umsatz","Gesamtleistung","Betriebsergebnis","Rohergebnis"], correctIndex: 0, explanation: "Umsatzerlöse abzüglich Herstellungskosten der Umsatzerlöse ergeben im UKV das Bruttoergebnis vom Umsatz." },
      { id: "q5", question: "Was folgt im GKV- wie im UKV-Schema unmittelbar nach dem Betriebsergebnis?", options: ["Sonstige Steuern","Finanzergebnis (u. a. Beteiligungserträge, Zinserträge und -aufwendungen)","Materialaufwand","Steuern vom Einkommen und Ertrag"], correctIndex: 1, explanation: "Nach dem Betriebsergebnis folgt in beiden Schemata zunächst das Finanzergebnis, bevor die Steuern abgezogen werden." },
      { id: "q6", question: "Wie ermittelt sich das Rohergebnis nach § 276 HGB im GKV-Schema?", options: ["Umsatzerlöse abzüglich Personalaufwand","Betriebsergebnis abzüglich Finanzergebnis","Gesamtleistung abzüglich Materialaufwand","Jahresüberschuss abzüglich Steuern"], correctIndex: 2, explanation: "Das Rohergebnis ergibt sich aus der Gesamtleistung (Umsatzerlöse, Bestandsveränderungen, aktivierte Eigenleistungen, sonstige betriebliche Erträge) abzüglich des Materialaufwands." },
      { id: "q7", question: "Welches ist ein zentraler Vorteil des GKV gegenüber dem UKV?", options: ["Verzicht auf jede Form der Erfolgsspaltung","Direkte Übernahme der Aufwendungen aus der Finanzbuchhaltung und direkter Ausweis von Bestandsveränderungen","Zusätzliche Anhangangabe zu Material- und Personalaufwand","Bessere internationale Akzeptanz"], correctIndex: 1, explanation: "Das GKV lässt sich Aufwendungen direkt aus der Finanzbuchhaltung übernehmen und weist Bestandsveränderungen unmittelbar aus." },
      { id: "yn1", type: "yesno", question: "Führen das Gesamtkostenverfahren und das Umsatzkostenverfahren stets zu unterschiedlichen Jahresüberschüssen?", correctAnswer: false, reasons: ["Nein, weil beide Verfahren nur unterschiedliche Gliederungslogiken für denselben operativen Erfolg darstellen.","Ja, weil das GKV Bestandsveränderungen einbezieht, das UKV aber nicht.","Ja, weil das UKV zusätzliche Erträge aus Beteiligungen berücksichtigt.","Nein, weil beide Verfahren identische Gliederungsvorschriften ohne jeden Unterschied verwenden."], correctReasonIndex: 0, explanation: "GKV und UKV unterscheiden sich nur im operativen Gliederungsschema (Aufwandsarten vs. Funktionsbereiche) und führen laut Text stets zum gleichen Jahresüberschuss." },
      { id: "q8", question: "Welches ist ein zentraler Vorteil des UKV gegenüber dem GKV?", options: ["Explizite Berücksichtigung von Bestandsveränderungen als eigener Posten","Vollständiger Verzicht auf jede Gliederung der Aufwendungen","Direkte Übernahme der Aufwendungen aus der Finanzbuchhaltung","Bessere internationale Akzeptanz sowie zusätzliche Anhangangaben zu Material- und Personalaufwand gem. § 285 Nr. 8 HGB"], correctIndex: 3, explanation: "Das UKV wird international besser akzeptiert und verlangt zusätzlich Anhangangaben zu Material- und Personalaufwand nach § 285 Nr. 8 HGB." },
      { id: "q9", question: "Wie werden die Aufwendungen im UKV gegliedert?", options: ["Nach Aufwandsarten wie Material- und Personalaufwand","Nach betrieblichen Funktionsbereichen wie Herstellung, Vertrieb und Verwaltung","Ausschließlich nach Kostenstellen der Verwaltung","Es erfolgt gar keine Gliederung der Aufwendungen"], correctIndex: 1, explanation: "Kennzeichnend für das UKV ist die Gliederung der Aufwendungen nach Funktionsbereichen statt nach Aufwandsarten." },
      { id: "q10", question: "Welche Aussage zum Verhältnis von GKV und UKV ist richtig?", options: ["Beide führen stets zum gleichen Jahresüberschuss, unterscheiden sich aber in der Gliederungslogik","Eine rechnerische Überleitung zwischen beiden Verfahren ist nicht möglich","Das GKV führt regelmäßig zu einem höheren Jahresüberschuss als das UKV","Das UKV ist nur für Personengesellschaften zulässig"], correctIndex: 0, explanation: "GKV und UKV sind lediglich zwei unterschiedliche Gliederungslogiken für denselben Sachverhalt und führen deshalb stets zum identischen Jahresüberschuss; eine Überleitung ist rechnerisch möglich." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Was versteht man unter dem 'Jahresüberschuss'?", options: ["Der im Anhang ausgewiesene Buchwert des Anlagevermögens","Der Bestand an liquiden Mitteln am Bilanzstichtag","Die Summe aller Umsatzerlöse eines Geschäftsjahres","Der positive Saldo der GuV einer Periode — die Erträge übersteigen die Aufwendungen"], correctIndex: 3, explanation: "Der Jahresüberschuss ist der positive Saldo der GuV, wenn die Erträge einer Periode die Aufwendungen übersteigen." },
      { id: "q2", question: "Wie wird der Endbetrag der GuV genannt, wenn die Aufwendungen die Erträge einer Periode übersteigen?", options: ["Bilanzgewinn","Jahresfehlbetrag","Rohergebnis","Jahresüberschuss"], correctIndex: 1, explanation: "Übersteigen die Aufwendungen die Erträge, liegt ein Jahresfehlbetrag vor." },
      { id: "yn1", type: "yesno", question: "Ist der in der GuV ermittelte Jahresüberschuss automatisch identisch mit dem tatsächlich ausschüttungsfähigen Bilanzgewinn?", correctAnswer: false, reasons: ["Ja, weil der Jahresüberschuss laut § 268 Abs. 1 HGB direkt als Dividende auszuzahlen ist.", "Nein, weil der Jahresüberschuss stets niedriger als der Bilanzgewinn ausfällt.", "Nein, weil der Bilanzgewinn erst durch Gewinnvortrag und Rücklagenbewegungen aus dem Jahresüberschuss abgeleitet wird.", "Ja, weil Rücklagenbewegungen erst nach der Ausschüttung berücksichtigt werden."], correctReasonIndex: 2, explanation: "Erst durch Hinzurechnen bzw. Abziehen von Gewinn-/Verlustvortrag sowie Rücklagenbewegungen entsteht aus dem Jahresüberschuss der Bilanzgewinn (§ 268 Abs. 1 HGB), über dessen Verwendung dann gesondert entschieden wird." },
      { id: "q3", question: "Wie ermittelt sich der Bilanzgewinn bzw. Bilanzverlust nach § 268 Abs. 1 HGB?", options: ["Ausschließlich aus den Umsatzerlösen des laufenden Jahres","Ausschließlich aus dem Rohergebnis der GuV","Aus der Bilanzsumme abzüglich des gesamten Eigenkapitals","Jahresüberschuss/-fehlbetrag zzgl./abzgl. Gewinn-/Verlustvortrag sowie Rücklagenbewegungen"], correctIndex: 3, explanation: "Der Bilanzgewinn ergibt sich aus dem Jahresüberschuss zzgl./abzgl. Gewinn-/Verlustvortrag und Entnahmen aus bzw. Einstellungen in Rücklagen." },
      { id: "q4", question: "Wer entscheidet typischerweise über die Verwendung des Bilanzgewinns einer Aktiengesellschaft (z. B. Höhe der Dividende)?", options: ["Der Abschlussprüfer","Ausschließlich der Vorstand ohne weitere Mitwirkung","Die Hauptversammlung","Das Finanzamt"], correctIndex: 2, explanation: "Über die Verwendung des Bilanzgewinns entscheidet bei der AG die Hauptversammlung." },
      { id: "q5", question: "Wie unterscheidet sich der Begriff 'Aufwand' vom Begriff 'Kosten'?", options: ["Kosten sind ausschließlich ein steuerrechtlicher Begriff ohne Bezug zur GuV","Beide Begriffe sind vollständig identisch und beliebig austauschbar","Aufwand erfasst jeden handelsrechtlichen Werteverzehr der Periode, Kosten dagegen nur den betriebsbedingten, sachzielbezogenen Werteverzehr","Aufwand kommt nur in der Kosten- und Leistungsrechnung vor"], correctIndex: 2, explanation: "Aufwand ist der gesamte handelsrechtliche Werteverzehr, Kosten sind ein enger gefasster, kalkulatorischer Begriff der KLR." },
      { id: "q6", question: "Welche Steuer zählt zu den 'Steuern vom Einkommen'?", options: ["Grundsteuer","Körperschaftsteuer bzw. Einkommensteuer","Gewerbesteuer","Kraftfahrzeugsteuer"], correctIndex: 1, explanation: "Körperschaftsteuer (bei Kapitalgesellschaften) bzw. Einkommensteuer (bei Personenunternehmen) sind Steuern vom Einkommen." },
      { id: "q7", question: "Welche Steuer zählt zu den 'Steuern vom Ertrag'?", options: ["Umsatzsteuer","Einkommensteuer","Gewerbesteuer","Körperschaftsteuer"], correctIndex: 2, explanation: "Die Gewerbesteuer knüpft an den Gewerbeertrag an und zählt zu den Steuern vom Ertrag." },
      { id: "q8", question: "Unter welchem GuV-Posten werden ergebnisunabhängige Steuern wie die Grundsteuer erfasst?", options: ["Sonstige Steuern","Materialaufwand","Ausschließlich unter sonstige betriebliche Aufwendungen","Steuern vom Einkommen und vom Ertrag"], correctIndex: 0, explanation: "Ergebnisunabhängige Steuern wie Grundsteuer oder Kfz-Steuer werden gesondert unter 'sonstige Steuern' ausgewiesen." },
      { id: "q9", question: "Was ist der Zweck des GuV-Postens 'andere aktivierte Eigenleistungen'?", options: ["Erfassung von Erträgen aus dem Verkauf von Beteiligungen","Neutralisierung des bereits erfassten Aufwands für selbst erstellte, aktivierte Vermögensgegenstände des Anlagevermögens","Ausweis von Zinserträgen aus Bankguthaben","Ausweis von Umsatzerlösen aus Fremdaufträgen"], correctIndex: 1, explanation: "Der Posten gleicht den bereits als Aufwand erfassten Werteverzehr für selbst erstellte, aktivierungsfähige Vermögensgegenstände aus." },
      { id: "q10", question: "Was zählt gemäß § 277 Abs. 1 HGB zu den Umsatzerlösen?", options: ["Nur Erträge aus Finanzanlagen","Erlöse aus Verkauf, Vermietung/Verpachtung von Produkten und aus Dienstleistungen, die für die gewöhnliche Geschäftstätigkeit typisch sind","Ausschließlich Erträge aus dem Verkauf von Anlagevermögen","Sämtliche Erträge eines Geschäftsjahres ohne Ausnahme"], correctIndex: 1, explanation: "Umsatzerlöse umfassen nach § 277 Abs. 1 HGB Erlöse aus der für die gewöhnliche Geschäftstätigkeit typischen Absatztätigkeit, abzüglich Erlösschmälerungen und USt." }
    ]
  }
];
