const BILANZIERUNG_CHAPTER8_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Was ist der Zweck der Gewinn- und Verlustrechnung?", options: ["Feststellung des aktuellen Marktwerts des Unternehmens","Ermittlung von Jahresüberschuss/-fehlbetrag und Ausweis der Ergebnisquellen","Ermittlung des Vermögens- und Kapitalbestands zu einem Stichtag","Berechnung der Umsatzsteuerschuld eines Geschäftsjahres"], correctIndex: 1, explanation: "Die GuV dient der Ermittlung von Jahresüberschuss bzw. -fehlbetrag sowie dem Ausweis der Quellen der erzielten Ergebnisse." },
      { id: "q2", question: "Welche Aussage zur GuV trifft zu?", options: ["Sie ist ein Bestandteil des Lageberichts","Sie ist wie die Bilanz eine Zeitpunktrechnung","Sie ist ausschließlich eine Finanzplanungsrechnung","Sie ist eine Zeitraumrechnung: Erträge ./. Aufwendungen einer Periode"], correctIndex: 3, explanation: "Die GuV stellt als Zeitraumrechnung die Erträge und Aufwendungen eines Geschäftsjahres gegenüber, im Gegensatz zur Bilanz als Zeitpunktrechnung." },
      { id: "q3", question: "Für welche Rechtsform gilt nach § 242 Abs. 2 HGB nur die einfache Pflicht zur Gegenüberstellung von Aufwendungen und Erträgen, ohne weitere Gliederungsvorschrift?", options: ["Börsennotierte Aktiengesellschaften","Personengesellschaften (inkl. Einzelunternehmen) ohne PublG-Pflicht","Konzerne mit ausländischen Tochtergesellschaften","Große Kapitalgesellschaften"], correctIndex: 1, explanation: "§ 242 Abs. 2 HGB verlangt vom Kaufmann nur eine Gegenüberstellung der Aufwendungen und Erträge; darüber hinausgehende Vorschriften bestehen für Personengesellschaften ohne PublG-Pflicht nicht." },
      { id: "q4", question: "Wo sind die detaillierten GuV-Gliederungsvorschriften für Kapitalgesellschaften geregelt?", options: ["§§ 275 ff. HGB","§ 5 EStG","§ 266 HGB","§ 242 Abs. 2 HGB"], correctIndex: 0, explanation: "Für Kapitalgesellschaften enthalten §§ 275 ff. HGB die detaillierten Regelungen zur Gliederung der GuV." },
      { id: "q5", question: "Welche Ausweisform der GuV ist für Kapitalgesellschaften zwingend vorgeschrieben?", options: ["Freie Form nach Wahl der Geschäftsleitung","Staffelform (Berichtsform)","Kontoform","Tabellenform nach IFRS"], correctIndex: 1, explanation: "Die Staffelform ist für Kapitalgesellschaften wegen der größeren Transparenz zwingend vorgeschrieben." },
      { id: "q6", question: "Was besagt das Bruttoprinzip nach § 246 Abs. 2 Satz 1 HGB?", options: ["Grundsätzlich keine Saldierung von Erträgen und Aufwendungen","Nur Bruttogewinne dürfen ausgeschüttet werden","Es betrifft ausschließlich die Bewertung des Anlagevermögens","Alle Beträge sind zwingend inklusive Umsatzsteuer auszuweisen"], correctIndex: 0, explanation: "Das Bruttoprinzip verbietet grundsätzlich die Verrechnung (Saldierung) von Erträgen und Aufwendungen." },
      { id: "q7", question: "In welchem Fall lässt das HGB seit dem BilMoG (2010) eine Saldierungspflicht zu?", options: ["Bei Vermögensgegenständen, die ausschließlich der Erfüllung von Schulden aus Altersversorgungsverpflichtungen dienen","Bei sämtlichen Umsatzerlösen ohne Ausnahme","Bei allen Finanzanlagen ohne Ausnahme","Nur bei außerplanmäßigen Abschreibungen auf Sachanlagen"], correctIndex: 0, explanation: "§ 246 Abs. 2 Satz 2 HGB sieht eine Saldierungspflicht insbesondere bei Wertpapieren vor, die ausschließlich Altersversorgungsverpflichtungen absichern." },
      { id: "q8", question: "Was unterscheidet das Gesamtkostenverfahren (GKV) grundsätzlich vom Umsatzkostenverfahren (UKV)?", options: ["GKV und UKV führen stets zu unterschiedlichen Jahresüberschüssen","Das UKV berücksichtigt keine Umsatzerlöse","Das UKV ist nur für Personengesellschaften zulässig","Das GKV gliedert nach Aufwandsarten inkl. Bestandsveränderungen, das UKV nach Funktionsbereichen"], correctIndex: 3, explanation: "GKV gliedert die Aufwendungen nach Arten und berücksichtigt Bestandsveränderungen explizit; UKV gliedert nach Funktionsbereichen (Herstellung, Vertrieb, Verwaltung)." },
      { id: "q9", question: "Wie ist die GuV bei kleinen und mittelgroßen Kapitalgesellschaften grundsätzlich zu gliedern?", options: ["Nach GKV oder UKV, ggf. mit gekürztem Schema gem. § 275 i. V. m. § 276 HGB","Ausschließlich nach IFRS-Vorschriften","Völlig frei nach GoB, ohne festes Schema","Ausschließlich in Kontoform"], correctIndex: 0, explanation: "Kleine und mittelgroße Kapitalgesellschaften dürfen GKV oder UKV mit einem (stark) gekürzten Schema nach § 275 i. V. m. § 276 HGB anwenden." },
      { id: "q10", question: "Welche Rechtsgrundlage regelt die GuV für Personengesellschaften/Einzelunternehmen, die dem Publizitätsgesetz (PublG) unterliegen?", options: ["§ 242 Abs. 2 HGB ohne weitere Vorgaben","Ausschließlich das Aktiengesetz","§ 320 HGB","§ 275 HGB i. V. m. § 5 Abs. 1 PublG"], correctIndex: 3, explanation: "Personengesellschaften/Einzelunternehmen, die dem PublG unterliegen, müssen die GuV nach § 275 HGB i. V. m. § 5 Abs. 1 PublG (GKV oder UKV) aufstellen." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Nach welcher HGB-Vorschrift ist die Gliederung des Gesamtkostenverfahrens (GKV) geregelt?", options: ["§ 266 HGB","§ 275 Abs. 2 HGB","§ 275 Abs. 3 HGB","§ 246 HGB"], correctIndex: 1, explanation: "Das GKV-Schema ist in § 275 Abs. 2 HGB geregelt." },
      { id: "q2", question: "Nach welcher HGB-Vorschrift ist die Gliederung des Umsatzkostenverfahrens (UKV) geregelt?", options: ["§ 275 Abs. 2 HGB","§ 268 HGB","§ 275 Abs. 3 HGB","§ 276 HGB"], correctIndex: 2, explanation: "Das UKV-Schema ist in § 275 Abs. 3 HGB geregelt." },
      { id: "q3", question: "Welcher Zwischensaldo markiert im GKV- wie im UKV-Schema den Übergang vom operativen zum finanzwirtschaftlichen Bereich?", options: ["Betriebsergebnis","Jahresüberschuss","Rohergebnis","Gesamtleistung"], correctIndex: 0, explanation: "Das Betriebsergebnis ist bei beiden Verfahren der letzte rein operative Zwischensaldo, bevor das Finanzergebnis hinzukommt." },
