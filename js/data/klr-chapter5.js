const KLR_CHAPTER5_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Reicht bei genau einem bindenden Engpass der absolute Stück-Deckungsbeitrag aus, um das optimale Produktionsprogramm zu bestimmen?", correctAnswer: false, reasons: ["Ja, weil das Produkt mit dem höchsten absoluten Deckungsbeitrag immer den größten Gesamtgewinn liefert.", "Nein, weil der absolute Deckungsbeitrag nicht berücksichtigt, wie viel vom knappen Faktor je Stück verbraucht wird.", "Ja, weil der Engpassfaktor im Stück-Deckungsbeitrag bereits automatisch enthalten ist.", "Nein, weil bei einem Engpass grundsätzlich nur der Verkaufspreis entscheidet."], correctReasonIndex: 1, explanation: "Bei einem Engpass ist der relative Deckungsbeitrag (Stück-db geteilt durch Faktorverbrauch) entscheidend, weil er den Verbrauch der knappen Ressource berücksichtigt - der absolute db allein sagt darüber nichts aus." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Rechtfertigt ein negativer DB II allein bereits automatisch die Elimination eines Produkts?", correctAnswer: false, reasons: ["Ja, weil DB II bereits alle relevanten Fixkosten des Produkts vollständig berücksichtigt.", "Nein, weil ein Teil der zugehörigen Produktfixkosten nicht abbaubare Sunk Costs sein können, die auch nach Elimination weiter anfallen.", "Ja, weil DB I bei negativem DB II zwangsläufig ebenfalls negativ ist.", "Nein, weil DB II ausschließlich auf Unternehmensebene berechnet wird."], correctReasonIndex: 1, explanation: "Sind Teile der Produktfixkosten nicht abbaubare Sunk Costs (z. B. wertlose Spezialabschreibungen), ist die tatsächliche Einsparung bei Elimination geringer als der ausgewiesene Fixkostenbetrag - ein negativer DB II rechtfertigt die Elimination daher nicht automatisch." },
  ...
  },
  {
    ...
    quiz: [
      { id: "yn1", type: "yesno", question: "Steigt die Break-even-Menge, wenn der Verkaufspreis sinkt und alle anderen Größen unverändert bleiben?", correctAnswer: true, reasons: ["Ja, weil ein sinkender Preis den Stück-Deckungsbeitrag verkleinert und damit eine größere Menge zur Fixkostendeckung nötig wird.", "Nein, weil die Break-even-Menge ausschließlich von den Fixkosten abhängt.", "Ja, weil sinkende Preise automatisch auch die Fixkosten erhöhen.", "Nein, weil ein sinkender Preis den Deckungsbeitrag vergrößert."], correctReasonIndex: 0, explanation: "Die Break-even-Menge ergibt sich als Fixkosten geteilt durch den Stück-Deckungsbeitrag; sinkt der Preis, sinkt der Deckungsbeitrag (Nenner), sodass eine größere Menge nötig wird, um dieselben Fixkosten zu decken." },
