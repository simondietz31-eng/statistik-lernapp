const KLR_CHAPTER5_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Wie berechnet sich der Deckungsbeitrag je Stück?", options: ["Verkaufspreis je Stück minus variable Stückkosten", "Variable Stückkosten minus Fixkosten je Stück", "Verkaufspreis je Stück minus Gesamtkosten je Stück", "Fixkosten geteilt durch die Absatzmenge"], correctIndex: 0, explanation: "Der Stück-Deckungsbeitrag ergibt sich als Verkaufspreis je Stück minus variable Stückkosten je Stück." },
      { id: "q2", question: "Warum reicht der absolute Stück-Deckungsbeitrag bei einem Engpass als Entscheidungskriterium nicht mehr aus?", options: ["Weil er nur bei einem einzigen Produkt berechnet werden kann", "Weil Fixkosten dabei doppelt gezählt werden", "Weil er nichts darüber aussagt, wie viel vom knappen Faktor je Stück verbraucht wird", "Weil er immer negativ ist"], correctIndex: 2, explanation: "Der absolute db berücksichtigt nicht den Verbrauch des knappen Faktors je Stück, weshalb bei einem Engpass der relative Deckungsbeitrag (db je Einheit des Engpassfaktors) entscheidend ist." },
      { id: "q3", question: "Wie wird der relative Deckungsbeitrag je Einheit des Engpassfaktors berechnet?", options: ["Fixkosten geteilt durch die Anzahl der Produkte", "Variable Stückkosten mal Absatzmenge", "Verkaufspreis geteilt durch die Absatzobergrenze", "Stück-Deckungsbeitrag geteilt durch den Produktionskoeffizienten (Faktorverbrauch je Stück)"], correctIndex: 3, explanation: "Der relative Deckungsbeitrag ergibt sich aus dem Stück-Deckungsbeitrag geteilt durch den Verbrauch des Engpassfaktors je Stück." },
      { id: "q4", question: "Was geschieht mit Produkten, deren Stück-Deckungsbeitrag negativ ist?", options: ["Sie erhalten automatisch Vorrang in der Rangfolge", "Sie werden unabhängig vom Engpass von vornherein ausgeschlossen", "Sie werden nur produziert, wenn kein Engpass besteht", "Sie werden gleichmäßig auf alle Engpässe verteilt"], correctIndex: 1, explanation: "Produkte mit negativem db decken nicht einmal ihre eigenen variablen Kosten und werden deshalb grundsätzlich ausgeschlossen." },
      { id: "q5", question: "Wie prüft man, ob ein potenzieller Engpassfaktor tatsächlich bindend ist?", options: ["Man prüft, ob die Fixkosten gedeckt sind", "Man vergleicht den Bedarf bei voller Absatzmenge der verbleibenden Produkte mit der verfügbaren Kapazität", "Man betrachtet nur das Produkt mit dem höchsten absoluten Deckungsbeitrag", "Man addiert einfach alle Verkaufspreise"], correctIndex: 1, explanation: "Ein Faktor ist nur dann tatsächlich ein Engpass, wenn der Bedarf bei voller Absatzmenge der verbleibenden Produkte die verfügbare Kapazität übersteigt." },
      { id: "q6", question: "Wie geht man bei genau einem bindenden Engpass vor, um das optimale Produktionsprogramm zu bestimmen?", options: ["Die Produkte in alphabetischer Reihenfolge einplanen", "Alle Produkte gleichmäßig auf die Kapazität verteilen", "Produkte nach fallendem relativem Deckungsbeitrag ordnen und der Reihe nach bis zur Absatzobergrenze einplanen, bis der Engpass ausgeschöpft ist", "Nur das Produkt mit dem höchsten Verkaufspreis produzieren"], correctIndex: 2, explanation: "Das Rangfolgeverfahren ordnet die Produkte nach fallendem relativem Deckungsbeitrag und plant sie bis zur jeweiligen Absatzobergrenze ein, bis die Engpasskapazität erschöpft ist." },
      { id: "q7", question: "Was versteht man unter dem \"Grenzprodukt\"?", options: ["Das letzte in der Rangfolge eingeplante Produkt, das oft nur teilweise produziert wird", "Das Produkt mit dem niedrigsten Verkaufspreis", "Das Produkt mit den höchsten Fixkosten", "Das Produkt, das immer ausgeschlossen wird"], correctIndex: 0, explanation: "Das Grenzprodukt ist das zuletzt eingeplante Produkt in der Rangfolge; bei ihm ist der Engpass meist bereits während der Einplanung erschöpft, sodass es nur teilweise produziert wird." },
      { id: "q8", question: "Woraus setzen sich die wertmäßigen Kosten eines Engpassfaktors zusammen?", options: ["Ausschließlich aus dem Marktpreis des Faktors", "Ausschließlich aus den Fixkosten des Unternehmens", "Aus der Summe aller Stück-Deckungsbeiträge", "Aus Grenzausgabe (Marktpreis) und Grenzgewinn (entgangener relativer Deckungsbeitrag des Grenzprodukts)"], correctIndex: 3, explanation: "Die wertmäßigen Kosten bestehen aus der Grenzausgabe (Marktpreis) zuzüglich des Grenzgewinns, also der Opportunitätskosten in Höhe des entgangenen relativen Deckungsbeitrags des Grenzprodukts." },
      { id: "q9", question: "Was zeigt der Grenzgewinn im Konzept der wertmäßigen Kosten?", options: ["Den Anteil der Fixkosten am Umsatz", "Den Gesamtgewinn des Unternehmens", "Den entgangenen relativen Deckungsbeitrag des Grenzprodukts, also die Opportunitätskosten des Engpasses", "Die Differenz zwischen Ist- und Sollkosten"], correctIndex: 2, explanation: "Der Grenzgewinn entspricht den Opportunitätskosten des Engpasses: dem Deckungsbeitrag, der entgeht, weil wegen der Knappheit nicht mehr vom Grenzprodukt produziert werden kann." },
      { id: "q10", question: "Was passiert mit den wertmäßigen Kosten, wenn nur der Marktpreis des Engpassfaktors steigt, sich Rangfolge und Grenzprodukt aber nicht ändern?", options: ["Sie sinken immer auf null", "Sie steigen um denselben Betrag wie der Marktpreis", "Sie sind davon grundsätzlich nicht berechenbar", "Sie bleiben oft unverändert, da Grenzausgabe und Grenzgewinn sich gegenläufig anpassen"], correctIndex: 3, explanation: "Steigt der Marktpreis, sinkt der relative Deckungsbeitrag (und damit der Grenzgewinn) aller Produkte um denselben Betrag je Faktoreinheit, sodass sich die Summe aus Grenzausgabe und Grenzgewinn oft nicht ändert." }
    ]
  },
  {
