const KLR_CHAPTER6_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Welche zwei Zwecke verfolgt die Plankostenrechnung?", options: ["Nur die Steuerbilanz", "Nur die Lagerbewertung", "Wirtschaftlichkeitskontrolle und Preisbildung/Kalkulation", "Nur die Wirtschaftlichkeitskontrolle"], correctIndex: 2, explanation: "Die Plankostenrechnung dient sowohl der Soll-Ist-Kontrolle als auch der Preisbildung über den Plan-Verrechnungssatz." },
      { id: "q2", question: "Wie berechnet sich der Plan-Verrechnungssatz?", options: ["Ist-Kosten / Ist-Beschäftigung", "Soll-Kosten / verrechnete Plankosten", "Fixkosten / variable Kosten", "Plankosten / Planbeschäftigung"], correctIndex: 3, explanation: "Der Plan-Verrechnungssatz ergibt sich aus den geplanten Kosten geteilt durch die Planbeschäftigung." },
      { id: "q3", question: "Was ist kennzeichnend für die starre Plankostenrechnung?", options: ["Es werden nur variable Kosten betrachtet", "Die Plankosten werden an die Ist-Beschäftigung angepasst", "Fixkosten werden separat ausgewiesen", "Die Plankosten werden nicht an die Ist-Beschäftigung angepasst"], correctIndex: 3, explanation: "Bei der starren Plankostenrechnung bleibt der ursprüngliche Planwert unverändert, egal wie hoch die Ist-Beschäftigung ist." },
      { id: "q4", question: "Warum ist die Gesamtabweichung der starren Plankostenrechnung zur Wirtschaftlichkeitskontrolle ungeeignet?", options: ["Weil sie nur für Dienstleistungsunternehmen gilt", "Weil sie ausschließlich Fixkosten enthält", "Weil sie Verbrauchs- und Beschäftigungsabweichung vermischt und Fixkosten nicht berücksichtigt", "Weil sie immer null ist"], correctIndex: 2, explanation: "Beschäftigungsbedingte Effekte auf die Fixkosten werden nicht von echten Wirtschaftlichkeitsabweichungen getrennt." },
      { id: "q5", question: "Wie lautet die Formel für die Soll-Kosten in der flexiblen Plankostenrechnung auf Vollkostenbasis?", options: ["Ist-Kosten × Beschäftigungsgrad", "Fixe Plankosten + variable Plankosten bei Ist-Beschäftigung", "Verrechnete Plankosten − Ist-Kosten", "Fixe Plankosten + variable Plankosten bei Planbeschäftigung"], correctIndex: 1, explanation: "Die Soll-Kosten passen die variablen Kosten an die tatsächliche Beschäftigung an, die Fixkosten bleiben unverändert." },
      { id: "q6", question: "Was zeigt die Verbrauchsabweichung (VA)?", options: ["Die tatsächliche Wirtschaftlichkeit unabhängig vom Beschäftigungsgrad", "Den Plan-Verrechnungssatz", "Die Kosten der Unter- oder Überbeschäftigung", "Die Differenz zwischen zwei Planjahren"], correctIndex: 0, explanation: "VA = Ist-Kosten − Soll-Kosten misst, wie wirtschaftlich bei der tatsächlichen Beschäftigung gearbeitet wurde." },
      { id: "q7", question: "Was zeigt die Beschäftigungsabweichung (BA)?", options: ["Den Lohnsatz der Mitarbeiter", "Die Kosten der Unter- bzw. Überbeschäftigung, insbesondere bei den Fixkosten", "Den Materialverbrauch", "Die reine Wirtschaftlichkeit der Fertigung"], correctIndex: 1, explanation: "BA = Soll-Kosten − verrechnete Plankosten = (1 − Ist-Beschäftigung/Planbeschäftigung) × Fixkosten." },
      { id: "q8", question: "Was gibt der Variator in der flexiblen Plankostenrechnung an?", options: ["Mit welchem Faktor bzw. zu wie viel Prozent sich eine Kostenart mit der Beschäftigung ändert", "Den Gesamtbetrag der Fixkosten", "Den Plan-Verrechnungssatz je Kostenstelle", "Die Höhe der Ist-Kosten"], correctIndex: 0, explanation: "Der Variator dient zur Aufspaltung der Kosten in einen fixen und einen variablen Anteil." },
      { id: "q9", question: "Was unterscheidet die Grenzplankostenrechnung von der flexiblen Plankostenrechnung auf Vollkostenbasis?", options: ["Sie verzichtet vollständig auf einen Plan-Verrechnungssatz", "Es gibt keine Soll-Ist-Vergleiche mehr", "Sie berücksichtigt nur die Planbeschäftigung", "Es werden nur variable Kosten verrechnet, Fixkosten werden separat ausgewiesen statt geschlüsselt"], correctIndex: 3, explanation: "Die Grenzplankostenrechnung vermeidet die oft willkürliche Schlüsselung der Fixkosten auf Kostenträger." },
      { id: "q10", question: "Eine Kostenstelle plant mit 1.000 Stück Planbeschäftigung, 10.000 € Fixkosten und einem Verrechnungssatz von 30 €/Stück. Die Ist-Beschäftigung beträgt 900 Stück. Wie hoch ist die Beschäftigungsabweichung?", options: ["1.000 €", "3.000 €", "900 €", "10.000 €"], correctIndex: 0, explanation: "BA = (1 − 900/1.000) × 10.000 € = 0,1 × 10.000 € = 1.000 €." }
    ]
  },
  {
