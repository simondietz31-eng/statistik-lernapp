const KLR_CHAPTER6_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist die Gesamtabweichung der starren Plankostenrechnung zur Wirtschaftlichkeitskontrolle gut geeignet?", correctAnswer: false, reasons: ["Ja, weil sie Verbrauchs- und Beschäftigungsabweichung exakt voneinander trennt.", "Nein, weil sie beschäftigungsbedingte Effekte auf die Fixkosten mit echten Wirtschaftlichkeitsabweichungen vermischt.", "Ja, weil sie ausschließlich den variablen Kostenanteil berücksichtigt.", "Nein, weil sie nur bei Überbeschäftigung überhaupt berechnet werden kann."], correctReasonIndex: 1, explanation: "Da die starre Plankostenrechnung die Plankosten nicht an die Ist-Beschäftigung anpasst, vermischt die Gesamtabweichung Beschäftigungsschwankungen mit echten Wirtschaftlichkeitsabweichungen und ist daher zur Kontrolle ungeeignet." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist die Materialverbrauchsabweichung typischerweise dem Einkauf zuzurechnen?", correctAnswer: false, reasons: ["Ja, weil der Einkauf über die Materialqualität entscheidet.", "Nein, weil sie i.d.R. der Fertigung zuzurechnen ist, da Mehrverbrauch meist durch Verschnitt, Ausschuss oder Qualitätsprobleme in der Produktion entsteht.", "Ja, weil sie zusammen mit der Preisabweichung immer denselben Verantwortungsbereich betrifft.", "Nein, weil sie der Personaleinsatzplanung zuzurechnen ist."], correctReasonIndex: 1, explanation: "Die Materialverbrauchsabweichung misst eine Mengenabweichung zum Standardpreis und ist i.d.R. der Fertigung zuzurechnen, während die Materialpreisabweichung dem Einkauf zugeordnet wird." },
