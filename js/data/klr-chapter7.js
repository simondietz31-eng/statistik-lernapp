const KLR_CHAPTER7_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Wird bei der FIFO-Methode der Endbestand zu den ältesten Einstandspreisen bewertet?", correctAnswer: false, reasons: ["Ja, weil FIFO die zuerst eingekauften Mengen im Lager belässt.", "Nein, weil bei FIFO die ältesten Mengen zuerst verbraucht werden und im Lager die jüngsten, zuletzt zugegangenen Mengen verbleiben.", "Ja, weil FIFO ausschließlich bei fallenden Preisen sinnvoll ist.", "Nein, weil der Endbestand bei FIFO immer zum Durchschnittspreis bewertet wird."], correctReasonIndex: 1, explanation: "FIFO unterstellt, dass die ältesten Mengen zuerst abgehen; im Lager bleiben deshalb gedanklich die zuletzt zugegangenen, jüngsten Mengen übrig, zu deren Preisen der Endbestand bewertet wird - nicht zu den ältesten Preisen." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Wird bei der kalkulatorischen Abschreibung im Maschinenstundensatz üblicherweise der aktuelle, oft niedrigere Wiederbeschaffungspreis angesetzt?", correctAnswer: false, reasons: ["Ja, weil dies den tatsächlichen Marktwert der Maschine am genauesten abbildet.", "Nein, weil i.d.R. die historischen Anschaffungskosten verwendet werden, um die Kapitalbindung nicht zu unterschätzen.", "Ja, weil der Wiederbeschaffungspreis gesetzlich vorgeschrieben ist.", "Nein, weil stattdessen immer der Restwert der Maschine angesetzt wird."], correctReasonIndex: 1, explanation: "In der Kostenrechnung werden für die kalkulatorische Abschreibung i.d.R. die historischen Anschaffungskosten verwendet, nicht der aktuelle, u. U. niedrigere Wiederbeschaffungspreis, um die tatsächliche Kapitalbindung nicht zu unterschätzen." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Wirkt sich starke Überbeschäftigung (Ist-Beschäftigung deutlich über Plan) typischerweise vorteilhaft auf die Beschäftigungsabweichung aus?", correctAnswer: true, reasons: ["Ja, weil bei Überbeschäftigung die verrechneten Plankosten stärker steigen als die Soll-Kosten und dadurch mehr Fixkosten gedeckt werden als geplant.", "Nein, weil die Beschäftigungsabweichung unabhängig vom Beschäftigungsgrad immer konstant bleibt.", "Ja, weil bei Überbeschäftigung automatisch weniger Fixkosten anfallen.", "Nein, weil Überbeschäftigung stets zu einer negativen Verbrauchsabweichung führt."], correctReasonIndex: 0, explanation: "Bei Überbeschäftigung wachsen die verrechneten Plankosten proportional zur Ist-Beschäftigung, während der Fixkostenanteil der Soll-Kosten konstant bleibt - dadurch wird die Beschäftigungsabweichung negativ, also vorteilhaft, weil mehr Fixkosten gedeckt werden als geplant." },
