const FINV_CHAPTER8_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Werden bei unterschiedlichen Zinssätzen in verschiedenen Jahren die einzelnen Jahreszinssätze einfach addiert, um den Endwert zu berechnen?", correctAnswer: false, reasons: ["Nein, weil man stattdessen die einzelnen Aufzinsungsfaktoren (1+i₁)·(1+i₂)·... multipliziert.", "Ja, weil sich Zinssätze über mehrere Perioden grundsätzlich addieren.", "Ja, weil nur so die tatsächliche Verzinsung jeder einzelnen Periode korrekt erfasst wird.", "Nein, weil in diesem Fall stets nur der höchste vorkommende Zinssatz verwendet wird."], correctReasonIndex: 0, explanation: "Bei unterschiedlichen Periodenzinssätzen wird jeder Zinssatz als eigener Aufzinsungsfaktor auf das bereits verzinste Kapital der Vorperiode angewendet, weshalb die Faktoren multipliziert werden: Kₙ = K₀·(1+i₁)·(1+i₂)·(1+i₃)·…" },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist der effektive Jahreszins bei unterjähriger Zinszuteilung (z. B. monatlich) stets höher als der nominale Jahreszins?", correctAnswer: true, reasons: ["Ja, weil die unterjährig gutgeschriebenen Zinsen innerhalb desselben Jahres bereits mitverzinst werden.", "Nein, weil Effektivzins und Nominalzins bei unterjähriger Zinszuteilung stets identisch sind.", "Nein, weil der Effektivzins ausschließlich von der Anzahl der Zinsperioden, nicht vom Zinseszinseffekt abhängt.", "Ja, weil bei unterjähriger Zinszuteilung grundsätzlich ein höherer Nominalzins vereinbart wird."], correctReasonIndex: 0, explanation: "Da bereits gutgeschriebene unterjährige Zinsen innerhalb desselben Jahres selbst wieder verzinst werden, liegt der effektive Jahreszins i_eff = (1+i_m)^m − 1 stets über dem nominalen Jahreszins i." },
