const FINV_CHAPTER2_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Gehört die Kapitalbeschaffung eines Unternehmens zur Controller-Rolle des CFO?", correctAnswer: false, reasons: ["Ja, weil der Controller für sämtliche Zahlungsvorgänge einschließlich der Kapitalbeschaffung zuständig ist.", "Nein, weil Kapitalbeschaffung und Kapitalanlage zur Treasurer-Rolle gehören, während der Controller Rechnungswesen und Planung verantwortet.", "Ja, weil Treasurer und Controller beim CFO stets identische Aufgaben ohne Abgrenzung wahrnehmen.", "Nein, weil Kapitalbeschaffung ausschließlich beim CEO und nicht beim CFO liegt."], correctReasonIndex: 1, explanation: "Der CFO nimmt zwei getrennte Rollen wahr: Als Treasurer steuert er Zahlungsvorgänge, Kapitalbeschaffung und Kapitalanlage, als Controller trägt er Rechnungswesenverantwortung, Informationsverarbeitung und Planungsverantwortung." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Verändert ein Aktivtausch die Bilanzsumme eines Unternehmens?", correctAnswer: false, reasons: ["Ja, weil beim Aktivtausch stets ein Aktiv- und ein Passivposten gleichzeitig steigen.", "Nein, weil beim Aktivtausch nur zwei Aktivposten gegenläufig um denselben Betrag verändert werden, die Bilanzsumme also gleich bleibt.", "Ja, weil jede Bilanzveränderung zwangsläufig zu einer Bilanzverlängerung führt.", "Nein, weil Aktivtausch nur bei Kreditrückzahlungen aus der Kasse auftritt."], correctReasonIndex: 1, explanation: "Beim Aktivtausch steigt ein Aktivposten (z. B. Maschine) und ein anderer sinkt (z. B. Kasse) um denselben Betrag — die Bilanzsumme bleibt rechnerisch unverändert, anders als bei Bilanzverlängerung oder -verkürzung." },
