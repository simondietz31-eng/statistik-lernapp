const VERTRIEB_CHAPTER7_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "q3", question: "Welche drei Besonderheiten des persönlichen Verkaufs nennt Maurer (2006)?", options: ["Unmittelbare Anwesenheit, Reaktion auf Mimik/Gestik, Gestaltung eigener nonverbaler Kommunikation", "Automatisierung, Standardisierung, Effizienz", "Niedrige Kosten, hohe Reichweite, Skalierbarkeit", "Anonymität, Bequemlichkeit, 24/7-Verfügbarkeit"], correctIndex: 0, explanation: "Maurer (2006) nennt die unmittelbare Anwesenheit mit Sichtkontakt, die Reaktionsmöglichkeit auf Mimik und Gestik sowie die bewusste Gestaltung der eigenen nonverbalen Kommunikation." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "q3", question: "Welche Grundregel gilt laut Vorlesung für nonverbales Verhalten?", options: ["Es wirkt nur, wenn es bewusst eingesetzt wird", "Es spielt im Verkaufsgespräch nur eine untergeordnete Rolle", "Es 'framed' immer und wirkt daher immer, ist kaum vermeidbar und erfordert Übung zur aktiven Steuerung", "Es lässt sich mit etwas Übung vollständig vermeiden"], correctIndex: 2, explanation: "Nonverbales Verhalten wirkt laut Grundregel immer, ist kaum vermeidbar und muss aktiv trainiert werden, um es gezielt steuern zu können." },
      { id: "q4", question: "Was ist funktionales nonverbales Verhalten?", options: ["Verhalten, das nur einem biologischen/persönlichen Komfortzweck dient und kein bewusstes Signal sendet", "Verhalten, das ausschließlich in der Abschlussphase auftritt", "Bewusst eingesetztes Verhalten, um ein Signal zu senden", "Verhalten, das immer Desinteresse ausdrücken soll"], correctIndex: 0, explanation: "Funktionales Verhalten dient dem eigenen Komfort und sendet kein bewusstes Signal, kann aber unbeabsichtigt Desinteresse kommunizieren." },
      { id: "q5", question: "Welche Art von nonverbalem Verhalten hat diagnostischen Wert für den Verkäufer?", options: ["Keine Art von nonverbalem Verhalten ist diagnostisch verwertbar", "Nur funktionales Verhalten", "Sowohl funktionales als auch nichtfunktionales Verhalten gleichermaßen", "Nichtfunktionales Verhalten, da es bewusst als Signal eingesetzt wird"], correctIndex: 3, explanation: "Nur nichtfunktionales Verhalten wird bewusst als Signal eingesetzt und lässt daher sinnvolle Rückschlüsse auf die Haltung des Kunden zu." },
      { id: "q6", question: "Welches Beispiel beschreibt nichtfunktionales (bewusst eingesetztes) nonverbales Verhalten?", options: ["Der Verkäufer räuspert sich zufällig", "Der Verkäufer sucht bewusst Augenkontakt, um Vertrauen zu signalisieren", "Der Kunde verschränkt beiläufig die Arme, weil es ihm bequemer ist", "Der Kunde rutscht unbewusst auf dem Stuhl hin und her"], correctIndex: 1, explanation: "Bewusst gesuchter Augenkontakt zur gezielten Signalisierung von Vertrauen ist ein klassisches Beispiel für nichtfunktionales Verhalten." },
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        solution: "Beispiel: 'Möchten Sie den Tarif mit 20 GB Datenvolumen oder lieber den mit unbegrenztem Datenvolumen für Ihr Smartphone?' Beide Antwortmöglichkeiten führen zu einem Vertragsabschluss, eine grundsätzliche Entscheidung zwischen 'Vertrag ja oder nein' wird durch die Fragestellung vermieden."
      },
      {
    ...
    quiz: [
      ...
      { id: "q3", question: "Was ist das Ziel der Alternativtechnik?", options: ["Den Kunden vor eine reine Ja/Nein-Entscheidung zu stellen", "Eine grundsätzliche Ja/Nein-Entscheidung zu vermeiden, indem zwei positive Alternativen angeboten werden", "Das Gespräch sofort zu beenden", "Den Preis zu verhandeln"], correctIndex: 1, explanation: "Die Alternativtechnik bietet zwei positive Optionen an und umgeht dadurch eine grundsätzliche Ja/Nein-Entscheidung." },
