const VERTRIEB_CHAPTER7_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Zielt eine geschlossene Frage darauf ab, den Kunden möglichst viele Details frei erzählen zu lassen?", correctAnswer: false, reasons: ["Nein, weil geschlossene Fragen den Antwortspielraum begrenzen und Bedürfnisse konkretisieren sollen.", "Ja, weil geschlossene Fragen sich inhaltlich nicht von offenen Fragen unterscheiden.", "Nein, weil geschlossene Fragen ausschließlich in der Abschlussphase gestellt werden dürfen.", "Ja, weil ein begrenzter Antwortspielraum automatisch mehr Details liefert."], correctReasonIndex: 0, explanation: "Geschlossene Fragen begrenzen den Antwortspielraum auf Ja/Nein oder konkrete Zahlen und dienen dazu, Bedürfnisse zu konkretisieren - das freie Erzählen ist gerade das Ziel offener Fragen." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Hat funktionales nonverbales Verhalten laut Vorlesung diagnostischen Wert für den Verkäufer?", correctAnswer: false, reasons: ["Nein, weil nur nichtfunktionales Verhalten bewusst als Signal gesendet wird und Rückschlüsse zulässt.", "Ja, weil jede Körperhaltung automatisch eine bewusste Botschaft an den Gesprächspartner sendet.", "Nein, weil nonverbales Verhalten im Verkaufsgespräch generell keine Rolle spielt.", "Ja, weil funktionales und nichtfunktionales Verhalten laut Vorlesung identisch definiert sind."], correctReasonIndex: 0, explanation: "Funktionales Verhalten dient nur dem eigenen Komfort und sendet kein bewusstes Signal - nur nichtfunktionales Verhalten wird strategisch eingesetzt und lässt daher verwertbare Rückschlüsse zu." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Darf laut Vorlesung der Kundennutzen bei der Anwendung von Abschlusstechniken vernachlässigt werden?", correctAnswer: false, reasons: ["Nein, weil unabhängig von der gewählten Technik der Kundennutzen stets maximal sein muss.", "Ja, weil Abschlusstechniken ausschließlich dem kurzfristigen Verkäuferinteresse dienen.", "Nein, weil Abschlusstechniken laut Vorlesung nur bei bereits fest entschlossenen Kunden überhaupt angewendet werden dürfen.", "Ja, weil der Kundennutzen erst nach dem Vertragsabschluss überhaupt relevant wird."], correctReasonIndex: 0, explanation: "Unabhängig davon, welche der zwölf Abschlusstechniken gewählt wird, gilt laut Vorlesung, dass der Kundennutzen dabei stets maximal sein muss." },
