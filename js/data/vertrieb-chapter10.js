const VERTRIEB_CHAPTER10_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Steht bei den Anforderungen an Vertriebs-IT-Systeme laut Vorlesung die Wirtschaftlichkeit im Fokus, nicht die Effektivität?", correctAnswer: false, reasons: ["Nein, weil die Wirtschaftlichkeit kaum quantifizierbar ist und daher die Effektivität im Fokus steht.", "Ja, weil Wirtschaftlichkeit die einzige messbare Größe im Vertrieb ist.", "Nein, weil ausschließlich Sicherheit als Kernaufgabe im Fokus steht.", "Ja, weil Benutzerorientierung und Wirtschaftlichkeit laut Vorlesung identisch definiert werden."], correctReasonIndex: 0, explanation: "Die Wirtschaftlichkeit bzw. Effizienz von Vertriebs-IT-Systemen ist kaum quantifizierbar, weshalb im Vertrieb die Effektivität und die Benutzerorientierung im Vordergrund stehen." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Steigt die optimale Bestellmenge q* laut Harris/Wilson-Formel, wenn die Lagerhaltungskosten h steigen?", correctAnswer: false, reasons: ["Nein, weil h im Nenner der Formel steht und q* daher mit steigendem h sinkt.", "Ja, weil h und q* laut Formel in einem direkt proportionalen Verhältnis stehen.", "Nein, weil q* unabhängig von h stets konstant bleibt.", "Ja, weil höhere Lagerhaltungskosten automatisch größere Bestellmengen erfordern, um Fixkosten zu sparen."], correctReasonIndex: 0, explanation: "In q* = √(2rK/h) steht h im Nenner: Steigen die Lagerhaltungskosten pro Stück, sinkt die optimale Bestellmenge, da häufigeres, kleineres Bestellen die Kapitalbindung im Lager reduziert." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist laut Vorlesung stets nur ein rein schrittweiser, unauffälliger Wandel für einen erfolgreichen Kulturwandel geeignet?", correctAnswer: false, reasons: ["Nein, weil manchmal ein sprunghafter Übergang ('Schockieren') notwendig ist.", "Ja, weil ein sprunghafter Übergang laut Vorlesung immer scheitert.", "Nein, weil Kulturwandel laut Vorlesung ausschließlich durch Schulungen erreicht wird.", "Ja, weil Top-Management-Unterstützung einen schrittweisen Wandel zwingend voraussetzt."], correctReasonIndex: 0, explanation: "Die Vorlesung nennt explizit, dass manchmal ein sprunghafter Übergang ('Schockieren') notwendig ist, um den Bruch mit der bisherigen Kultur sichtbar zu machen - ein rein schrittweiser Wandel ist also nicht immer ausreichend." },
