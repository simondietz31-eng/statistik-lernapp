const VERTRIEB_CHAPTER6_TOPICS = [
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        solution: [{ type: "p", text: "Die gesamte Logik der Preisbündelung beruht darauf, individuelle Preisbereitschaften der Kunden möglichst gut abzuschöpfen — sowohl bei der Wahl der Einzelpreise als auch bei der Wahl des Bündelpreises. Sind die zugrunde gelegten Zahlungsbereitschaftswerte falsch oder ungenau gemessen (z. B. durch schlechte Befragungsmethoden), führt jede darauf aufbauende Preisberechnung zu suboptimalen oder sogar falschen Preisentscheidungen, die Umsatz und Gewinn schmälern statt maximieren. Eine valide Datengrundlage ist daher die Grundvoraussetzung für jede der drei Preisbündelungsformen." }]
      }
    ],
    quiz: [
      { id: "q1", question: "Was ist Preisbündelung im Kontext der Preisdifferenzierung?", options: ["Eine spezifische Implementierungsform der Preisdifferenzierung", "Eine Form der Kostenorientierung", "Eine Form des direkten Vertriebs", "Eine völlig eigenständige Strategie ohne Bezug zur Preisdifferenzierung"], correctIndex: 0, explanation: "Preisbündelung ist laut Vorlesung eine spezifische Implementierungsform der Preisdifferenzierung: Sie setzt Preise nicht anhand eines einheitlichen Leistungsniveaus, sondern schöpft individuelle Preisbereitschaften ab, indem sie diese über ein Produktbündel verteilt statt sie einzeln zu bepreisen." },
      { id: "q2", question: "Was überträgt Preisbündelung laut Kernmechanismus von einem Produkt auf ein anderes?", options: ["Vertriebspartner und deren Konditionen", "Lagerbestände am Ende der Verkaufssaison", "Ungenutzte Preisbereitschaft", "Herstellkosten pro produzierter Einheit"], correctIndex: 2, explanation: "Preisbündelung überträgt laut Kernmechanismus ungenutzte Preisbereitschaft eines Kunden für ein Produkt A auf ein anderes Produkt B, indem beide über einen gemeinsamen Bündelpreis angeboten werden. So wird die individuelle Zahlungsbereitschaft besser abgeschöpft als bei getrennten Einzelpreisen." },
      { id: "q3", question: "Welche der folgenden ist KEINE der drei Formen der Preisbündelung?", options: ["Einzelpreisbildung ohne jegliche Bündelung", "Gemischte Preisbündelung mit freier Wahl", "Progressive Preisbündelung", "Reine Preisbündelung ausschließlich als Paket"], correctIndex: 2, explanation: "Die drei genannten Formen der Preisbündelung sind Einzelpreisbildung, reine Preisbündelung und gemischte Preisbündelung. Eine 'progressive Preisbündelung' wird in der Vorlesung nirgends als eigenständige Form eingeführt." },
      { id: "q4", question: "Was kennzeichnet die reine Preisbündelung?", options: ["Jedes Produkt hat stets einen eigenen, separaten Einzelpreis", "Produkte sind ausschließlich als Paket zu einem Bündelpreis erhältlich", "Kunden können bei jedem Kauf frei zwischen Bündelkauf und reinem Einzelkauf wählen", "Es gibt in diesem Modell gar keinen einzigen festen Preis"], correctIndex: 1, explanation: "Bei der reinen Preisbündelung sind die Produkte laut Definition ausschließlich als gemeinsames Paket zu einem Bündelpreis erhältlich, ein separater Einzelkauf ist nicht möglich. Das unterscheidet sie von der gemischten Preisbündelung, bei der der Kunde frei wählen kann." },
      { id: "q5", question: "Was kennzeichnet die gemischte Preisbündelung?", options: ["Der Kunde kann zwischen Bündelkauf und Einzelkauf wählen", "Alle Kunden zahlen zwingend denselben Preis wie bei reiner Bündelung", "Nur der Anbieter entscheidet, was der Kunde kauft", "Es gibt kein Bündelangebot"], correctIndex: 0, explanation: "Bei der gemischten Preisbündelung kann der Kunde laut Definition selbst wählen, ob er das Bündel zum Bündelpreis kauft oder die Produkte einzeln zu ihren jeweiligen Einzelpreisen erwirbt. Das unterscheidet sie klar von der reinen Preisbündelung, bei der nur das Paket erhältlich ist." },
      { id: "yn1", type: "yesno", question: "Kann Preisbündelung Umsatz und Gewinn erhöhen, ohne das Produkt selbst zu verändern?", correctAnswer: true, reasons: ["Ja, weil sie individuelle Preisbereitschaft besser über die Produkte hinweg abschöpft.", "Nein, weil eine Umsatzsteigerung stets eine Produktänderung voraussetzt.", "Ja, weil Preisbündelung automatisch die Herstellkosten des Anbieters senkt.", "Nein, weil Preisbündelung ausschließlich bei identischen Zahlungsbereitschaften aller Kunden funktioniert."], correctReasonIndex: 0, explanation: "Preisbündelung überträgt ungenutzte Preisbereitschaft eines Kunden für ein Produkt auf ein anderes und schöpft so die individuelle Zahlungsbereitschaft besser ab, ganz ohne das Produkt selbst zu verändern." },
      { id: "q6", question: "Was besagt die Faustregel bei exakt gleich hohem Umsatz von Einzelpreisbildung und reiner Preisbündelung?", options: ["Beide Optionen sind gleichermaßen abzulehnen", "Reine Preisbündelung ist vorzuziehen", "Es sollte eine dritte Option gewählt werden", "Einzelpreisbildung ist vorzuziehen"], correctIndex: 1, explanation: "Fallen die Umsätze von Einzelpreisbildung und reiner Preisbündelung laut Faustregel exakt gleich hoch aus, ist die reine Preisbündelung vorzuziehen, da sie operativ einfacher zu handhaben ist und ohne Umsatznachteil zusätzliche Vorteile bieten kann." },
      { id: "q7", question: "Wie wird beim allgemeinen Verfahren zur Preisoptimierung vorgegangen?", options: ["Nur den niedrigsten angebotenen Preis ohne weitere Prüfung wählen", "Zahlungsbereitschaften sortieren und den umsatzmaximalen Preis auswählen", "Nur den höchstmöglichen Preis ohne Rücksicht auf die verkaufte Menge wählen", "Eine rein zufällige Auswahl eines beliebigen Preises ohne Systematik"], correctIndex: 1, explanation: "Beim allgemeinen Verfahren zur Preisoptimierung werden laut Vorlesung die Zahlungsbereitschaften absteigend sortiert, jeder Wert wird als möglicher Kandidatenpreis getestet, und der Preis mit dem höchsten Umsatz (Preis mal zugehörige Menge) wird gewählt." },
      { id: "q8", question: "Wie wird die Menge zu einem gegebenen Kandidatenpreis bestimmt?", options: ["Als Gesamtzahl aller ursprünglich befragten Kunden, unabhängig vom gewählten Preis", "Als Anzahl der Kunden mit der jeweils niedrigsten Zahlungsbereitschaft im Datensatz", "Als ein stets fester Wert von genau 1 unabhängig vom Preis", "Als Anzahl der Kunden, deren Zahlungsbereitschaft mindestens diesem Preis entspricht"], correctIndex: 3, explanation: "Die Menge zu einem gegebenen Kandidatenpreis ergibt sich laut Verfahren aus der Anzahl der Kunden, deren Zahlungsbereitschaft mindestens diesem Preis entspricht - nicht aus der Gesamtzahl aller Kunden oder einem festen Wert, unabhängig vom gewählten Preis." },
      { id: "q9", question: "Was ist eine notwendige Voraussetzung für erfolgreiche Preisbündelung?", options: ["Ein möglichst niedriger Herstellkostenanteil am Gesamtpreis", "Eine möglichst geringe Anzahl an unterschiedlichen Kundengruppen", "Der vollständige und dauerhafte Verzicht auf jegliche Einzelpreise", "Eine valide Messung der Zahlungsbereitschaften der Kunden"], correctIndex: 3, explanation: "Da die gesamte Logik der Preisbündelung darauf beruht, individuelle Preisbereitschaften der Kunden abzuschöpfen, ist laut Vorlesung eine valide Messung dieser Zahlungsbereitschaften notwendige Voraussetzung - fehlerhafte Daten führen zu suboptimalen Preisentscheidungen." },
      { id: "q10", question: "Warum kann Preisbündelung Umsatz und Gewinn erhöhen, ohne das Produkt selbst zu verändern?", options: ["Weil sie die zugrunde liegenden Herstellkosten des Produkts spürbar senkt", "Weil sie jeglichen Wettbewerb im relevanten Markt vollständig eliminiert", "Weil sie automatisch und garantiert die Nachfrage sämtlicher Kunden vollständig verdoppelt", "Weil sie individuelle Preisbereitschaft über die Produkte hinweg besser abschöpft"], correctIndex: 3, explanation: "Preisbündelung erhöht Umsatz und Gewinn laut Vorlesung, weil sie die individuelle Preisbereitschaft der Kunden über die Produkte hinweg besser abschöpft, ohne dass Herstellkosten gesenkt oder der Wettbewerb beeinflusst werden müssen." }
    ]
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Erzielt im durchgerechneten Beispiel die gemischte Preisbündelung den höchsten Gewinn aller drei Strategien?", correctAnswer: false, reasons: ["Nein, weil die reine Preisbündelung mit 340 € den höchsten Gewinn erzielt, die gemischte nur 270 €.", "Ja, weil gemischte Preisbündelung durch die freie Wahlmöglichkeit der Kunden immer den höchsten Gewinn erzielt.", "Nein, weil in diesem Beispiel die Einzelpreisbildung mit 280 € den höchsten Gewinn erzielt.", "Ja, weil Kunde C durch sein Cherry-Picking den Gewinn der gemischten Bündelung maximiert."], correctReasonIndex: 0, explanation: "Im verifizierten Ranking dieses Beispiels liegt die reine Preisbündelung mit 340 € vorn, vor Einzelpreisbildung (280 €) und gemischter Preisbündelung (270 €), da Cherry-Picking wie bei Kunde C den Gewinn der gemischten Strategie senkt." },
