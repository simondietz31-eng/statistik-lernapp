const NATWISS_CHAPTER10_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Was ist die SI-Einheit der elektrischen Ladung?", options: ["Coulomb (C) – Einheit der elektrischen Ladung", "Volt (V) – Einheit der Spannung", "Ampere (A) – Einheit der Stromstärke", "Farad (F) – Einheit der Kapazität"], correctIndex: 0, explanation: "Die SI-Einheit der elektrischen Ladung ist das Coulomb (C), benannt nach Charles-Augustin de Coulomb. Da der Strom als Ladung pro Zeit definiert ist (I = dQ/dt), folgt direkt aus der Stromeinheit die Ladungseinheit: 1 C = 1 A·s. Volt, Ampere und Farad sind die Einheiten von Spannung, Stromstärke bzw. Kapazität – verwandte, aber andere elektrische Größen." },
      ...
      { id: "yn1", type: "yesno", question: "Ist die Coulombkraft zwischen zwei geladenen Teilchen unabhängig von deren Masse?", correctAnswer: true, reasons: ["Ja, weil das Coulombsche Gesetz F = k·|q₁||q₂|/r² ausschließlich von den Ladungen und ihrem Abstand abhängt, nicht von den Massen der Ladungsträger.", "Nein, weil schwerere Ladungsträger laut Coulombschem Gesetz automatisch eine größere elektrische Kraft aufeinander ausüben.", "Ja, weil Coulombkraft und Gravitationskraft bei geladenen Teilchen identisch sind und sich daher aus der Masse ergeben.", "Nein, weil die Coulomb-Konstante k von der Masse der beteiligten Teilchen abhängt."], correctReasonIndex: 0, explanation: "Das Coulombsche Gesetz F = k·|q₁||q₂|/r² enthält nur die Ladungen und den Abstand – die Massen der Ladungsträger tauchen darin nicht auf, im Gegensatz zur (bei geladenen Elementarteilchen meist vernachlässigbaren) Gravitationskraft, die von der Masse abhängt." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Fällt das elektrische Potenzial einer Punktladung mit demselben Abstandsgesetz ab wie die elektrische Feldstärke (beide ∝ 1/r²)?", correctAnswer: false, reasons: ["Nein, weil das Potenzial φ ∝ 1/r nur linear mit dem Kehrwert des Abstands abfällt, während die Feldstärke E ∝ 1/r² quadratisch abfällt.", "Ja, weil Potenzial und Feldstärke über E = −dφ/dx direkt gleichgesetzt werden können und daher dasselbe Abstandsgesetz erfüllen.", "Nein, weil das Potenzial überhaupt nicht vom Abstand abhängt, sondern nur von der Ladung Q.", "Ja, weil beide Größen aus demselben Coulombschen Gesetz abgeleitet werden und daher identische Exponenten haben müssen."], correctReasonIndex: 0, explanation: "Das Potenzial φ = kQ/r fällt mit 1/r ab, während die Feldstärke E = kQ/r² mit 1/r² abfällt; das liegt daran, dass φ das Wegintegral von E ist, wodurch beim Integrieren eine Potenz von r im Nenner verloren geht." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "q2", question: "Welche Einheit hat die Kapazität?", options: ["Weber (Wb), Einheit des magnetischen Flusses", "Ohm (Ω), Einheit des elektrischen Widerstands", "Henry (H), Einheit der Induktivität", "Farad (F), Einheit der Kapazität"], correctIndex: 3, explanation: "Die Kapazität wird in Farad gemessen, definiert als 1 F = 1 C/V. Weber, Ohm und Henry sind reale SI-Einheiten, gehören aber zu magnetischem Fluss, elektrischem Widerstand bzw. Induktivität — verwandten, aber anderen elektrischen Größen." },
      { id: "q3", question: "Wie lautet die Formel für die Kapazität eines Plattenkondensators (Fläche A, Abstand d, relative Permittivität ε_r)?", options: ["C = ε₀ · A · d, also proportional zum Abstand", "C = ε₀ · ε_r · d / A, mit d im Zähler", "C = ε_r / (ε₀ · A · d), als reiner Kehrwert", "C = ε₀ · ε_r · A / d, die Plattenkondensator-Formel"], correctIndex: 3, explanation: "Die Kapazität des Plattenkondensators ist C = ε₀·ε_r·A/d — sie steigt mit größerer Plattenfläche A (mehr Raum für Ladung) und sinkt mit größerem Abstand d (schwächere Feldwirkung zwischen den Platten). Die Distraktoren vertauschen A und d im Zähler/Nenner oder bilden fälschlich einen reinen Kehrwert." },
      ...
      { id: "q7", question: "Wie lautet die Formel für die im Kondensator gespeicherte Energie?", options: ["E = Q / C, also Ladung durch Kapazität", "E = C · U, ohne Quadrat der Spannung", "E = ½ · C · U², die Energie im Kondensator", "E = C² · U, mit quadrierter Kapazität"], correctIndex: 2, explanation: "Die gespeicherte elektrische Energie beträgt E = ½·C·U² (äquivalent zu Q²/(2C) bzw. ½·Q·U), weil beim Aufladen die Spannung von 0 auf U ansteigt und die Arbeit dabei integriert werden muss. Die übrigen Optionen ergäben eine falsche Einheit oder eine lineare statt quadratische Abhängigkeit von U." },
      { id: "yn1", type: "yesno", question: "Verdoppelt sich die auf einem Kondensator gespeicherte Ladung Q, wenn die Spannung U verdoppelt wird (bei konstanter Kapazität C)?", correctAnswer: true, reasons: ["Ja, weil Q = C·U linear von der Spannung abhängt; bei konstanter Kapazität führt eine Verdopplung von U direkt zu einer Verdopplung von Q.", "Nein, weil sich die Ladung wie die Energie quadratisch mit der Spannung ändert und sich daher vervierfacht.", "Ja, weil sich auch die Kapazität C automatisch verdoppelt, wenn die Spannung erhöht wird.", "Nein, weil die Ladung eines Kondensators unabhängig von der angelegten Spannung stets konstant bleibt."], correctReasonIndex: 0, explanation: "Aus Q = C·U folgt bei konstanter Kapazität C ein linearer Zusammenhang zwischen Ladung und Spannung; eine Verdopplung von U verdoppelt daher Q – im Unterschied zur Energie E = ½CU², die quadratisch von U abhängt und sich vervierfacht." },
