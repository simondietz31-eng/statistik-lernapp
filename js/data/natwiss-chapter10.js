const NATWISS_CHAPTER10_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist die Coulombkraft zwischen zwei geladenen Teilchen unabhängig von deren Masse?", correctAnswer: true, reasons: ["Ja, weil das Coulombsche Gesetz F = k·|q₁||q₂|/r² nur von den Ladungen und ihrem Abstand abhängt, nicht von der Masse.", "Nein, weil schwerere Ladungsträger laut Coulombschem Gesetz automatisch eine größere elektrische Kraft aufeinander ausüben.", "Ja, weil Coulombkraft und Gravitationskraft bei geladenen Teilchen identisch sind und sich daher aus der Masse ergeben.", "Nein, weil die Coulomb-Konstante k tatsächlich direkt von der Masse der beteiligten Ladungsträger abhängt."], correctReasonIndex: 0, explanation: "Das Coulombsche Gesetz F = k·|q₁||q₂|/r² enthält nur die Ladungen und den Abstand – die Massen der Ladungsträger tauchen darin nicht auf, im Gegensatz zur (bei geladenen Elementarteilchen meist vernachlässigbaren) Gravitationskraft, die von der Masse abhängt." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Fällt das elektrische Potenzial einer Punktladung mit demselben Abstandsgesetz ab wie die elektrische Feldstärke (beide ∝ 1/r²)?", correctAnswer: false, reasons: ["Nein, weil das Potenzial φ ∝ 1/r nur linear abfällt, während die Feldstärke E ∝ 1/r² quadratisch abfällt.", "Ja, weil Potenzial und Feldstärke über E = −dφ/dx direkt gleichgesetzt werden können und daher dasselbe Abstandsgesetz erfüllen.", "Nein, weil das Potenzial überhaupt nicht vom Abstand abhängt, sondern ausschließlich von der Größe der Ladung Q selbst.", "Ja, weil beide Größen aus demselben Coulombschen Gesetz abgeleitet werden und daher identische Exponenten haben müssen."], correctReasonIndex: 0, explanation: "Das Potenzial φ = kQ/r fällt mit 1/r ab, während die Feldstärke E = kQ/r² mit 1/r² abfällt; das liegt daran, dass φ das Wegintegral von E ist, wodurch beim Integrieren eine Potenz von r im Nenner verloren geht." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Verdoppelt sich die auf einem Kondensator gespeicherte Ladung Q, wenn die Spannung U verdoppelt wird (bei konstanter Kapazität C)?", correctAnswer: true, reasons: ["Ja, weil Q = C·U linear von der Spannung abhängt; eine Verdopplung von U verdoppelt daher auch Q.", "Nein, weil sich die Ladung wie die Energie quadratisch mit der Spannung ändert und sich daher vervierfacht.", "Ja, weil sich auch die Kapazität C automatisch verdoppelt, wenn die angelegte Spannung erhöht wird.", "Nein, weil die Ladung eines Kondensators unabhängig von der angelegten Spannung stets konstant bleibt."], correctReasonIndex: 0, explanation: "Aus Q = C·U folgt bei konstanter Kapazität C ein linearer Zusammenhang zwischen Ladung und Spannung; eine Verdopplung von U verdoppelt daher Q – im Unterschied zur Energie E = ½CU², die quadratisch von U abhängt und sich vervierfacht." },
