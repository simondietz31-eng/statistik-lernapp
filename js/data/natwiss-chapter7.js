const NATWISS_CHAPTER7_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist der lineare Ausdehnungskoeffizient von Aluminium kleiner als der von Stahl?", correctAnswer: false, reasons: ["Nein, weil α_Aluminium ≈ 24 × 10⁻⁶ K⁻¹ doppelt so groß ist wie α_Stahl ≈ 12 × 10⁻⁶ K⁻¹ – Aluminium dehnt sich bei gleicher Temperaturänderung stärker aus.", "Ja, weil Aluminium als Leichtmetall grundsätzlich eine geringere Wärmeausdehnung als Stahl hat.", "Nein, weil sich Stahl aufgrund seiner höheren Dichte bei Erwärmung überhaupt nicht ausdehnt.", "Ja, weil beide Metalle denselben Ausdehnungskoeffizienten besitzen und der Unterschied nur an der Dichte liegt."], correctReasonIndex: 0, explanation: "Laut den genannten Werten hat Aluminium mit α ≈ 24 × 10⁻⁶ K⁻¹ einen doppelt so großen linearen Ausdehnungskoeffizienten wie Stahl (α ≈ 12 × 10⁻⁶ K⁻¹) und dehnt sich bei gleicher Temperaturänderung folglich stärker aus." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Führt eine Verdopplung des Drucks bei konstanter Temperatur (isotherm) zu einer Verdopplung des Volumens?", correctAnswer: false, reasons: ["Nein, weil nach dem Boyle-Mariotte-Gesetz p·V = const bei konstanter Temperatur gilt – eine Druckverdopplung führt zu einer Halbierung des Volumens, nicht zu einer Verdopplung.", "Ja, weil Druck und Volumen bei konstanter Temperatur stets proportional zueinander sind.", "Nein, weil sich bei isothermer Zustandsänderung automatisch auch die Stoffmenge n verdoppelt.", "Ja, weil pV = nRT bedeutet, dass eine Druckerhöhung immer eine gleich große Volumenerhöhung nach sich zieht."], correctReasonIndex: 0, explanation: "Bei isothermer Zustandsänderung ist p·V = const (Boyle-Mariotte); eine Verdopplung von p erfordert daher eine Halbierung von V, damit das Produkt konstant bleibt – Druck und Volumen verhalten sich also umgekehrt, nicht direkt proportional." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Haben N₂- und O₂-Moleküle bei gleicher Temperatur dieselbe quadratische Mittelgeschwindigkeit v_rms?", correctAnswer: false, reasons: ["Nein, weil v_rms = √(3RT/M) von der Molmasse M abhängt; O₂ (M = 32 g/mol) ist schwerer als N₂ (M = 28 g/mol) und hat daher eine etwas kleinere v_rms, obwohl beide dieselbe mittlere kinetische Energie besitzen.", "Ja, weil die mittlere kinetische Energie ⟨E_kin⟩ = (3/2)k_BT bei gleicher Temperatur für beide Gase identisch ist und daraus zwangsläufig dieselbe Geschwindigkeit folgt.", "Nein, weil O₂ als zweiatomiges Molekül grundsätzlich eine andere Bewegungsart als N₂ ausführt.", "Ja, weil v_rms in der kinetischen Gastheorie nur von der Temperatur abhängt, nicht von der Molekülmasse."], correctReasonIndex: 0, explanation: "Obwohl N₂ und O₂ bei gleicher Temperatur dieselbe mittlere kinetische Energie (3/2)k_BT besitzen, unterscheidet sich ihre v_rms = √(3RT/M), da M im Nenner steht; das schwerere O₂-Molekül bewegt sich im Mittel etwas langsamer." },
