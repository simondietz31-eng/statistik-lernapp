const NATWISS_CHAPTER7_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist der lineare Ausdehnungskoeffizient von Aluminium kleiner als der von Stahl?", correctAnswer: false, reasons: ["Nein, weil α_Aluminium ≈ 24 × 10⁻⁶ K⁻¹ etwa doppelt so groß ist wie α_Stahl ≈ 12 × 10⁻⁶ K⁻¹.", "Ja, weil Aluminium als Leichtmetall grundsätzlich immer eine geringere Wärmeausdehnung als schwerere Metalle wie Stahl aufweist.", "Nein, weil sich Stahl aufgrund seiner deutlich höheren Dichte bei Erwärmung überhaupt nicht messbar ausdehnt.", "Ja, weil beide Metalle denselben Ausdehnungskoeffizienten besitzen und der Unterschied nur an der Dichte liegt."], correctReasonIndex: 0, explanation: "Laut den genannten Werten hat Aluminium mit α ≈ 24 × 10⁻⁶ K⁻¹ einen doppelt so großen linearen Ausdehnungskoeffizienten wie Stahl (α ≈ 12 × 10⁻⁶ K⁻¹) und dehnt sich bei gleicher Temperaturänderung folglich stärker aus." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Führt eine Verdopplung des Drucks bei konstanter Temperatur (isotherm) zu einer Verdopplung des Volumens?", correctAnswer: false, reasons: ["Nein, weil nach dem Boyle-Mariotte-Gesetz p·V = const gilt, wodurch eine Druckverdopplung das Volumen halbiert.", "Ja, weil Druck und Volumen bei konstanter Temperatur nach dem allgemeinen Gasgesetz stets direkt proportional zueinander sind.", "Nein, weil sich bei isothermer Zustandsänderung automatisch auch die Stoffmenge n im Behälter verdoppelt, wodurch p·V ansteigt.", "Ja, weil pV = nRT bedeutet, dass eine Druckerhöhung immer eine gleich große Volumenerhöhung nach sich zieht."], correctReasonIndex: 0, explanation: "Bei isothermer Zustandsänderung ist p·V = const (Boyle-Mariotte); eine Verdopplung von p erfordert daher eine Halbierung von V, damit das Produkt konstant bleibt – Druck und Volumen verhalten sich also umgekehrt, nicht direkt proportional." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Haben N₂- und O₂-Moleküle bei gleicher Temperatur dieselbe quadratische Mittelgeschwindigkeit v_rms?", correctAnswer: false, reasons: ["Nein, weil v_rms = √(3RT/M) von der Molmasse M abhängt; O₂ ist schwerer als N₂ und hat daher eine etwas kleinere v_rms.", "Ja, weil die mittlere kinetische Energie (3/2)k_BT bei gleicher Temperatur für beide Gase identisch ist und daraus dieselbe Geschwindigkeit folgt.", "Nein, weil O₂ als zweiatomiges Molekül grundsätzlich eine völlig andere Bewegungsart und Stoßfrequenz als das Molekül N₂ ausführt.", "Ja, weil v_rms in der kinetischen Gastheorie ausschließlich von der absoluten Temperatur abhängt, niemals von der Molekülmasse selbst."], correctReasonIndex: 0, explanation: "Obwohl N₂ und O₂ bei gleicher Temperatur dieselbe mittlere kinetische Energie (3/2)k_BT besitzen, unterscheidet sich ihre v_rms = √(3RT/M), da M im Nenner steht; das schwerere O₂-Molekül bewegt sich im Mittel etwas langsamer." },
