const CHAPTER1_TOPICS = [
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Besitzt die Verhältnisskala einen natürlichen, absoluten Nullpunkt?", correctAnswer: true, reasons: [
        "Ja, weil erst dieser Nullpunkt sinnvolle Verhältnisse wie 'doppelt so viel' erlaubt.",
        "Nein, weil nur die Intervallskala einen Nullpunkt besitzt.",
        "Ja, weil jede metrische Skala automatisch ordinalskaliert ist.",
        "Nein, weil Verhältnisse auch ohne Nullpunkt interpretierbar sind."
      ], correctReasonIndex: 0, explanation: "Die Verhältnisskala zeichnet sich gegenüber der Intervallskala genau dadurch aus, dass ein natürlicher Nullpunkt existiert, wodurch auch Verhältnisse zwischen Werten sinnvoll interpretierbar werden." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist die Sekundärstatistik in der Regel zeit- und kosteneffizienter als die Primärstatistik?", correctAnswer: true, reasons: [
        "Ja, weil bereits vorhandene Daten weiterverwendet werden und keine neue Erhebung nötig ist.",
        "Nein, weil auch bei Sekundärstatistik stets eine komplette Neuerhebung erfolgen muss.",
        "Ja, weil Sekundärstatistik immer eine Vollerhebung voraussetzt.",
        "Nein, weil Sekundärdaten grundsätzlich ungenauer erhoben werden als Primärdaten."
      ], correctReasonIndex: 0, explanation: "Da bei der Sekundärstatistik bereits vorhandene Daten genutzt werden, entfällt der Aufwand einer eigenen Erhebung - das macht sie zeit- und kosteneffizienter als die Primärstatistik." },
