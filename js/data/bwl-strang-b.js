const BWL_STRANG_B_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Welche drei Ebenen umfasst der Transformationsprozess der betrieblichen Leistungserstellung?", options: ["Angebots-, Nachfrage- und Preisebene", "Nur die Güterebene", "Güter-, Finanz- und Dispositionsebene", "Personal-, Kapital- und Bodenebene"], correctIndex: 2, explanation: "Der Transformationsprozess läuft gleichzeitig auf drei Ebenen ab: dem Realgüterstrom (Güterebene), den Zahlungsströmen zwischen den Beteiligten (Finanzebene) und der koordinierenden Planungs- und Entscheidungsebene (Dispositionsebene), die die anderen beiden Ebenen steuert." },
      { id: "q2", question: "Ein Potenzialfaktor unterscheidet sich von einem Repetierfaktor dadurch, dass er...", options: ["nur bei Dienstleistungen vorkommt", "Leistungsvermögen über mehrere Perioden bereitstellt statt einmalig verbraucht zu werden", "im Produktionsprozess sofort und vollständig verbraucht wird wie ein Werkstoff", "praktisch niemals ausfällt oder ersetzt werden muss"], correctIndex: 1, explanation: "Potenzialfaktoren wie Betriebsmittel oder Arbeitskraft stellen wiederholt nutzbares Leistungsvermögen über mehrere Perioden bereit, während Repetierfaktoren wie Werkstoffe oder Energie im Prozess direkt verbraucht werden." },
      { id: "q3", question: "Limitationalität liegt vor, wenn...", options: ["Faktoren in einem festen, unveränderlichen Mengenverhältnis eingesetzt werden müssen", "im Produktionsprozess nur ein einziger Faktor überhaupt existiert", "Faktoren beliebig, ohne festes Verhältnis gegeneinander austauschbar sind", "der erzielte Output vollständig unabhängig vom eingesetzten Input ist"], correctIndex: 0, explanation: "Bei Limitationalität ist das Mengenverhältnis der Faktoren fest vorgegeben — z. B. 1 Tischplatte plus 4 Tischbeine ergeben einen Tisch, mehr Platten allein erhöhen den Output nicht." },
      { id: "yn1", type: "yesno", question: "Können Produktionsfaktoren bei Limitationalität beliebig ohne festes Verhältnis gegeneinander ausgetauscht werden?", correctAnswer: false, reasons: ["Nein, weil bei Limitationalität die Faktoren in einem festen Mengenverhältnis eingesetzt werden müssen", "Ja, weil Limitationalität laut Definition beliebigen Faktoraustausch ohne festes Verhältnis erlaubt", "Nein, weil bei Limitationalität überhaupt keine Produktion möglich ist", "Ja, weil das Ertragsgesetz bei Limitationalität einen linearen Austausch vorschreibt"], correctReasonIndex: 0, explanation: "Limitationalität bedeutet ein festes Mengenverhältnis der Faktoren (z. B. 1 Platte + 4 Beine = 1 Tisch) - beliebiger Austausch ist gerade bei Substitutionalität möglich, nicht bei Limitationalität." },
      { id: "q4", question: "Welche Kennzahl misst die Verzinsung des eingesetzten Kapitals?", options: ["Rentabilität", "Wirtschaftlichkeit", "Produktivität", "Liquidität"], correctIndex: 0, explanation: "Rentabilität setzt den Gewinn ins Verhältnis zum eingesetzten Kapital. Wirtschaftlichkeit (Ertrag/Aufwand) und Produktivität (Output/Input-Mengenrelation) sind dagegen wert- bzw. mengenbezogene Effizienzmaße, Liquidität misst die Zahlungsfähigkeit." },
      { id: "q5", question: "Warum ist Arbeitskraft ein Produktionsfaktor mit 'Sonderstellung'?", options: ["Weil sie im Gegensatz zu allen anderen Faktoren praktisch nie ausfällt", "Weil sie als einziger Produktionsfaktor gesetzlich nicht reguliert ist", "Weil sie ausschließlich bei Dienstleistungen als Faktor vorkommt", "Weil sie sowohl geistige (potenzialfaktorartige) als auch physische (eher verbrauchsnahe) Komponenten hat"], correctIndex: 3, explanation: "Arbeitskraft lässt sich nicht eindeutig einer einzigen Faktorkategorie zuordnen, da sie zugleich dauerhaft nutzbares Leistungsvermögen (potenzialfaktorartig) und im Arbeitsprozess verzehrte Energie (repetierfaktorartig) umfasst." },
      { id: "q6", question: "Betriebliches Gesundheitsmanagement setzt laut Vorlesung primär an...", options: ["ausschließlich an der Finanzebene des Transformationsprozesses an", "der Input-Seite, um den Potenzialfaktor Arbeitskraft zu stabilisieren", "an keiner der drei genannten Transformationsebenen an", "der Output-Seite als rein werbliches Marketinginstrument an"], correctIndex: 1, explanation: "BGM zielt auf Qualifikation, Regeneration und Arbeitsfähigkeit als Teil des Inputs 'Arbeitskraft' und wird zugleich auf der Output-Seite als mitproduziertes Wertschöpfungsergebnis verstanden — nicht als Zusatzprogramm." },
      { id: "q7", question: "Ein Objektfaktor im Sinne der Produktionsfaktorsystematik ist...", options: ["begrifflich identisch mit einem Repetierfaktor", "lediglich ein anderes Wort für Betriebsmittel", "ausschließlich bei der Produktion von Sachgütern relevant", "ein vom Kunden selbst bereitgestelltes Element, z. B. das zu reparierende Fahrzeug"], correctIndex: 3, explanation: "Objektfaktoren wie das Kundenfahrzeug oder der Patient werden vom Kunden selbst in den Prozess eingebracht, statt vom Betrieb disponiert zu werden — anders als Potenzial- oder Repetierfaktoren." },
      { id: "q8", question: "Welche Aussage zum Ertragsgesetz bei Substitutionalität ist richtig?", options: ["Das Verhältnis von Faktoreinsatz zu Output verläuft stets exakt linear", "Substitutionalität schließt jede Form des Faktoraustauschs vollständig aus", "Das Verhältnis von Faktoreinsatz zu Output ist gemäß Ertragsgesetz nicht linear", "Das Ertragsgesetz gilt ausschließlich im Fall der Limitationalität"], correctIndex: 2, explanation: "Bei Substitutionalität können Faktoren ohne festes Verhältnis gegeneinander ausgetauscht werden, doch verläuft der Zusammenhang zwischen Faktoreinsatz und Output gemäß Ertragsgesetz nicht linear." },
      { id: "q9", question: "Welche der folgenden Aussagen zu Sachgütern und Dienstleistungen ist laut Vorlesung korrekt?", options: ["Sachgüter erfordern grundsätzlich eine besonders hohe Kundenintegration", "Sachgüter werden meist vor dem Kundenkonsum produziert, Dienstleistungen meist simultan zum Konsum", "Zwischen Sachgütern und Dienstleistungen besteht im Output kein relevanter Unterschied", "Dienstleistungen sind ebenso lagerfähig wie materielle Sachgüter"], correctIndex: 1, explanation: "Sachgüter sind materiell und lagerfähig, sodass ihre Produktion dem Konsum zeitlich vorausgehen kann; Dienstleistungen sind dagegen meist immateriell, mit simultaner Produktion und Konsum sowie hoher Kundenintegration." },
      { id: "q10", question: "Informationen werden in der Vorlesung als...", options: ["ausschließlich als Teil der Repetierfaktoren mitgezählt", "nur im Rahmen der Finanzebene überhaupt berücksichtigt", "zunehmend als eigenständiger, eigener Produktionsfaktor betrachtet", "als irrelevanter Nebenaspekt der Produktion bezeichnet"], correctIndex: 2, explanation: "Neben Potenzial-, Repetier- und Objektfaktoren gewinnen Informationen laut Vorlesung zunehmend an Bedeutung als eigenständiger, vierter Produktionsfaktor." }
    ]
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Spricht eine hohe Spezifität der benötigten Leistung laut Transaktionskostentheorie eher für Fremdbezug?", correctAnswer: false, reasons: ["Nein, weil hohe Spezifität das Risiko opportunistischen Verhaltens von Lieferanten erhöht und daher eher für Eigenfertigung spricht", "Ja, weil spezifische Leistungen laut Text immer am günstigsten extern beschafft werden können", "Nein, weil Spezifität überhaupt keinen Einfluss auf die Make-or-Buy-Entscheidung hat", "Ja, weil hohe Spezifität das Hold-up-Risiko laut Text vollständig beseitigt"], correctReasonIndex: 0, explanation: "Hohe Spezifität erhöht das Hold-up-Risiko durch opportunistisches Lieferantenverhalten und spricht daher eher für Eigenfertigung, nicht für Fremdbezug." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Gehört der Servicegrad zu den Formalzielen der Beschaffung?", correctAnswer: false, reasons: ["Nein, weil der Servicegrad ein Sachziel ist, während Formalziele z. B. Wirtschaftlichkeit und Risiko betreffen", "Ja, weil der Servicegrad laut Text das zentrale Formalziel der Beschaffung darstellt", "Nein, weil Beschaffungsziele grundsätzlich nicht in Sach- und Formalziele unterteilt werden", "Ja, weil Formalziele ausschließlich die Verfügbarkeitswahrscheinlichkeit betreffen"], correctReasonIndex: 0, explanation: "Servicegrad (Verfügbarkeitswahrscheinlichkeit) gehört zu den Sachzielen; Formalziele sind Wirtschaftlichkeits-, Risiko- und Nachhaltigkeitsziel." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Eignet sich die verbrauchsorientierte Bedarfsermittlung eher für A-Güter als für C-Güter?", correctAnswer: false, reasons: ["Nein, weil sich die verbrauchsorientierte Methode eher für geringerwertige, gut vorhersehbare C-Güter eignet", "Ja, weil A-Güter wegen ihres hohen Wertanteils immer verbrauchsorientiert disponiert werden", "Nein, weil verbrauchsorientierte Ermittlung ausschließlich bei Dienstleistungen angewendet wird", "Ja, weil C-Güter laut Text stets programmorientiert ermittelt werden müssen"], correctReasonIndex: 0, explanation: "Für A-Güter mit hohem Wertanteil lohnt sich der genauere programmorientierte Ansatz; die einfachere verbrauchsorientierte Methode passt eher zu geringwertigen C-Gütern." },
  ...
  },
  {
    ...
    quiz: [
      { id: "yn1", type: "yesno", question: "Erhöht Single Sourcing das Risiko einer Abhängigkeit vom Lieferanten?", correctAnswer: true, reasons: ["Ja, weil die Konzentration auf einen einzigen Lieferanten Abhängigkeit und Lieferengpassrisiko erhöht", "Nein, weil Single Sourcing laut Text automatisch mehrere gleichwertige Lieferanten einbindet", "Ja, weil Single Sourcing gesetzlich verpflichtend mindestens drei Lieferanten vorschreibt", "Nein, weil Abhängigkeitsrisiken laut Text ausschließlich bei Multiple Sourcing auftreten"], correctReasonIndex: 0, explanation: "Single Sourcing konzentriert den Bezug auf einen Lieferanten - das bietet Preisvorteile, erhöht aber die Abhängigkeit und das Risiko bei Lieferausfall." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist der Meldebestand identisch mit dem Mindestbestand?", correctAnswer: false, reasons: ["Nein, weil der Meldebestand aus Mindestbestand plus erwartetem Verbrauch während der Wiederbeschaffungszeit besteht", "Ja, weil beide Begriffe laut Text synonym für dieselbe Bestandsgrenze verwendet werden", "Nein, weil der Meldebestand ausschließlich die maximale Lagerkapazität beschreibt", "Ja, weil beide Größen unabhängig von der Wiederbeschaffungszeit gleich hoch sind"], correctReasonIndex: 0, explanation: "Der Meldebestand ist größer als der Mindestbestand, da er zusätzlich den erwarteten Verbrauch während der Wiederbeschaffungszeit einschließt." },
  ...
  },
  {
    ...
    quiz: [
      { id: "yn1", type: "yesno", question: "Beschreibt das Gesetz von Little den Zusammenhang I = R · T (Bestand = Output-Rate mal Durchlaufzeit)?", correctAnswer: true, reasons: ["Ja, weil der Bestand dem Produkt aus Output-Rate und Durchlaufzeit entspricht", "Nein, weil das Gesetz von Little ausschließlich für Dienstleistungen gilt", "Ja, weil Little's Law stattdessen die Summe aus Rate und Zeit beschreibt", "Nein, weil zwischen Bestand, Rate und Zeit laut Text kein fester Zusammenhang besteht"], correctReasonIndex: 0, explanation: "Das Gesetz von Little besagt I = R · T - Bestand ist das Produkt aus Durchsatzrate und Durchlaufzeit, wie die Beispiele Restaurant und Zahnklinik zeigen." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Können Dienstleistungen wegen ihrer Nicht-Lagerungsfähigkeit auf Vorrat produziert werden, um Nachfragespitzen abzufedern?", correctAnswer: false, reasons: ["Nein, weil Produktion und Konsum durch das Uno-actu-Prinzip zeitlich zusammenfallen und keine Lagerung möglich ist", "Ja, weil Dienstleistungen laut Text ebenso lagerfähig sind wie Sachgüter", "Nein, weil Dienstleistungen grundsätzlich keine Nachfrageschwankungen aufweisen", "Ja, weil das Uno-actu-Prinzip gezielt die Vorratsproduktion von Dienstleistungen ermöglicht"], correctReasonIndex: 0, explanation: "Das Uno-actu-Prinzip beschreibt die Gleichzeitigkeit von Produktion und Konsum - deshalb sind Dienstleistungen nicht lagerfähig und Nachfragespitzen müssen direkt durch Personalkapazität abgedeckt werden." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Bilden Beschaffung, Bedarfsermittlung, Lieferantenmanagement, Bestellung, Produktion und Dienstleistung den roten Faden der Wertschöpfungskette in genau dieser chronologischen Reihenfolge?", correctAnswer: true, reasons: ["Ja, weil diese sechs Bausteine laut Text chronologisch aufeinander aufbauen", "Nein, weil die Produktion laut Text immer vor der Beschaffung stattfindet", "Ja, weil diese Reihenfolge zufällig gewählt wurde und beliebig vertauschbar ist", "Nein, weil Dienstleistung und Lieferantenmanagement laut Text denselben Baustein bilden"], correctReasonIndex: 0, explanation: "Der Text nennt explizit diese chronologische Kette: Beschaffung → Bedarfsermittlung → Lieferantenmanagement → Bestellung → Produktion → Dienstleistung." },
