const BWL_STRANG_B_TOPICS = [
  {
    ...
    quiz: [
      { id: "q1", question: "Welche drei Ebenen umfasst der Transformationsprozess der betrieblichen Leistungserstellung?", options: ["Güter-, Finanz- und Dispositionsebene", "Personal-, Kapital- und Bodenebene", "Angebots-, Nachfrage- und Preisebene", "Nur die Güterebene"], correctIndex: 0, explanation: "Materialfluss, Zahlungsfluss und die koordinierende Planungs-/Entscheidungsebene bilden zusammen den Transformationsprozess." },
      { id: "q2", question: "Ein Potenzialfaktor unterscheidet sich von einem Repetierfaktor dadurch, dass er...", options: ["im Produktionsprozess vollständig verbraucht wird", "Leistungsvermögen über mehrere Perioden bereitstellt statt einmalig verbraucht zu werden", "nur bei Dienstleistungen vorkommt", "niemals ersetzt werden muss"], correctIndex: 1, explanation: "Potenzialfaktoren wie Betriebsmittel oder Arbeitskraft stellen wiederholt nutzbares Leistungsvermögen bereit." },
      { id: "q3", question: "Limitationalität liegt vor, wenn...", options: ["Faktoren beliebig gegeneinander austauschbar sind", "Faktoren nur in einem festen Mengenverhältnis eingesetzt werden können", "der Output unabhängig vom Input ist", "nur ein einziger Faktor existiert"], correctIndex: 1, explanation: "Bei Limitationalität ist z. B. das Verhältnis Tischplatte zu Tischbeinen fest vorgegeben." },
      { id: "q4", question: "Welche Kennzahl misst die Verzinsung des eingesetzten Kapitals?", options: ["Produktivität", "Liquidität", "Rentabilität", "Wirtschaftlichkeit"], correctIndex: 2, explanation: "Rentabilität setzt Gewinn ins Verhältnis zu Kapital bzw. Umsatz." },
      { id: "q5", question: "Warum ist Arbeitskraft ein Produktionsfaktor mit 'Sonderstellung'?", options: ["Weil sie nie ausfällt", "Weil sie sowohl geistige (potenzialfaktorartige) als auch physische (eher verbrauchsnahe) Komponenten hat", "Weil sie gesetzlich nicht reguliert ist", "Weil sie nur bei Dienstleistungen vorkommt"], correctIndex: 1, explanation: "Arbeitskraft lässt sich nicht eindeutig nur einer Faktorkategorie zuordnen." },
      { id: "q6", question: "Betriebliches Gesundheitsmanagement setzt laut Vorlesung primär an...", options: ["der Output-Seite als reines Marketinginstrument", "der Input-Seite, um den Potenzialfaktor Arbeitskraft zu stabilisieren", "ausschließlich der Finanzebene", "gar keiner der Transformationsebenen"], correctIndex: 1, explanation: "BGM zielt auf Qualifikation, Regeneration und Arbeitsfähigkeit als Teil des Inputs 'Arbeitskraft'." },
      { id: "q7", question: "Ein Objektfaktor im Sinne der Produktionsfaktorsystematik ist...", options: ["ein vom Kunden selbst bereitgestelltes Element, z. B. das zu reparierende Fahrzeug", "ein Synonym für Betriebsmittel", "ausschließlich bei Sachgütern relevant", "identisch mit einem Repetierfaktor"], correctIndex: 0, explanation: "Objektfaktoren wie das Kundenfahrzeug oder der Patient werden vom Kunden eingebracht, nicht vom Betrieb disponiert." },
      { id: "q8", question: "Welche Aussage zum Ertragsgesetz bei Substitutionalität ist richtig?", options: ["Das Verhältnis von Faktoreinsatz zu Output ist stets exakt linear", "Das Verhältnis von Faktoreinsatz zu Output ist gemäß Ertragsgesetz nicht linear", "Substitutionalität schließt jede Form von Faktoraustausch aus", "Das Ertragsgesetz gilt nur für Limitationalität"], correctIndex: 1, explanation: "Bei Substitutionalität verläuft der Zusammenhang zwischen Faktoreinsatz und Output gemäß Ertragsgesetz nicht linear." },
      { id: "q9", question: "Welche der folgenden Aussagen zu Sachgütern und Dienstleistungen ist laut Vorlesung korrekt?", options: ["Sachgüter werden meist vor dem Kundenkonsum produziert, Dienstleistungen meist simultan zum Konsum", "Dienstleistungen sind grundsätzlich lagerfähig wie Sachgüter", "Sachgüter erfordern immer eine hohe Kundenintegration", "Es gibt keinen Unterschied zwischen Sachgütern und Dienstleistungen im Output"], correctIndex: 0, explanation: "Sachgüter sind materiell und lagerfähig, Dienstleistungen meist immateriell mit simultaner Produktion und Konsum." },
      { id: "q10", question: "Informationen werden in der Vorlesung als...", options: ["irrelevanter Nebenaspekt der Produktion bezeichnet", "zunehmend als eigener Produktionsfaktor betrachtet", "ausschließlich Teil der Repetierfaktoren gezählt", "nur bei der Finanzebene berücksichtigt"], correctIndex: 1, explanation: "Neben Potenzial-, Repetier- und Objektfaktoren gewinnen Informationen zunehmend an Bedeutung als eigenständiger Produktionsfaktor." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Was beschreibt die Leistungstiefe eines Unternehmens?", options: ["Die Anzahl der Mitarbeitenden", "Den Anteil der selbst erbrachten Wertschöpfung im Verhältnis zu fremdbezogenen Vorleistungen", "Die Tiefe der Lagerhaltung", "Die Anzahl der Produktionsstandorte"], correctIndex: 1, explanation: "Leistungstiefe misst, wie viel Wertschöpfung intern versus extern erfolgt." },
      { id: "q2", question: "Welches Instrument vergleicht Fixkosten und variable Kosten der Eigenfertigung mit dem Bezugspreis, um eine kritische Menge zu ermitteln?", options: ["Break-even-Analyse", "ABC-Analyse", "Lorenzkurve", "SWOT-Analyse"], correctIndex: 0, explanation: "Die Break-even-Analyse liefert die Menge, ab der Eigenfertigung günstiger ist als Fremdbezug." },
      { id: "q3", question: "Laut Transaktionskostentheorie spricht hohe Unsicherheit (z. B. schwankende Nachfrage) eher für...", options: ["Eigenfertigung, wegen besserer Kontrolle", "Fremdbezug, wegen der Flexibilitätsvorteile des Marktes", "weder Eigenfertigung noch Fremdbezug", "eine sofortige Betriebsschließung"], correctIndex: 1, explanation: "Bei hoher Unsicherheit bietet der Markt mehr Flexibilität als eine starre interne Struktur." },
      { id: "q4", question: "Welche Kriterien werden bei einer Nutzwertanalyse für Make-or-Buy-Entscheidungen typischerweise gewichtet bewertet?", options: ["Nur der Preis", "Mehrere Zielkriterien wie Kosten, Qualität, Risiko und Kernkompetenz", "Ausschließlich das Firmenalter des Anbieters", "Nur die Anzahl der Mitarbeitenden des Lieferanten"], correctIndex: 1, explanation: "Die Nutzwertanalyse erlaubt die Berücksichtigung mehrerer, unterschiedlich gewichteter Kriterien." },
      { id: "q5", question: "Warum ist die Entscheidung, ob BGM intern oder extern organisiert wird, laut Vorlesung keine reine Kostenfrage?", options: ["Weil BGM gesetzlich immer intern sein muss", "Weil sie bestimmt, wie nachhaltig Leistungsfähigkeit und Wohlbefinden im Unternehmen verankert werden", "Weil externe Anbieter immer verboten sind", "Weil interne Lösungen immer günstiger sind"], correctIndex: 1, explanation: "Die Wahl der BGM-Organisationsform ist eine strategische Investitionsentscheidung mit langfristiger Wirkung." },
      { id: "q6", question: "Ein 'Hold-up-Problem' im Kontext von Make-or-Buy entsteht vor allem bei...", options: ["sehr standardisierten, überall verfügbaren Leistungen", "hoch spezifischen Leistungen, bei denen der Lieferant nachträglich Verhandlungsmacht ausnutzen kann", "sehr kurzfristigen Verträgen ohne jede Spezifität", "vollständiger Eigenfertigung ohne externe Partner"], correctIndex: 1, explanation: "Spezifische Investitionen erhöhen die Abhängigkeit vom Lieferanten und damit das Opportunismusrisiko." },
      { id: "q7", question: "Das Make-or-Buy-Portfolio ordnet Entscheidungen entlang welcher zwei Dimensionen an?", options: ["Preis und Farbe", "Strategische Bedeutung und Beschaffungsrisiko", "Anzahl Mitarbeitende und Umsatz", "Lagerbestand und Lieferzeit"], correctIndex: 1, explanation: "Diese zwei Dimensionen strukturieren das Make-or-Buy-Portfolio." },
      { id: "q8", question: "Hohe Leistungstiefe bedeutet tendenziell...", options: ["niedrigere Fixkosten und weniger interne Kompetenz", "mehr interne Kompetenz und Nähe zu Mitarbeitenden, aber höhere Fixkosten", "automatisch geringere Qualität", "immer den günstigsten Marktpreis"], correctIndex: 1, explanation: "Mehr Eigenfertigung bringt Nähe und Kontrolle mit sich, aber auch höhere Fixkostenbelastung." },
      { id: "q9", question: "Bei der Nutzwertanalyse werden zunächst...", options: ["nur die Kosten verglichen", "Mindestanforderungen definiert, bevor eine gewichtete Punktbewertung erfolgt", "zufällige Punkte vergeben", "ausschließlich juristische Aspekte geprüft"], correctIndex: 1, explanation: "Erst Mindestanforderungen, dann gewichtete Bewertung mehrerer Kriterien." },
      { id: "q10", question: "Im Klinik-Beispiel würde 'Billig und Mies GmbH' voraussichtlich in welchem Szenario am besten abschneiden?", options: ["Sicherheits-Szenario", "Kostenminimierungs-Szenario", "Attraktivierungs-Szenario mit Fokus auf Spitzenqualität", "In keinem Szenario"], correctIndex: 1, explanation: "Als günstiger Standardanbieter passt dieser Anbieter am besten zu einem auf Kosten fokussierten Szenario." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Welches Beschaffungsziel gehört zu den Formalzielen?", options: ["Versorgungsziel (richtige Menge, Qualität, Zeit)", "Wirtschaftlichkeitsziel (Kostenminimierung)", "Servicegrad", "Servicezeit"], correctIndex: 1, explanation: "Das Wirtschaftlichkeitsziel ist ein Formalziel; Versorgungsziel, Servicegrad und Servicezeit sind Sachziele." },
      { id: "q2", question: "Was beschreibt der Servicegrad in der Beschaffung?", options: ["Die Freundlichkeit des Lieferanten", "Die Verfügbarkeitswahrscheinlichkeit eines Beschaffungsobjekts", "Die Anzahl der Beschaffungsobjekte", "Die Höhe der Lagerkosten"], correctIndex: 1, explanation: "Der Servicegrad gibt an, mit welcher Wahrscheinlichkeit ein Bedarf gedeckt werden kann." },
      { id: "q3", question: "Zentrale Beschaffung bietet vor allem den Vorteil...", options: ["höherer Bedarfsnähe der einzelnen Abteilungen", "einheitlicher Standards und gebündelter Anforderungen (z. B. Rahmenverträge)", "vollständiger Autonomie der Fachabteilungen", "geringerer Verhandlungsmacht gegenüber Lieferanten"], correctIndex: 1, explanation: "Zentrale Beschaffung bündelt Bedarfe und ermöglicht einheitliche, oft günstigere Rahmenverträge." },
      ...
      { id: "q5", question: "Warum kann Sparen bei der Beschaffung von Arbeitsmitteln indirekt Gesundheitskosten erhöhen?", options: ["Weil billigere Materialien immer besser sind", "Weil nicht-ergonomische, minderwertige Ausstattung die Belastung der Mitarbeitenden erhöhen kann", "Weil Beschaffung nichts mit Gesundheit zu tun hat", "Weil teure Materialien gesetzlich verboten sind"], correctIndex: 1, explanation: "Schlechte Ausstattung (z. B. unergonomische Werkzeuge) kann Belastung und in der Folge Gesundheitskosten erhöhen." },
      { id: "q6", question: "Ein hybrides Beschaffungsmodell kombiniert...", options: ["nur zentrale Elemente", "zentrale strategische Standards mit dezentraler, bedarfsspezifischer Anpassung", "nur dezentrale Elemente", "Beschaffung und Vertrieb in einer Abteilung"], correctIndex: 1, explanation: "Das hybride Modell verbindet einheitliche Mindeststandards mit lokaler Flexibilität." },
      { id: "q7", question: "Welches Beschaffungsobjekt hat typischerweise einen geringen Mengen-/Wertanteil im Endprodukt, ist aber dennoch darin enthalten?", options: ["Rohstoff", "Hilfsstoff", "Betriebsmittel", "Kapital"], correctIndex: 1, explanation: "Hilfsstoffe wie Nähgarn sind im Endprodukt enthalten, aber mit geringem Mengen-/Wertanteil." },
      { id: "q8", question: "Global Sourcing bezeichnet...", options: ["den Einkauf ausschließlich im Inland", "große Volumina bei wenigen, weltweit ausgewählten Lieferanten", "den Verzicht auf jede Lieferantenbeziehung", "eine Form der Personalbeschaffung"], correctIndex: 1, explanation: "Global Sourcing bündelt Bedarfe international bei ausgewählten Lieferanten." },
      { id: "q9", question: "Der Zielkonflikt zwischen Bedarfsträger und Management in der Beschaffung besteht typischerweise zwischen...", options: ["hohem Servicegrad und niedrigen Kosten", "Personal und Kapital", "Inland und Ausland", "Qualität und Nachhaltigkeit ausschließlich"], correctIndex: 0, explanation: "Der Bedarfsträger wünscht hohe Verfügbarkeit, das Management niedrige Kosten - ein klassischer Zielkonflikt." },
      { id: "q10", question: "Welche Beschaffungsfunktion steht üblicherweise am Anfang des Beschaffungsprozesses?", options: ["Bestellabwicklung", "Bedarfsermittlung", "Lieferantenmanagement", "Wareneingangskontrolle"], correctIndex: 1, explanation: "Ohne Kenntnis des Bedarfs können die nachfolgenden Beschaffungsschritte nicht sinnvoll geplant werden." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Der Sekundärbedarf bezeichnet...", options: ["die Menge verkaufsfähiger Enderzeugnisse", "den Bedarf an Rohstoffen, Teilen und Baugruppen zur Herstellung der Enderzeugnisse", "nur den Bedarf an Hilfsstoffen", "den bereits gedeckten Lagerbestand"], correctIndex: 1, explanation: "Sekundärbedarf leitet sich aus dem Primärbedarf über die Stückliste ab." },
      { id: "q2", question: "Wie berechnet sich der Nettobedarf?", options: ["Bruttobedarf plus Lagerbestand", "Bruttobedarf minus Lagerbestand minus laufende Bestellungen plus Vormerkbedarf", "Primärbedarf mal Anzahl der Artikel", "Bruttobedarf geteilt durch die Anzahl der Perioden"], correctIndex: 1, explanation: "Der Nettobedarf berücksichtigt bereits vorhandene und zugesagte Mengen." },
      { id: "q3", question: "A-Güter in der ABC-Analyse zeichnen sich aus durch...", options: ["hohen Mengenanteil, aber geringen Wertanteil", "geringen Mengenanteil, aber hohen Wertanteil", "gleich hohen Mengen- und Wertanteil", "keinerlei Priorität in der Disposition"], correctIndex: 1, explanation: "A-Güter machen typischerweise nur 10-20% der Menge, aber 60-80% des Werts aus." },
      { id: "q4", question: "Welche Bedarfsermittlungsmethode basiert auf dem historischen Verbrauch?", options: ["Programmorientierte Bedarfsermittlung", "Verbrauchsorientierte Bedarfsermittlung", "Deduktive Ermittlung", "Nutzwertanalyse"], correctIndex: 1, explanation: "Die verbrauchsorientierte Methode nutzt Vergangenheitswerte zur Prognose." },
      { id: "q5", question: "Warum wird Personal in der Vorlesung explizit als 'Sicherheitsbestand' bezeichnet?", options: ["Weil Personal wie Lagerbestände eingelagert werden kann", "Weil fehlende Personalpuffer zu chronischer Überlastung führen können, ähnlich wie fehlende Sicherheitsbestände bei Material", "Weil Personal keine Rolle in der Bedarfsplanung spielt", "Weil Personal immer im Überfluss vorhanden ist"], correctIndex: 1, explanation: "Analog zu Materialbeständen wirken Personalpuffer stabilisierend gegen Belastungsspitzen." },
      { id: "q6", question: "Was ist der Hauptzweck der ABC-Analyse?", options: ["Alle Artikel gleich intensiv zu bearbeiten", "Knappe Dispositionsressourcen gezielt auf die wertmäßig bedeutsamsten Artikel zu konzentrieren", "Nur die Lagerhaltungskosten zu berechnen", "Lieferanten zu bewerten"], correctIndex: 1, explanation: "Die ABC-Analyse priorisiert die Materialdisposition nach Wertigkeit." },
      { id: "q7", question: "Der Tertiärbedarf bezieht sich auf...", options: ["die verkaufsfähigen Enderzeugnisse", "Hilfs- und Betriebsstoffe", "ausschließlich Personal", "den Lagerbestand am Jahresende"], correctIndex: 1, explanation: "Tertiärbedarf ist der abgeleitete Bedarf an Hilfs- und Betriebsstoffen." },
      { id: "q8", question: "Wie wird die ABC-Analyse grafisch typischerweise dargestellt?", options: ["Als Tortendiagramm", "Als Lorenzkurve (kumulierte Wert- vs. Mengenanteile)", "Als Histogramm", "Als Netzdiagramm"], correctIndex: 1, explanation: "Die kumulierten Anteile werden klassischerweise als Lorenzkurve dargestellt." },
      { id: "q9", question: "Eine Überdeckung bei der Personalbedarfsermittlung führt tendenziell zu...", options: ["Überstunden und Zeitdruck", "Leerlauf und Motivationsverlust", "höherer Produktivität automatisch", "keinen Auswirkungen"], correctIndex: 1, explanation: "Zu viel eingeplantes Personal führt zu Leerlaufzeiten, was die Motivation senken kann." },
      { id: "q10", question: "Programmorientierte Bedarfsermittlung stützt sich rechnerisch vor allem auf...", options: ["die Stückliste", "reine Schätzungen ohne Datengrundlage", "nur die Lagerkapazität", "das Wetter"], correctIndex: 0, explanation: "Über die Stückliste wird der Bedarf an Teilen/Baugruppen aus dem Produktionsprogramm abgeleitet." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Welche Sourcing-Strategie konzentriert sich bewusst auf genau einen Lieferanten?", options: ["Double Sourcing", "Single Sourcing", "Multiple Sourcing", "Modular Sourcing"], correctIndex: 1, explanation: "Single Sourcing bedeutet die Beschränkung auf einen einzigen Lieferanten." },
      { id: "q2", question: "Der größte Nachteil von Single Sourcing ist:", options: ["zu geringe Preiszugeständnisse", "hohe Abhängigkeit und Risiko bei Lieferausfall", "zu hoher Koordinationsaufwand mit vielen Lieferanten", "fehlende Möglichkeit zur Qualitätskontrolle"], correctIndex: 1, explanation: "Die Konzentration auf einen Lieferanten erhöht das Abhängigkeitsrisiko erheblich." },
      { id: "q3", question: "Ein Qualitätsaudit als Bewertungsinstrument kann sich beziehen auf...", options: ["nur auf den Preis eines Lieferanten", "Verfahren, Produkte oder das gesamte Qualitätsmanagementsystem", "ausschließlich die Finanzberichte des Lieferanten", "die Anzahl der Mitarbeitenden des Lieferanten"], correctIndex: 1, explanation: "Verfahrens-, Produkt- und System-Audit sind die drei genannten Auditarten." },
      { id: "q4", question: "Die 'Wertebene' der Lieferanten-Abnehmer-Beziehung bezieht sich vor allem auf...", options: ["die vertragliche/verfügungsrechtliche Beziehung zwischen den Parteien", "nur den physischen Warenfluss", "die persönliche Sympathie zwischen Einkäufern", "die Werbung des Lieferanten"], correctIndex: 0, explanation: "Die Wertebene betrachtet Verfügungsrechte, Verträge und Zusicherungen." },
      { id: "q5", question: "Modular Sourcing setzt typischerweise voraus...", options: ["möglichst viele unabhängige Einzellieferanten", "eine enge Entwicklungspartnerschaft mit dem Systemlieferanten", "den vollständigen Verzicht auf Lieferantenbewertung", "ausschließlich Lagerproduktion"], correctIndex: 1, explanation: "Da der Lieferant komplette Baugruppen entwickelt und liefert, ist eine enge Partnerschaft nötig." },
      { id: "q6", question: "Warum ist die Wahl ergonomischer, sicherer Produkte laut Vorlesung explizit eine Lieferantenentscheidung mit Gesundheitsbezug?", options: ["Weil Lieferanten keinen Einfluss auf Arbeitsbedingungen haben", "Weil die gelieferten Materialien/Arbeitsmittel unmittelbar die Belastung der Mitarbeitenden beeinflussen", "Weil das nur die Personalabteilung betrifft", "Weil ergonomische Produkte immer teurer sind"], correctIndex: 1, explanation: "Die Qualität der bezogenen Arbeitsmittel wirkt sich direkt auf Sicherheit und Belastung am Arbeitsplatz aus." },
      { id: "q7", question: "Double Sourcing bedeutet im Vergleich zu Single Sourcing...", options: ["Konzentration auf einen Lieferanten", "Verteilung des Bedarfs auf zwei Lieferanten, was Preisvergleich ermöglicht, aber mehr Aufwand erzeugt", "den vollständigen Verzicht auf Lieferantenauswahl", "ausschließlich internationale Lieferanten"], correctIndex: 1, explanation: "Zwei Lieferanten ermöglichen Wettbewerb, erhöhen aber Vertragsmanagement-Aufwand." },
      { id: "q8", question: "Die Lieferantendatei dient vor allem dazu...", options: ["Informationen zu Qualität, Liefertreue und Finanzsituation systematisch zu sammeln", "ausschließlich Kontaktdaten zu speichern", "Lieferanten automatisch zu sperren", "den Beschaffungspreis festzulegen"], correctIndex: 0, explanation: "Sie bündelt alle relevanten Bewertungsinformationen zu einem Lieferanten." },
      { id: "q9", question: "Ein 'Abbruchkandidat' in der Lieferanten-Lebenszyklus-Phase ist ein Lieferant, der...", options: ["gerade erst vorausgewählt wurde", "auf dem Weg zur endgültigen Beendigung der Lieferbeziehung ist", "der wichtigste strategische Partner ist", "automatisch wieder freigegeben wird"], correctIndex: 1, explanation: "Der Abbruchkandidat-Status markiert das Ende einer Lieferbeziehung." },
      { id: "q10", question: "Welche Sourcing-Strategie zielt explizit auf die Stimulierung von Wettbewerb zwischen mehreren Lieferanten ab?", options: ["Single Sourcing", "Multiple Sourcing", "Modular Sourcing ausschließlich", "keine der genannten"], correctIndex: 1, explanation: "Multiple Sourcing verteilt den Bedarf bewusst auf mehrere Lieferanten, um Wettbewerb zu fördern." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Der Meldebestand ist definiert als...", options: ["die maximale Lagerkapazität", "Mindestbestand plus Verbrauch während der Wiederbeschaffungszeit", "der niedrigste jemals erreichte Lagerbestand", "identisch mit dem Höchstbestand"], correctIndex: 1, explanation: "Bei Erreichen des Meldebestands muss spätestens eine neue Bestellung ausgelöst werden." },
      { id: "q2", question: "Bestellfixe Kosten sind Kosten, die...", options: ["mit der Bestellmenge linear steigen", "unabhängig von der Bestellmenge anfallen (z. B. Administration)", "nur bei sehr großen Bestellungen entstehen", "identisch mit Lagerhaltungskosten sind"], correctIndex: 1, explanation: "Bestellfixe Kosten fallen pro Bestellvorgang an, unabhängig von der bestellten Menge." },
      { id: "q3", question: "Die Andlersche Formel dient zur Berechnung...", options: ["des Meldebestands", "der optimalen Bestellmenge", "der Servicegrad-Kosten-Kurve", "des Gini-Koeffizienten"], correctIndex: 1, explanation: "Sie minimiert die Summe aus bestellfixen und bestellvariablen Kosten." },
      { id: "q4", question: "Das Bestellpunktverfahren ist...", options: ["zeitgesteuert mit festen Bestellterminen", "mengengesteuert - Bestellung bei Unterschreiten des Meldebestands", "nur für Dienstleistungen anwendbar", "identisch mit dem Bestellrhythmusverfahren"], correctIndex: 1, explanation: "Das Bestellpunktverfahren reagiert auf den Lagerbestand, nicht auf feste Zeitpunkte." },
      { id: "q5", question: "Die XYZ-Analyse klassifiziert Materialien nach...", options: ["ihrem Wertanteil", "der Vorhersehbarkeit/Regelmäßigkeit ihres Verbrauchs", "ihrer Lagertemperatur", "ihrem Herkunftsland"], correctIndex: 1, explanation: "X = regelmäßig, Y = saisonal, Z = unregelmäßig - jeweils bezogen auf die Verbrauchsvorhersehbarkeit." },
      { id: "q6", question: "Warum kann Digitalisierung im Bestellwesen laut Vorlesung 'digitalen Stress' erzeugen?", options: ["Weil digitale Systeme nie Fehler haben", "Weil permanente Echtzeitkontrolle und mögliche Systemfehler psychischen Druck erhöhen können, trotz Entlastung bei Routinetätigkeiten", "Weil digitale Bestellungen gesetzlich verboten sind", "Weil Digitalisierung immer die Kosten senkt, ohne Nachteile"], correctIndex: 1, explanation: "Digitalisierung wirkt zweischneidig: Entlastung bei Routine, aber neue Belastung durch Kontrolle und Störanfälligkeit." },
      ...
      { id: "q8", question: "Bestellvariable Kosten verhalten sich wie?", options: ["Sie sind unabhängig von der Bestellmenge", "Sie steigen mit der Bestellmenge (z. B. Zins-/Lagerhaltungskosten)", "Sie sinken immer mit steigender Menge", "Sie existieren nur bei Dienstleistungen"], correctIndex: 1, explanation: "Je mehr auf einmal bestellt wird, desto höher die Kapitalbindung und Lagerhaltungskosten." },
      { id: "q9", question: "Just-in-Time-Strategien erhöhen laut Vorlesung typischerweise...", options: ["nur die Kosten ohne jeden Vorteil", "die Effizienz, aber auch die Stressanfälligkeit bei Störungen", "ausschließlich die Sicherheit der Versorgung", "die Lagerbestände"], correctIndex: 1, explanation: "JIT reduziert Lagerkosten, macht den Prozess aber störanfälliger." },
      { id: "q10", question: "Y-Güter in der XYZ-Analyse zeichnen sich aus durch...", options: ["regelmäßigen, gut vorhersehbaren Verbrauch", "saisonalen Verbrauch", "völlig unregelmäßigen, unvorhersehbaren Verbrauch", "keinerlei Verbrauch"], correctIndex: 1, explanation: "Y-Güter liegen zwischen den gut vorhersehbaren X-Gütern und den unregelmäßigen Z-Gütern." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Das Gesetz von Little lautet:", options: ["$I = R \\cdot T$", "$I = R + T$", "$I = R - T$", "$I = R / T^2$"], correctIndex: 0, explanation: "Bestand ist das Produkt aus Output-Rate und Durchlaufzeit." },
      { id: "q2", question: "Die Output-Rate $R$ beschreibt...", options: ["die Menge an Einheiten aktuell im Prozess", "die Menge, die den Prozess je Zeiteinheit verlässt", "die Zeit, die eine Einheit im Prozess verbringt", "die Anzahl der Maschinen"], correctIndex: 1, explanation: "R ist der Durchsatz - Output je Zeiteinheit." },
      ...
      { id: "q4", question: "Massenproduktion unterscheidet sich von Serienproduktion vor allem dadurch, dass sie...", options: ["zeitlich unbegrenzt und ohne Umrüstung auf andere Produkte läuft", "immer nur ein einzelnes Stück produziert", "ausschließlich für Dienstleistungen gilt", "keine Automatisierung nutzt"], correctIndex: 0, explanation: "Massenproduktion läuft dauerhaft ohne notwendige Umrüstung, Serienproduktion für begrenzte Zeit mit anschließender Umrüstung." },
      { id: "q5", question: "Das Funktionsprinzip (Verrichtungsprinzip) in der Produktionsorganisation bedeutet:", options: ["Alle Arbeitsgänge zur Rundumbearbeitung eines Objekts werden zusammengefasst", "Gleichartige Arbeitssysteme werden räumlich/organisatorisch zusammengefasst", "Es gibt keine Struktur in der Fertigung", "Nur ein einziger Arbeitsschritt existiert"], correctIndex: 1, explanation: "Das Gegenstück ist das Objektprinzip mit Rundumbearbeitung." },
      { id: "q6", question: "Warum kann taktgebundene Fließfertigung gesundheitlich belastend sein?", options: ["Weil sie zu viel Autonomie bietet", "Weil sie monotone Belastung durch repetitive, streng getaktete Arbeit erzeugen kann", "Weil sie nie zu Zeitdruck führt", "Weil sie ausschließlich in Büros stattfindet"], correctIndex: 1, explanation: "Die enge Taktbindung kann zu einseitiger, monotoner Belastung führen." },
      { id: "q7", question: "Eine divergierende Erzeugnisstruktur liegt vor, wenn...", options: ["ein Produkt maximal einen Vorgänger hat", "ein Produkt aus mehreren Einzelteilen besteht", "ein Produkt mehrere Nachfolger hat", "keine Struktur erkennbar ist"], correctIndex: 2, explanation: "Divergierend bedeutet, dass aus einem Ausgangsteil mehrere unterschiedliche Endprodukte entstehen können (z. B. eine Zündkerze für mehrere Motortypen)." },
      { id: "q8", question: "Werkstattfertigung (Objektprinzip) bietet im Vergleich zur Fließfertigung typischerweise...", options: ["weniger Autonomie, aber geringere Koordinationsanforderungen", "mehr Autonomie, aber auch höhere Koordinationsanforderungen", "keinerlei Unterschiede zur Fließfertigung", "ausschließlich Nachteile"], correctIndex: 1, explanation: "Werkstattfertigung erlaubt mehr Gestaltungsspielraum, erfordert aber mehr Abstimmung." },
      { id: "q9", question: "Warum reduzieren Pufferkapazitäten laut Vorlesung die Fehlerquote?", options: ["Weil sie Belastungsspitzen abfedern und damit Stress und Hetze verringern", "Weil sie automatisch die Maschinen reparieren", "Weil sie den Materialpreis senken", "Puffer haben keinen Einfluss auf Fehlerquoten"], correctIndex: 0, explanation: "Weniger Zeitdruck durch Puffer senkt die Wahrscheinlichkeit von Fehlern." },
      { id: "q10", question: "Eine konvergierende Erzeugnisstruktur liegt zum Beispiel vor bei...", options: ["der Herstellung eines Telefons aus vielen Einzelteilen", "einem Holzlöffel aus einem einzigen Holzstück", "einer Zündkerze für mehrere Motortypen", "einem Produkt ohne Vorgänger"], correctIndex: 0, explanation: "Konvergierend bedeutet, dass mehrere Teile zu einem Endprodukt zusammengeführt werden." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Das Uno-actu-Prinzip beschreibt...", options: ["die Lagerfähigkeit von Dienstleistungen", "die Gleichzeitigkeit von Produktion und Konsum einer Dienstleistung", "eine Preisstrategie", "ein Qualitätssiegel"], correctIndex: 1, explanation: "Dienstleistungen werden im selben Moment produziert und konsumiert." },
      ...
      { id: "q3", question: "Die 'Integration des externen Faktors' bei Dienstleistungen bedeutet:", options: ["Der Kunde bzw. sein Objekt ist integraler Bestandteil des Erstellungsprozesses", "Externe Berater erstellen die Dienstleistung", "Die Dienstleistung wird komplett automatisiert erbracht", "Kunden haben keinen Einfluss auf die Leistung"], correctIndex: 0, explanation: "Ohne die Mitwirkung des Kunden (oder seines Objekts) kann die Dienstleistung oft nicht erbracht werden." },
      { id: "q4", question: "Warum ist Kapazitätsplanung bei Dienstleistungen besonders anspruchsvoll?", options: ["Weil Dienstleistungen beliebig lagerbar sind", "Weil mangels Lagerpuffer Nachfrage und Kapazität synchronisiert werden müssen", "Weil es bei Dienstleistungen keine Nachfrageschwankungen gibt", "Weil Kapazitätsplanung bei Dienstleistungen gesetzlich verboten ist"], correctIndex: 1, explanation: "Ohne Lagerpuffer muss die Kapazität möglichst genau der schwankenden Nachfrage entsprechen." },
      { id: "q5", question: "Individuelle Bedienung (z. B. Arztbesuch) und Selbstbedienung (z. B. Getränkeautomat) unterscheiden sich nach...", options: ["dem Grad des Kundenkontakts", "der Lagerfähigkeit", "dem Rohstoffverbrauch", "der Rechtsform des Anbieters"], correctIndex: 0, explanation: "Diese Einteilung bezieht sich auf die Intensität und Form des Kundenkontakts." },
      { id: "q6", question: "Warum ist integrative Gesundheitsförderung in Dienstleistungsorganisationen laut Vorlesung 'kein Zusatz, sondern Voraussetzung stabiler Wertschöpfung'?", options: ["Weil Gesundheitsförderung nichts kostet", "Weil Personal als dominanter, engpassanfälliger Faktor direkt über die Stabilität der Leistungserstellung entscheidet", "Weil es gesetzlich vorgeschrieben ist", "Weil Dienstleistungen ohnehin nie unter Druck stehen"], correctIndex: 1, explanation: "Da Personal der zentrale Engpassfaktor ist und Belastung unmittelbar durchschlägt, ist seine Gesunderhaltung strukturell für die Wertschöpfung selbst entscheidend." },
      { id: "q7", question: "Warum ist Qualitätskontrolle bei Dienstleistungen schwieriger als bei Sachgütern?", options: ["Weil Dienstleistungen billiger sind", "Weil die Qualität stark personenabhängig ist und subjektiv während der Leistungserbringung wahrgenommen wird, statt im Nachhinein prüfbar zu sein", "Weil Dienstleistungen nie Fehler haben", "Weil es bei Dienstleistungen keine Kunden gibt"], correctIndex: 1, explanation: "Anders als bei Sachgütern lässt sich die Qualität nicht vor der Auslieferung isoliert prüfen." },
      { id: "q8", question: "Emotionale Arbeit im Sinne der Vorlesung entsteht besonders bei...", options: ["Selbstbedienungsautomaten", "hoher Kundenintegration wie in Pflege oder Beratung", "reiner Sachgüterproduktion", "vollautomatisierten Fertigungsstraßen"], correctIndex: 1, explanation: "Direkter, intensiver Kundenkontakt erzeugt zusätzliche emotionale Beanspruchung." },
      { id: "q9", question: "Warum können bei Dienstleistungen Kapazitätsengpässe nicht wie bei Sachgütern durch Lagerbestände abgefedert werden?", options: ["Weil Dienstleistungen nicht lagerfähig sind (Uno-actu-Prinzip)", "Weil Dienstleistungen zu billig sind", "Weil es bei Dienstleistungen keine Nachfrage gibt", "Weil Lagerhaltung gesetzlich verboten ist"], correctIndex: 0, explanation: "Da Produktion und Konsum zeitlich zusammenfallen, kann nicht auf Vorrat produziert werden." },
      { id: "q10", question: "Resilientes Kapazitätsmanagement in Dienstleistungsorganisationen umfasst laut Vorlesung unter anderem...", options: ["Mehrfachqualifikation, zeitliche Flexibilisierung und Puffer statt Maximalauslastung", "ausschließlich Personalabbau", "die vollständige Automatisierung aller Kundenkontakte", "die Abschaffung von Pausenzeiten"], correctIndex: 0, explanation: "Diese Maßnahmen reduzieren das Burnout-Risiko und stabilisieren die Wertschöpfung." }
    ]
  },
  {
    ...
    quiz: [
      { id: "q1", question: "Welche sechs inhaltlichen Bausteine bilden den roten Faden der Wertschöpfungskette?", options: ["Beschaffung, Bedarfsermittlung, Lieferantenmanagement, Bestellung, Produktion, Dienstleistung", "Planung, Kontrolle, Steuerung, Organisation, Führung, Bewertung", "Marketing, Vertrieb, Service, Finanzen, Personal, IT", "Nur Produktion und Dienstleistung"], correctIndex: 0, explanation: "Diese sechs Bausteine bilden die chronologische Kette der Wertschöpfung." },
      { id: "q2", question: "Was liefert die Wertschöpfungskette im Vergleich zum Prozessmanagement-Strang?", options: ["Dieselbe abstrakte Steuerungslogik ohne inhaltlichen Unterschied", "Die konkreten inhaltlichen Bausteine, die die Steuerungslogik des Prozessmanagements ausfüllen", "Ausschließlich rechtliche Vorgaben", "Keinen Zusammenhang zum Prozessmanagement"], correctIndex: 1, explanation: "Prozessmanagement liefert die Steuerungslogik, die Wertschöpfungskette die inhaltlichen Funktionen." },
      ...
      { id: "q4", question: "Warum reicht laut Fazit-Kapitel weder eine rein marktorientierte noch eine rein ressourcenorientierte Perspektive auf Wertschöpfung allein aus?", options: ["Weil beide Perspektiven identisch sind", "Weil erst die Integration beider sicherstellt, dass Wertschöpfung sowohl marktfähig als auch mit vorhandenen Ressourcen leistbar ist", "Weil nur die Marktorientierung überhaupt relevant ist", "Weil Ressourcenorientierung gesetzlich vorgeschrieben ist"], correctIndex: 1, explanation: "Beide Perspektiven ergänzen sich - wie bereits im Prozessmanagement-Strang erläutert." },
      { id: "q5", question: "Welches Beispiel zeigt die 'Doppelwirkung von Effizienzinstrumenten' entlang der Wertschöpfungskette am deutlichsten?", options: ["Just-in-Time-Bestellungen, die Effizienz schaffen, aber die Störanfälligkeit erhöhen", "Die Wahl des Firmensitzes", "Die Anzahl der Feiertage im Jahr", "Die Struktur des Organigramms"], correctIndex: 0, explanation: "JIT ist das zentrale Beispiel für gleichzeitig positive und negative Effizienzwirkungen." },
      { id: "q6", question: "'Strukturelle statt additive Gesundheitsförderung' zeigt sich in der Wertschöpfungskette zum Beispiel durch...", options: ["ein separates Wellness-Zusatzprogramm ohne Bezug zu Prozessen", "ergonomische Arbeitsmittel in der Beschaffung und Pufferkapazitäten in der Produktion", "den Verzicht auf jede Gesundheitsmaßnahme", "ausschließlich finanzielle Boni"], correctIndex: 1, explanation: "Gesundheitsförderung ist in jeder Gestaltungsentscheidung entlang der Kette mitgedacht, nicht nachträglich angehängt." }
    ]
  }
];
