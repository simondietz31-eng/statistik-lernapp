const NATWISS_CHAPTER1_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Verdoppelt sich der Bremsweg eines Autos, wenn die Anfangsgeschwindigkeit bei gleicher Bremsverzögerung verdoppelt wird?", correctAnswer: false, reasons: ["Nein, weil der Bremsweg laut s = v₀²/(2a) quadratisch von der Geschwindigkeit abhängt und sich daher vervierfacht.", "Ja, weil der Bremsweg proportional zur Geschwindigkeit ist, ähnlich wie bei gleichförmiger Bewegung.", "Nein, weil sich die Bremsverzögerung a bei höherer Geschwindigkeit automatisch verdoppelt.", "Ja, weil sich Bremsweg und Bremszeit stets im gleichen Verhältnis wie die Geschwindigkeit ändern."], correctReasonIndex: 0, explanation: "Aus s = v₀²/(2·|a|) folgt eine quadratische Abhängigkeit vom Anfangsgeschwindigkeit: Bei doppeltem v₀ vervierfacht sich der Bremsweg statt sich nur zu verdoppeln." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Gibt die Avogadro-Konstante die Anzahl der Teilchen in einem Kilogramm eines beliebigen Stoffes an?", correctAnswer: false, reasons: ["Nein, weil N_A die Teilchenzahl pro Mol angibt, nicht pro Kilogramm – welche Masse einem Mol entspricht, hängt von der molaren Masse des Stoffes ab.", "Ja, weil ein Mol per Definition genau einem Kilogramm eines beliebigen Stoffes entspricht.", "Nein, weil sich N_A nur auf gasförmige Stoffe bezieht, nicht auf feste oder flüssige.", "Ja, weil die Avogadro-Konstante direkt aus der Masse eines Kilogramms Kohlenstoff berechnet wird."], correctReasonIndex: 0, explanation: "N_A = 6,022·10²³ mol⁻¹ gibt die Teilchenzahl pro Mol an, unabhängig von der Masse; welche Masse einem Mol entspricht, hängt von der molaren Masse des jeweiligen Stoffes ab (z. B. 18 g/mol bei Wasser)." },
