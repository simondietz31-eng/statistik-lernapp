const NATWISS_CHAPTER1_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Verdoppelt sich der Bremsweg eines Autos, wenn die Anfangsgeschwindigkeit bei gleicher Bremsverzögerung verdoppelt wird?", correctAnswer: false, reasons: ["Nein, weil der Bremsweg s = v₀²/(2a) quadratisch von v₀ abhängt und sich daher vervierfacht.", "Ja, weil der Bremsweg proportional zur Geschwindigkeit ist, ähnlich wie bei gleichförmiger Bewegung.", "Nein, weil sich die Bremsverzögerung a bei höherer Geschwindigkeit wegen des größeren Fahrbahnwiderstands automatisch verdoppelt.", "Ja, weil sich Bremsweg und Bremszeit stets im gleichen Verhältnis wie die Geschwindigkeit ändern."], correctReasonIndex: 0, explanation: "Aus s = v₀²/(2·|a|) folgt eine quadratische Abhängigkeit vom Anfangsgeschwindigkeit: Bei doppeltem v₀ vervierfacht sich der Bremsweg statt sich nur zu verdoppeln." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Hat ein Punkt am Pol der Erde aufgrund der Erdrotation dieselbe Bahngeschwindigkeit wie ein Punkt am Äquator?", correctAnswer: false, reasons: ["Nein, weil die Bahngeschwindigkeit v = ω·r vom Abstand r zur Drehachse abhängt und dieser am Pol praktisch null ist.", "Ja, weil alle Punkte der Erde dieselbe Winkelgeschwindigkeit ω besitzen und das allein die Bahngeschwindigkeit bestimmt.", "Nein, weil am Pol die Erdanziehungskraft geringer ist als am Äquator.", "Ja, weil die Bahngeschwindigkeit nur von der Umlaufzeit T abhängt, die überall auf der Erde gleich ist."], correctReasonIndex: 0, explanation: "Die Bahngeschwindigkeit v = ω·r hängt vom Abstand r zur Drehachse ab; am Pol ist r ≈ 0, sodass v_Pol ≈ 0 ist, während am Äquator v ≈ 463 m/s beträgt – trotz gleicher Winkelgeschwindigkeit ω." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Gibt die Avogadro-Konstante die Anzahl der Teilchen in einem Kilogramm eines beliebigen Stoffes an?", correctAnswer: false, reasons: ["Nein, weil N_A die Teilchenzahl pro Mol angibt, nicht pro Kilogramm; die Molmasse legt die Masse fest.", "Ja, weil ein Mol nach der SI-Definition stets genau einem Kilogramm eines beliebigen Stoffes entsprechen soll.", "Nein, weil sich N_A historisch nur auf gasförmige Stoffe bezieht, nicht auf feste oder flüssige Substanzen.", "Ja, weil die Avogadro-Konstante direkt aus der Masse eines Kilogramms Kohlenstoff berechnet wird."], correctReasonIndex: 0, explanation: "N_A = 6,022·10²³ mol⁻¹ gibt die Teilchenzahl pro Mol an, unabhängig von der Masse; welche Masse einem Mol entspricht, hängt von der molaren Masse des jeweiligen Stoffes ab (z. B. 18 g/mol bei Wasser)." },
