const NATWISS_CHAPTER13_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "natwiss-wechselstrom-q4", question: "Ein Transformator erhöht die Spannung von 230 V auf 11500 V. Wie ist das Windungszahlverhältnis N₁/N₂?", options: ["1/50, aus dem Windungsverhältnis N₂/N₁", "1/100, bei falscher Rechnung", "100, als Kehrwert vertauscht", "50, ohne Kehrwertbildung"], correctIndex: 0, explanation: "Da N₁/N₂ = U₁/U₂ gilt, folgt N₁/N₂ = 230/11500 = 1/50 — die Primärseite hat 50-mal weniger Windungen als die Sekundärseite, passend zur Spannungserhöhung. Ein Wert größer als 1 würde fälschlich eine Spannungsreduktion implizieren." },
      { id: "natwiss-wechselstrom-q5", question: "Was ist der Leistungsfaktor cos φ bei einem reinen Widerstand?", options: ["1, bei rein ohmscher Last (φ = 0°)", "0,5, wie bei einer Phasenverschiebung von 60°", "1/√2, wie bei 45° Phasenverschiebung", "0, wie bei reiner Blindleistung"], correctIndex: 0, explanation: "An einem reinen Widerstand sind Strom und Spannung stets phasengleich (φ = 0), sodass cos φ = 1 gilt und die gesamte Scheinleistung als Wirkleistung genutzt wird. Bei Spulen oder Kondensatoren tritt dagegen eine Phasenverschiebung auf, die cos φ unter 1 senkt." },
      { id: "natwiss-wechselstrom-q6", question: "Bei welcher Frequenz tritt Resonanz in einem R-L-C-Reihenschwingkreis auf?", options: ["f₀ = 1/(2πRC), mit R statt L im Nenner", "f₀ = R/(2πL), als falsche Kombination", "f₀ = 1/(2π√(LC)), die Thomsonsche Schwingungsformel", "f₀ = 2π√(LC), mit vertauschtem Kehrwert"], correctIndex: 2, explanation: "Resonanz liegt vor, wenn sich die Impedanzen von Spule und Kondensator gerade aufheben, Z_L = Z_C, also ω₀L = 1/(ω₀C). Daraus folgt ω₀ = 1/√(LC) und somit f₀ = 1/(2π√(LC)) — der Widerstand R geht in diese Resonanzbedingung gar nicht ein." },
      { id: "natwiss-wechselstrom-q7", question: "Wie groß ist die Impedanz einer idealen Spule bei Gleichstrom (f = 0)?", options: ["Der Wert ωL, unabhängig von f", "0, im Resonanzfall", "Unendlich groß, wie bei einem Kondensator", "Gleich der Induktivität L selbst"], correctIndex: 1, explanation: "Bei f = 0 ist auch ω = 2πf = 0, wodurch Z_L = ωL ebenfalls null wird — eine ideale Spule leitet Gleichstrom also völlig widerstandslos. Ein unendlich großer Widerstand bei Gleichstrom würde stattdessen das Verhalten eines Kondensators beschreiben." },
      { id: "yn1", type: "yesno", question: "Sperrt ein idealer Kondensator Gleichstrom (f = 0) vollständig?", correctAnswer: true, reasons: ["Ja, weil Z_C = 1/(ωC) bei f = 0 gegen unendlich strebt – ein idealer Kondensator lässt im stationären Zustand keinen Gleichstrom fließen.", "Nein, weil ein Kondensator bei jeder Frequenz, auch bei f = 0, denselben endlichen Widerstand Z_C besitzt.", "Ja, weil ein Kondensator laut einfacher Bauteillehre grundsätzlich gar keinen elektrischen Strom leiten kann, völlig unabhängig von der anliegenden Frequenz.", "Nein, weil Gleichstrom stets ungehindert durch jedes Bauelement fließt, das keinen ohmschen Widerstand besitzt."], correctReasonIndex: 0, explanation: "Z_C = 1/(ωC) wächst mit sinkender Frequenz und wird bei f = 0 (Gleichstrom) unendlich groß – im eingeschwungenen Zustand fließt daher kein Strom durch einen idealen Kondensator, während er bei hohen Frequenzen nahezu widerstandslos wirkt." },
  ...
  },
  {
    ...
    quiz: [
      { id: "natwiss-em-q1", question: "Was ist die Resonanzfrequenz eines LC-Schwingkreises?", options: ["f₀ = 1/(2π√(LC)), die Thomsonsche Schwingungsformel", "f₀ = √(LC)/(2π), mit vertauschtem Kehrwert", "f₀ = 2π/(LC), ohne Wurzel", "f₀ = 2π√(LC), ohne Kehrwertbildung"], correctIndex: 0, explanation: "Aus ω₀ = 1/√(LC) folgt direkt f₀ = ω₀/(2π) = 1/(2π√(LC)) — analog zur mechanischen Schwingung, bei der Masse und Federkonstante die Frequenz bestimmen, übernehmen hier L und C diese Rolle." },
      { id: "natwiss-em-q2", question: "Mit welcher Geschwindigkeit breiten sich EM-Wellen im Vakuum aus?", options: ["3·10¹⁰ m/s, eine Zehnerpotenz zu groß", "3·10⁶ m/s, eine Zehnerpotenz zu klein", "3·10⁸ m/s, die Lichtgeschwindigkeit im Vakuum", "Es hängt von der Frequenz der Welle ab"], correctIndex: 2, explanation: "Nach c = 1/√(μ₀ε₀) ≈ 3·10⁸ m/s hängt die Ausbreitungsgeschwindigkeit im Vakuum nur von den beiden Feldkonstanten ab, nicht von der Frequenz — alle EM-Wellen, von Radiowellen bis Gammastrahlung, sind im Vakuum gleich schnell." },
      ...
      { id: "yn1", type: "yesno", question: "Ist bei maximalem Strom im LC-Schwingkreis die gesamte Energie im elektrischen Feld des Kondensators gespeichert?", correctAnswer: false, reasons: ["Nein, weil bei maximalem Strom die Kondensatorspannung null ist und die gesamte Energie im Magnetfeld der Spule steckt.", "Ja, weil im LC-Kreis die Energie unabhängig vom Zeitpunkt immer vollständig im elektrischen Feld verbleibt.", "Nein, weil bei maximalem Strom die Energie vollständig als Wärme im ohmschen Widerstand abgegeben wird.", "Ja, weil Strom und Kondensatorspannung im idealen LC-Schwingkreis laut Energieerhaltung stets zeitgleich gemeinsam ihr jeweiliges Maximum durchlaufen."], correctReasonIndex: 0, explanation: "Im idealen LC-Kreis pendelt die Energie zwischen elektrischem und magnetischem Feld; wenn der Strom maximal ist, ist die Kondensatorspannung null, sodass in diesem Moment die gesamte Energie im Magnetfeld der Spule steckt, nicht im elektrischen Feld des Kondensators." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Kann sich eine elektromagnetische Welle laut Maxwell-Gleichungen auch ohne materielles Trägermedium ausbreiten?", correctAnswer: true, reasons: ["Ja, weil sich laut Maxwell-Gleichungen ein zeitlich veränderliches E-Feld und B-Feld gegenseitig erzeugen, wodurch die Welle unabhängig von einem Trägermedium existieren kann.", "Nein, weil jede Welle laut klassischer Definition zwingend ein schwingungsfähiges materielles Medium wie Luft, Wasser oder Äther zur Ausbreitung benötigt, ohne das keine Schwingung übertragen werden kann.", "Ja, weil elektromagnetische Wellen im Gegensatz zu mechanischen Schallwellen grundsätzlich überhaupt keinerlei Energie über die Entfernung transportieren können.", "Nein, weil sich das elektrische und das magnetische Feld im Vakuum ohne ein stützendes Trägermedium sofort gegenseitig vollständig auslöschen würden."], correctReasonIndex: 0, explanation: "Die gegenseitige Erzeugung von E- und B-Feld nach den Maxwell-Gleichungen (rot E = −∂B/∂t und rot B = μ₀ε₀∂E/∂t) ermöglicht die Ausbreitung einer elektromagnetischen Welle im Vakuum, ganz ohne materielles Trägermedium – anders als bei mechanischen Wellen wie Schall." },
      { id: "natwiss-maxwell-q8", question: "Wer erkannte als Erster, dass Licht eine elektromagnetische Welle ist?", options: ["Maxwell, durch die vereinheitlichten Feldgleichungen", "Newton, durch seine Optik-Experimente", "Faraday, durch seine Induktionsversuche", "Hertz, durch experimentellen Nachweis"], correctIndex: 0, explanation: "Maxwell berechnete 1865 aus seinen Feldgleichungen c = 1/√(μ₀ε₀) ≈ 3·10⁸ m/s — identisch mit der bekannten Lichtgeschwindigkeit — und schloss daraus theoretisch, dass Licht eine elektromagnetische Welle sein muss. Hertz wies elektromagnetische Wellen später experimentell nach, bestätigte damit aber Maxwells frühere Vorhersage." },
      { id: "natwiss-maxwell-q9", question: "Wie skaliert die Intensität einer EM-Welle mit der elektrischen Feldamplitude E₀?", options: ["I ist umgekehrt proportional zu E₀", "I ist direkt proportional zu E₀", "I ist proportional zur Quadratwurzel von E₀", "I ist proportional zu E₀², da I ∝ |E|² gilt"], correctIndex: 3, explanation: "Nach I = ½·c·ε₀·E₀² hängt die Intensität quadratisch von der Feldamplitude ab — eine Verdopplung von E₀ vervierfacht also die transportierte Energie, nicht nur verdoppelt sie." },
