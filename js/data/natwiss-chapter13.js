const NATWISS_CHAPTER13_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Sperrt ein idealer Kondensator Gleichstrom (f = 0) vollständig?", correctAnswer: true, reasons: ["Ja, weil Z_C = 1/(ωC) bei f = 0 (also ω = 0) gegen unendlich strebt – ein idealer Kondensator lässt daher im stationären Zustand keinen Gleichstrom fließen.", "Nein, weil ein Kondensator bei jeder Frequenz, auch bei f = 0, denselben endlichen Widerstand Z_C besitzt.", "Ja, weil ein Kondensator grundsätzlich gar keinen Strom leiten kann, unabhängig von der Frequenz.", "Nein, weil Gleichstrom stets ungehindert durch jedes Bauelement fließt, das keinen ohmschen Widerstand besitzt."], correctReasonIndex: 0, explanation: "Z_C = 1/(ωC) wächst mit sinkender Frequenz und wird bei f = 0 (Gleichstrom) unendlich groß – im eingeschwungenen Zustand fließt daher kein Strom durch einen idealen Kondensator, während er bei hohen Frequenzen nahezu widerstandslos wirkt." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Ist bei maximalem Strom im LC-Schwingkreis die gesamte Energie im elektrischen Feld des Kondensators gespeichert?", correctAnswer: false, reasons: ["Nein, weil bei maximalem Strom die Kondensatorspannung null ist und die gesamte Schwingungsenergie stattdessen im Magnetfeld der Spule gespeichert ist.", "Ja, weil im LC-Kreis die Energie unabhängig vom Zeitpunkt immer vollständig im elektrischen Feld verbleibt.", "Nein, weil bei maximalem Strom die Energie vollständig als Wärme im ohmschen Widerstand abgegeben wird.", "Ja, weil Strom und Kondensatorspannung im LC-Kreis stets gleichzeitig ihr Maximum erreichen."], correctReasonIndex: 0, explanation: "Im idealen LC-Kreis pendelt die Energie zwischen elektrischem und magnetischem Feld; wenn der Strom maximal ist, ist die Kondensatorspannung null, sodass in diesem Moment die gesamte Energie im Magnetfeld der Spule steckt, nicht im elektrischen Feld des Kondensators." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Kann sich eine elektromagnetische Welle laut Maxwell-Gleichungen auch ohne materielles Trägermedium ausbreiten?", correctAnswer: true, reasons: ["Ja, weil sich laut Maxwell-Gleichungen ein zeitlich veränderliches E-Feld und ein zeitlich veränderliches B-Feld gegenseitig erzeugen (Faraday- und Ampère-Maxwell-Gesetz), wodurch die Welle unabhängig von einem Trägermedium existieren kann.", "Nein, weil jede Welle laut Definition ein schwingungsfähiges Medium wie Luft oder Äther zur Ausbreitung benötigt.", "Ja, weil elektromagnetische Wellen im Gegensatz zu Schallwellen überhaupt keine Energie transportieren.", "Nein, weil sich E- und B-Feld im Vakuum ohne Trägermedium sofort gegenseitig auslöschen würden."], correctReasonIndex: 0, explanation: "Die gegenseitige Erzeugung von E- und B-Feld nach den Maxwell-Gleichungen (rot E = −∂B/∂t und rot B = μ₀ε₀∂E/∂t) ermöglicht die Ausbreitung einer elektromagnetischen Welle im Vakuum, ganz ohne materielles Trägermedium – anders als bei mechanischen Wellen wie Schall." },
