const FINV_CHAPTER4_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Gewähren Vorzugsaktien in der Regel ein volles Stimmrecht?", correctAnswer: false, reasons: ["Ja, weil Vorzugsaktien stets mehr Stimmrechte als Stammaktien besitzen.", "Nein, weil Vorzugsaktien i. d. R. auf das Stimmrecht verzichten, dafür aber meist eine bevorzugte Dividende bieten.", "Ja, weil ausschließlich Vorzugsaktien überhaupt an der Börse gehandelt werden dürfen.", "Nein, weil Vorzugsaktien in Deutschland grundsätzlich verboten sind."], correctReasonIndex: 1, explanation: "Vorzugsaktien verzichten typischerweise auf das Stimmrecht, gewähren den Aktionären dafür aber meist eine höhere oder vorrangige Dividende gegenüber Stammaktien, die das volle Stimmrecht besitzen." },
  ...
  },
  {
    ...
    quiz: [
      { id: "yn1", type: "yesno", question: "Steigt das theoretisch faire KGV, wenn die erwartete Wachstumsrate bei gleichbleibender Renditeerwartung steigt?", correctAnswer: true, reasons: ["Nein, weil das faire KGV unabhängig von der erwarteten Wachstumsrate ist.", "Ja, weil der Nenner (Renditeerwartung minus Wachstumsrate) kleiner wird und das KGV dadurch rechnerisch steigt.", "Nein, weil eine höhere Wachstumsrate automatisch die Renditeerwartung im gleichen Maß senkt.", "Ja, weil die Wachstumsrate direkt mit dem Börsenkurs multipliziert wird."], correctReasonIndex: 1, explanation: "Da KGV = 1/(Renditeerwartung − Wachstumsrate), verkleinert eine steigende Wachstumsrate bei gleichbleibender Renditeerwartung den Nenner, wodurch das faire KGV steigt." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Liegt der Mischkurs nach einer Kapitalerhöhung stets unter dem alten Kurs, wenn der Ausgabepreis der neuen Aktien unter dem alten Kurs liegt?", correctAnswer: true, reasons: ["Nein, weil der Mischkurs unabhängig vom Ausgabepreis immer gleich dem alten Kurs bleibt.", "Ja, weil der Mischkurs als gewichteter Durchschnitt zwischen dem niedrigeren Ausgabepreis und dem alten Kurs liegt und diesen somit unterschreitet.", "Nein, weil das Bezugsrecht den Mischkurs automatisch über den alten Kurs anhebt.", "Ja, weil neue Aktien grundsätzlich einen höheren Nennwert als alte Aktien besitzen."], correctReasonIndex: 1, explanation: "Der Mischkurs ist ein mit den jeweiligen Aktienanzahlen gewichteter Durchschnitt aus altem Kurs und Ausgabepreis; liegt der Ausgabepreis unter dem alten Kurs, liegt auch der Mischkurs zwangsläufig unter dem alten Kurs." }
    ]
  }
];
