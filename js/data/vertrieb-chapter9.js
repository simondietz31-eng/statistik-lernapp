const VERTRIEB_CHAPTER9_TOPICS = [
  {
    ...
    quiz: [
      ...
      { id: "yn1", type: "yesno", question: "Misst Effizienz laut Vorlesung, ob das übergeordnete Ziel überhaupt erreicht wird?", correctAnswer: false, reasons: ["Nein, weil das die Definition von Effektivität ist; Effizienz misst, wie gut Ressourcen genutzt werden.", "Ja, weil Effektivität und Effizienz im Vertriebscontrolling synonym verwendet werden.", "Nein, weil Effizienz ausschließlich bei ergebnisbezogenen Zielen gemessen wird.", "Ja, weil Effizienz per Definition 'die richtigen Dinge tun' bedeutet."], correctReasonIndex: 0, explanation: "Effektivität bedeutet 'die richtigen Dinge zu tun' (Zielerreichung), Effizienz dagegen 'die Dinge richtig zu tun' (guter Ressourceneinsatz) - beide Dimensionen sind klar zu unterscheiden." },
